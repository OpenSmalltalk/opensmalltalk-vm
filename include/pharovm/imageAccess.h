...
typedef struct {
	...
	void (*imageReportProgress)(size_t totalSize, size_t currentSize, char* text);
} _FileAccessHandler;
...
#define sqImageReportProgress(totalSize, currentSize, text)	currentFileAccessHandler()->imageReportProgress(totalSize, currentSize, text)
