...
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-eem.91 uuid: d5a27862-3af2-4716-b40e-acfc86943ae7
   from
	NewspeakInterpreter VMMaker.oscog-eem.91 uuid: d5a27862-3af2-4716-b40e-acfc86943ae7
 */
static char __buildInfo[] = "NewspeakInterpreter VMMaker.oscog-eem.91 uuid: d5a27862-3af2-4716-b40e-acfc86943ae7 " __DATE__ ;
...
const char *interpreterVersion = "Newspeak Virtual Machine NewspeakInterpreter_VMMaker.oscog-eem.91";
...
;
		...
		CASE(126)
			/* dynamicSuperSendBytecode */
			{
				...
				mClassMixin = longAt(((longAt((GIV(method) + BaseHeaderSize) + (((((((usqInt) (longAt((GIV(method) + BaseHeaderSize) + (HeaderIndex << ShiftForWord)))) >> 10) & 255) - 1) + LiteralStart) << ShiftForWord))) + BaseHeaderSize) + (ValueIndex << ShiftForWord));
...
;
		...
		CASE(127)
			/* pushImplicitReceiverBytecode */
			{
				...
				mixin = longAt(((longAt((GIV(method) + BaseHeaderSize) + (((((((usqInt) (longAt((GIV(method) + BaseHeaderSize) + (HeaderIndex << ShiftForWord)))) >> 10) & 255) - 1) + LiteralStart) << ShiftForWord))) + BaseHeaderSize) + (ValueIndex << ShiftForWord));
			...
			l6:	/* end lookupMethodInDictionary: */;
				...
				object = GIV(receiver);
			l7:	/* end implicitReceiverForMixin:implementing: */;
		...
		commonSupersend:
			/* superclassSend */
			{
				...
				VM_LABEL(0superclassSend);
								GIV(lkupClass) = longAt(((longAt(((longAt((GIV(method) + BaseHeaderSize) + (((((((usqInt) (longAt((GIV(method) + BaseHeaderSize) + (HeaderIndex << ShiftForWord)))) >> 10) & 255) - 1) + LiteralStart) << ShiftForWord))) + BaseHeaderSize) + (ValueIndex << ShiftForWord))) + BaseHeaderSize) + (SuperclassIndex << ShiftForWord));
				goto commonSend;
			}
;
			BREAK;
...
;
		...
		CASE(139)
			...
			l14:	/* end explicitOuterReceiver:withObject:withMixin: */;
				longAtPointerput((localSP += BytesPerWord), object);
			}
;
			BREAK;
