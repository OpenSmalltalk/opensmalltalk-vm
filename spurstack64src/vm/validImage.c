...
{
	return (((sqInt)((usqInt)(anInteger) << 0x3F))) + (((usqInt) (((usqInt)anInteger))) >> 1);
}
...
{
	return (bytesInObject(objOop)) >= (64 /* numFreeLists */ * 8 /* allocationUnit */);
}
...
numSlotsOfAny(sqInt objOop)
{
	...
	return (numSlots == (numSlotsMask())
		? (/* begin rawOverflowSlotsOf: */
			((usqLong) (((usqInt) (((usqInt)(((sqInt)((usqInt)((longAt(objOop - BaseHeaderSize))) << 8)))))) >> 8)))
		: numSlots);
}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if ((numSlotsOfAny(objOop)) >= (numSlotsMask())) {
		...
		print(" slotc ");
		printHexnp(((usqInt) (((usqInt)(((sqInt)((usqInt)((longAt(objOop - BaseHeaderSize))) << 8)))))) >> 8);
		/* begin space */
		printChar(' ');
	}
	else {
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	min = 3;
	for (i = min, iLimiT = (64 /* numFreeLists */ - 1); i <= iLimiT; i += 1) {
