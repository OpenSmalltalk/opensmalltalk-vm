/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-eem.2934 uuid: 8fba4a5b-3424-47bb-b2de-f632bd307408
   from
	ImageLeakChecker VMMaker.oscog-eem.2934 uuid: 8fba4a5b-3424-47bb-b2de-f632bd307408
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.2934 uuid: 8fba4a5b-3424-47bb-b2de-f632bd307408 " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.2934]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	longAtput(lastWordInPastSpace, (firstEdenObject == (((eden()).start))
		? 0
		: 1));
	longAtput(lastWordInPastSpace + 4, ((sqInt)((usqInt)((numSlotsMask())) << (numSlotsHalfShift()))));
}
...
{
	return (bytesInObject(objOop)) >= (0x100);
}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (((fmt >= (firstLongFormat())) && (fmt <= ((firstByteFormat()) - 1)))) {
		for (i = 0, iLimiT = (((((num32BitUnitsOf(oop)) < 0x100) ? (num32BitUnitsOf(oop)) : 0x100)) - 1); i <= iLimiT; i += 1) {
	...
	if (fmt == (sixtyFourBitIndexableFormat())) {
		for (i = 0, iLimiT = (((((num64BitUnitsOf(oop)) < 0x100) ? (num64BitUnitsOf(oop)) : 0x100)) - 1); i <= iLimiT; i += 1) {
	...
	if (((fmt >= (firstShortFormat())) && (fmt <= ((firstShortFormat()) + 1)))) {
		for (i = 0, iLimiT = (((((num16BitUnitsOf(oop)) < 0x100) ? (num16BitUnitsOf(oop)) : 0x100)) - 1); i <= iLimiT; i += 1) {
