/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-nice.2715 uuid: 78e2f556-9829-42fe-963d-e19dfc43c0e9
   from
	ImageLeakChecker VMMaker.oscog-nice.2715 uuid: 78e2f556-9829-42fe-963d-e19dfc43c0e9
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-nice.2715 uuid: 78e2f556-9829-42fe-963d-e19dfc43c0e9 " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-nice.2715]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	for (i = 0, iLimiT = (0x1F); i <= iLimiT; i += 1) {
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	unusedBits = (1U << 22 /* classIndexFieldWidth */) | (1ULL << (54));
...
{
	return (bytesInObject(objOop)) >= (256);
}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	totalFreeBytes = 0;
	for (i = 1, iLimiT = (0x1F); i <= iLimiT; i += 1) {
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	min = 2;
	for (i = min, iLimiT = (0x1F); i <= iLimiT; i += 1) {
