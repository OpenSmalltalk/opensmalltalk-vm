openssl_spec_download_url:=https://www.openssl.org/source/openssl-1.0.2m.tar.gz
openssl_spec_archive_name:=openssl-1.0.2m.tar.gz
openssl_spec_unpack_dir_name:=openssl-1.0.2m
