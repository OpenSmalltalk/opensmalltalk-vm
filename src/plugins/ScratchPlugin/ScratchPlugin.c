/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.787 uuid: 4b38ebc1-339f-4523-a9fc-047923108211
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.787 uuid: 4b38ebc1-339f-4523-a9fc-047923108211 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ScratchPlugin VMMaker.oscog-eem.787 (i)"
#else
	"ScratchPlugin VMMaker.oscog-eem.787 (e)"
#endif
;
...
interpolatedFromxywidthheight(unsigned int *bitmap, sqInt xFixed, sqInt yFixed, sqInt w, sqInt h)
{
	...
	if (xFrac > 0) {
		...
		frac1 = 1024 - xFrac;
		r = ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
		g = ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
	...
	if (xFrac > 0) {
		...
		frac11 = 1024 - xFrac;
		r1 = ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
		g1 = ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
		b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 1024 - xFrac;
				r1 = ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
				g = ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
				b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
			...
			if (xFrac > 0) {
				...
				frac11 = 1024 - xFrac;
				r2 = ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
				g1 = ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
				b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
			...
			frac12 = 1024 - yFrac;
			r3 = ((frac12 * ((((usqInt) topPix >> 16)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 16)) & 0xFF))) / 1024;
			g2 = ((frac12 * ((((usqInt) topPix >> 8)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 8)) & 0xFF))) / 1024;
			b2 = ((frac12 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) / 1024;
...
l1:	/* end checkedUnsignedIntPtrOf: */;
	...
	if (xFrac > 0) {
		...
		frac1 = 1024 - xFrac;
		r = ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
		g = ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
	...
	if (xFrac > 0) {
		...
		frac11 = 1024 - xFrac;
		r1 = ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) / 1024;
		g1 = ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) / 1024;
		b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 1024;
