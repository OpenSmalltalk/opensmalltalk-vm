/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primCloseAccessorDepth = 0;
EXPORT(signed char) primGetOptionAccessorDepth = 0;
EXPORT(signed char) primIsPortOpenAccessorDepth = 0;
EXPORT(signed char) primitiveBlurAccessorDepth = 0;
EXPORT(signed char) primitiveBrightnessShiftAccessorDepth = 0;
EXPORT(signed char) primitiveCondenseSoundAccessorDepth = 0;
EXPORT(signed char) primitiveDoubleSizeAccessorDepth = 0;
EXPORT(signed char) primitiveExtractChannelAccessorDepth = 0;
EXPORT(signed char) primitiveFisheyeAccessorDepth = 0;
EXPORT(signed char) primitiveGetFolderPathAccessorDepth = 0;
EXPORT(signed char) primitiveHalfSizeAverageAccessorDepth = 0;
EXPORT(signed char) primitiveHalfSizeDiagonalAccessorDepth = 0;
EXPORT(signed char) primitiveHueShiftAccessorDepth = 0;
EXPORT(signed char) primitiveInterpolateAccessorDepth = 0;
EXPORT(signed char) primitiveIsHiddenAccessorDepth = 0;
EXPORT(signed char) primitiveOpenURLAccessorDepth = 0;
EXPORT(signed char) primitiveSaturationShiftAccessorDepth = 0;
EXPORT(signed char) primitiveScaleAccessorDepth = 0;
EXPORT(signed char) primitiveSetUnicodePasteBufferAccessorDepth = 0;
EXPORT(signed char) primitiveSetWindowTitleAccessorDepth = 0;
EXPORT(signed char) primitiveShortToLongPathAccessorDepth = 0;
EXPORT(signed char) primitiveWaterRipples1AccessorDepth = 0;
EXPORT(signed char) primitiveWhirlAccessorDepth = 0;
EXPORT(signed char) primOpenPortNamedAccessorDepth = 0;
EXPORT(signed char) primPortNameAccessorDepth = 0;
EXPORT(signed char) primReadAccessorDepth = 0;
EXPORT(signed char) primSetOptionAccessorDepth = 0;
EXPORT(signed char) primWriteAccessorDepth = 0;
