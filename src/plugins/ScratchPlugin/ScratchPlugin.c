/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.594 uuid: dc0cca0d-8f63-4da1-a647-94be0840104b
   from
	ScratchPlugin VMMaker.oscog-eem.594 uuid: dc0cca0d-8f63-4da1-a647-94be0840104b
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.594 uuid: dc0cca0d-8f63-4da1-a647-94be0840104b " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ScratchPlugin VMMaker.oscog-eem.594 (i)"
#else
	"ScratchPlugin VMMaker.oscog-eem.594 (e)"
#endif
;
...
interpolatedFromxywidthheight(unsigned int *bitmap, sqInt xFixed, sqInt yFixed, sqInt w, sqInt h)
{
	...
	if (xFrac > 0) {
		...
		if (topPix == 0) {
			topPix = (bitmap[index + 1]) & 0xFFFFFF;
			goto l1;
		}
		...
		frac1 = 1024 - xFrac;
		r = ((sqInt) ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
		g = ((sqInt) ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
		b = ((sqInt) ((frac1 * (topPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
	...
	if (xFrac > 0) {
		/* begin interpolate:and:frac: */
		if (bottomPix == 0) {
			bottomPix = (bitmap[index + 1]) & 0xFFFFFF;
			goto l2;
		}
		if (((bitmap[index + 1]) & 0xFFFFFF) == 0) {
			bottomPix = bottomPix;
		...
		frac11 = 1024 - xFrac;
		r1 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
		g1 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((bitmap[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
		b1 = ((sqInt) ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
	...
	frac12 = 1024 - yFrac;
	r2 = ((sqInt) ((frac12 * ((((usqInt) topPix >> 16)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 16)) & 0xFF))) >> 10);
	g2 = ((sqInt) ((frac12 * ((((usqInt) topPix >> 8)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 8)) & 0xFF))) >> 10);
	b2 = ((sqInt) ((frac12 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) >> 10);
...
interpolateandfrac(sqInt pix1, sqInt pix2, sqInt frac2)
{
	...
	frac1 = 1024 - frac2;
	r = ((sqInt) ((frac1 * ((((usqInt) pix1 >> 16)) & 0xFF)) + (frac2 * ((((usqInt) pix2 >> 16)) & 0xFF))) >> 10);
	g = ((sqInt) ((frac1 * ((((usqInt) pix1 >> 8)) & 0xFF)) + (frac2 * ((((usqInt) pix2 >> 8)) & 0xFF))) >> 10);
	b = ((sqInt) ((frac1 * (pix1 & 0xFF)) + (frac2 * (pix2 & 0xFF))) >> 10);
	result = ((((usqInt) r << 16)) + (((usqInt) g << 8))) + b;
	if (result == 0) {
		result = 1;
	}
...
primitiveExtractChannel(void)
{
	...
	success(isWords(dstOop));
	sz = stSizeOf(srcOop);
	success((stSizeOf(dstOop)) >= (((sqInt) sz >> 1)));
	if (failed()) {
		return null;
	}
	src = ((short *) (firstIndexableField(srcOop)));
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 1024 - xFrac;
				r1 = ((sqInt) ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
				g = ((sqInt) ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
				b = ((sqInt) ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
			...
			if (xFrac > 0) {
				...
				frac11 = 1024 - xFrac;
				r2 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
				g1 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
				b1 = ((sqInt) ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
			...
			frac12 = 1024 - yFrac;
			r3 = ((sqInt) ((frac12 * ((((usqInt) topPix >> 16)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 16)) & 0xFF))) >> 10);
			g2 = ((sqInt) ((frac12 * ((((usqInt) topPix >> 8)) & 0xFF)) + (yFrac * ((((usqInt) bottomPix >> 8)) & 0xFF))) >> 10);
			b2 = ((sqInt) ((frac12 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) >> 10);
...
l1:	/* end checkedUnsignedIntPtrOf: */;
	...
	if (xFrac > 0) {
		...
		frac1 = 1024 - xFrac;
		r = ((sqInt) ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
		g = ((sqInt) ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
		b = ((sqInt) ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
	...
	if (xFrac > 0) {
		...
		frac11 = 1024 - xFrac;
		r1 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 16)) & 0xFF))) >> 10);
		g1 = ((sqInt) ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) ((in[index + 1]) & 0xFFFFFF) >> 8)) & 0xFF))) >> 10);
		b1 = ((sqInt) ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) >> 10);
...
primitiveSetUnicodePasteBuffer(void)
{
	...
	utf16 = ((short int *) (firstIndexableField(strOop)));
...
primitiveShortToLongPath(void)
{
	...
	if ((isIntegerObject(shortPathOop))
	 || (!(isBytes(shortPathOop)))) {
		success(0);
		return 0;
	}
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (d < radiusSquared) {
				...
				xFrac = (((sqInt)(1024.0 * ((((cosa * dx) - (sina * dy)) / scaleX) + centerX)))) & 0x3FF;
				if (x1 == -1) {
					x1 = 0;
					xFrac = 0;
				}
				...
				yFrac = (((sqInt)(1024.0 * ((((sina * dx) + (cosa * dy)) / scaleY) + centerY)))) & 0x3FF;
				if (y1 == -1) {
					y1 = 0;
					yFrac = 0;
				}
...
void* ScratchPlugin_exports[][3] = {
	...
	{"ScratchPlugin", "primClose\000\000", (void*)primClose},
	{"ScratchPlugin", "primGetOption\000\000", (void*)primGetOption},
	{"ScratchPlugin", "primIsPortOpen\000\000", (void*)primIsPortOpen},
	{"ScratchPlugin", "primitiveBlur\000\001", (void*)primitiveBlur},
	{"ScratchPlugin", "primitiveBrightnessShift\000\001", (void*)primitiveBrightnessShift},
	{"ScratchPlugin", "primitiveCondenseSound\000\000", (void*)primitiveCondenseSound},
	{"ScratchPlugin", "primitiveDoubleSize\000\000", (void*)primitiveDoubleSize},
	{"ScratchPlugin", "primitiveExtractChannel\000\001", (void*)primitiveExtractChannel},
	{"ScratchPlugin", "primitiveFisheye\000\001", (void*)primitiveFisheye},
	{"ScratchPlugin", "primitiveGetFolderPath\000\000", (void*)primitiveGetFolderPath},
	{"ScratchPlugin", "primitiveHalfSizeAverage\000\000", (void*)primitiveHalfSizeAverage},
	{"ScratchPlugin", "primitiveHalfSizeDiagonal\000\000", (void*)primitiveHalfSizeDiagonal},
	{"ScratchPlugin", "primitiveHueShift\000\001", (void*)primitiveHueShift},
	{"ScratchPlugin", "primitiveInterpolate\000\001", (void*)primitiveInterpolate},
	{"ScratchPlugin", "primitiveIsHidden\000\001", (void*)primitiveIsHidden},
	{"ScratchPlugin", "primitiveOpenURL\000\001", (void*)primitiveOpenURL},
	{"ScratchPlugin", "primitiveSaturationShift\000\001", (void*)primitiveSaturationShift},
	{"ScratchPlugin", "primitiveScale\000\000", (void*)primitiveScale},
	{"ScratchPlugin", "primitiveSetUnicodePasteBuffer\000\001", (void*)primitiveSetUnicodePasteBuffer},
	{"ScratchPlugin", "primitiveSetWindowTitle\000\001", (void*)primitiveSetWindowTitle},
	{"ScratchPlugin", "primitiveShortToLongPath\000\001", (void*)primitiveShortToLongPath},
	{"ScratchPlugin", "primitiveWaterRipples1\000\001", (void*)primitiveWaterRipples1},
	{"ScratchPlugin", "primitiveWhirl\000\001", (void*)primitiveWhirl},
	{"ScratchPlugin", "primOpenPortNamed\000\001", (void*)primOpenPortNamed},
	{"ScratchPlugin", "primPortCount\000\377", (void*)primPortCount},
	{"ScratchPlugin", "primPortName\000\000", (void*)primPortName},
	{"ScratchPlugin", "primRead\000\001", (void*)primRead},
	{"ScratchPlugin", "primSetOption\000\000", (void*)primSetOption},
	{"ScratchPlugin", "primWrite\000\001", (void*)primWrite},
