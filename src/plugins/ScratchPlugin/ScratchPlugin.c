/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	ScratchPlugin VMMaker.oscog-eem.3792 uuid: b00773bb-68a0-441a-b1b0-211aa4a67e97
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.3792 uuid: b00773bb-68a0-441a-b1b0-211aa4a67e97 " __DATE__ ;
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.3792 " INT_EXT;
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 0x400 - xFrac;
				rSqInt = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
...
l3:;
			...
			if (xFrac > 0) {
				...
				frac1 = 0x400 - xFrac;
				rSqInt = ((frac1 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
				g = ((frac1 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
				b = ((frac1 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
				result = ((((((usqInt)(rSqInt) << 16)))) + (((((usqInt)(g) << 8))))) + b;
				if (!result) {
					result = 1;
				}
...
l4:;
			...
			frac1 = 0x400 - yFrac;
			rSqInt = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 16)) & 0xFF))) / 0x400;
			g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 8)) & 0xFF))) / 0x400;
...
l3:;
	...
	if (xFrac > 0) {
		...
		frac1 = 0x400 - xFrac;
		r = ((frac1 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
		g = ((frac1 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
		b = ((frac1 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
		resultSqInt = ((((((usqInt)(r) << 16)))) + (((((usqInt)(g) << 8))))) + b;
		if (!resultSqInt) {
...
l2:;
	...
	frac1 = 0x400 - yFrac;
	r = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 16)) & 0xFF))) / 0x400;
	g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 8)) & 0xFF))) / 0x400;
	b = ((frac1 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) / 0x400;
	resultSqInt = ((((((usqInt)(r) << 16)))) + (((((usqInt)(g) << 8))))) + b;
	if (!resultSqInt) {
