/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0 " __DATE__ ;
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.3417 " INT_EXT;
...
primitiveFisheye(void)
{
	...
	out = firstIndexableField(outOop);
	l5:	/* end checkedUnsignedIntPtrOf: */;
	sz = stSizeOf(inOop);
	success((stSizeOf(outOop)) == sz);
	if (failed()) {
		return null;
	...
	l2:	/* end interpolate:and:frac: */;
			...
			pix = result2;
	l3:	/* end interpolatedFrom:x:y:width:height: */;
			out[(y * width) + x] = pix;
		}
	}
	pop(4);
