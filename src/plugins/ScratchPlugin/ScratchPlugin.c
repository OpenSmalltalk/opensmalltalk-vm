/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.3101 uuid: 343b46dc-8e9f-48c8-bb97-74b76f1d07cc
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.3101 uuid: 343b46dc-8e9f-48c8-bb97-74b76f1d07cc " __DATE__ ;
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.3101 " INT_EXT;
...
interpolatedFromxywidthheight(unsigned int *bitmap, sqInt xFixed, sqInt yFixed, sqInt w, sqInt h)
{
	...
	if (xFrac > 0) {
		...
		frac1 = 0x400 - xFrac;
		r = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((bitmap[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
		g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((bitmap[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
	...
	if (xFrac > 0) {
		...
		frac11 = 0x400 - xFrac;
		r1 = ((frac11 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((bitmap[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
		g1 = ((frac11 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((bitmap[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
		b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((bitmap[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
...
primitiveFisheye(void)
{
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 0x400 - xFrac;
				r3 = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
				g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
				b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
	...
	l3:	/* end interpolate:and:frac: */;
			...
			if (xFrac > 0) {
				...
				frac11 = 0x400 - xFrac;
				r1 = ((frac11 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
				g1 = ((frac11 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
				b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
				result1 = (((((sqInt)((usqInt)(r1) << 16)))) + ((((sqInt)((usqInt)(g1) << 8))))) + b1;
				if (result1 == 0) {
					result1 = 1;
				}
...
primitiveInterpolate(void)
{
	...
	if (xFrac > 0) {
		...
		frac1 = 0x400 - xFrac;
		r = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) / 0x400;
		g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) / 0x400;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) / 0x400;
...
void* ScratchPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCondenseSound\000\001\000", (void*)primitiveCondenseSound},
	{(void*)_m, "primitiveDoubleSize\000\001\000", (void*)primitiveDoubleSize},
	{(void*)_m, "primitiveExtractChannel\000\001\000", (void*)primitiveExtractChannel},
	...
	{(void*)_m, "primitiveInterpolate\000\001\000", (void*)primitiveInterpolate},
	...
	{(void*)_m, "primitiveSetUnicodePasteBuffer\000\001\000", (void*)primitiveSetUnicodePasteBuffer},
	{(void*)_m, "primitiveSetWindowTitle\000\001\000", (void*)primitiveSetWindowTitle},
	{(void*)_m, "primitiveShortToLongPath\000\001\000", (void*)primitiveShortToLongPath},
