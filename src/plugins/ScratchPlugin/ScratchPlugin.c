/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ScratchPlugin VMMaker.oscog-eem.1072 (i)"
#else
	"ScratchPlugin VMMaker.oscog-eem.1072 (e)"
#endif
;
...
interpolatedFromxywidthheight(unsigned int *bitmap, sqInt xFixed, sqInt yFixed, sqInt w, sqInt h)
{
	...
	if (xFrac > 0) {
		...
		if (bottomPix == 0) {
			bottomPix = ((sqInt) pix21);
			goto l2;
		}
		if (pix21 == 0) {
			bottomPix = ((sqInt) bottomPix);
			goto l2;
		}
		frac11 = 1024 - xFrac;
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 1024 - xFrac;
				r1 = ((frac1 * ((((usqInt) topPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) pix2 >> 16)) & 0xFF))) / 1024;
				g = ((frac1 * ((((usqInt) topPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) pix2 >> 8)) & 0xFF))) / 1024;
				b = ((frac1 * (topPix & 0xFF)) + (xFrac * (pix2 & 0xFF))) / 1024;
			...
			if (xFrac > 0) {
				...
				frac11 = 1024 - xFrac;
				r2 = ((frac11 * ((((usqInt) bottomPix >> 16)) & 0xFF)) + (xFrac * ((((usqInt) pix21 >> 16)) & 0xFF))) / 1024;
				g1 = ((frac11 * ((((usqInt) bottomPix >> 8)) & 0xFF)) + (xFrac * ((((usqInt) pix21 >> 8)) & 0xFF))) / 1024;
				b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (pix21 & 0xFF))) / 1024;
