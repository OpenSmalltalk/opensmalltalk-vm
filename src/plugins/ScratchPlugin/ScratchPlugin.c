/* Automatically generated by
   ...
   from
	ScratchPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015
 */
static char __buildInfo[] = "ScratchPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015 " __DATE__ ;
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.2995 " INT_EXT;
...
bitmapatputHsv(unsigned int *bitmap, sqInt i, sqInt hue, sqInt saturation, sqInt brightness)
{
	...
	t = t / 3922;
	if (0 == hI) {
		outPix = (((((sqInt)((usqInt)(v) << 16)))) + ((((sqInt)((usqInt)(t) << 8))))) + p;
	}
	if (1 == hI) {
		outPix = (((((sqInt)((usqInt)(q) << 16)))) + ((((sqInt)((usqInt)(v) << 8))))) + p;
	}
	if (2 == hI) {
		outPix = (((((sqInt)((usqInt)(p) << 16)))) + ((((sqInt)((usqInt)(v) << 8))))) + t;
	}
	if (3 == hI) {
		outPix = (((((sqInt)((usqInt)(p) << 16)))) + ((((sqInt)((usqInt)(q) << 8))))) + v;
	}
	if (4 == hI) {
		outPix = (((((sqInt)((usqInt)(t) << 16)))) + ((((sqInt)((usqInt)(p) << 8))))) + v;
	}
	if (5 == hI) {
		outPix = (((((sqInt)((usqInt)(v) << 16)))) + ((((sqInt)((usqInt)(p) << 8))))) + q;
	}
	if (outPix == 0) {
		outPix = 1;
	}
...
interpolatedFromxywidthheight(unsigned int *bitmap, sqInt xFixed, sqInt yFixed, sqInt w, sqInt h)
{
	...
	if (xFrac > 0) {
		...
		frac1 = 0x400 - xFrac;
		r = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(pix2)) >> 16)) & 0xFF))) / 0x400;
		g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(pix2)) >> 8)) & 0xFF))) / 0x400;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (pix2 & 0xFF))) / 0x400;
		result = (((((sqInt)((usqInt)(r) << 16)))) + ((((sqInt)((usqInt)(g) << 8))))) + b;
		if (result == 0) {
			result = 1;
		}
		topPix = result;
	...
	if (xFrac > 0) {
		...
		frac11 = 0x400 - xFrac;
		r1 = ((frac11 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(pix21)) >> 16)) & 0xFF))) / 0x400;
		g1 = ((frac11 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(pix21)) >> 8)) & 0xFF))) / 0x400;
		b1 = ((frac11 * (bottomPix & 0xFF)) + (xFrac * (pix21 & 0xFF))) / 0x400;
		result1 = (((((sqInt)((usqInt)(r1) << 16)))) + ((((sqInt)((usqInt)(g1) << 8))))) + b1;
		if (result1 == 0) {
			result1 = 1;
		}
		bottomPix = result1;
	...
	frac12 = 0x400 - yFrac;
	r2 = ((frac12 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 16)) & 0xFF))) / 0x400;
	g2 = ((frac12 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (yFrac * (((((usqInt)(bottomPix)) >> 8)) & 0xFF))) / 0x400;
	b2 = ((frac12 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) / 0x400;
	result2 = (((((sqInt)((usqInt)(r2) << 16)))) + ((((sqInt)((usqInt)(g2) << 8))))) + b2;
	if (result2 == 0) {
		result2 = 1;
	}
	return result2;
...
interpolateandfrac(sqInt pix1, sqInt pix2, sqInt frac2)
{
	...
	frac1 = 0x400 - frac2;
	r = ((frac1 * (((((usqInt)(pix1)) >> 16)) & 0xFF)) + (frac2 * (((((usqInt)(pix2)) >> 16)) & 0xFF))) / 0x400;
	g = ((frac1 * (((((usqInt)(pix1)) >> 8)) & 0xFF)) + (frac2 * (((((usqInt)(pix2)) >> 8)) & 0xFF))) / 0x400;
	b = ((frac1 * (pix1 & 0xFF)) + (frac2 * (pix2 & 0xFF))) / 0x400;
	result = (((((sqInt)((usqInt)(r) << 16)))) + ((((sqInt)((usqInt)(g) << 8))))) + b;
	if (result == 0) {
		result = 1;
	}
	...
	for (y = 1; y <= (height - 2); y += 1) {
		for (x = 1; x <= (width - 2); x += 1) {
			...
			if (n == 0) {
				...
				outPix = (((((sqInt)((usqInt)((rTotal / n)) << 16)))) + ((((sqInt)((usqInt)((gTotal / n)) << 8))))) + (bTotal / n);
			}
	...
	for (x = 0; x < width; x += 1) {
		for (y = 0; y < height; y += 1) {
			...
			if (xFrac > 0) {
				...
				frac1 = 0x400 - xFrac;
				r3 = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) + (xFrac * (((((usqInt)(pix2)) >> 16)) & 0xFF))) / 0x400;
				g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(pix2)) >> 8)) & 0xFF))) / 0x400;
				b = ((frac1 * (topPix & 0xFF)) + (xFrac * (pix2 & 0xFF))) / 0x400;
				result = (((((sqInt)((usqInt)(r3) << 16)))) + ((((sqInt)((usqInt)(g) << 8))))) + b;
				if (result == 0) {
					result = 1;
				}
				topPix = result;
...
primitiveInterpolate(void)
{
	...
	if (xFrac > 0) {
		...
		g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) + (xFrac * (((((usqInt)(pix2)) >> 8)) & 0xFF))) / 0x400;
		b = ((frac1 * (topPix & 0xFF)) + (xFrac * (pix2 & 0xFF))) / 0x400;
		result3 = (((((sqInt)((usqInt)(r) << 16)))) + ((((sqInt)((usqInt)(g) << 8))))) + b;
		if (result3 == 0) {
			result3 = 1;
		}
		topPix = result3;
...
void* ScratchPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveBlur\000\000\000", (void*)primitiveBlur},
	{(void*)_m, "primitiveBrightnessShift\000\000\000", (void*)primitiveBrightnessShift},
	{(void*)_m, "primitiveCondenseSound\000\000\000", (void*)primitiveCondenseSound},
	{(void*)_m, "primitiveDoubleSize\000\000\000", (void*)primitiveDoubleSize},
	{(void*)_m, "primitiveExtractChannel\000\000\000", (void*)primitiveExtractChannel},
	{(void*)_m, "primitiveFisheye\000\000\000", (void*)primitiveFisheye},
	{(void*)_m, "primitiveGetFolderPath\000\000\000", (void*)primitiveGetFolderPath},
	{(void*)_m, "primitiveHalfSizeAverage\000\000\000", (void*)primitiveHalfSizeAverage},
	{(void*)_m, "primitiveHalfSizeDiagonal\000\000\000", (void*)primitiveHalfSizeDiagonal},
	{(void*)_m, "primitiveHueShift\000\000\000", (void*)primitiveHueShift},
	{(void*)_m, "primitiveInterpolate\000\000\000", (void*)primitiveInterpolate},
	{(void*)_m, "primitiveIsHidden\000\000\000", (void*)primitiveIsHidden},
	{(void*)_m, "primitiveOpenURL\000\000\000", (void*)primitiveOpenURL},
	{(void*)_m, "primitiveSaturationShift\000\000\000", (void*)primitiveSaturationShift},
	{(void*)_m, "primitiveScale\000\000\000", (void*)primitiveScale},
	{(void*)_m, "primitiveSetUnicodePasteBuffer\000\000\000", (void*)primitiveSetUnicodePasteBuffer},
	{(void*)_m, "primitiveSetWindowTitle\000\000\000", (void*)primitiveSetWindowTitle},
	{(void*)_m, "primitiveShortToLongPath\000\000\000", (void*)primitiveShortToLongPath},
	{(void*)_m, "primitiveWaterRipples1\000\000\000", (void*)primitiveWaterRipples1},
	{(void*)_m, "primitiveWhirl\000\000\000", (void*)primitiveWhirl},
	{(void*)_m, "primOpenPortNamed\000\000\000", (void*)primOpenPortNamed},
...
EXPORT(signed short) primitiveBlurMetadata = 0;
EXPORT(signed short) primitiveBrightnessShiftMetadata = 0;
EXPORT(signed short) primitiveCondenseSoundMetadata = 0;
EXPORT(signed short) primitiveDoubleSizeMetadata = 0;
EXPORT(signed short) primitiveExtractChannelMetadata = 0;
EXPORT(signed short) primitiveFisheyeMetadata = 0;
...
EXPORT(signed short) primitiveHueShiftMetadata = 0;
EXPORT(signed short) primitiveInterpolateMetadata = 0;
EXPORT(signed short) primitiveIsHiddenMetadata = 0;
EXPORT(signed short) primitiveOpenURLMetadata = 0;
EXPORT(signed short) primitiveSaturationShiftMetadata = 0;
EXPORT(signed short) primitiveScaleMetadata = 0;
EXPORT(signed short) primitiveSetUnicodePasteBufferMetadata = 0;
EXPORT(signed short) primitiveSetWindowTitleMetadata = 0;
EXPORT(signed short) primitiveShortToLongPathMetadata = 0;
EXPORT(signed short) primitiveWaterRipples1Metadata = 0;
EXPORT(signed short) primitiveWhirlMetadata = 0;
EXPORT(signed short) primOpenPortNamedMetadata = 0;
