/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2225 uuid: a3791777-370b-419b-9708-9e73bf94e39b
   from
	FilePlugin VMMaker.oscog-eem.2225 uuid: a3791777-370b-419b-9708-9e73bf94e39b
 */
static char __buildInfo[] = "FilePlugin VMMaker.oscog-eem.2225 uuid: a3791777-370b-419b-9708-9e73bf94e39b " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin VMMaker.oscog-eem.2225 (i)"
#else
	"FilePlugin VMMaker.oscog-eem.2225 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
l1:	/* end fileValueOf: */;
	...
	if (!(failed())) {
		sqFileOpenNew(file, nameIndex, nameSize);
	}
	return fileOop;
}
