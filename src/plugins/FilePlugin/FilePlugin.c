/* Automatically generated by
   ...
   from
	FilePlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "FilePlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "FilePlugin VMMaker.oscog-eem.3453 " INT_EXT;
static void * sCCPfn;
static void * sCDFfn;
static void * sCDPfn;
static void * sCGFTfn;
...
{
	if (!(		/* begin interpreterProxyHasCharacterObjectOf */
...
#endif /* SPURVM */
	stringPtr = ((char *) (firstIndexableField(nameString)));
...
primitiveDirectoryCreate(void)
{
	...
	dirNameIndex = ((char *) (firstIndexableField(dirName)));
	/* If the security plugin can be loaded, use it to check for permission.
	   If not, assume it's ok */
...
primitiveDirectoryEntry(void)
{
	...
	pathNameIndex = ((char *) (firstIndexableField(pathName)));
	pathNameSize = byteSizeOf(pathName);
	reqNameIndex = ((char *) (firstIndexableField(requestedName)));
...
primitiveDirectoryGetMacTypeAndCreator(void)
{
	...
	creatorStringIndex = ((char *) (firstIndexableField(creatorString)));
	typeStringIndex = ((char *) (firstIndexableField(typeString)));
	fileNameIndex = ((char *) (firstIndexableField(fileName)));
	/* If the security plugin can be loaded, use it to check for permission.
	   If not, assume it's ok */
...
primitiveFileDelete(void)
{
	...
	nameIndex = ((char *) (firstIndexableField(namePointer)));
	/* If the security plugin can be loaded, use it to check for permission.
	   If not, assume it's ok */
...
#  else // COGMTVM
	...
	elementSize1 = (byteSizeOf(array1)) / slotSize1;
...
#  else // SPURVM
	...
	elementSize2 = bytesPerElement(array2);
...
primitiveFileRename(void)
{
	...
	newNameIndex = ((char *) (firstIndexableField(newNamePointer)));
	newNameSize = byteSizeOf(newNamePointer);
	oldNameIndex = ((char *) (firstIndexableField(oldNamePointer)));
