/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-eem.2339 uuid: 1f823336-4229-4929-8a75-545797124625
   from
	FilePlugin * VMMaker.oscog-eem.2339 uuid: 1f823336-4229-4929-8a75-545797124625
 */
static char __buildInfo[] = "FilePlugin * VMMaker.oscog-eem.2339 uuid: 1f823336-4229-4929-8a75-545797124625 " __DATE__ ;
...
#if PharoVM
EXPORT(sqInt) fileOpenFdwrite(int fd, sqInt writeFlag);
#endif /* PharoVM */
#if PharoVM
EXPORT(sqInt) fileOpenFilewrite(FILE *cfile, sqInt writeFlag);
#endif /* PharoVM */
...
#if PharoVM
EXPORT(sqInt) primitiveFileOpenUseFile(void);
#endif /* PharoVM */
#if PharoVM
EXPORT(sqInt) primitiveFileOpenUseFileDescriptor(void);
#endif /* PharoVM */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin * VMMaker.oscog-eem.2339 (i)"
#else
	"FilePlugin * VMMaker.oscog-eem.2339 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
/*	Open the fd as file. Answer the file oop. */
	...
	/* FilePlugin>>#fileOpenFd:write: */
#if PharoVM
EXPORT(sqInt)
fileOpenFdwrite(int fd, sqInt writeFlag)
{
    SQFile *file;
    sqInt fileOop;
	...
	l1:	/* end fileValueOf: */;
	if (!(failed())) {
		sqFileFdOpen(file, fd, writeFlag);
	}
	return fileOop;
}
#endif /* PharoVM */
...
/*	Open the FILE* as file. Answer the file oop. */
	...
	/* FilePlugin>>#fileOpenFile:write: */
#if PharoVM
EXPORT(sqInt)
fileOpenFilewrite(FILE *cfile, sqInt writeFlag)
{
    SQFile *file;
    sqInt fileOop;
	...
	l1:	/* end fileValueOf: */;
	if (!(failed())) {
		sqFileFileOpen(file, cfile, writeFlag);
	}
	return fileOop;
}
#endif /* PharoVM */
...
primitiveFileOpenUseFile(void)
{
	...
	if (!(failed())) {
		filePointer = fileOpenFilewrite(cfile, writeFlag);
	}
	if (!(failed())) {
	...
	/* FilePlugin>>#primitiveFileOpenUseFileDescriptor */
#if PharoVM
EXPORT(sqInt)
primitiveFileOpenUseFileDescriptor(void)
{
    int fd;
    sqInt fdPointer;
    sqInt filePointer;
	...
	filePointer = fileOpenFdwrite(fd, writeFlag);
	if (!(failed())) {
		return popthenPush(3, filePointer);
	}
	return primitiveFail();
...
#if PharoVM
	{(void*)_m, "fileOpenFdwrite", (void*)fileOpenFdwrite},
#endif /* PharoVM */
#if PharoVM
	{(void*)_m, "fileOpenFilewrite", (void*)fileOpenFilewrite},
#endif /* PharoVM */
...
#if PharoVM
	{(void*)_m, "primitiveFileOpenUseFile\000\002", (void*)primitiveFileOpenUseFile},
#endif /* PharoVM */
#if PharoVM
	{(void*)_m, "primitiveFileOpenUseFileDescriptor\000\000", (void*)primitiveFileOpenUseFileDescriptor},
#endif /* PharoVM */
...
#if PharoVM
signed char primitiveFileOpenUseFileAccessorDepth = 2;
#endif /* PharoVM */
#if PharoVM
signed char primitiveFileOpenUseFileDescriptorAccessorDepth = 0;
#endif /* PharoVM */
