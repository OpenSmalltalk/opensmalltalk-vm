/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-VB.2365 uuid: 031d2e37-e6e1-8b4a-84fc-0215cda32967
   from
	FilePlugin * VMMaker.oscog-VB.2365 uuid: 031d2e37-e6e1-8b4a-84fc-0215cda32967
 */
static char __buildInfo[] = "FilePlugin * VMMaker.oscog-VB.2365 uuid: 031d2e37-e6e1-8b4a-84fc-0215cda32967 " __DATE__ ;
...
EXPORT(sqInt) primitiveStdioDescriptorIsATTY(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin * VMMaker.oscog-VB.2365 (i)"
#else
	"FilePlugin * VMMaker.oscog-VB.2365 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
primitiveHasFileAccess(void)
{
	...
	/* FilePlugin>>#primitiveStdioDescriptorIsATTY */
EXPORT(sqInt)
primitiveStdioDescriptorIsATTY(void)
{
    sqInt isStdoutRedirected;

	isStdoutRedirected = sqStdioDescriptorIsATTY() ;
	pop(1);
	pushInteger(isStdoutRedirected);
	return 0;
}
...
void* FilePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveStdioDescriptorIsATTY\000\377", (void*)primitiveStdioDescriptorIsATTY},
