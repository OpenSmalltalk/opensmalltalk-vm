/* Automatically generated by
   ...
   from
	FilePlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190
 */
static char __buildInfo[] = "FilePlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190 " __DATE__ ;
...
static const char *moduleName = "FilePlugin VMMaker.oscog-eem.3024 " INT_EXT;
static void * sCCPfn;
static void * sCDFfn;
static void * sCDPfn;
static void * sCGFTfn;
...
primitiveConnectToFile(void)
{
	...
	/* begin pointerFrom: */
	if (!((isBytes(cfileOop))
		 && ((stSizeOf(cfileOop)) == (sizeof(void *))))) {
		primitiveFailFor(PrimErrBadArgument);
		cfile = null;
		goto l1;
	}
	ptr = firstIndexableField(cfileOop);
	cfile = ptr[0];
	l1:	/* end pointerFrom: */;
	if (failed()) {
...
void* FilePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveConnectToFile\000\002\000", (void*)primitiveConnectToFile},
	...
	{(void*)_m, "primitiveFileAtEnd\000\000\000", (void*)primitiveFileAtEnd},
	{(void*)_m, "primitiveFileClose\000\000\000", (void*)primitiveFileClose},
	...
	{(void*)_m, "primitiveFileFlush\000\000\000", (void*)primitiveFileFlush},
	{(void*)_m, "primitiveFileGetPosition\000\000\000", (void*)primitiveFileGetPosition},
	{(void*)_m, "primitiveFileOpen\000\002\000", (void*)primitiveFileOpen},
	{(void*)_m, "primitiveFileOpenNew\000\002\000", (void*)primitiveFileOpenNew},
	...
	{(void*)_m, "primitiveFileSetPosition\000\000\000", (void*)primitiveFileSetPosition},
	{(void*)_m, "primitiveFileSize\000\000\000", (void*)primitiveFileSize},
	{(void*)_m, "primitiveFileStdioHandles\000\377\000", (void*)primitiveFileStdioHandles},
	{(void*)_m, "primitiveFileSync\000\000\000", (void*)primitiveFileSync},
	{(void*)_m, "primitiveFileTruncate\000\000\000", (void*)primitiveFileTruncate},
	{(void*)_m, "primitiveFileWrite\000\000\000", (void*)primitiveFileWrite},
...
#if SPURVM
EXPORT(signed short) primitiveConnectToFileMetadata = 0x200;
...
EXPORT(signed short) primitiveFileAtEndMetadata = 0;
EXPORT(signed short) primitiveFileCloseMetadata = 0;
EXPORT(signed short) primitiveFileDeleteMetadata = 0x100;
EXPORT(signed short) primitiveFileDescriptorTypeMetadata = 0;
EXPORT(signed short) primitiveFileFlushMetadata = 0;
EXPORT(signed short) primitiveFileGetPositionMetadata = 0;
EXPORT(signed short) primitiveFileOpenMetadata = 0x200;
EXPORT(signed short) primitiveFileOpenNewMetadata = 0x200;
EXPORT(signed short) primitiveFileRenameMetadata = 0x100;
EXPORT(signed short) primitiveFileSetPositionMetadata = 0;
EXPORT(signed short) primitiveFileSizeMetadata = 0;
EXPORT(signed short) primitiveFileSyncMetadata = 0;
EXPORT(signed short) primitiveFileTruncateMetadata = 0;
EXPORT(signed short) primitiveFileWriteMetadata = 0;
#endif // SPURVM
