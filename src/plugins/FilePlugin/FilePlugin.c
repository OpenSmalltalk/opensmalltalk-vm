/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-akg.2341 uuid: d0fa56c5-cccb-41b4-b28d-4c54c9acdccf
   from
	FilePlugin * VMMaker.oscog-akg.2341 uuid: d0fa56c5-cccb-41b4-b28d-4c54c9acdccf
 */
static char __buildInfo[] = "FilePlugin * VMMaker.oscog-akg.2341 uuid: d0fa56c5-cccb-41b4-b28d-4c54c9acdccf " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin * VMMaker.oscog-akg.2341 (i)"
#else
	"FilePlugin * VMMaker.oscog-akg.2341 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
primitiveConnectToFileDescriptor(void)
{
	...
	filePointer = connectToFdwrite(fd, writeFlag);
	if (!(failed())) {
		return popthenPush(3, filePointer);
	}
	return primitiveFail();
...
void* FilePlugin_exports[][3] = {
	{(void*)_m, "connectToFdwrite", (void*)connectToFdwrite},
	{(void*)_m, "connectToFilewrite", (void*)connectToFilewrite},
	...
	{(void*)_m, "primitiveConnectToFile\000\002", (void*)primitiveConnectToFile},
...
signed char primitiveConnectToFileAccessorDepth = 2;
