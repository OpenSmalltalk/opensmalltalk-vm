/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
   from
	LargeIntegersPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.3423 " INT_EXT;
...
primAnyBitFromTo(void)
{
	...
	if (isIntegerObject(integer)) {
		...
		magnitude = integer;
		stop = ((to < (highBitOfLargeInt(magnitude))) ? to : (highBitOfLargeInt(magnitude)));
		if (from > stop) {
			someBitIsSet = 0;
			goto l2;
		}
