/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.1851 uuid: a2b37448-8ea6-480e-aa07-e99d6de1744a
   from
	LargeIntegersPlugin VMMaker.oscog-eem.1851 uuid: a2b37448-8ea6-480e-aa07-e99d6de1744a
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.1851 uuid: a2b37448-8ea6-480e-aa07-e99d6de1744a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"LargeIntegers v2.0 VMMaker.oscog-eem.1851 (i)"
#else
	"LargeIntegers v2.0 VMMaker.oscog-eem.1851 (e)"
#endif
;
...
anyBitOfLargeIntfromto(sqInt anOop, sqInt start, sqInt stopArg)
{
	...
	if (firstDigitIx == lastDigitIx) {
		/* begin cDigitOf:at: */
		cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(magnitude)))));
...
cDigitDivlenremlenquolen(unsigned int *pDiv, sqInt divLen, unsigned int *pRem, sqInt remLen, unsigned int *pQuo, sqInt quoLen)
{
	...
	for (k = 1; k <= ql; k += 1) {
		...
		pQuo[quoLen - k] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(q));
	}
	return 0;
}
...
cDigitLshiftfromlentolen(sqInt shiftCount, unsigned int *pFrom, sqInt lenFrom, unsigned int *pTo, sqInt lenTo)
{
	...
	for (i = 0; i <= limit; i += 1) {
		...
		pTo[i + digitShift] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((carry | (digit << bitShift)) & 0xFFFFFFFFU)));
...
cDigitRshiftfromlentolen(sqInt shiftCount, unsigned int *pFrom, sqInt lenFrom, unsigned int *pTo, sqInt lenTo)
{
	...
	for (j = start; j <= limit; j += 1) {
		...
		pTo[j - start] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((carry | (digit << leftShift)) & 0xFFFFFFFFU)));
...
;
	...
	pWordRes = ((unsigned int *) (((unsigned int *) (firstIndexableField(sum)))));
	accum = 0;
...
#endif /* SPURVM */
;
		cDigitCopyFromtolen(((unsigned int *) (firstIndexableField(sum))), ((unsigned int *) (firstIndexableField(newSum))), longDigitLen);

		/* C index! */
		sum = newSum;
		/* begin cDigitOf:at:put: */
		cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(sum)))));
...
;
	...
	pWordRes = ((unsigned int *) (((unsigned int *) (firstIndexableField(result)))));
...
;
	...
	pDiv = ((unsigned int *) (((unsigned int *) (firstIndexableField(div)))));
	divLen = ((slotSizeOf(div)) + 3) / 4;
	pRem = ((unsigned int *) (((unsigned int *) (firstIndexableField(rem)))));
	remLen = ((slotSizeOf(rem)) + 3) / 4;
	pQuo = ((unsigned int *) (((unsigned int *) (firstIndexableField(quo)))));
...
;
	...
	pThird = ((unsigned int *) (((unsigned int *) (firstIndexableField(thirdLarge)))));
	pRes = ((unsigned int *) (((unsigned int *) (firstIndexableField(prod)))));
	limit1 = firstLen - 1;
	limit2 = secondLen - 1;
	limit3 = thirdLen - 1;
	lastDigit = 0;
...
;
	...
	pWordShort = ((unsigned int *) (((unsigned int *) (firstIndexableField(shortInt)))));
	pWordLong = ((unsigned int *) (((unsigned int *) (firstIndexableField(longInt)))));
	pWordRes = ((unsigned int *) (((unsigned int *) (firstIndexableField(prod)))));
	if ((((shortLen + 3) / 4) == 1)
	 && ((pWordShort[0]) == 0)) {
		goto l1;
	}
...
digitOfLargeIntat(sqInt aBytesOop, sqInt ix)
{
	...
	if (ix > (((slotSizeOf(aBytesOop)) + 3) / 4)) {
		...
		/* begin cDigitOf:at: */
		cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(aBytesOop)))));
...
;
	...
	pWordRes = ((unsigned int *) (((unsigned int *) (firstIndexableField(res)))));
	z = 0;
...
digitRshiftlookfirst(sqInt anOop, sqInt shiftCount, sqInt a)
{
	...
	pUint32 = ((unsigned int *) (((unsigned int *) (firstIndexableField(anOop)))));
	realLength = a;
	do {
		if (realLength == 0) {
			oldBitLen = 0;
...
;
	...
	copyLen = (oldDigitLen < newDigitLen
		? oldDigitLen
		: newDigitLen);
	cDigitCopyFromtolen(((unsigned int *) (firstIndexableField(aBytesObject))), ((unsigned int *) (firstIndexableField(newBytes))), copyLen);
	return newBytes;
}
...
normalizeNegative(sqInt aLargeNegativeInteger)
{
	...
	/* begin cDigitOf:at: */
	cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(aLargeNegativeInteger)))));
...
normalizePositive(sqInt aLargePositiveInteger)
{
	...
	/* begin cDigitOf:at: */
	cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(aLargePositiveInteger)))));
	val = SQ_SWAP_4_BYTES_IF_BIGENDIAN((cPointer[digitLen - 1]));
	...
	if (digitLen <= sLen) {
		...
		val2 = val;
		if (digitLen > 1) {
			val2 = (val2 << 32) + (cDigitOfat(((unsigned int *) (firstIndexableField(aLargePositiveInteger))), 1 - 1));
		}
		if (val2 <= maxVal) {
...
unsafeDigitOfLargeIntat(sqInt anOop, sqInt ix)
{
	...
	/* begin cDigitOf:at: */
	cPointer = ((unsigned int *) (((unsigned int *) (firstIndexableField(anOop)))));
	return SQ_SWAP_4_BYTES_IF_BIGENDIAN((cPointer[ix - 1]));
}
