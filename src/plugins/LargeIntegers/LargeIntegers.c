/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscog-eem.3009 uuid: d75b453d-0170-480a-bcb1-d7a2721e1a10
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.3009 uuid: d75b453d-0170-480a-bcb1-d7a2721e1a10 " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.3009 " INT_EXT;
...
normalizeNegative(sqInt aLargeNegativeInteger)
{
	...
	if (digitLen <= sLen) {
		...
		val2 = val;
		if (digitLen > 1) {
			val2 = (val2 << 32) + (cDigitOfat(((unsigned int *) (firstIndexableField(aLargeNegativeInteger))), 0));
		}
		if (val2 <= minVal) {
...
normalizePositive(sqInt aLargePositiveInteger)
{
	...
	if (digitLen <= sLen) {
		...
		if (digitLen > 1) {
			...
			val2 = ((((unsigned long long)val2)) << 32) + (cDigitOfat(((unsigned int *) (firstIndexableField(aLargePositiveInteger))), 0));
		}
		if (val2 <= maxVal) {
...
primAnyBitFromTo(void)
{
	...
	if (isIntegerObject(integer)) {
		...
		magnitude = integer;
		stop = ((to < (cDigitHighBitlen(((unsigned int *) (firstIndexableField(magnitude))), ((byteSizeOf(magnitude)) + 3) / 4))) ? to : (cDigitHighBitlen(((unsigned int *) (firstIndexableField(magnitude))), ((byteSizeOf(magnitude)) + 3) / 4)));
		if (from > stop) {
			someBitIsSet = 0;
			goto l2;
		}
	...
	if (!(failed())) {
		_return_value = ((someBitIsSet) ? trueObject() : falseObject());
		if (!(failed())) {
...
void* LargeIntegers_exports[][3] = {
	...
	{(void*)_m, "primAnyBitFromTo\000\002\001", (void*)primAnyBitFromTo},
	{(void*)_m, "primDigitAdd\000\003\001", (void*)primDigitAdd},
	{(void*)_m, "primDigitBitAnd\000\001\001", (void*)primDigitBitAnd},
	{(void*)_m, "primDigitBitOr\000\001\001", (void*)primDigitBitOr},
	{(void*)_m, "primDigitBitShiftMagnitude\000\003\001", (void*)primDigitBitShiftMagnitude},
	{(void*)_m, "primDigitBitXor\000\001\001", (void*)primDigitBitXor},
	{(void*)_m, "primDigitCompare\000\001\001", (void*)primDigitCompare},
	{(void*)_m, "primDigitDivNegative\000\002\001", (void*)primDigitDivNegative},
	{(void*)_m, "primDigitMultiplyNegative\000\002\001", (void*)primDigitMultiplyNegative},
	{(void*)_m, "primDigitSubtract\000\004\001", (void*)primDigitSubtract},
	...
	{(void*)_m, "primMontgomeryTimesModulo\000\003\001", (void*)primMontgomeryTimesModulo},
...
EXPORT(signed short) primAnyBitFromToMetadata = 513;
EXPORT(signed short) primDigitAddMetadata = 769;
EXPORT(signed short) primDigitBitAndMetadata = 0x101;
EXPORT(signed short) primDigitBitOrMetadata = 0x101;
EXPORT(signed short) primDigitBitShiftMagnitudeMetadata = 769;
EXPORT(signed short) primDigitBitXorMetadata = 0x101;
EXPORT(signed short) primDigitCompareMetadata = 0x101;
EXPORT(signed short) primDigitDivNegativeMetadata = 513;
EXPORT(signed short) primDigitMultiplyNegativeMetadata = 513;
EXPORT(signed short) primDigitSubtractMetadata = 1025;
EXPORT(signed short) primMontgomeryDigitLengthMetadata = -255;
EXPORT(signed short) primMontgomeryTimesModuloMetadata = 769;
