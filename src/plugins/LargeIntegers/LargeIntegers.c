/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015 " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.2995 " INT_EXT;
...
primAnyBitFromTo(void)
{
	...
	if (isIntegerObject(integer)) {
		...
		magnitude = integer;
		stop = ((to < (cDigitHighBitlen(((unsigned int *) (firstIndexableField(magnitude))), ((slotSizeOf(magnitude)) + 3) / 4))) ? to : (cDigitHighBitlen(((unsigned int *) (firstIndexableField(magnitude))), ((slotSizeOf(magnitude)) + 3) / 4)));
		if (from > stop) {
			someBitIsSet = 0;
			goto l2;
		}
