/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscog-eem.2751 uuid: 877f34de-92b0-49a1-b34d-a6e97fe7aa4e
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.2751 uuid: 877f34de-92b0-49a1-b34d-a6e97fe7aa4e " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.2751 " INT_EXT;
...
primAnyBitFromTo(void)
{
	...
	if (isIntegerObject(integer)) {
		...
		if (firstDigitIx == lastDigitIx) {
			...
			zeroBasedDigitIndex = firstDigitIx - 1;
			digit = SQ_SWAP_4_BYTES_IF_BIGENDIAN((cPointer[zeroBasedDigitIndex]));
			someBitIsSet = ((sqInt) ((digit & (firstMask & lastMask)) != 0));
			goto l2;
		}
		if (((cDigitOfat(((unsigned int *) (firstIndexableField(magnitude))), firstDigitIx - 1)) & firstMask) != 0) {
			someBitIsSet = ((sqInt) 1);
			goto l2;
		}
		for (ix = (firstDigitIx + 1); ix < lastDigitIx; ix += 1) {
			if ((cDigitOfat(((unsigned int *) (firstIndexableField(magnitude))), ix - 1)) != 0) {
...
void* LargeIntegers_exports[][3] = {
	...
	{(void*)_m, "primAnyBitFromTo\000\000", (void*)primAnyBitFromTo},
...
signed char primAnyBitFromToAccessorDepth = 0;
