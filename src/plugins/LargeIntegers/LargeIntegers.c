/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.3453 " INT_EXT;
...
anyBitOfLargeIntfromto(sqInt anOop, sqInt start, sqInt stopArg)
{
	...
	magnitude = anOop;
	stop = ((stopArg < (highBitOfLargeInt(magnitude))) ? stopArg : (highBitOfLargeInt(magnitude)));
	if (start > stop) {
		return 0;
	}
	...
	if (firstDigitIx == lastDigitIx) {
		digit = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(magnitude))))[firstDigitIx - 1]));
		return (digit & (firstMask & lastMask)) != 0;
	}
	if (((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(magnitude))))[firstDigitIx - 1]))) & firstMask) != 0) {
		return 1;
	}
	for (ix = (firstDigitIx + 1); ix < lastDigitIx; ix += 1) {
		if ((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(magnitude))))[ix - 1]))) != 0) {
			return 1;
		}
	}
	if (((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(magnitude))))[lastDigitIx - 1]))) & lastMask) != 0) {
		return 1;
	}
	return 0;
}
...
cDigitSublenwithleninto(unsigned int *pWordSmall, sqInt smallLen, unsigned int *pWordLarge, sqInt largeLen, unsigned int *pWordRes)
{
	...
	for (i = 0; i < smallLen; i += 1) {
		...
		/* begin cDigitOf:at:put: */
		pWordRes[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((z & 0xFFFFFFFFU)));
		z = 0 - ((z) >> 0x3F);
	}
...
#  endif // BytesPerOop == 4
	...
	for (ix = 1; ix <= digitSize; ix += 1) {
		/* begin cDigitOf:at:put: */
		pDigit[ix - 1] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((((usqInt)(((val < 0
	? 0 - val
	: val)))) >> ((ix - 1) * 32))));
	}
	return res;
...
digitAddLargewith(sqInt firstInteger, sqInt secondInteger)
{
	...
	for (i = 0; i < shortDigitLen; i += 1) {
		accum = (((accum) >> 32) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(shortInt))))[i])))) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(longInt))))[i])));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(sum))))[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((accum & 0xFFFFFFFFU)));
	}
	for (i = shortDigitLen; i < longDigitLen; i += 1) {
		accum = ((accum) >> 32) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(longInt))))[i])));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(sum))))[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((accum & 0xFFFFFFFFU)));
	}
	...
	if (over > 0) {
		...
		for (i1 = 0; i1 < longDigitLen; i1 += 1) {
			(((unsigned int *) (firstIndexableField(newSum))))[i1] = ((((unsigned int *) (firstIndexableField(sum))))[i1]);
		}
		/* C index! */
		sum = newSum;
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(sum))))[longDigitLen] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(over));
	}
	else {
		if (neg) {
			sum = normalizeNegative(sum);
		}
		else {
			sum = normalizePositive(sum);
		}
	}
	return sum;
}
...
digitBitLogicwithopIndex(sqInt firstInteger, sqInt secondInteger, sqInt opIx)
{
	...
	if (opIx == andOpIndex) {
		for (i = 0; i <= limit; i += 1) {
			(((unsigned int *) (firstIndexableField(result))))[i] = (((((unsigned int *) (firstIndexableField(shortLarge))))[i]) & ((((unsigned int *) (firstIndexableField(longLarge))))[i]));
		}
		limit = ((longLen + 3) / 4) - 1;
	...
	if (opIx == orOpIndex) {
		...
		limit = ((longLen + 3) / 4) - 1;
		for (i = ((shortLen + 3) / 4); i <= limit; i += 1) {
			(((unsigned int *) (firstIndexableField(result))))[i] = ((((unsigned int *) (firstIndexableField(longLarge))))[i]);
		}
		goto l1;
	}
	if (opIx == xorOpIndex) {
...
digitDivLargewithnegative(sqInt firstInteger, sqInt secondInteger, sqInt neg)
{
	...
	d = 32 - (cHighBit32(SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(secondInteger))))[secondDigitLen - 1]))));
	...
	dl = divLen - 1;
	ql = quoLen;
	dh = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(div))))[dl - 1]));
	if (dl == 1) {
		dnh = 0;
	}
	else {
		dnh = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(div))))[dl - 2]));
	}
	for (k = 1; k <= ql; k += 1) {
		/* maintain quo*arg+rem=self */
		/* Estimate rem/div by dividing the leading two unint32 of rem by dh. */
		...
		a = 0;
		for (i = 1; i <= divLen; i += 1) {
			hi = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(div))))[i - 1]))) * ((q) >> 32);
			lo = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(div))))[i - 1]))) * (q & 0xFFFFFFFFU);
			b = ((SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRem[l - 1]))) - a) - (lo & 0xFFFFFFFFU);
			/* begin cDigitOf:at:put: */
			pRem[l - 1] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((b & 0xFFFFFFFFU)));
			b = ((b) >> 32) | ((0 - ((b) >> 0x3F)) & 0xFFFFFFFF00000000ULL);
		...
		if (a > 0) {
			...
			a = 0;
			for (i = 1; i <= divLen; i += 1) {
				a = (((a) >> 32) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRem[l - 1])))) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(div))))[i - 1])));
				/* begin cDigitOf:at:put: */
				pRem[l - 1] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((a & 0xFFFFFFFFU)));
				l += 1;
			}
		...
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(quo))))[quoLen - k] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((((unsigned int) q))));
	}
...
digitMontgomerytimesmodulomInvModB(sqInt firstLarge, sqInt secondLarge, sqInt thirdLarge, unsigned int mInv)
{
	...
	lastDigit = 0;
	for (i = 0; i <= limit1; i += 1) {
		accum3 = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(firstLarge))))[i]));
		accum3 = (accum3 * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((*((unsigned int *) (firstIndexableField(secondLarge)))))))) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRes[0])));
		u = (accum3 * mInv) & 0xFFFFFFFFU;
		accum2 = u * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((*((unsigned int *) (firstIndexableField(thirdLarge)))))));
		accum = (accum2 & 0xFFFFFFFFU) + (accum3 & 0xFFFFFFFFU);
		accum = (((accum) >> 32) + ((accum2) >> 32)) + ((accum3) >> 32);
		for (k = 1; k <= limit2; k += 1) {
			accum3 = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(firstLarge))))[i]));
			accum3 = (accum3 * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(secondLarge))))[k])))) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRes[k])));
			accum2 = u * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(thirdLarge))))[k])));
			accum = (accum + (accum2 & 0xFFFFFFFFU)) + (accum3 & 0xFFFFFFFFU);
			/* begin cDigitOf:at:put: */
			pRes[k - 1] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((accum & 0xFFFFFFFFU)));
			accum = (((accum) >> 32) + ((accum2) >> 32)) + ((accum3) >> 32);
	...
	for (i = firstLen; i <= limit3; i += 1) {
		accum = SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRes[0]));
		u = (accum * mInv) & 0xFFFFFFFFU;
		accum += u * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((*((unsigned int *) (firstIndexableField(thirdLarge)))))));
		accum = (accum) >> 32;
		for (k = 1; k <= limit3; k += 1) {
			accum2 = u * (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(thirdLarge))))[k])));
			accum = (accum + (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRes[k])))) + (accum2 & 0xFFFFFFFFU);
	...
	if (!((lastDigit == 0)
		 && ((cDigitComparewithlen(((unsigned int *) (firstIndexableField(thirdLarge))), pRes, thirdLen)) == 1))) {
		/* self cDigitSub: pThird len: thirdLen with: pRes len: thirdLen into: pRes */
		accum = 0;
		for (i = 0; i <= limit3; i += 1) {
			accum = (accum + (SQ_SWAP_4_BYTES_IF_BIGENDIAN((pRes[i])))) - (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(thirdLarge))))[i])));
			/* begin cDigitOf:at:put: */
			pRes[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((accum & 0xFFFFFFFFU)));
			accum = 0 - ((accum) >> 0x3F);
		}
...
digitMultiplyLargewithnegative(sqInt firstInteger, sqInt secondInteger, sqInt neg)
{
	...
	for (i = 0; i <= limitShort; i += 1) {
		if (((digit = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(shortInt))))[i])))) != 0) {
			k = i;
			/* Loop invariant: 0<=carry<=16rFFFFFFFF, k=i+j-1 (ST) */
			/* -> Loop invariant: 0<=carry<=16rFFFFFFFF, k=i+j (C) (?) */
			carry = 0;
			for (j = 0; j <= limitLong; j += 1) {
				ab = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(longInt))))[j]));
				ab = ((ab * digit) + carry) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(prod))))[k])));
				carry = (ab) >> 32;
				/* begin cDigitOf:at:put: */
				(((unsigned int *) (firstIndexableField(prod))))[k] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((ab & 0xFFFFFFFFU)));
				k += 1;
			}
			if (k < (((longLen + shortLen) + 3) / 4)) {
				/* begin cDigitOf:at:put: */
				(((unsigned int *) (firstIndexableField(prod))))[k] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(carry));
			}
		}
	}
	l1:	/* end cDigitMultiply:len:with:len:into:len: */;
	if (neg) {
...
{
	if (ix > (((byteSizeOf(aBytesOop)) + 3) / 4)) {
		return 0;
	}
	else {
		return SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aBytesOop))))[ix - 1]));
	}
}
...
digitSubLargewith(sqInt firstInteger, sqInt secondInteger)
{
	...
	if (firstDigitLen == secondDigitLen) {
		while ((firstDigitLen > 1)
		 && ((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(firstInteger))))[firstDigitLen - 1]))) == (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(secondInteger))))[firstDigitLen - 1]))))) {
			firstDigitLen -= 1;
		}
	...
	for (i = 0; i < smallerDigitLen; i += 1) {
		z = (z + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(larger))))[i])))) - (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(smaller))))[i])));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(res))))[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((z & 0xFFFFFFFFU)));
		z = 0 - ((z) >> 0x3F);
	}
	for (i = smallerDigitLen; i < largeDigitLen; i += 1) {
		z += SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(larger))))[i]));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(res))))[i] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN((z & 0xFFFFFFFFU)));
		z = 0 - ((z) >> 0x3F);
	}
...
digitLshift(sqInt anOop, sqInt shiftCount)
{
	...
	if (bitShift == 0) {
		...
		for (i1 = 0; i1 < (((newDigitLen - 1) - digitShift) + 1); i1 += 1) {
			((((unsigned int *) (firstIndexableField(newOop)))) + digitShift)[i1] = (((((unsigned int *) (firstIndexableField(anOop)))))[i1]);
		}
		goto l1;
	}
	rshift = 32 - bitShift;
	...
	limit = oldDigitLen - 1;
	for (i = 0; i <= limit; i += 1) {
		digit = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(anOop))))[i]));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(newOop))))[i + digitShift] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((carry | (((usqInt)(digit) << bitShift))) & 0xFFFFFFFFU)));
		carry = ((usqInt)(digit)) >> rshift;
	}
	if (!(carry == 0)) {
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(newOop))))[newDigitLen - 1] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(carry));
	}
...
digitRshiftlookfirst(sqInt anOop, sqInt shiftCount, sqInt a)
{
	...
	oldBitLen = cDigitHighBitlen(((unsigned int *) (firstIndexableField(anOop))), a);
	...
	if (bitShift == 0) {
		...
		for (i = 0; i < (((newDigitLen - 1)) + 1); i += 1) {
			((((unsigned int *) (firstIndexableField(newOop)))))[i] = (((((unsigned int *) (firstIndexableField(anOop)))) + digitShift)[i]);
		}
		goto l1;
	}
	leftShift = 32 - bitShift;
	carry = ((usqInt)((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(anOop))))[digitShift]))))) >> bitShift;
	start = digitShift + 1;
	limit = oldDigitLen - 1;
	for (j = start; j <= limit; j += 1) {
		digit = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(anOop))))[j]));
		/* begin cDigitOf:at:put: */
		(((unsigned int *) (firstIndexableField(newOop))))[j - start] = (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((carry | (((usqInt)(digit) << leftShift))) & 0xFFFFFFFFU)));
		carry = ((usqInt)(digit)) >> bitShift;
	}
	if (!(carry == 0)) {
		/* begin cDigitOf:at:put: */
	...
	l1:	/* end cDigitRshift:from:len:to:len: */;
	return newOop;
}
...
{
	return cDigitHighBitlen(((unsigned int *) (firstIndexableField(anOop))), ((byteSizeOf(anOop)) + 3) / 4);
}
...
isNormalized(sqInt aLargeInteger)
{
	...
	len = byteSizeOf(aLargeInteger);
	if (len == 0) {
		return 0;
	}
	if (((((unsigned char *) (firstIndexableField(aLargeInteger))))[len - 1]) == 0) {
		return 0;
	}
	return 1;
}
...
largeIntgrowTo(sqInt aBytesObject, sqInt newByteLen)
{
	...
	for (i = 0; i < copyLen; i += 1) {
		(((unsigned int *) (firstIndexableField(newBytes))))[i] = ((((unsigned int *) (firstIndexableField(aBytesObject))))[i]);
	}
	return newBytes;
}
...
normalizeNegative(sqInt aLargeNegativeInteger)
{
	...
	while ((digitLen != 0)
	 && ((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargeNegativeInteger))))[digitLen - 1]))) == 0)) {
		digitLen -= 1;
	}
	if (digitLen == 0) {
		return integerObjectOf(0);
	}
	val = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargeNegativeInteger))))[digitLen - 1]));
	...
	if (digitLen <= sLen) {
		...
		val2 = val;
		if (digitLen > 1) {
			val2 = (val2 << 32) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargeNegativeInteger))))[0])));
		}
		if (val2 <= minVal) {
...
normalizePositive(sqInt aLargePositiveInteger)
{
	...
	while ((digitLen != 0)
	 && ((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargePositiveInteger))))[digitLen - 1]))) == 0)) {
		digitLen -= 1;
	}
	if (digitLen == 0) {
		return integerObjectOf(0);
	}
	val = SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargePositiveInteger))))[digitLen - 1]));
	...
	if (digitLen <= sLen) {
		...
		if (digitLen > 1) {
			...
			val2 = ((((unsigned long long)val2)) << 32) + (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(aLargePositiveInteger))))[0])));
		}
		if (val2 <= maxVal) {
...
primAnyBitFromTo(void)
{
	...
	if (isIntegerObject(integer)) {
		...
		if (from <= to) {
			...
			mask = ((((usqInt)1)) << (((to < (((sizeof(usqInt)) * 8) - 1)) ? to : (((sizeof(usqInt)) * 8) - 1)))) - ((((usqInt)1)) << ((((from - 1) < (((sizeof(usqInt)) * 8) - 1)) ? (from - 1) : (((sizeof(usqInt)) * 8) - 1))));
...
primDigitBitShiftMagnitude(void)
{
	...
	rShift = 0 - shiftCount;
	aLargeInteger = digitRshiftlookfirst(aLarge, rShift, ((byteSizeOf(aLarge)) + 3) / 4);
	/* begin normalize: */
	if (isLargePositiveIntegerObject(aLargeInteger)) {
...
primDigitDivNegative(void)
{
	...
	d = 32 - (cHighBit32(SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(secondAsLargeInteger))))[secondDigitLen - 1]))));
	...
	_return_value = result;
	l2:	/* end digitDivLarge:with:negative: */;
	if (!(failed())) {
		methodReturnValue(_return_value);
	}
	return null;
...
primDigitMultiplyNegative(void)
{
	...
	l1:	/* end cDigitMultiply:len:with:len:into:len: */;
	if (neg) {
		_return_value = normalizeNegative(prod);
	}
	else {
...
primDigitSubtract(void)
{
	...
	if (firstDigitLen == secondDigitLen) {
		while ((firstDigitLen > 1)
		 && ((SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(firstLarge))))[firstDigitLen - 1]))) == (SQ_SWAP_4_BYTES_IF_BIGENDIAN(((((unsigned int *) (firstIndexableField(secondLarge))))[firstDigitLen - 1]))))) {
			firstDigitLen -= 1;
		}
		secondDigitLen = firstDigitLen;
	}
	...
	if (neg) {
		_return_value = normalizeNegative(res);
	}
	else {
		_return_value = normalizePositive(res);
	}
...
void* LargeIntegers_exports[][3] = {
	...
	{(void*)_m, "primDigitBitShiftMagnitude\000\001\001", (void*)primDigitBitShiftMagnitude},
	{(void*)_m, "primDigitBitXor\000\001\001", (void*)primDigitBitXor},
	{(void*)_m, "primDigitCompare\000\001\001", (void*)primDigitCompare},
	{(void*)_m, "primDigitDivNegative\000\001\001", (void*)primDigitDivNegative},
	{(void*)_m, "primDigitMultiplyNegative\000\001\001", (void*)primDigitMultiplyNegative},
	{(void*)_m, "primDigitSubtract\000\001\001", (void*)primDigitSubtract},
	{(void*)_m, "primGetModuleName\000\377\000", (void*)primGetModuleName},
	{(void*)_m, "primMontgomeryDigitLength\000\377\001", (void*)primMontgomeryDigitLength},
	{(void*)_m, "primMontgomeryTimesModulo\000\001\001", (void*)primMontgomeryTimesModulo},
	{(void*)_m, "primNormalizeNegative\000\001\001", (void*)primNormalizeNegative},
	{(void*)_m, "primNormalizePositive\000\001\001", (void*)primNormalizePositive},
