/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.1883 uuid: a87f979f-7e5b-44d1-804d-fc8403bde06d
   from
	LargeIntegersPlugin VMMaker.oscog-eem.1883 uuid: a87f979f-7e5b-44d1-804d-fc8403bde06d
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.1883 uuid: a87f979f-7e5b-44d1-804d-fc8403bde06d " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"LargeIntegers v2.0 VMMaker.oscog-eem.1883 (i)"
#else
	"LargeIntegers v2.0 VMMaker.oscog-eem.1883 (e)"
#endif
;
...
;
	...
	copyLen = (oldDigitLen < newDigitLen
		...
		: newDigitLen);
	/* begin cDigitCopyFrom:to:len: */
	pFrom = ((unsigned int *) (((unsigned int *) (firstIndexableField(aBytesObject)))));
	pTo = ((unsigned int *) (((unsigned int *) (firstIndexableField(newBytes)))));
