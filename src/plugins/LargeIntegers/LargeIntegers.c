/* Automatically generated by
   ...
   from
	LargeIntegersPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8
 */
static char __buildInfo[] = "LargeIntegersPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8 " __DATE__ ;
...
static const char *moduleName = "LargeIntegers v2.0 VMMaker.oscog-eem.3444 " INT_EXT;
...
digitLshift(sqInt anOop, sqInt shiftCount)
{
	...
	cDigitLshiftfromlentolen(shiftCount, ((unsigned int *) (firstIndexableField(anOop))), oldDigitLen, ((unsigned int *) (firstIndexableField(newOop))), newDigitLen);
	return newOop;
}
...
digitRshiftlookfirst(sqInt anOop, sqInt shiftCount, sqInt a)
{
	...
	cDigitRshiftfromlentolen(shiftCount, ((unsigned int *) (firstIndexableField(anOop))), oldDigitLen, ((unsigned int *) (firstIndexableField(newOop))), newDigitLen);
	return newOop;
}
