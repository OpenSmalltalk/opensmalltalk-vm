/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2728 uuid: 9d29dbcb-8c21-4d75-a8cc-c2af3fd75b03
   from
	DESPlugin CryptographyPlugins-ul.19 uuid: 524d0dac-cbe0-459b-8b63-3c8479cd354c
 */
static char __buildInfo[] = "DESPlugin CryptographyPlugins-ul.19 uuid: 524d0dac-cbe0-459b-8b63-3c8479cd354c " __DATE__ ;
...
static const char *moduleName = "DESPlugin CryptographyPlugins-ul.19 " INT_EXT;
...
primitiveDESCookKey(void)
{
	...
	cooked = ((unsigned int *) (firstIndexableField(oop1)));
	if (failed()) {
		return null;
	}
	processKeymodeto(raw, encode != 0, cooked);
	pop(3);
	return 0;
}
