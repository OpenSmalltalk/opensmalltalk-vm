...
/* Automatically generated by
   ...
   from
	SerialPlugin * VMMaker-dtl.314 uuid: 27bc9a3b-01be-47b3-8e3a-b5f5554a389d
 */
static char __buildInfo[] = "SerialPlugin * VMMaker-dtl.314 uuid: 27bc9a3b-01be-47b3-8e3a-b5f5554a389d " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SerialPlugin 6 April 2013 (i)"
#else
	"SerialPlugin 6 April 2013 (e)"
#endif
;
