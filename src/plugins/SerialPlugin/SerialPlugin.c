 ...
 */
static char __buildInfo[] = "SerialPlugin VMMaker-oscog.40 uuid: 637db40c-33c6-4263-816e-1b8cc19e3c99 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SerialPlugin VMMaker-oscog.40 (i)"
#else
	"SerialPlugin VMMaker-oscog.40 (e)"
#endif
;
