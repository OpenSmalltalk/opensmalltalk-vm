/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2489 uuid: bb2e13a9-7687-4c72-830d-3f928b6e9f0c
   from
	SerialPlugin VMMaker.oscog-eem.2489 uuid: bb2e13a9-7687-4c72-830d-3f928b6e9f0c
 */
static char __buildInfo[] = "SerialPlugin VMMaker.oscog-eem.2489 uuid: bb2e13a9-7687-4c72-830d-3f928b6e9f0c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SerialPlugin VMMaker.oscog-eem.2489 (i)"
#else
	"SerialPlugin VMMaker.oscog-eem.2489 (e)"
#endif
;
...
primitiveSerialPortCloseByName(void)
{
	...
	serialPortCloseByName(portName);
	if (failed()) {
		return null;
	}
	pop(1);
