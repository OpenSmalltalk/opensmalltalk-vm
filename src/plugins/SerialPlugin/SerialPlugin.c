/* Automatically generated by
   ...
   from
	SerialPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "SerialPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "SerialPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveSerialPortCloseAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortOpenAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortOpenByNameAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortReadAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortReadByNameAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortWriteAccessorDepth = 0;
EXPORT(signed char) primitiveSerialPortWriteByNameAccessorDepth = 0;
