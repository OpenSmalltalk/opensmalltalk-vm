...
/* Automatically generated by
   ...
   from
	SerialPlugin VMMaker-dtl.355 uuid: 9e6e08b4-e8f0-44b0-803c-de1559fbcb27
 */
static char __buildInfo[] = "SerialPlugin VMMaker-dtl.355 uuid: 9e6e08b4-e8f0-44b0-803c-de1559fbcb27 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SerialPlugin 25 November 2014 (i)"
#else
	"SerialPlugin 25 November 2014 (e)"
#endif
;
