/* Automatically generated by
   ...
   from
	UnicodePlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "UnicodePlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "UnicodePlugin VMMaker.oscog-eem.3453 " INT_EXT;
...
primitiveDrawString(void)
{
	...
	bitmapPtr = ((void *) ((failed()
	? 0
	: firstIndexableField(bitmapOop))));
	if (failed()) {
		return null;
	}
...
void* UnicodePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveClipboardGet\000\001\000", (void*)primitiveClipboardGet},
	{(void*)_m, "primitiveClipboardPut\000\001\000", (void*)primitiveClipboardPut},
