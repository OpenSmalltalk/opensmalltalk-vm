/* Automatically generated by
   ...
   from
	FloatMathPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "FloatMathPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "FloatMathPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveArcCosAccessorDepth = 0;
EXPORT(signed char) primitiveArcCosHAccessorDepth = 0;
EXPORT(signed char) primitiveArcSinAccessorDepth = 0;
EXPORT(signed char) primitiveArcSinHAccessorDepth = 0;
EXPORT(signed char) primitiveArcTanAccessorDepth = 0;
EXPORT(signed char) primitiveArcTan2AccessorDepth = 0;
EXPORT(signed char) primitiveArcTanHAccessorDepth = 0;
EXPORT(signed char) primitiveCosAccessorDepth = 0;
EXPORT(signed char) primitiveCosHAccessorDepth = 0;
EXPORT(signed char) primitiveExpAccessorDepth = 0;
EXPORT(signed char) primitiveFModAccessorDepth = 0;
EXPORT(signed char) primitiveFractionalPartAccessorDepth = 0;
EXPORT(signed char) primitiveHypotAccessorDepth = 0;
EXPORT(signed char) primitiveLog10AccessorDepth = 0;
EXPORT(signed char) primitiveLogNAccessorDepth = 0;
EXPORT(signed char) primitiveRaisedToPowerAccessorDepth = 0;
EXPORT(signed char) primitiveSinAccessorDepth = 0;
EXPORT(signed char) primitiveSinHAccessorDepth = 0;
EXPORT(signed char) primitiveSqrtAccessorDepth = 0;
EXPORT(signed char) primitiveTanAccessorDepth = 0;
EXPORT(signed char) primitiveTanHAccessorDepth = 0;
EXPORT(signed char) primitiveTimesTwoPowerAccessorDepth = 0;
