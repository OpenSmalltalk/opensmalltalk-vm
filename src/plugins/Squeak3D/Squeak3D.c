/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.1543 uuid: 7ab33230-086d-4b21-a335-26f16100a3b4
   from
	B3DEnginePlugin Balloon3D-Plugins-tpr.9 uuid: f7c4982a-8771-4b3d-beb5-7cee14ae6e22
 */
static char __buildInfo[] = "B3DEnginePlugin Balloon3D-Plugins-tpr.9 uuid: f7c4982a-8771-4b3d-beb5-7cee14ae6e22 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"Squeak3D Balloon3D-Plugins-tpr.9 (i)"
#else
	"Squeak3D Balloon3D-Plugins-tpr.9 (e)"
#endif
;
		...
		for (j = 0; j < lightCount; j += 1) {
			...
			if (lightFlags & FlagPositional) {
				...
				if (!((l2vDistance == 0.0)
					...
					scale2 = -1.0 / l2vDistance;
				}
				l2vDirection[0] = ((l2vDirection[0]) * scale2);
				l2vDirection[1] = ((l2vDirection[1]) * scale2);
				l2vDirection[2] = ((l2vDirection[2]) * scale2);
			}
			else {
			...
			if ((lightFlags & FlagSpecularPart)
			 && ((primMaterial[MaterialShininess]) > 0.0)) {
				...
				if (vbFlags & VBUseLocalViewer) {
					...
					scale3 = (((aVector[0]) * (aVector[0])) + ((aVector[1]) * (aVector[1]))) + ((aVector[2]) * (aVector[2]));
					if ((scale3 == 0.0)
					 || (scale3 == 1.0)) {
						scale1 = scale3;
						goto l1;
					}
					scale1 = 1.0 / (sqrt(scale3));
				l1:	/* end inverseLengthOfFloat: */;
					l2vSpecDir[0] = ((l2vSpecDir[0]) - ((litVertex[PrimVtxPositionX]) * scale1));
					l2vSpecDir[1] = ((l2vSpecDir[1]) - ((litVertex[PrimVtxPositionY]) * scale1));
					l2vSpecDir[2] = ((l2vSpecDir[2]) - ((litVertex[PrimVtxPositionZ]) * scale1));
				}
				else {
...
loadRasterizerState(sqInt stackIndex)
{
	...
	stateOop = stackObjectValue(stackIndex);
	if (failed()) {
		return 0;
	}
	if (!((isPointers(stateOop))
...
void* Squeak3D_exports[][3] = {
	{"Squeak3D", "b3dClipPolygon\000\001", (void*)b3dClipPolygon},
	{"Squeak3D", "b3dComputeMinIndexZ\000\001", (void*)b3dComputeMinIndexZ},
	{"Squeak3D", "b3dComputeMinZ\000\001", (void*)b3dComputeMinZ},
	{"Squeak3D", "b3dDetermineClipFlags\000\001", (void*)b3dDetermineClipFlags},
	{"Squeak3D", "b3dInitializeRasterizerState\000\002", (void*)b3dInitializeRasterizerState},
	{"Squeak3D", "b3dInitPrimitiveObject\000\001", (void*)b3dInitPrimitiveObject},
	{"Squeak3D", "b3dInplaceHouseHolderInvert\000\000", (void*)b3dInplaceHouseHolderInvert},
	{"Squeak3D", "b3dLoadIndexArray\000\000", (void*)b3dLoadIndexArray},
	{"Squeak3D", "b3dLoadVertexBuffer\000\000", (void*)b3dLoadVertexBuffer},
	{"Squeak3D", "b3dMapVertexBuffer\000\001", (void*)b3dMapVertexBuffer},
	{"Squeak3D", "b3dOrthoNormInverseMatrix\000\001", (void*)b3dOrthoNormInverseMatrix},
	{"Squeak3D", "b3dPrimitiveNextClippedTriangle\000\001", (void*)b3dPrimitiveNextClippedTriangle},
	{"Squeak3D", "b3dPrimitiveObjectSize\000\377", (void*)b3dPrimitiveObjectSize},
	{"Squeak3D", "b3dPrimitiveTextureSize\000\377", (void*)b3dPrimitiveTextureSize},
	{"Squeak3D", "b3dRasterizerVersion\000\377", (void*)b3dRasterizerVersion},
	{"Squeak3D", "b3dShaderVersion\000\377", (void*)b3dShaderVersion},
	{"Squeak3D", "b3dShadeVertexBuffer\000\001", (void*)b3dShadeVertexBuffer},
	{"Squeak3D", "b3dStartRasterizer\000\002", (void*)b3dStartRasterizer},
	{"Squeak3D", "b3dTransformDirection\000\001", (void*)b3dTransformDirection},
	{"Squeak3D", "b3dTransformerVersion\000\377", (void*)b3dTransformerVersion},
	{"Squeak3D", "b3dTransformMatrixWithInto\000\000", (void*)b3dTransformMatrixWithInto},
	{"Squeak3D", "b3dTransformPoint\000\001", (void*)b3dTransformPoint},
	{"Squeak3D", "b3dTransformPrimitiveNormal\000\000", (void*)b3dTransformPrimitiveNormal},
	{"Squeak3D", "b3dTransformPrimitivePosition\000\000", (void*)b3dTransformPrimitivePosition},
	{"Squeak3D", "b3dTransformPrimitiveRasterPosition\000\000", (void*)b3dTransformPrimitiveRasterPosition},
	{"Squeak3D", "b3dTransformVertexBuffer\000\001", (void*)b3dTransformVertexBuffer},
	{"Squeak3D", "b3dTransposeMatrix\000\001", (void*)b3dTransposeMatrix},
	...
	{"Squeak3D", "primitiveSetBitBltPlugin\000\001", (void*)primitiveSetBitBltPlugin},
