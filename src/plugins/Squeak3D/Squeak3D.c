...
static int determineClipFlagscount(void *vtxArray, sqInt count);
...
b3dInitPrimitiveObject(void)
{
	...
	primObj = ((void *) (firstIndexableField(primOop)));
	/* Do the work */
			...
			if (lightScale > 0.001) {
				...
				if (((lightFlags & FlagDiffusePart) != 0)) {
					...
					if (cosAngle > 0.0) {
						...
						scale1 = lightScale * cosAngle;
						/* begin addPart:from:trackFlag:scale: */
						if (((vbFlags & VBTrackDiffuse) != 0)) {
							rPart1 = ((vtxInColor[0]) * (lightPart1[0])) * scale1;
							gPart1 = ((vtxInColor[1]) * (lightPart1[1])) * scale1;
							bPart1 = ((vtxInColor[2]) * (lightPart1[2])) * scale1;
							aPart1 = ((vtxInColor[3]) * (lightPart1[3])) * scale1;
						}
						else {
							/* Note: This should be pre-computed. */
							rPart1 = (((primMaterial + DiffusePart)[0]) * (lightPart1[0])) * scale1;
							gPart1 = (((primMaterial + DiffusePart)[1]) * (lightPart1[1])) * scale1;
							bPart1 = (((primMaterial + DiffusePart)[2]) * (lightPart1[2])) * scale1;
							aPart1 = (((primMaterial + DiffusePart)[3]) * (lightPart1[3])) * scale1;
						}
...
loadRasterizerState(sqInt stackIndex)
{
	...
	objPtr = ((void *) (firstIndexableField(obj)));
...
loadTextureinto(sqInt textureOop, B3DTexture *destPtr)
{
	...
	bitsPtr = ((void *) (firstIndexableField(formBits)));
