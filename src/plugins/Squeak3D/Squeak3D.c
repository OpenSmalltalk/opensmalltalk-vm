/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-nice.2957 uuid: e820d3f1-42f7-4e56-a91f-1d4961d2a2c5
   from
...
EXPORT(signed char) b3dClipPolygonAccessorDepth = 1;
EXPORT(signed char) b3dComputeMinIndexZAccessorDepth = 1;
EXPORT(signed char) b3dComputeMinZAccessorDepth = 1;
EXPORT(signed char) b3dDetermineClipFlagsAccessorDepth = 1;
EXPORT(signed char) b3dInitializeRasterizerStateAccessorDepth = 1;
EXPORT(signed char) b3dInitPrimitiveObjectAccessorDepth = 1;
EXPORT(signed char) b3dInplaceHouseHolderInvertAccessorDepth = 0;
EXPORT(signed char) b3dLoadIndexArrayAccessorDepth = 0;
EXPORT(signed char) b3dLoadVertexBufferAccessorDepth = 0;
EXPORT(signed char) b3dMapVertexBufferAccessorDepth = 1;
EXPORT(signed char) b3dOrthoNormInverseMatrixAccessorDepth = 1;
EXPORT(signed char) b3dPrimitiveNextClippedTriangleAccessorDepth = 1;
EXPORT(signed char) b3dShadeVertexBufferAccessorDepth = 1;
EXPORT(signed char) b3dStartRasterizerAccessorDepth = 2;
EXPORT(signed char) b3dTransformDirectionAccessorDepth = 1;
EXPORT(signed char) b3dTransformMatrixWithIntoAccessorDepth = 0;
EXPORT(signed char) b3dTransformPointAccessorDepth = 1;
EXPORT(signed char) b3dTransformPrimitiveNormalAccessorDepth = 0;
EXPORT(signed char) b3dTransformPrimitivePositionAccessorDepth = 0;
EXPORT(signed char) b3dTransformPrimitiveRasterPositionAccessorDepth = 0;
EXPORT(signed char) b3dTransformVertexBufferAccessorDepth = 1;
EXPORT(signed char) b3dTransposeMatrixAccessorDepth = 1;
