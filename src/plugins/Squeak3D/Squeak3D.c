/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	B3DEnginePlugin Balloon3D-Plugins-eem.26 uuid: 8b92d5bd-d65a-432a-b877-cd21806935ce
 */
static char __buildInfo[] = "B3DEnginePlugin Balloon3D-Plugins-eem.26 uuid: 8b92d5bd-d65a-432a-b877-cd21806935ce " __DATE__ ;
...
static const char *moduleName = "Squeak3D Balloon3D-Plugins-eem.26 " INT_EXT;
...
b3dMapVertexBuffer(void)
{
	...
	boxArray = stackMutableObjectValue(0);
	vtxCount = stackIntegerValue(1);
	if (!(failed())) {
		if (((fetchClassOf(boxArray)) == (classArray()))
		 && ((slotSizeOf(boxArray)) == 4)) {
			if ((vtxArray = stackPrimitiveVertexArrayofSize(2, vtxCount))) {
				/* mapVB:ofSize:into: can no longer fail or GC */
				...
				/* floatObjectOf: can no longer fail */
				storePointerofObjectwithValue(0, boxArray, floatObjectOf(left));
				storePointerofObjectwithValue(1, boxArray, floatObjectOf(top));
				storePointerofObjectwithValue(2, boxArray, floatObjectOf(right));
				storePointerofObjectwithValue(3, boxArray, floatObjectOf(bottom));
				return pop(3);
			}
		}
	}
...
{
	methodReturnInteger((((sizeof(B3DPrimitiveObject)) / 4) + ((sizeof(B3DPrimitiveVertex)) / 4)) + 2);
	return 0;
}
...
{
	methodReturnInteger(((sizeof(B3DTexture)) / 4) + 1);
	return 0;
}
				...
				if (((lightFlags & FlagDiffusePart) != 0)) {
					...
					if (cosAngle > 0.0) {
						...
						if (((vbFlags & VBTrackDiffuse) != 0)) {
							...
							/* Note: This should be pre-computed. */
							rPart = (((primMaterial + DiffusePart)[0]) * (lightPart[0])) * scale;
							gPart = (((primMaterial + DiffusePart)[1]) * (lightPart[1])) * scale;
							bPart = (((primMaterial + DiffusePart)[2]) * (lightPart[2])) * scale;
							aPart = (((primMaterial + DiffusePart)[3]) * (lightPart[3])) * scale;
						}
						vtxOutColor[0] = ((vtxOutColor[0]) + rPart);
						vtxOutColor[1] = ((vtxOutColor[1]) + gPart);
						vtxOutColor[2] = ((vtxOutColor[2]) + bPart);
			...
			if ((((lightFlags & FlagSpecularPart) != 0))
			 && ((primMaterial[MaterialShininess]) > 0.0)) {
				...
				if (((vbFlags & VBUseLocalViewer) != 0)) {
					...
					scaleDouble = ((((litVertex + PrimVtxPosition)[0]) * ((litVertex + PrimVtxPosition)[0])) + (((litVertex + PrimVtxPosition)[1]) * ((litVertex + PrimVtxPosition)[1]))) + (((litVertex + PrimVtxPosition)[2]) * ((litVertex + PrimVtxPosition)[2]));
					if ((scaleDouble == 0.0)
					 || (scaleDouble == 1.0)) {
						scale = scaleDouble;
						goto l1;
...
l1:
				...
				if (cosAngle > 0.0) {
					...
					if (((vbFlags & VBTrackSpecular) != 0)) {
						...
						/* Note: This should be pre-computed. */
						rPart = (((primMaterial + SpecularPart)[0]) * (lightPart[0])) * specularFactor;
						gPart = (((primMaterial + SpecularPart)[1]) * (lightPart[1])) * specularFactor;
						bPart = (((primMaterial + SpecularPart)[2]) * (lightPart[2])) * specularFactor;
						aPart = (((primMaterial + SpecularPart)[3]) * (lightPart[3])) * specularFactor;
					}
					vtxOutColor[0] = ((vtxOutColor[0]) + rPart);
					vtxOutColor[1] = ((vtxOutColor[1]) + gPart);
					vtxOutColor[2] = ((vtxOutColor[2]) + bPart);
		...
		(((int*) litVertex))[PrimVtxColor32] = (b + ((((usqInt)((g + ((((usqInt)((r + ((((usqInt)(a) << 8))))) << 8))))) << 8))));
...
l2:
	...
	if ((((mvFlags & FlagM44NoPerspective) != 0))
	 && (prFlags == 0)) {
...
loadTexturesFrom(sqInt stackIndex)
{
	...
	for (i = 0; i < n; i += 1) {
		...
		if (!((b3dLoadTexture(destPtr, formWidth, formHeight, formDepth, ((unsigned int *) bitsPtr), 0, NULL)) == B3D_NO_ERROR)) {
			return primitiveFail();
		}
	}
	return 0;
...
stackPrimitiveVertexArrayofSize(sqInt index, sqInt nItems)
{
	...
	if ((oop = stackObjectValue(index))) {
		if ((isWords(oop))
		 && ((((oopSize = slotSizeOf(oop))) >= (nItems * PrimVertexSize))
...
void* Squeak3D_exports[][3] = {
	...
	{(void*)_m, "b3dComputeMinIndexZ\000\001\000", (void*)b3dComputeMinIndexZ},
	{(void*)_m, "b3dComputeMinZ\000\001\000", (void*)b3dComputeMinZ},
	{(void*)_m, "b3dDetermineClipFlags\000\001\000", (void*)b3dDetermineClipFlags},
	{(void*)_m, "b3dInitializeRasterizerState\000\002\000", (void*)b3dInitializeRasterizerState},
	{(void*)_m, "b3dInitPrimitiveObject\000\001\000", (void*)b3dInitPrimitiveObject},
	{(void*)_m, "b3dInplaceHouseHolderInvert\000\377\000", (void*)b3dInplaceHouseHolderInvert},
	{(void*)_m, "b3dLoadIndexArray\000\001\000", (void*)b3dLoadIndexArray},
	{(void*)_m, "b3dLoadVertexBuffer\000\001\000", (void*)b3dLoadVertexBuffer},
	{(void*)_m, "b3dMapVertexBuffer\000\001\000", (void*)b3dMapVertexBuffer},
	{(void*)_m, "b3dOrthoNormInverseMatrix\000\001\000", (void*)b3dOrthoNormInverseMatrix},
	{(void*)_m, "b3dPrimitiveNextClippedTriangle\000\001\000", (void*)b3dPrimitiveNextClippedTriangle},
	{(void*)_m, "b3dPrimitiveObjectSize\000\377\000", (void*)b3dPrimitiveObjectSize},
	{(void*)_m, "b3dPrimitiveTextureSize\000\377\000", (void*)b3dPrimitiveTextureSize},
	{(void*)_m, "b3dRasterizerVersion\000\377\000", (void*)b3dRasterizerVersion},
	{(void*)_m, "b3dShaderVersion\000\377\000", (void*)b3dShaderVersion},
	{(void*)_m, "b3dShadeVertexBuffer\000\001\000", (void*)b3dShadeVertexBuffer},
	{(void*)_m, "b3dStartRasterizer\000\377\000", (void*)b3dStartRasterizer},
	{(void*)_m, "b3dTransformDirection\000\001\000", (void*)b3dTransformDirection},
	{(void*)_m, "b3dTransformerVersion\000\377\000", (void*)b3dTransformerVersion},
	{(void*)_m, "b3dTransformMatrixWithInto\000\377\000", (void*)b3dTransformMatrixWithInto},
	{(void*)_m, "b3dTransformPoint\000\001\000", (void*)b3dTransformPoint},
	{(void*)_m, "b3dTransformPrimitiveNormal\000\000\000", (void*)b3dTransformPrimitiveNormal},
	{(void*)_m, "b3dTransformPrimitivePosition\000\377\000", (void*)b3dTransformPrimitivePosition},
	{(void*)_m, "b3dTransformPrimitiveRasterPosition\000\377\000", (void*)b3dTransformPrimitiveRasterPosition},
	{(void*)_m, "b3dTransformVertexBuffer\000\001\000", (void*)b3dTransformVertexBuffer},
...
EXPORT(signed short) b3dComputeMinIndexZMetadata = 0x100;
EXPORT(signed short) b3dComputeMinZMetadata = 0x100;
