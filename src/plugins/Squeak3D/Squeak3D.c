		...
		for (j = 0; j < lightCount; j += 1) {
			...
			if (((lightFlags & FlagPositional) != 0)) {
				...
				if (!((l2vDistance == 0.0)
					...
					scale3 = -1.0 / l2vDistance;
				}
				l2vDirection[0] = ((l2vDirection[0]) * scale3);
				l2vDirection[1] = ((l2vDirection[1]) * scale3);
				l2vDirection[2] = ((l2vDirection[2]) * scale3);
			}
			else {
