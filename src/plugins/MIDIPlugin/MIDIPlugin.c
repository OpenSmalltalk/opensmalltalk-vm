/* Automatically generated by
   ...
   from
	MIDIPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "MIDIPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "MIDIPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveMIDIClosePortAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIGetPortDirectionalityAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIGetPortNameAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIOpenPortAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIParameterGetAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIParameterGetOrSetAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIParameterSetAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIReadAccessorDepth = 0;
EXPORT(signed char) primitiveMIDIWriteAccessorDepth = 0;
