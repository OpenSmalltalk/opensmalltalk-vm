/* Automatically generated by
   ...
   from
	CroquetPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "CroquetPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "CroquetPlugin VMMaker.oscog-eem.3453 " INT_EXT;
...
primitiveARC4Transform(void)
{
	...
	m = ((unsigned char *) (firstIndexableField(mOop)));
	buffer = ((unsigned char *) (firstIndexableField(bufOop)));
...
primitiveTransformMatrixWithInto(void)
{
	...
	m2 = ((isWords(oop1))
	 && ((slotSizeOf(oop1)) == 16)
		? firstIndexableField(oop1)
		: 0);
	/* begin stackMatrix: */
	oop2 = stackValue(2);
	m1 = ((isWords(oop2))
	 && ((slotSizeOf(oop2)) == 16)
		? firstIndexableField(oop2)
		: 0);
	if ((m1 == null)
	 || ((m2 == null)
	 || ((m3 == null)
...
primitiveTriBoxIntersects(void)
{
	...
	maxCorner = ((isWords(oop3))
	 && ((slotSizeOf(oop3)) == 3)
		? firstIndexableField(oop3)
		: 0);
	/* begin stackVector3: */
	oop4 = stackValue(4);
	minCorner = ((isWords(oop4))
	 && ((slotSizeOf(oop4)) == 3)
		? firstIndexableField(oop4)
		: 0);
	if ((v0 == null)
	 || ((v1 == null)
	 || ((v2 == null)
