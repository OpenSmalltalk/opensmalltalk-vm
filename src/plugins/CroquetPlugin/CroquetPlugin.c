/* Automatically generated by
   ...
   from
	CroquetPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "CroquetPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "CroquetPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveAdj3AccessorDepth = 1;
EXPORT(signed char) primitiveARC4TransformAccessorDepth = 1;
EXPORT(signed char) primitiveDet3AccessorDepth = 1;
EXPORT(signed char) primitiveGatherEntropyAccessorDepth = 1;
EXPORT(signed char) primitiveInplaceHouseHolderInvertAccessorDepth = 0;
EXPORT(signed char) primitiveInverseByAdjointAccessorDepth = 1;
EXPORT(signed char) primitiveMD5TransformAccessorDepth = 1;
EXPORT(signed char) primitiveOptimizeVertexIndicesForCacheLocalityAccessorDepth = 1;
EXPORT(signed char) primitiveOrthoNormInverseMatrixAccessorDepth = 1;
EXPORT(signed char) primitiveTransformDirectionAccessorDepth = 1;
EXPORT(signed char) primitiveTransformMatrixWithIntoAccessorDepth = 0;
EXPORT(signed char) primitiveTransformVector3AccessorDepth = 1;
EXPORT(signed char) primitiveTransposeMatrixAccessorDepth = 1;
EXPORT(signed char) primitiveTriBoxIntersectsAccessorDepth = 0;
