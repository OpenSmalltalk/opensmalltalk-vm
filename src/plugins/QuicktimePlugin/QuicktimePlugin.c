/* Automatically generated by
   ...
   from
	QuicktimePlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "QuicktimePlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "QuicktimePlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveClearFrameCompletedSemaphoreAccessorDepth = 0;
EXPORT(signed char) primitiveDestroyHandleAccessorDepth = 0;
EXPORT(signed char) primitiveDestroySurfaceAccessorDepth = 0;
EXPORT(signed char) primitiveSetFrameCompletedSemaphoreAccessorDepth = 0;
EXPORT(signed char) primitiveSetGWorldPtrOntoExistingSurfaceAccessorDepth = 0;
EXPORT(signed char) primitiveSetGWorldPtrOntoSurfaceAccessorDepth = 0;
