...
EXPORT(signed char) primitiveDecodeStateAccessorDepth = 1;
EXPORT(signed char) primitiveInitializeStateAccessorDepth = 1;
EXPORT(signed char) primitiveProcessBufferWithStateAccessorDepth = 1;
