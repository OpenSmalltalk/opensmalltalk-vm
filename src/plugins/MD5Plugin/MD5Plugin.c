...
static sqInt primitiveDecodeState(void);
static sqInt primitiveInitializeState(void);
static sqInt primitivePluginAvailable(void);
static sqInt primitiveProcessBufferWithState(void);
