/* Smalltalk from Squeak4.4 with VMMaker 4.12.13 translated as C source on 10 January 2014 5:30:24 pm */
...
static sqInt bits_byteAt(sqInt oop);
static sqInt bits_byteAtput(sqInt oop, int val);
static sqInt bits_byteAtPointer(char *ptr);
static sqInt bits_byteAtPointerput(char *ptr, int val);
static sqInt bits_intAt(sqInt oop);
static sqInt bits_intAtput(sqInt oop, int val);
static sqInt bits_intAtPointer(char *ptr);
static sqInt bits_intAtPointerput(char *ptr, unsigned int val);
static sqInt bits_long32At(sqInt ptr);
static sqInt bits_long32Atput(sqInt ptr, int val);
static sqInt bits_longAt(sqInt oop);
static sqInt bits_longAtput(sqInt oop, sqInt val);
static sqInt bits_longAtPointer(char *ptr);
static sqInt bits_longAtPointerput(char *ptr, sqInt val);
static sqInt bits_oopAt(sqInt oop);
static sqInt bits_oopAtput(sqInt oop, sqInt val);
static sqInt bits_oopAtPointer(char *ptr);
static sqInt bits_oopAtPointerput(char *ptr, sqInt val);
static usqInt bits_oopForPointer(char *ptr);
static char * bits_pointerForOop(usqInt oop);
static sqInt bits_shortAt(sqInt oop);
static sqInt bits_shortAtput(sqInt oop, int val);
static sqInt bits_shortAtPointer(char *ptr);
static sqInt bits_shortAtPointerput(char *ptr, int val);
static sqInt bits_shortUnsignedAtPointer(char *ptr);
static char * bits_sqMemoryBaseAddress(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"RomePlugin yo.39 10 January 2014 (i)"
#else
	"RomePlugin yo.39 10 January 2014 (e)"
#endif
;
...
static sqInt bits_byteAt(sqInt oop) {
	return ((sqInt) ((((unsigned char *) ((sqMemoryBase) + oop)))[0]));
}
...
static sqInt bits_byteAtput(sqInt oop, int val) {
	return ((sqInt) ((((unsigned char *) ((sqMemoryBase) + oop)))[0] = val));
}
...
static sqInt bits_byteAtPointer(char *ptr) {
	return ((sqInt) ((((unsigned char *) ptr))[0]));
}
...
static sqInt bits_byteAtPointerput(char *ptr, int val) {
	return ((sqInt) ((((unsigned char *) ptr))[0] = val));
}
...
static sqInt bits_intAt(sqInt oop) {
	return ((sqInt) ((((unsigned int *) ((sqMemoryBase) + oop)))[0]));
}
...
static sqInt bits_intAtput(sqInt oop, int val) {
	return ((sqInt) ((((unsigned int *) ((sqMemoryBase) + oop)))[0] = val));
}
...
static sqInt bits_intAtPointerput(char *ptr, unsigned int val) {
	return ((sqInt) ((((unsigned int *) ptr))[0] = val));
}
...
static sqInt bits_long32At(sqInt ptr) {
	return ((sqInt) ((((unsigned int *) ((sqMemoryBase) + ptr)))[0]));
}
...
static sqInt bits_long32Atput(sqInt ptr, int val) {
	return ((sqInt) ((((unsigned int *) ((sqMemoryBase) + ptr)))[0] = val));
}
...
static sqInt bits_longAtput(sqInt oop, sqInt val) {
	return ((sqInt) ((((sqInt *) ((sqMemoryBase) + oop)))[0] = val));
}
...
static sqInt bits_oopAt(sqInt oop) {
	return (((sqInt *) ((sqMemoryBase) + oop)))[0];
}
...
static sqInt bits_oopAtput(sqInt oop, sqInt val) {
	return (((sqInt *) ((sqMemoryBase) + oop)))[0] = val;
}
...
static usqInt bits_oopForPointer(char *ptr) {
	return ((usqInt) (ptr - (sqMemoryBase)));
}
...
static sqInt bits_shortAt(sqInt oop) {
	return ((sqInt) ((((short *) ((sqMemoryBase) + oop)))[0]));
}
...
static sqInt bits_shortAtput(sqInt oop, int val) {
	return ((sqInt) ((((short *) ((sqMemoryBase) + oop)))[0] = (((short) val))));
}
...
static sqInt bits_shortAtPointerput(char *ptr, int val) {
	return ((sqInt) ((((short *) ptr))[0] = (((short) val))));
}
...
static sqInt bits_shortUnsignedAtPointer(char *ptr) {
	return ((sqInt) ((((unsigned short *) ptr))[0]));
}
...
EXPORT(sqInt) initialiseModule(void) {
	...
	for (i = 0, iLimiT = (lastIndex(contexts)); i <= iLimiT; i += 1) {
		contexts[i] = null;
	}
	for (i = 0, iLimiT = (lastIndex(fontDescriptions)); i <= iLimiT; i += 1) {
