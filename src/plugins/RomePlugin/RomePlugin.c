/* Smalltalk from Squeak4.3 with VMMaker 4.11.4 translated as C source on 25 March 2013 9:44 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"RomePlugin yo.39 25 March 2013 (i)"
#else
	"RomePlugin yo.39 25 March 2013 (e)"
#endif
;
