/* Smalltalk from Squeak4.4 with VMMaker 4.12.10 translated as C source on 21 December 2013 11:35:05 am */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"RomePlugin yo.39 21 December 2013 (i)"
#else
	"RomePlugin yo.39 21 December 2013 (e)"
#endif
;
