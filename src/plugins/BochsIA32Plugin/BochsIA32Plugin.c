/* Automatically generated by
   ...
   from
	BochsIA32Plugin Cog-eem.458 uuid: 020d2521-b443-4f38-99c9-51dca417fef2
 */
static char __buildInfo[] = "BochsIA32Plugin Cog-eem.458 uuid: 020d2521-b443-4f38-99c9-51dca417fef2 " __DATE__ ;
...
static const char *moduleName = "BochsIA32Plugin Cog-eem.458 " INT_EXT;
...
primitiveIntegerRegisterState(void)
{
	...
	if ((byteSizeOf(registerStateVector)) != (NumIntegerRegisterStateFields * (sizeof(int /* begin integerRegisterElementType */)))) {
		return primitiveFailFor(PrimErrBadArgument);
	}
