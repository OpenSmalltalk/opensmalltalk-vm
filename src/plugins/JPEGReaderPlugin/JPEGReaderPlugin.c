/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscog-eem.1809 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscog-eem.1809 (e)"
#endif
;
...
colorConvertGrayscaleMCU(void)
{
	...
	for (i = 0; i < jpegBitsSize; i += 1) {
		...
		y = ((y < 1) ? 1 : y);
		jpegBits[i] = (((0xFF000000ULL + (y << 16)) + (y << 8)) + y);
	}
	return 0;
}
...
colorConvertMCU(void)
{
	...
	for (i = 0; i < jpegBitsSize; i += 1) {
		...
		blue = ((blue < 1) ? 1 : blue);
		jpegBits[i] = (((0xFF000000ULL + (((usqInt) red << 16))) + (((usqInt) green << 8))) + blue);
	}
	return 0;
}
