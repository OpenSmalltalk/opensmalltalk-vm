/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-eem.2062 uuid: f42af46e-c315-4da9-8a34-aa300763e11c
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.2062 uuid: f42af46e-c315-4da9-8a34-aa300763e11c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscog-eem.2062 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscog-eem.2062 (e)"
#endif
;
...
idctBlockIntqt(int *anArray, int *qt)
{
	...
	for (i = 0; i < DCTSize; i += 1) {
		...
		if (anACTerm == -1) {
			dcval = ((int)((usqInt)(((anArray[i]) * (qt[0]))) << Pass1Bits));
			...
			t0 = ((int)((usqInt)((z2 + z3)) << ConstBits));
			t1 = ((int)((usqInt)((z2 - z3)) << ConstBits));
			t10 = t0 + t3;
			t13 = t0 - t3;
			t11 = t1 + t2;
			t12 = t1 - t2;
	...
	for (i = 0; i <= (DCTSize2 - DCTSize); i += DCTSize) {
		...
		t2 = z1 + (z3 * (0 - FIXn1n847759065));
		t3 = z1 + (z2 * FIXn0n765366865);
		t0 = ((int)((usqInt)(((ws[i]) + (ws[i + 4]))) << ConstBits));
		t1 = ((int)((usqInt)(((ws[i]) - (ws[i + 4]))) << ConstBits));
		t10 = t0 + t3;
		t13 = t0 - t3;
		t11 = t1 + t2;
		t12 = t1 - t2;
