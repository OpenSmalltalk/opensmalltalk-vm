/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	JPEGReaderPlugin VMMaker.oscog-eem.3784 uuid: ad2305b0-44cb-456b-8b07-7a1a9825bc2b
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.3784 uuid: ad2305b0-44cb-456b-8b07-7a1a9825bc2b " __DATE__ ;
...
static const char *moduleName = "JPEGReaderPlugin VMMaker.oscog-eem.3784 " INT_EXT;
...
primitiveColorConvertMCU(void)
{
	...
	oop = fetchPointerofObject(0, arrayOop);
	if (!((colorComponentfrom(yComponent, oop))
		 && (colorComponentBlocksfrom(yBlocks, oop)))) {
		return primitiveFail();
	}
	oop = fetchPointerofObject(1, arrayOop);
	if (!((colorComponentfrom(cbComponent, oop))
		 && (colorComponentBlocksfrom(cbBlocks, oop)))) {
		return primitiveFail();
	}
	oop = fetchPointerofObject(2, arrayOop);
	if (!((colorComponentfrom(crComponent, oop))
