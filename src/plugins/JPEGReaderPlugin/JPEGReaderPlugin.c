/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-eem.1851 uuid: a2b37448-8ea6-480e-aa07-e99d6de1744a
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.1851 uuid: a2b37448-8ea6-480e-aa07-e99d6de1744a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscog-eem.1851 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscog-eem.1851 (e)"
#endif
;
...
decodeBlockIntocomponent(int *anArray, int *aColorComponent)
{
	...
	if (byte != 0) {
		...
		jsBitBuffer = jsBitBuffer & ((1L << jsBitCount) - 1);
		bits = value;
	l4:	/* end getBits: */;
