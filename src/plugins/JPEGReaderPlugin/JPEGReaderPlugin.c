/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "JPEGReaderPlugin VMMaker.oscog-eem.3453 " INT_EXT;
...
primitiveDecodeMCU(void)
{
	...
	anArray = ((int *) (firstIndexableField(arrayOop)));
	if (failed()) {
		return null;
	}
...
primitiveIdctInt(void)
{
	...
	qt = ((int *) (firstIndexableField(arrayOop)));
	arrayOop = stackValue(1);
	if (!((isWords(arrayOop))
		 && ((slotSizeOf(arrayOop)) == DCTSize2))) {
		return primitiveFail();
