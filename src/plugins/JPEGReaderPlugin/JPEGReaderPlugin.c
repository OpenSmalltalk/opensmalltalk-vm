/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-eem.3009 uuid: d75b453d-0170-480a-bcb1-d7a2721e1a10
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-eem.3009 uuid: d75b453d-0170-480a-bcb1-d7a2721e1a10 " __DATE__ ;
...
static const char *moduleName = "JPEGReaderPlugin VMMaker.oscog-eem.3009 " INT_EXT;
...
colorConvertGrayscaleMCU(void)
{
	...
	for (i = 0; i < jpegBitsSize; i += 1) {
		...
		sampleIndex = ((((sqInt)((usqInt)((dy & 7)) << 3)))) + (dx & 7);
...
colorConvertMCU(void)
{
	...
	for (i = 0; i < jpegBitsSize; i += 1) {
		...
		sampleIndex1 = ((((sqInt)((usqInt)((dy1 & 7)) << 3)))) + (dx1 & 7);
		...
		sampleIndex2 = ((((sqInt)((usqInt)((dy2 & 7)) << 3)))) + (dx2 & 7);
		...
		blue = ((blue < 1) ? 1 : blue);
		jpegBits[i] = (((0xFF000000U + ((((sqInt)((usqInt)(red) << 16))))) + ((((sqInt)((usqInt)(green) << 8))))) + blue);
	}
	return 0;
}
	...
	if (byte != 0) {
		...
		if (byte > jsBitCount) {
			...
			while (jsBitCount <= 16) {
				...
				jsBitBuffer = ((((sqInt)((usqInt)(jsBitBuffer) << 8)))) | byte1;
				jsBitCount += 8;
			}
	l1:	/* end fillBuffer */;
			if (byte > jsBitCount) {
		...
		if (byte != 0) {
			...
			if (byte > jsBitCount) {
				...
				while (jsBitCount <= 16) {
					...
					jsBitBuffer = ((((sqInt)((usqInt)(jsBitBuffer) << 8)))) | byte2;
					jsBitCount += 8;
				}
	l4:	/* end fillBuffer */;
				if (byte > jsBitCount) {
...
fillBuffer(void)
{
	...
	while (jsBitCount <= 16) {
		...
		jsBitBuffer = ((((sqInt)((usqInt)(jsBitBuffer) << 8)))) | byte;
		jsBitCount += 8;
	}
	return jsBitCount;
}
...
void* JPEGReaderPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveColorConvertGrayscaleMCU\000\002\000", (void*)primitiveColorConvertGrayscaleMCU},
	{(void*)_m, "primitiveColorConvertMCU\000\003\000", (void*)primitiveColorConvertMCU},
	{(void*)_m, "primitiveDecodeMCU\000\003\000", (void*)primitiveDecodeMCU},
...
EXPORT(signed short) primitiveColorConvertGrayscaleMCUMetadata = 0x200;
EXPORT(signed short) primitiveColorConvertMCUMetadata = 0x300;
EXPORT(signed short) primitiveDecodeMCUMetadata = 0x300;
