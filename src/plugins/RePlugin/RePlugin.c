/* Automatically generated by
   ...
   from
	RePlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "RePlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"RePlugin VMMaker.oscog-eem.222 (i)"
#else
	"RePlugin VMMaker.oscog-eem.222 (e)"
#endif
;
...
rcvrExtraPtr(void)
{
	...
	extraObj = interpreterProxy->fetchPointerofObject(3, rcvr);
	return ((int) ((extraObj == (interpreterProxy->nilObject())
	? null
	: interpreterProxy->arrayValueOf(extraObj))));
}
