/* Automatically generated by
   ...
   from
	RePlugin VMMaker-oscog.8 uuid: b336429e-652e-4551-8d38-a00ef67eaa61
 */
static char __buildInfo[] = "RePlugin VMMaker-oscog.8 uuid: b336429e-652e-4551-8d38-a00ef67eaa61 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"RePlugin VMMaker-oscog.8 (i)"
#else
	"RePlugin VMMaker-oscog.8 (e)"
#endif
;
