/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3771 uuid: f42a1a6b-883f-49ca-897a-3b6ed5251764
	(Compiler-ct.535)
   from
	IA32ABIPlugin VMMaker.oscog-eem.3771 uuid: f42a1a6b-883f-49ca-897a-3b6ed5251764
 */
static char __buildInfo[] = "IA32ABIPlugin VMMaker.oscog-eem.3771 uuid: f42a1a6b-883f-49ca-897a-3b6ed5251764 " __DATE__ ;
...
static const char *moduleName = "IA32ABI VMMaker.oscog-eem.3771 " INT_EXT;
...
primDoubleAt(void)
{
	...
	/* begin index:length:inRange: */
	dataSize = longAt((void *)(rcvr + BaseHeaderSize));
	if (!((dataSize == 0)
		 || ((byteOffset >= 0)
		 && (byteOffset <= ((SQABS(dataSize)) - 8))))) {
		return primitiveFailFor(PrimErrBadIndex);
	}
...
primOopAt(void)
{
	...
	if (!((dataSize == 0)
		 || ((byteOffset >= 0)
		 && (byteOffset <= ((SQABS(dataSize)) - BytesPerOop))))) {
		return primitiveFailFor(PrimErrBadIndex);
	}
	if (isOopImmutable(rcvr)) {
		return primitiveFailFor(PrimErrNoModification);
