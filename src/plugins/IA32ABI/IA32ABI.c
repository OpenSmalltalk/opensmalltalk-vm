/* Automatically generated by
   ...
   from
	IA32ABIPlugin VMMaker.oscog-eem.1468 uuid: 2b6a8fd8-cddf-447d-bee4-11d53d2ef9bc
 */
static char __buildInfo[] = "IA32ABIPlugin VMMaker.oscog-eem.1468 uuid: 2b6a8fd8-cddf-447d-bee4-11d53d2ef9bc " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"IA32ABI VMMaker.oscog-eem.1468 (i)"
#else
	"IA32ABI VMMaker.oscog-eem.1468 (e)"
#endif
;
...
primStrlenThroughPointerAtIndex(void)
{
	...
	if (!((((dataSize = longAt(rcvr + BaseHeaderSize))) == 0)
		 || (((((usqInt)byteOffset)) + BytesPerOop) <= (abs(dataSize))))) {
		return primitiveFailFor(PrimErrBadIndex);
	}
