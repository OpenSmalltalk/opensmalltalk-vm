/* Smalltalk from Squeak4.4 with VMMaker 4.12.13 translated as C source on 10 January 2014 5:30:29 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 10 January 2014 (i)"
#else
	"XDisplayControlPlugin 10 January 2014 (e)"
#endif
;
