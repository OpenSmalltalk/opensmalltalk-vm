/* Smalltalk from Squeak4.5 with VMMaker 4.13.4 translated as C source on 12 March 2014 12:58:08 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 12 March 2014 (i)"
#else
	"XDisplayControlPlugin 12 March 2014 (e)"
#endif
;
