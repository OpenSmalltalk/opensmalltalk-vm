/* Smalltalk from Squeak4.5 with VMMaker 4.15.1 translated as C source on 23 January 2016 2:15:38 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 23 January 2016 (i)"
#else
	"XDisplayControlPlugin 23 January 2016 (e)"
#endif
;
