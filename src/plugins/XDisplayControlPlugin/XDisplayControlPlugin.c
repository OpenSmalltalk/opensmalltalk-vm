/* Smalltalk from Squeak4.4 with VMMaker 4.12.10 translated as C source on 21 December 2013 11:35:09 am */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 21 December 2013 (i)"
#else
	"XDisplayControlPlugin 21 December 2013 (e)"
#endif
;
