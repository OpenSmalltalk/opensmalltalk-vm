/* Smalltalk from Squeak4.4 with VMMaker 4.12.9 translated as C source on 11 December 2013 8:17:06 am */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 11 December 2013 (i)"
#else
	"XDisplayControlPlugin 11 December 2013 (e)"
#endif
;
