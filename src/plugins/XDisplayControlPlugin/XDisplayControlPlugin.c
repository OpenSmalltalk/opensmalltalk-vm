/* Smalltalk from Squeak4.4 with VMMaker 4.12.7 translated as C source on 27 October 2013 11:14:02 am */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 27 October 2013 (i)"
#else
	"XDisplayControlPlugin 27 October 2013 (e)"
#endif
;
