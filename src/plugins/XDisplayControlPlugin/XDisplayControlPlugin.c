/* Smalltalk from Squeak4.4 with VMMaker 4.12.8 translated as C source on 31 October 2013 7:50:44 pm */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"XDisplayControlPlugin 31 October 2013 (i)"
#else
	"XDisplayControlPlugin 31 October 2013 (e)"
#endif
;
