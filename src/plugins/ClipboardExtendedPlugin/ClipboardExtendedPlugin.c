/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3271 uuid: 720839b5-3779-4885-a0dc-f804b7404cea
   from
	ClipboardExtendedPlugin VMMaker.oscog-eem.3271 uuid: 720839b5-3779-4885-a0dc-f804b7404cea
 */
static char __buildInfo[] = "ClipboardExtendedPlugin VMMaker.oscog-eem.3271 uuid: 720839b5-3779-4885-a0dc-f804b7404cea " __DATE__ ;
...
static const char *moduleName = "ClipboardExtendedPlugin VMMaker.oscog-eem.3271 " INT_EXT;
...
ioHasClipboardDataInFormat(void)
{
	...
	format = stackValue(0);
	if (isIntegerObject(format)) {
		hasFormat = sqPasteboardhasDataInFormat(((void *)clipboard), integerValueOf(format));
		if (!(failed())) {
			methodReturnBool(hasFormat);
			return null;
		}
	}
	if (isBytes(format)) {
		hasFormat = sqPasteboardhasDataInFormatformatLength(((void *)clipboard), firstIndexableField(format), byteSizeOf(format));
		if (!(failed())) {
			methodReturnBool(hasFormat);
			return null;
		}
