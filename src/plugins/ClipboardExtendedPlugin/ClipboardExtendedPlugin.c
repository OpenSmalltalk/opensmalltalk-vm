/* Automatically generated by
   ...
   from
	ClipboardExtendedPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "ClipboardExtendedPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "ClipboardExtendedPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) ioAddClipboardDataAccessorDepth = 0;
EXPORT(signed char) ioClearClipboardAccessorDepth = 0;
EXPORT(signed char) ioGetClipboardFormatAccessorDepth = 0;
EXPORT(signed char) ioReadClipboardDataAccessorDepth = 0;
