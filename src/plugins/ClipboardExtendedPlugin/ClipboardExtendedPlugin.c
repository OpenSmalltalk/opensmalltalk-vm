/* Automatically generated by
   ...
   from
	ClipboardExtendedPlugin VMMaker.oscog-eem.3270 uuid: 2ed5e56f-f39f-4da9-9403-c83acc745010
 */
static char __buildInfo[] = "ClipboardExtendedPlugin VMMaker.oscog-eem.3270 uuid: 2ed5e56f-f39f-4da9-9403-c83acc745010 " __DATE__ ;
...
static const char *moduleName = "ClipboardExtendedPlugin VMMaker.oscog-eem.3270 " INT_EXT;
...
ioHasClipboardDataInFormat(void)
{
	...
	format = stackValue(0);
	if (isIntegerObject(format)) {
		methodReturnBool(sqPasteboardhasDataInFormat(((void *)clipboard), integerValueOf(format)));
		return null;
	}
	if (isBytes(format)) {
		methodReturnBool(sqPasteboardhasDataInFormatformatLength(((void *)clipboard), firstIndexableField(format), byteSizeOf(format)));
		return null;
	}
	primitiveFailFor(PrimErrBadArgument);
	return null;
