/* Automatically generated by
   ...
   from
	MacMenubarPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867
 */
static char __buildInfo[] = "MacMenubarPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"MacMenubarPlugin VMMaker.oscog-eem.1809 (i)"
#else
	"MacMenubarPlugin VMMaker.oscog-eem.1809 (e)"
#endif
;
...
#  endif /* TARGET_API_MAC_CARBON */
	...
	_return_value = (BytesPerWord == 8
		? positive64BitIntegerFor(((long) menuHandle))
		: positive32BitIntegerFor(((long) menuHandle)));
	if (failed()) {
		return null;
	}
	popthenPush(2, _return_value);
...
#  endif /* TARGET_API_MAC_CARBON */
	...
	_return_value = (BytesPerWord == 8
		? positive64BitIntegerFor(((long) applicationMenu))
		: positive32BitIntegerFor(((long) applicationMenu)));
	if (failed()) {
		return null;
	}
	popthenPush(3, _return_value);
