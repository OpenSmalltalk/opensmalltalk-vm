/* Automatically generated by
   ...
   from
	MacMenubarPlugin VMMaker.oscog-eem.2672 uuid: 335f401c-b41b-48dc-b7be-2d33156978af
 */
static char __buildInfo[] = "MacMenubarPlugin VMMaker.oscog-eem.2672 uuid: 335f401c-b41b-48dc-b7be-2d33156978af " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
static 	"MacMenubarPlugin VMMaker.oscog-eem.2672 (i)";
#else
static 	"MacMenubarPlugin VMMaker.oscog-eem.2672 (e)";
#endif
...
primitiveCountMenuItems(void)
{
	...
	if (!(failed())) {
		popthenPush(2, integerObjectOf(returnValue));
	}
	return null;
}
...
#  endif /* TARGET_API_MAC_CARBON */
	if (!(failed())) {
		popthenPush(3, integerObjectOf(outIndex));
	}
	return null;
}
...
primitiveGetItemCmd(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(aCharacter));
	}
	return null;
}
...
primitiveGetItemIcon(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(iconIndex));
	}
	return null;
}
...
primitiveGetItemStyle(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(chStyle));
	}
	return null;
}
...
primitiveGetMenuID(void)
{
	...
	if (!(failed())) {
		popthenPush(2, integerObjectOf(menuID));
	}
	return null;
}
...
primitiveGetMenuItemFontID(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(outFontID));
	}
	return null;
}
...
primitiveGetMenuItemHierarchicalID(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(outHierID));
	}
	return null;
}
...
primitiveGetMenuItemModifiers(void)
{
	...
	if (!(failed())) {
		popthenPush(3, integerObjectOf(outModifers));
	}
	return null;
}
