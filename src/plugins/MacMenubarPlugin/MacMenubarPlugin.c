/* Automatically generated by
   ...
   from
	MacMenubarPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "MacMenubarPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "MacMenubarPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveAppendMenuAccessorDepth = 0;
EXPORT(signed char) primitiveAppendMenuItemTextAccessorDepth = 0;
EXPORT(signed char) primitiveCheckMenuItemAccessorDepth = 0;
EXPORT(signed char) primitiveCountMenuItemsAccessorDepth = 0;
EXPORT(signed char) primitiveCreateStandardWindowMenuAccessorDepth = 0;
EXPORT(signed char) primitiveDeleteMenuAccessorDepth = 0;
EXPORT(signed char) primitiveDeleteMenuItemAccessorDepth = 0;
EXPORT(signed char) primitiveDisableMenuCommandAccessorDepth = 0;
EXPORT(signed char) primitiveDisableMenuItemAccessorDepth = 0;
EXPORT(signed char) primitiveDisableMenuItemIconAccessorDepth = 0;
EXPORT(signed char) primitiveDisposeMenuAccessorDepth = 0;
EXPORT(signed char) primitiveDisposeMenuBarAccessorDepth = 0;
EXPORT(signed char) primitiveEnableMenuCommandAccessorDepth = 0;
EXPORT(signed char) primitiveEnableMenuItemAccessorDepth = 0;
EXPORT(signed char) primitiveEnableMenuItemIconAccessorDepth = 0;
EXPORT(signed char) primitiveGetIndMenuItemWithCommandIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetIndMenuWithCommandIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetItemCmdAccessorDepth = 0;
EXPORT(signed char) primitiveGetItemIconAccessorDepth = 0;
EXPORT(signed char) primitiveGetItemMarkAccessorDepth = 0;
EXPORT(signed char) primitiveGetItemStyleAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuHandleAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemCommandIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemFontIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemHierarchicalIDAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemKeyGlyphAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemModifiersAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemTextAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuItemTextEncodingAccessorDepth = 0;
EXPORT(signed char) primitiveGetMenuTitleAccessorDepth = 0;
EXPORT(signed char) primitiveHiliteMenuAccessorDepth = 0;
EXPORT(signed char) primitiveInsertFontResMenuAccessorDepth = 0;
EXPORT(signed char) primitiveInsertIntlResMenuAccessorDepth = 0;
EXPORT(signed char) primitiveInsertMenuAccessorDepth = 0;
EXPORT(signed char) primitiveInsertMenuItemAccessorDepth = 0;
EXPORT(signed char) primitiveIsMenuItemEnabledAccessorDepth = 0;
EXPORT(signed char) primitiveIsMenuItemIconEnabledAccessorDepth = 0;
EXPORT(signed char) primitiveNewMenuAccessorDepth = 0;
EXPORT(signed char) primitiveSetItemCmdAccessorDepth = 0;
EXPORT(signed char) primitiveSetItemIconAccessorDepth = 0;
EXPORT(signed char) primitiveSetItemMarkAccessorDepth = 0;
EXPORT(signed char) primitiveSetItemStyleAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuBarAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemCommandIDAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemFontIDAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemHierarchicalIDAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemKeyGlyphAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemModifiersAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemTextAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuItemTextEncodingAccessorDepth = 0;
EXPORT(signed char) primitiveSetMenuTitleAccessorDepth = 0;
