/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-eem.2508 uuid: 0562ff91-dad2-41f0-980e-87e9f5bd7eda
   from
	ThreadedARM64FFIPlugin * VMMaker.oscog-eem.2508 uuid: 0562ff91-dad2-41f0-980e-87e9f5bd7eda
 */
static char __buildInfo[] = "ThreadedARM64FFIPlugin * VMMaker.oscog-eem.2508 uuid: 0562ff91-dad2-41f0-980e-87e9f5bd7eda " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM64FFIPlugin * VMMaker.oscog-eem.2508 (i)"
#else
	"ARM64FFIPlugin * VMMaker.oscog-eem.2508 (e)"
#endif
;
...
#          endif /* BytesPerWord == 8 */
	...
	if (atomicType == FFITypeSingleFloat) {
		...
		if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
			((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = (((double) floatValue));
