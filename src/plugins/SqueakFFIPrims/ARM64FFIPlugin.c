/* Automatically generated by
   ...
   from
	ThreadedARM64FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315
 */
static char __buildInfo[] = "ThreadedARM64FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315 " __DATE__ ;
...
static const char *moduleName = "ARM64FFIPlugin VMMaker.oscog-nice.2763 " INT_EXT;
...
/*	Answer if a struct result of a given size is able to be returned in
	registers. NB: this is a predicate! #canReturnInRegistersStructOfSize:
	does NOT return a struct in anything!
 */

	/* ThreadedARM64FFIPlugin>>#canReturnInRegistersStructOfSize: */
static sqInt
...
/*	Set the return type to true if returning the struct via register */
	...
	/* ThreadedARM64FFIPlugin>>#encodeStructReturnTypeIn: */
static sqInt
...
#            endif /* COGMTVM */
			...
			if (includesBehaviorThatOf(oopClass, classExternalData())) {
				...
				if (ptrClass11 == (classExternalAddress())) {
					...
					availableRegisterSpace2 = (NumIntRegArgs - ((calloutState->integerRegisterIndex))) * BytesPerWord;
					...
					if (availableRegisterSpace2 > 0) {
						if (structSize2 <= availableRegisterSpace2) {
							...
							(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + ((((usqInt)((structSize2 + 3))) >> 3)));
						}
						else {
...
#            endif /* COGMTVM */
						...
						availableRegisterSpace11 = (NumIntRegArgs - ((calloutState->integerRegisterIndex))) * BytesPerWord;
						...
						if (availableRegisterSpace11 > 0) {
							if (structSize11 <= availableRegisterSpace11) {
								...
								(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + ((((usqInt)((structSize11 + 3))) >> 3)));
							}
							else {
...
#              endif /* COGMTVM */
	...
	l32:	/* end ffiArgument:Spec:Class:in: */;
		if (err != 0) {
...
;
		...
		result = result1;
	l33:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
#  else /* COGMTVM */
	...
	l65:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l63;
	}
...
#  endif /* COGMTVM */
	...
	l62:	/* end ffiValidateExternalData:AtomicType: */;
					if (failed()) {
						err1 = null;
						goto l42;
					}
...
#                endif /* BytesPerWord == 8 */
	...
	l37:	/* end ffiValidateExternalData:AtomicType: */;
					}
					if (failed()) {
						err1 = null;
						goto l42;
				...
				if ((((usqInt)(atomicType51)) >> 1) == (((usqInt)(FFITypeSignedChar)) >> 1)) {
					...
					if (includesBehaviorThatOf(oopClass1, classString())) {
						/* begin ffiPushString:OfLength:in: */
						pointer7 = ((char *) (firstIndexableField(oop3)));
			...
			case FFIFlagStructure:
				...
				if (includesBehaviorThatOf(oopClass1, argClass1)) {
					...
					if (ptrClass31 == (classExternalAddress())) {
						...
						availableRegisterSpace3 = (NumIntRegArgs - ((calloutState1->integerRegisterIndex))) * BytesPerWord;
						...
						if (availableRegisterSpace3 > 0) {
							if (structSize3 <= availableRegisterSpace3) {
								...
								(calloutState1->integerRegisterIndex = ((calloutState1->integerRegisterIndex)) + ((((usqInt)((structSize3 + 3))) >> 3)));
							}
							else {
...
#              endif /* COGMTVM */
							...
							availableRegisterSpace12 = (NumIntRegArgs - ((calloutState1->integerRegisterIndex))) * BytesPerWord;
							...
							if (availableRegisterSpace12 > 0) {
								if (structSize12 <= availableRegisterSpace12) {
									...
									(calloutState1->integerRegisterIndex = ((calloutState1->integerRegisterIndex)) + ((((usqInt)((structSize12 + 3))) >> 3)));
								}
								else {
				...
				if (includesBehaviorThatOf(oopClass1, classExternalData())) {
					...
					if (ptrClass111 == (classExternalAddress())) {
						...
						availableRegisterSpace21 = (NumIntRegArgs - ((calloutState1->integerRegisterIndex))) * BytesPerWord;
						...
						if (availableRegisterSpace21 > 0) {
							if (structSize21 <= availableRegisterSpace21) {
								...
								(calloutState1->integerRegisterIndex = ((calloutState1->integerRegisterIndex)) + ((((usqInt)((structSize21 + 3))) >> 3)));
							}
							else {
...
#              endif /* COGMTVM */
							...
							availableRegisterSpace111 = (NumIntRegArgs - ((calloutState1->integerRegisterIndex))) * BytesPerWord;
							...
							if (availableRegisterSpace111 > 0) {
								if (structSize111 <= availableRegisterSpace111) {
									...
									(calloutState1->integerRegisterIndex = ((calloutState1->integerRegisterIndex)) + ((((usqInt)((structSize111 + 3))) >> 3)));
								}
								else {
	...
	l42:	/* end ffiArgument:Spec:Class:in: */;
		if (err1 != 0) {
			/* begin cleanupCalloutState: */
...
;
	...
	l43:	/* end ffiCalloutTo:SpecOnStack:in: */;
...
;
	...
	l66:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
#  endif /* COGMTVM */
	return;
}
