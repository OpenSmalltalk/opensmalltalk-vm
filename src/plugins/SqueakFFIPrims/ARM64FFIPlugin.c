/* Automatically generated by
   ...
   from
	ThreadedARM64FFIPlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190
 */
static char __buildInfo[] = "ThreadedARM64FFIPlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190 " __DATE__ ;
...
static const char *moduleName = "ARM64FFIPlugin VMMaker.oscog-eem.3024 " INT_EXT;
...
#          endif
	...
	l2:	/* end ffiIntegerValueOf: */;
		...
		case 9:
			...
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((sqLong) value1));
				(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
			}
			else {
				if ((((calloutState->currentArg)) + BytesPerWord) > ((calloutState->limit))) {
