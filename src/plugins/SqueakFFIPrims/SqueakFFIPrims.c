/* Smalltalk from Squeak4.4 with VMMaker 4.12.13 translated as C source on 10 January 2014 5:30:16 pm */
/* Automatically generated by
	VMPluginCodeGenerator VMMaker-dtl.337 uuid: 000f5b24-c747-4c6d-ba3e-ac1985565d83
   from
	FFIPlugin VMMaker-dtl.337 uuid: 000f5b24-c747-4c6d-ba3e-ac1985565d83
 */
static char __buildInfo[] = "FFIPlugin VMMaker-dtl.337 uuid: 000f5b24-c747-4c6d-ba3e-ac1985565d83 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SqueakFFIPrims 10 January 2014 (i)"
#else
	"SqueakFFIPrims 10 January 2014 (e)"
#endif
;
...
static sqInt ffiArgumentSpecClass(sqInt oop, sqInt argSpec, sqInt argClass) {
	...
	ffiArgHeader = ((sqInt) ((((sqInt *) ((sqMemoryBase) + ffiArgSpec)))[0]));
...
l1:	/* end ffiLogCallout: */;
	...
	ffiRetHeader = ((sqInt) ((((sqInt *) ((sqMemoryBase) + ffiRetSpec)))[0]));
...
EXPORT(sqInt) primitiveFFIIntegerAt(void) {
	...
	if (byteSize < 4) {
		...
		if (byteSize == 1) {
			value = ((sqInt) ((((unsigned char *) ((sqMemoryBase) + addr)))[0]));
		} else {
		...
		value = ((sqInt) ((((sqInt *) ((sqMemoryBase) + addr)))[0]));
		if (isSigned) {
...
EXPORT(sqInt) primitiveFFIIntegerAtPut(void) {
	...
	if (byteSize < 4) {
		...
		if (byteSize == 1) {
			((sqInt) ((((unsigned char *) ((sqMemoryBase) + addr)))[0] = value));
		} else {
			*((short int *) addr) = value;
		}
	} else {
		((sqInt) ((((sqInt *) ((sqMemoryBase) + addr)))[0] = value));
	}
