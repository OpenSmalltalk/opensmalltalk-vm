/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3268 uuid: b157851d-3135-4853-9b4a-b72296787205
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3268 uuid: b157851d-3135-4853-9b4a-b72296787205 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3268"
#define WordSize 8
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3268 " INT_EXT;
...
#  endif
	...
	result2 = retOop11;
	l15:	/* end ffiCalloutTo:SpecOnStack:in: */;
	/* begin cleanupCalloutState: */
	while (((calloutState1->stringArgIndex)) > 0) {
		free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
	}
