/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315 " __DATE__ ;
...
static sqInt registerTypeForStructSpecsOfLengthStartingAtByteOffsetEightbyteOffset(sqInt initialRegisterType, unsigned int *specs, sqInt specSize, unsigned int *indexPtr, sqInt initialByteOffset, sqInt initialEightbyteOffset);
static sqInt registerTypeForUnionSpecsOfLengthStartingAtByteOffsetEightbyteOffset(sqInt initialRegisterType, unsigned int *specs, sqInt specSize, unsigned int *indexPtr, sqInt byteOffset, sqInt eightbyteOffset);
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-nice.2763 " INT_EXT;
...
encodeStructReturnTypeIn(CalloutState *calloutState)
{
	...
	if (((calloutState->structReturnSize)) <= (WordSize * 2)) {
		registerType = registerTypeForStructSpecsOfLength(firstIndexableField((calloutState->ffiRetSpec)), slotSizeOf((calloutState->ffiRetSpec)));
	}
	else {
...
ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass, CalloutState *calloutState)
{
    ...
    sqInt numDoubleRegisters11;
    sqInt numDoubleRegisters2;
    sqInt numIntegerRegisters;
    sqInt numIntegerRegisters1;
    sqInt numIntegerRegisters11;
    sqInt numIntegerRegisters2;
    sqInt oopClass;
    int passField0InXmmReg;
    int passField0InXmmReg1;
    int passField0InXmmReg11;
    int passField0InXmmReg2;
    int passField1InXmmReg;
    int passField1InXmmReg1;
    int passField1InXmmReg11;
    int passField1InXmmReg2;
    char *pointer;
    void *pointer1;
    void *pointer2;
    void *pointer3;
	...
	passField1InXmmReg11 = 0;
	passField1InXmmReg2 = 0;
	pointer5 = ((void *) 0);
	pointer6 = ((void *) 0);
	if (!(isWords(argSpec))) {
...
#              endif /* BytesPerWord == 8 */
	...
	l7:	/* end ffiFloatValueOf: */;
			...
			if (atomicType2 == FFITypeSingleFloat) {
				/* begin ffiPushSingleFloat:in: */
				if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
					(((float *) (((calloutState->floatRegisters)) + ((calloutState->floatRegisterIndex)))))[0] = floatValue1;
					(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
				}
				else {
					if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
...
#                endif /* BytesPerWord == 8 */
	...
	l17:	/* end ffiFloatValueOf: */;
				...
				if (atomicType11 == FFITypeSingleFloat) {
					/* begin ffiPushSingleFloat:in: */
					if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
						(((float *) (((calloutState->floatRegisters)) + ((calloutState->floatRegisterIndex)))))[0] = floatValue3;
						(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
					}
					else {
						if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
...
#                endif /* BytesPerWord == 8 */
	...
	l15:	/* end ffiFloatValueOf: */;
				...
				if (atomicType21 == FFITypeSingleFloat) {
					/* begin ffiPushSingleFloat:in: */
					if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
						(((float *) (((calloutState->floatRegisters)) + ((calloutState->floatRegisterIndex)))))[0] = floatValue11;
						(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
					}
					else {
						if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
...
#              endif /* BytesPerWord == 8 */
	...
	l16:	/* end ffiFloatValueOf: */;
			...
			if (atomicType31 == FFITypeSingleFloat) {
				/* begin ffiPushSingleFloat:in: */
				if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
					(((float *) (((calloutState->floatRegisters)) + ((calloutState->floatRegisterIndex)))))[0] = floatValue2;
					(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
				}
				else {
					if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
			...
			if (includesBehaviorThatOf(oopClass, argClass)) {
				...
				if (ptrClass3 == (classExternalAddress())) {
					...
					if (structSize <= 16) {
						...
						registerType = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec3), argSpecSize);
						if (!(registerType == 6)) {
							...
							if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <= NumFloatRegArgs)
							 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
								if (passField0InXmmReg) {
									/* begin ffiPushDoubleFloat:in: */
									if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
										((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress2))[0]);
										(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
									}
									else {
										if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
										...
										storeFloatAtPointerfrom((calloutState->currentArg), (((double *) ptrAddress2))[0]);
										(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
									}
	l37:	/* end ffiPushDoubleFloat:in: */;
								}
								else {
									/* begin ffiPushSignedLongLong:in: */
									if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
										((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress2))[0])));
										(calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1;
									}
									else {
										if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
										...
										longAtput((calloutState->currentArg), (((long long *) ptrAddress2))[0]);
										(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
									}
	l26:	/* end ffiPushSignedLongLong:in: */;
								}
								if (structSize > 8) {
									if (passField1InXmmReg) {
										/* begin ffiPushDoubleFloat:in: */
										if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
											((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress2))[1]);
											(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
											...
											storeFloatAtPointerfrom((calloutState->currentArg), (((double *) ptrAddress2))[1]);
											(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
										}
	l31:	/* end ffiPushDoubleFloat:in: */;
									}
									else {
										/* begin ffiPushSignedLongLong:in: */
										if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
											((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress2))[1])));
											(calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
											...
											longAtput((calloutState->currentArg), (((long long *) ptrAddress2))[1]);
											(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
										}
	l38:	/* end ffiPushSignedLongLong:in: */;
									}
								}
								return 0;
							}
					...
					memcpy((calloutState->currentArg), ((char *) ptrAddress2), structSize);
...
#            endif /* COGMTVM */
	...
	l29:	/* end ffiPushSignedLongLong:in: */;
									}
									if (structSize1 > 8) {
	...
	l24:	/* end ffiPushSignedLongLong:in: */;
										}
									}
									return 0;
								}
						...
						memcpy((calloutState->currentArg), ((char *) ptrAddress2), structSize1);
				...
				if (ptrClass11 == (classExternalAddress())) {
					...
					if (structSize2 <= 16) {
						...
						/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
						   ...
						   typedef struct { long a; float b; float c; } s2g;
						   typedef struct { int a; float b; int c; float d; } s2h; */
						registerType2 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec2), argSpecSize2);
						if (!(registerType2 == 6)) {

							/* check case of invalid alignment => pass by memory */
							passField0InXmmReg2 = (registerType2 & 1) == 0;
							if (structSize2 <= 8) {
								numIntegerRegisters2 = registerType2 & 1;
								numDoubleRegisters2 = 1 - numIntegerRegisters2;
							}
							else {
								passField1InXmmReg2 = (registerType2 & 2) == 0;
								numIntegerRegisters2 = (((usqInt)((registerType2 & 2))) >> 1) + (registerType2 & 1);
								numDoubleRegisters2 = 2 - numIntegerRegisters2;
							}
							if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters2) <= NumFloatRegArgs)
							 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters2) <= NumIntRegArgs)) {
								if (passField0InXmmReg2) {
									/* begin ffiPushDoubleFloat:in: */
									if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
										((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress1))[0]);
										(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
									}
									else {
										if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
										...
										storeFloatAtPointerfrom((calloutState->currentArg), (((double *) ptrAddress1))[0]);
										(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
									}
	l28:	/* end ffiPushDoubleFloat:in: */;
								}
								else {
									/* begin ffiPushSignedLongLong:in: */
									if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
										((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress1))[0])));
										(calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1;
									}
									else {
										if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
										...
										longAtput((calloutState->currentArg), (((long long *) ptrAddress1))[0]);
										(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
									}
	l36:	/* end ffiPushSignedLongLong:in: */;
								}
								if (structSize2 > 8) {
									if (passField1InXmmReg2) {
										/* begin ffiPushDoubleFloat:in: */
										if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
											((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress1))[1]);
											(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
											...
											storeFloatAtPointerfrom((calloutState->currentArg), (((double *) ptrAddress1))[1]);
											(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
										}
	l23:	/* end ffiPushDoubleFloat:in: */;
									}
									else {
										/* begin ffiPushSignedLongLong:in: */
										if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
											((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress1))[1])));
											(calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
											...
											longAtput((calloutState->currentArg), (((long long *) ptrAddress1))[1]);
											(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
										}
	l30:	/* end ffiPushSignedLongLong:in: */;
									}
								}
								return 0;
							}
					...
					roundedSize2 = (((structSize2 + 7) | 7) - 7);
					if ((((calloutState->currentArg)) + roundedSize2) > ((calloutState->limit))) {
						return FFIErrorCallFrameTooBig;
					}
					memcpy((calloutState->currentArg), ((char *) ptrAddress1), structSize2);
...
#            endif /* COGMTVM */
						...
						if (structSize11 <= 16) {
							...
							/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
							   ...
							   typedef struct { long a; float b; float c; } s2g;
							   typedef struct { int a; float b; int c; float d; } s2h; */
							registerType11 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec11), argSpecSize11);
							if (!(registerType11 == 6)) {

								/* check case of invalid alignment => pass by memory */
								passField0InXmmReg11 = (registerType11 & 1) == 0;
								if (structSize11 <= 8) {
									numIntegerRegisters11 = registerType11 & 1;
									numDoubleRegisters11 = 1 - numIntegerRegisters11;
								}
								else {
									passField1InXmmReg11 = (registerType11 & 2) == 0;
									numIntegerRegisters11 = (((usqInt)((registerType11 & 2))) >> 1) + (registerType11 & 1);
									numDoubleRegisters11 = 2 - numIntegerRegisters11;
								}
								if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters11) <= NumFloatRegArgs)
								 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters11) <= NumIntRegArgs)) {
									if (passField0InXmmReg11) {
										/* begin ffiPushDoubleFloat:in: */
										if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
											((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress1))[0]);
											(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
	...
	l34:	/* end ffiPushSignedLongLong:in: */;
									}
									if (structSize11 > 8) {
										if (passField1InXmmReg11) {
											/* begin ffiPushDoubleFloat:in: */
											if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
												((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) ptrAddress1))[1]);
												(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
	...
	l35:	/* end ffiPushSignedLongLong:in: */;
										}
									}
									return 0;
								}
						...
						roundedSize11 = (((structSize11 + 7) | 7) - 7);
						if ((((calloutState->currentArg)) + roundedSize11) > ((calloutState->limit))) {
							return FFIErrorCallFrameTooBig;
						}
						memcpy((calloutState->currentArg), ((char *) ptrAddress1), structSize11);
...
#  endif /* COGMTVM */
	...
	if (!returnStructByValue) {
		intRet = dispatchFunctionPointerwithwithwithwithwithwith(((sqInt (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		ownVM(myThreadIndex);
...
;
	...
	switch (registerType) {
	case 0:
		sddRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturnDD (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		sRetPtr = ((void *)((&sddRet)));
		break;
	case 1:
		sidRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturnID (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		sRetPtr = ((void *)((&sidRet)));
		break;
	case 2:
		sdiRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturnDI (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		sRetPtr = ((void *)((&sdiRet)));
		break;
	case 3:
		siiRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturnII (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		sRetPtr = ((void *)((&siiRet)));
		break;
	case 4:
		floatRet = dispatchFunctionPointerwithwithwithwithwithwith(((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
...
#                endif /* BytesPerWord == 8 */
	...
	l45:	/* end ffiValidateExternalData:AtomicType: */;
					}
					if (failed()) {
						err = null;
						goto l49;
					...
					if (ptrClass3 == (classExternalAddress())) {
						...
						if (structSize <= 16) {
							...
							/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
							   ...
							   typedef struct { long a; float b; float c; } s2g;
							   typedef struct { int a; float b; int c; float d; } s2h; */
							registerType3 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec3), argSpecSize);
							if (!(registerType3 == 6)) {

								/* check case of invalid alignment => pass by memory */
								passField0InXmmReg = (registerType3 & 1) == 0;
								if (structSize <= 8) {
									numIntegerRegisters = registerType3 & 1;
									numDoubleRegisters = 1 - numIntegerRegisters;
								}
								else {
									passField1InXmmReg = (registerType3 & 2) == 0;
									numIntegerRegisters = (((usqInt)((registerType3 & 2))) >> 1) + (registerType3 & 1);
									numDoubleRegisters = 2 - numIntegerRegisters;
								}
								if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <= NumFloatRegArgs)
								 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
...
#              endif /* COGMTVM */
	...
	l49:	/* end ffiArgument:Spec:Class:in: */;
		if (err != 0) {
			/* begin cleanupCalloutState: */
			while (((calloutState->stringArgIndex)) > 0) {
				free(((calloutState->stringArgs))[(calloutState->stringArgIndex = ((calloutState->stringArgIndex)) - 1)]);
...
#        endif /* COGMTVM */
	...
	l15:	/* end ffiPushSignedLongLong:in: */;
							}
						}
						return 0;
					}
...
#        endif /* COGMTVM */
	...
	l13:	/* end ffiPushSignedLongLong:in: */;
							}
							if (structSize11 > 8) {
								if (passField1InXmmReg11) {
									/* begin ffiPushDoubleFloat:in: */
	...
	l9:	/* end ffiPushSignedLongLong:in: */;
								}
							}
							return 0;
						}
...
primitiveCallout(void)
{
    ...
    sqInt numDoubleRegisters1;
    sqInt numDoubleRegisters11;
    sqInt numDoubleRegisters111;
    sqInt numDoubleRegisters12;
    sqInt numDoubleRegisters2;
    sqInt numDoubleRegisters21;
    sqInt numDoubleRegisters3;
    sqInt numIntegerRegisters;
    sqInt numIntegerRegisters1;
    sqInt numIntegerRegisters11;
    sqInt numIntegerRegisters111;
    sqInt numIntegerRegisters12;
    sqInt numIntegerRegisters2;
    sqInt numIntegerRegisters21;
    sqInt numIntegerRegisters3;
    sqInt oop;
    sqInt oop1;
    sqInt oop11;
    sqInt oop2;
    ...
    int passField0InXmmReg1;
    int passField0InXmmReg11;
    int passField0InXmmReg111;
    int passField0InXmmReg12;
    int passField0InXmmReg2;
    int passField0InXmmReg21;
    int passField0InXmmReg3;
    int passField1InXmmReg;
    int passField1InXmmReg1;
    int passField1InXmmReg11;
    int passField1InXmmReg111;
    int passField1InXmmReg12;
    int passField1InXmmReg2;
    int passField1InXmmReg21;
    int passField1InXmmReg3;
    void *pointer;
    void *pointer1;
    void *pointer11;
    void *pointer2;
    ...
    sqInt registerType1;
    sqInt registerType11;
    sqInt registerType111;
    sqInt registerType12;
    sqInt registerType2;
    sqInt registerType21;
    sqInt registerType3;
    sqInt registerType31;
    sqInt registerType4;
    sqInt requiredStackSize;
	...
	passField1InXmmReg1 = 0;
	passField1InXmmReg11 = 0;
	passField1InXmmReg111 = 0;
	passField1InXmmReg12 = 0;
	passField1InXmmReg2 = 0;
	passField1InXmmReg21 = 0;
	passField1InXmmReg3 = 0;
	pointer5 = ((void *) 0);
	pointer51 = ((void *) 0);
	pointer6 = ((void *) 0);
	pointer61 = ((void *) 0);
...
;
		...
		result = result1;
	l50:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
#  else /* COGMTVM */
	...
	l96:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l94;
	}
...
#      endif /* COGMTVM */
	...
	l93:	/* end ffiValidateExternalData:AtomicType: */;
					if (failed()) {
						err1 = null;
						goto l97;
					}
	...
	l57:	/* end ffiFloatValueOf: */;
					...
					if (atomicType121 == FFITypeSingleFloat) {
						...
						if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
							(((float *) (((calloutState1->floatRegisters)) + ((calloutState1->floatRegisterIndex)))))[0] = floatValue4;
							...
							long64AtPointerput((calloutState1->currentArg), 0);
...
#                endif /* BytesPerWord == 8 */
	...
	l69:	/* end ffiFloatValueOf: */;
				...
				if (atomicType22 == FFITypeSingleFloat) {
					/* begin ffiPushSingleFloat:in: */
					if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
						(((float *) (((calloutState1->floatRegisters)) + ((calloutState1->floatRegisterIndex)))))[0] = floatValue12;
						(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
					}
					else {
						if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
	...
	l55:	/* end ffiValidateExternalData:AtomicType: */;
					}
					if (failed()) {
						err1 = null;
						goto l97;
...
#                  endif /* BytesPerWord == 8 */
	...
	l73:	/* end ffiFloatValueOf: */;
					...
					if (atomicType111 == FFITypeSingleFloat) {
						/* begin ffiPushSingleFloat:in: */
						if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
							(((float *) (((calloutState1->floatRegisters)) + ((calloutState1->floatRegisterIndex)))))[0] = floatValue31;
							(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
						}
						else {
							if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
...
#                  endif /* BytesPerWord == 8 */
	...
	l81:	/* end ffiFloatValueOf: */;
					...
					if (atomicType211 == FFITypeSingleFloat) {
						/* begin ffiPushSingleFloat:in: */
						if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
							(((float *) (((calloutState1->floatRegisters)) + ((calloutState1->floatRegisterIndex)))))[0] = floatValue111;
							(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
						}
						else {
							if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
...
#                endif /* BytesPerWord == 8 */
	...
	l76:	/* end ffiFloatValueOf: */;
				...
				if (atomicType311 == FFITypeSingleFloat) {
					/* begin ffiPushSingleFloat:in: */
					if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
						(((float *) (((calloutState1->floatRegisters)) + ((calloutState1->floatRegisterIndex)))))[0] = floatValue21;
						(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
					}
					else {
						if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
					...
					if (ptrClass31 == (classExternalAddress())) {
						...
						if (structSize3 <= 16) {
							...
							/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
							   ...
							   typedef struct { long a; float b; float c; } s2g;
							   typedef struct { int a; float b; int c; float d; } s2h; */
							registerType31 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec31), argSpecSize3);
							if (!(registerType31 == 6)) {

								/* check case of invalid alignment => pass by memory */
								passField0InXmmReg3 = (registerType31 & 1) == 0;
								if (structSize3 <= 8) {
									numIntegerRegisters3 = registerType31 & 1;
									numDoubleRegisters3 = 1 - numIntegerRegisters3;
								}
								else {
									passField1InXmmReg3 = (registerType31 & 2) == 0;
									numIntegerRegisters3 = (((usqInt)((registerType31 & 2))) >> 1) + (registerType31 & 1);
									numDoubleRegisters3 = 2 - numIntegerRegisters3;
								}
								if (((((calloutState1->floatRegisterIndex)) + numDoubleRegisters3) <= NumFloatRegArgs)
								 && ((((calloutState1->integerRegisterIndex)) + numIntegerRegisters3) <= NumIntRegArgs)) {
									if (passField0InXmmReg3) {
										/* begin ffiPushDoubleFloat:in: */
										if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
											((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress21))[0]);
											(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
											...
											storeFloatAtPointerfrom((calloutState1->currentArg), (((double *) ptrAddress21))[0]);
											(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
										}
	l54:	/* end ffiPushDoubleFloat:in: */;
									}
									else {
										/* begin ffiPushSignedLongLong:in: */
										if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
											((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress21))[0])));
											(calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
											...
											longAtput((calloutState1->currentArg), (((long long *) ptrAddress21))[0]);
											(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
										}
	l70:	/* end ffiPushSignedLongLong:in: */;
									}
									if (structSize3 > 8) {
										if (passField1InXmmReg3) {
											/* begin ffiPushDoubleFloat:in: */
											if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
												((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress21))[1]);
												(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
											}
											else {
												if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
												...
												storeFloatAtPointerfrom((calloutState1->currentArg), (((double *) ptrAddress21))[1]);
												(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
											}
	l75:	/* end ffiPushDoubleFloat:in: */;
										}
										else {
											/* begin ffiPushSignedLongLong:in: */
											if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
												((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress21))[1])));
												(calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1;
											}
											else {
												if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
												...
												longAtput((calloutState1->currentArg), (((long long *) ptrAddress21))[1]);
												(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
											}
	l52:	/* end ffiPushSignedLongLong:in: */;
										}
									}
									err1 = 0;
									goto l97;
						...
						roundedSize3 = (((structSize3 + 7) | 7) - 7);
						if ((((calloutState1->currentArg)) + roundedSize3) > ((calloutState1->limit))) {
							err1 = FFIErrorCallFrameTooBig;
							goto l97;
						}
						memcpy((calloutState1->currentArg), ((char *) ptrAddress21), structSize3);
...
#              endif /* COGMTVM */
							...
							if (structSize12 <= 16) {
								...
								/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
								   ...
								   typedef struct { long a; float b; float c; } s2g;
								   typedef struct { int a; float b; int c; float d; } s2h; */
								registerType12 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec12), argSpecSize12);
								if (!(registerType12 == 6)) {

									/* check case of invalid alignment => pass by memory */
									passField0InXmmReg12 = (registerType12 & 1) == 0;
									if (structSize12 <= 8) {
										numIntegerRegisters12 = registerType12 & 1;
										numDoubleRegisters12 = 1 - numIntegerRegisters12;
									}
									else {
										passField1InXmmReg12 = (registerType12 & 2) == 0;
										numIntegerRegisters12 = (((usqInt)((registerType12 & 2))) >> 1) + (registerType12 & 1);
										numDoubleRegisters12 = 2 - numIntegerRegisters12;
									}
									if (((((calloutState1->floatRegisterIndex)) + numDoubleRegisters12) <= NumFloatRegArgs)
									 && ((((calloutState1->integerRegisterIndex)) + numIntegerRegisters12) <= NumIntRegArgs)) {
										if (passField0InXmmReg12) {
											/* begin ffiPushDoubleFloat:in: */
											if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
												((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress21))[0]);
												(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
	...
	l58:	/* end ffiPushSignedLongLong:in: */;
										}
										if (structSize12 > 8) {
											if (passField1InXmmReg12) {
												/* begin ffiPushDoubleFloat:in: */
												if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
													((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress21))[1]);
													(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
	...
	l79:	/* end ffiPushSignedLongLong:in: */;
											}
										}
										err1 = 0;
										goto l97;
							...
							roundedSize12 = (((structSize12 + 7) | 7) - 7);
							if ((((calloutState1->currentArg)) + roundedSize12) > ((calloutState1->limit))) {
								err1 = FFIErrorCallFrameTooBig;
								goto l97;
							}
							memcpy((calloutState1->currentArg), ((char *) ptrAddress21), structSize12);
					...
					if (ptrClass111 == (classExternalAddress())) {
						...
						if (structSize21 <= 16) {
							...
							/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
							   ...
							   typedef struct { long a; float b; float c; } s2g;
							   typedef struct { int a; float b; int c; float d; } s2h; */
							registerType21 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec21), argSpecSize21);
							if (!(registerType21 == 6)) {

								/* check case of invalid alignment => pass by memory */
								passField0InXmmReg21 = (registerType21 & 1) == 0;
								if (structSize21 <= 8) {
									numIntegerRegisters21 = registerType21 & 1;
									numDoubleRegisters21 = 1 - numIntegerRegisters21;
								}
								else {
									passField1InXmmReg21 = (registerType21 & 2) == 0;
									numIntegerRegisters21 = (((usqInt)((registerType21 & 2))) >> 1) + (registerType21 & 1);
									numDoubleRegisters21 = 2 - numIntegerRegisters21;
								}
								if (((((calloutState1->floatRegisterIndex)) + numDoubleRegisters21) <= NumFloatRegArgs)
								 && ((((calloutState1->integerRegisterIndex)) + numIntegerRegisters21) <= NumIntRegArgs)) {
									if (passField0InXmmReg21) {
										/* begin ffiPushDoubleFloat:in: */
										if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
											((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress11))[0]);
											(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
											...
											storeFloatAtPointerfrom((calloutState1->currentArg), (((double *) ptrAddress11))[0]);
											(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
										}
	l63:	/* end ffiPushDoubleFloat:in: */;
									}
									else {
										/* begin ffiPushSignedLongLong:in: */
										if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
											((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress11))[0])));
											(calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1;
										}
										else {
											if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
											...
											longAtput((calloutState1->currentArg), (((long long *) ptrAddress11))[0]);
											(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
										}
	l56:	/* end ffiPushSignedLongLong:in: */;
									}
									if (structSize21 > 8) {
										if (passField1InXmmReg21) {
											/* begin ffiPushDoubleFloat:in: */
											if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
												((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress11))[1]);
												(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
											}
											else {
												if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
												...
												storeFloatAtPointerfrom((calloutState1->currentArg), (((double *) ptrAddress11))[1]);
												(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
											}
	l83:	/* end ffiPushDoubleFloat:in: */;
										}
										else {
											/* begin ffiPushSignedLongLong:in: */
											if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
												((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = (((usqInt) ((((long long *) ptrAddress11))[1])));
												(calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1;
											}
											else {
												if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
												...
												longAtput((calloutState1->currentArg), (((long long *) ptrAddress11))[1]);
												(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
											}
	l80:	/* end ffiPushSignedLongLong:in: */;
										}
									}
									err1 = 0;
									goto l97;
						...
						roundedSize21 = (((structSize21 + 7) | 7) - 7);
						if ((((calloutState1->currentArg)) + roundedSize21) > ((calloutState1->limit))) {
							err1 = FFIErrorCallFrameTooBig;
							goto l97;
						}
						memcpy((calloutState1->currentArg), ((char *) ptrAddress11), structSize21);
...
#              endif /* COGMTVM */
							...
							if (structSize111 <= 16) {
								...
								/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
								   ...
								   typedef struct { long a; float b; float c; } s2g;
								   typedef struct { int a; float b; int c; float d; } s2h; */
								registerType111 = registerTypeForStructSpecsOfLength(((unsigned int *) argSpec111), argSpecSize111);
								if (!(registerType111 == 6)) {

									/* check case of invalid alignment => pass by memory */
									passField0InXmmReg111 = (registerType111 & 1) == 0;
									if (structSize111 <= 8) {
										numIntegerRegisters111 = registerType111 & 1;
										numDoubleRegisters111 = 1 - numIntegerRegisters111;
									}
									else {
										passField1InXmmReg111 = (registerType111 & 2) == 0;
										numIntegerRegisters111 = (((usqInt)((registerType111 & 2))) >> 1) + (registerType111 & 1);
										numDoubleRegisters111 = 2 - numIntegerRegisters111;
									}
									if (((((calloutState1->floatRegisterIndex)) + numDoubleRegisters111) <= NumFloatRegArgs)
									 && ((((calloutState1->integerRegisterIndex)) + numIntegerRegisters111) <= NumIntRegArgs)) {
										if (passField0InXmmReg111) {
											/* begin ffiPushDoubleFloat:in: */
											if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
												((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress11))[0]);
												(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
	...
	l61:	/* end ffiPushSignedLongLong:in: */;
										}
										if (structSize111 > 8) {
											if (passField1InXmmReg111) {
												/* begin ffiPushDoubleFloat:in: */
												if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
													((calloutState1->floatRegisters))[(calloutState1->floatRegisterIndex)] = ((((double *) ptrAddress11))[1]);
													(calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1;
	...
	l59:	/* end ffiPushSignedLongLong:in: */;
											}
										}
										err1 = 0;
										goto l97;
							...
							roundedSize111 = (((structSize111 + 7) | 7) - 7);
							if ((((calloutState1->currentArg)) + roundedSize111) > ((calloutState1->limit))) {
								err1 = FFIErrorCallFrameTooBig;
								goto l97;
							}
							memcpy((calloutState1->currentArg), ((char *) ptrAddress11), structSize111);
	...
	l97:	/* end ffiArgument:Spec:Class:in: */;
		if (err1 != 0) {
			/* begin cleanupCalloutState: */
			while (((calloutState1->stringArgIndex)) > 0) {
				free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
...
;
	...
	registerType4 = (calloutState1->structReturnType);
	
	switch (registerType4) {
	case 0:
...
;
	...
	result2 = retOop11;
	l67:	/* end ffiCalloutTo:SpecOnStack:in: */;
...
;
	...
	l100:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
#  endif /* COGMTVM */
	return;
}
...
static sqInt
registerTypeForStructSpecsOfLengthStartingAtByteOffsetEightbyteOffset(sqInt initialRegisterType, unsigned int *specs, sqInt specSize, unsigned int *indexPtr, sqInt initialByteOffset, sqInt initialEightbyteOffset)
{
    sqInt alignment;
    sqInt atomic;
    sqInt byteOffset;
...
static sqInt
registerTypeForUnionSpecsOfLengthStartingAtByteOffsetEightbyteOffset(sqInt initialRegisterType, unsigned int *specs, sqInt specSize, unsigned int *indexPtr, sqInt byteOffset, sqInt eightbyteOffset)
{
    sqInt atomic;
    sqInt isInt;
    sqInt recurse;
