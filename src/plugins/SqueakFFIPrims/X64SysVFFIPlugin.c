/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1950 uuid: b4089b49-1494-49d2-8966-57cba5c92194
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1950 uuid: b4089b49-1494-49d2-8966-57cba5c92194 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-eem.1950 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.1950 (e)"
#endif
;
...
if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
					...
					l5:	/* end ffiPushSignedLongLong:in: */;
					}
					if (structSize > 8) {
...
;
			storePointerofObjectwithValue(0, retOop1, oop2);
			oop3 = methodReturnValue(retOop1);
		l8:	/* end ffiReturnPointer:ofType:in: */;
		}
		else {
/* begin ffiReturnStruct:ofType:in: */
...
mask = (((unsigned long)1)) << (shift - 1);
			...
			oop3 = ((((usqInt) atomicType) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
				? (atomicType & 1
						...
						: positive64BitIntegerFor(retVal1))
				: characterObjectOf(retVal1 & 0xFF));
		l17:	/* end ffiCreateIntegralResultOop:ofAtomicType:in: */;
		}
...
;
			storePointerofObjectwithValue(0, retOop11, oop21);
			oop4 = methodReturnValue(retOop11);
		l19:	/* end ffiReturnPointer:ofType:in: */;
		}
		else {
/* begin ffiReturnStruct:ofType:in: */
...
mask1 = (((unsigned long)1)) << (shift1 - 1);
	...
	l25:	/* end ffiCreateIntegralResultOop:ofAtomicType:in: */;
	}
...
if (!((((unsigned long long)value)) < (1U << (8 * byteSize)))) {
				return primitiveFail();
			}
		}
	}
