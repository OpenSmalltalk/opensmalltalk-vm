/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3477 uuid: 2de18dc7-c0eb-403e-953d-0fddeb535cfb
	(Compiler-eem.512)
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3477 uuid: 2de18dc7-c0eb-403e-953d-0fddeb535cfb
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3477 uuid: 2de18dc7-c0eb-403e-953d-0fddeb535cfb " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3477"
#define WordSize 8
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3477 " INT_EXT;
static sqInt nilObj;
		...
		if (((((calloutState->ffiRetHeader)) & FFIFlagPointer) != 0)) {
			...
			if (retClass == nilObj) {
				...
				if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedChar8)) >> 1)) {
					result = (!(stringForCString(((usqInt) retVal)))
							? fetchPointerofObject(PrimErrNoMemory + 1, primitiveErrorTable())
							: stringForCString(((usqInt) retVal)));
					goto l5;
				}
