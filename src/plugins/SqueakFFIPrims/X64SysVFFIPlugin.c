/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-nice.1981 uuid: b8675b17-30ec-479d-977d-bc2c6c9aa941
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.1981 uuid: b8675b17-30ec-479d-977d-bc2c6c9aa941
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.1981 uuid: b8675b17-30ec-479d-977d-bc2c6c9aa941 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-nice.1981 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-nice.1981 (e)"
#endif
;
				 ...
				 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
					...
					if (structSize1 > 8) {
						...
						l7:	/* end ffiPushDoubleFloat:in: */;
							...
							/* begin ffiPushSignedLongLong:in: */
							value3 = ((sqLong) ((((long long *) ptrAddress))[1]));
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
								((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) value3));
								(calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1;
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								longAtput((calloutState->currentArg), value3);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
						l8:	/* end ffiPushSignedLongLong:in: */;
						}
...
;
	...
	l12:	/* end ffiCalloutTo:SpecOnStack:in: */;
		...
		result = result1;
	l13:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		...
		intRet1 = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturn (*)(long, long, long, long, long, long)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3], ((calloutState1->integerRegisters))[4], ((calloutState1->integerRegisters))[5]);
	}
		...
		if (((calloutState1->ffiRetHeader)) & FFIFlagPointer) {
			...
			if (retClass11 == (nilObject())) {
				...
				if ((((usqInt) atomicType11) >> 1) == (((usqInt) FFITypeSignedChar) >> 1)) {
					...
					if (cPointer1 == null) {
						oop31 = methodReturnValue(nilObject());
						goto l25;
					}
					...
					oop31 = methodReturnValue(strOop1);
					goto l25;
				}
...
;
				...
				oop31 = methodReturnValue(retOop11);
				goto l25;
			}
...
;
			storePointerofObjectwithValue(0, retOop11, oop21);
			oop31 = methodReturnValue(retOop11);
		l25:	/* end ffiReturnPointer:ofType:in: */;
		}
		else {
			/* begin ffiReturnStruct:ofType:in: */
...
;
			...
			storePointerofObjectwithValue(0, retOop2, oop11);
			oop31 = methodReturnValue(retOop2);
		}
		result2 = oop31;
		goto l17;
	}
	if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		oop31 = floatObjectOf(floatRet1);
	}
	else {
		/* begin ffiCreateIntegralResultOop:ofAtomicType:in: */
		retVal11 = (intRet1.a);
		...
		oop31 = ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
			? (atomicType2 & 1
					? signed64BitIntegerFor(retVal11)
					: positive64BitIntegerFor(retVal11))
			: characterObjectOf(retVal11 & 0xFF));
	l19:	/* end ffiCreateIntegralResultOop:ofAtomicType:in: */;
	}
	result2 = methodReturnValue(oop31);
l17:	/* end ffiCalloutTo:SpecOnStack:in: */;
	/* begin cleanupCalloutState: */
	while (((calloutState1->stringArgIndex)) > 0) {
		free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
	}
l26:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
