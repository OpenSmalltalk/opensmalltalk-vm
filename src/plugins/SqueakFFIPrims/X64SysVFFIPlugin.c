/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3068 uuid: f00f2700-05d1-45ac-bcd7-8703af0c9192
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3068 uuid: f00f2700-05d1-45ac-bcd7-8703af0c9192
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3068 uuid: f00f2700-05d1-45ac-bcd7-8703af0c9192 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3068"
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3068 " INT_EXT;
	...
	l2:	/* end ffiIntegerValueOf: */;
		...
		case 9:
			...
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				longAtput((calloutState->currentArg), value1);
				(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
			}
			return 0;
		case 10:
...
#        endif // COGMTVM
				...
				if (atomicType != FFITypeVoid) {
					...
					if (specType != atomicType) {
						...
						if (!((atomicType >= FFITypeUnsignedInt8)
							 && ((atomicType <= FFITypeSignedChar32)
	...
	l3:	/* end ffiValidateExternalData:AtomicType: */;
			...
			if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedChar8)) >> 1)) {
				...
				atomicType1 = FFITypeUnsignedInt8;
			}
#      if COGMTVM
...
#      endif // COGMTVM
			if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
