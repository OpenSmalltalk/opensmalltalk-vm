/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d
	(Compiler-eem.514)
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3550"
#define WordSize 8
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3550 " INT_EXT;
static sqInt nilObj;
...
#      endif // COGMTVM
			...
			if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
				...
				if (isAlienObj) {
					pointer1 = ((void *) (((char *)(/* startOfData: */
	((longAt((void *)(valueOop + BaseHeaderSize))) > 0
