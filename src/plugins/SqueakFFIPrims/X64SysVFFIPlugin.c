/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3077 uuid: 8ad52133-62f2-4e1e-bf92-9b29ba104d62
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3077 uuid: 8ad52133-62f2-4e1e-bf92-9b29ba104d62
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3077 uuid: 8ad52133-62f2-4e1e-bf92-9b29ba104d62 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3077"
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3077 " INT_EXT;
...
#        endif // COGMTVM
	...
	l3:	/* end ffiValidateExternalData:AtomicType: */;
			...
			if ((isExternalAddress = oopClass == (classExternalAddress()))) {
				...
				if ((isString = includesBehaviorThatOf(oopClass, classString()))) {
					isAlien = 0;
				}
				else {
					isAlien = includesBehaviorThatOf(oopClass, classAlien());
				}
			}
		...
		if (atomicType <= FFITypeSignedInt32) {
			...
			if (atomicType <= ((BytesPerWord == 8
				...
				shift = ((BytesPerWord == 8)
				 && (atomicType >= FFITypeUnsignedInt32)
					? 32
		...
		if (atomicType2 <= FFITypeSignedInt32) {
			...
			if (atomicType2 <= ((BytesPerWord == 8
				...
				shift1 = ((BytesPerWord == 8)
				 && (atomicType2 >= FFITypeUnsignedInt32)
					? 32
...
void* X64SysVFFIPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveExternalAddressFromInteger\000\377\001", (void*)primitiveExternalAddressFromInteger},
...
EXPORT(signed short) primitiveExternalAddressFromIntegerMetadata = -255;
