...
<<<<<<< HEAD
	VMPluginCodeGenerator VMMaker.oscog-eem.2039 uuid: 78dde0e7-e826-47ad-b2ef-4a8aff88b963
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2039 uuid: 78dde0e7-e826-47ad-b2ef-4a8aff88b963
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2039 uuid: 78dde0e7-e826-47ad-b2ef-4a8aff88b963 " __DATE__ ;
=======
	VMPluginCodeGenerator VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff " __DATE__ ;
>>>>>>> 3a6a4e05ed7fe09f6f6702bc8207059f88b3c7a5
...
#ifdef SQUEAK_BUILTIN_PLUGIN
<<<<<<< HEAD
	"X64SysVFFIPlugin VMMaker.oscog-eem.2039 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.2039 (e)"
=======
	"X64SysVFFIPlugin VMMaker.oscog-nice.2038 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-nice.2038 (e)"
>>>>>>> 3a6a4e05ed7fe09f6f6702bc8207059f88b3c7a5
#endif
;
		...
		if (((calloutState->ffiRetHeader)) & FFIFlagPointer) {
			...
			if (retClass1 == (nilObject())) {
				...
				if ((((usqInt) atomicType1) >> 1) == (((usqInt) FFITypeSignedChar) >> 1)) {
					...
					if (!(((usqInt) (((usqLong) intRet))))) {
						retOop1 = nilObject();
						goto l3;
					}
					cString = ((char *) (((usqInt) (((usqLong) intRet)))));
					strLen = 0;
...
;
	...
	if (atomicType == FFITypeBool) {
		...
		value = (byteSize == (sizeof(((usqLong) intRet)))
			? ((usqLong) intRet)
			: (((usqLong) intRet)) & (((((unsigned long long)1)) << (byteSize * 8)) - 1));
		return (value == 0
			? falseObject()
			: trueObject());
	}
	if (atomicType <= FFITypeSignedInt) {
		...
		if (atomicType <= ((BytesPerWord == 8
			...
			value = (((usqLong) intRet)) & (((((unsigned long long)1)) << shift) - 1);
			if (atomicType & 1) {
		...
		return (atomicType & 1
			? (BytesPerWord == 8
					? signed64BitIntegerFor(((usqLong) intRet))
					: signed32BitIntegerFor(((usqLong) intRet)))
			: (BytesPerWord == 8
					? positive64BitIntegerFor(((usqLong) intRet))
					: positive32BitIntegerFor(((usqLong) intRet))));
	}
	return ((((usqInt) atomicType) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
		? (atomicType & 1
				? signed64BitIntegerFor(((usqLong) intRet))
				: positive64BitIntegerFor(((usqLong) intRet)))
		: characterObjectOf((((usqLong) intRet)) & 0xFF));
}
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop2), (returnStructInRegisters((calloutState->structReturnSize))
			? ((void *)((&intRet)))
			: (calloutState->limit)), (calloutState->structReturnSize));
				...
				if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters1) <= NumFloatRegArgs)
				 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
					...
					if (structSize1 > 8) {
						if (passField1InXmmReg1) {
							/* begin ffiPushDoubleFloat:in: */
							value3 = (((double *) ptrAddress))[1];
							if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
								((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = value3;
								(calloutState->floatRegisterIndex) = ((calloutState->floatRegisterIndex)) + 1;
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								storeFloatAtPointerfrom((calloutState->currentArg), value3);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
...
l17:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l13;
	}
		...
		if (((calloutState1->ffiRetHeader)) & FFIFlagPointer) {
			...
			if (retClass11 == (nilObject())) {
				...
				if ((((usqInt) atomicType11) >> 1) == (((usqInt) FFITypeSignedChar) >> 1)) {
					...
					/* String return */
					/* begin ffiReturnCStringFrom: */
					if (!(((usqInt) (((usqLong) intRet1))))) {
						retOop11 = nilObject();
						goto l16;
					}
					cString1 = ((char *) (((usqInt) (((usqLong) intRet1)))));
					strLen1 = 0;
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop21), (returnStructInRegisters((calloutState1->structReturnSize))
			? ((void *)((&intRet1)))
	...
	if (atomicType2 == FFITypeBool) {
		...
		value1 = (byteSize1 == (sizeof(((usqLong) intRet1)))
			? ((usqLong) intRet1)
			: (((usqLong) intRet1)) & (((((unsigned long long)1)) << (byteSize1 * 8)) - 1));
		result2 = (value1 == 0
			? falseObject()
			: trueObject());
		goto l21;
	...
	if (atomicType2 <= FFITypeSignedInt) {
		...
		if (atomicType2 <= ((BytesPerWord == 8
			...
			value1 = (((usqLong) intRet1)) & (((((unsigned long long)1)) << shift1) - 1);
			if (atomicType2 & 1) {
		...
		result2 = (atomicType2 & 1
			? (BytesPerWord == 8
					? signed64BitIntegerFor(((usqLong) intRet1))
					: signed32BitIntegerFor(((usqLong) intRet1)))
			: (BytesPerWord == 8
					? positive64BitIntegerFor(((usqLong) intRet1))
					: positive32BitIntegerFor(((usqLong) intRet1))));
		goto l21;
	}
	result2 = ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
		? (atomicType2 & 1
				? signed64BitIntegerFor(((usqLong) intRet1))
				: positive64BitIntegerFor(((usqLong) intRet1)))
		: characterObjectOf((((usqLong) intRet1)) & 0xFF));
l21:	/* end ffiCalloutTo:SpecOnStack:in: */;
	/* begin cleanupCalloutState: */
	while (((calloutState1->stringArgIndex)) > 0) {
		free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
	}
