/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2040 uuid: 5c1c9278-c66a-4508-8b7c-fb1b0c8b3e46
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2040 uuid: 5c1c9278-c66a-4508-8b7c-fb1b0c8b3e46 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-eem.2040 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.2040 (e)"
#endif
;
...
#if SPURVM
				oop11 = instantiateClassindexableSize(classOop, BytesPerWord);
...
;
	...
	l16:	/* end ffiCalloutTo:SpecOnStack:in: */;
		...
		result = result1;
	l5:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
l6:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l8;
	}
...
#if SPURVM
				oop12 = instantiateClassindexableSize(classExternalAddress(), BytesPerWord);
...
#if SPURVM
			oop12 = instantiateClassindexableSize(classOop1, BytesPerWord);
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop3), (returnStructInRegisters((calloutState1->structReturnSize))
			? ((void *)((&intRet1)))
...
l22:	/* end ffiCalloutTo:SpecOnStack:in: */;
	/* begin cleanupCalloutState: */
	while (((calloutState1->stringArgIndex)) > 0) {
		free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
	}
