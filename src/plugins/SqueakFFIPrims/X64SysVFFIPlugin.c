/* Automatically generated by
	...
	(Compiler-eem.512)
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3475 uuid: d9ef6856-42d8-4074-bde7-82f1e1d41282
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3475 uuid: d9ef6856-42d8-4074-bde7-82f1e1d41282 " __DATE__ ;
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3475 " INT_EXT;
static sqInt nilObj;
		...
		if (((((calloutState->ffiRetHeader)) & FFIFlagPointer) != 0)) {
			...
			if (retClass == nilObj) {
				...
				if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedChar8)) >> 1)) {
					...
					for (iSqInt = 0; iSqInt < strLen; iSqInt += 1) {
						strPtr[iSqInt] = (cString[iSqInt]);
					}
					retOop = strOop;
					/* end ffiReturnCStringFrom: */
l5:
					result = retOop;
					goto l6;
				}
