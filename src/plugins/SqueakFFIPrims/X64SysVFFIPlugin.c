/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2685 uuid: eb95e6f3-a3ce-462b-91c4-a27a10b43ce3
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2685 uuid: eb95e6f3-a3ce-462b-91c4-a27a10b43ce3
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.2685 uuid: eb95e6f3-a3ce-462b-91c4-a27a10b43ce3 " __DATE__ ;
...
static sqInt ffiReturnStructofTypein(void *sixteenByteRetPtr, sqInt ffiRetType, CalloutState *calloutState);
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.2685 " INT_EXT;
...
static sqInt
ffiReturnStructofTypein(void *sixteenByteRetPtr, sqInt ffiRetType, CalloutState *calloutState)
{
    sqInt oop;
    sqInt retClass;
    sqInt retOop;
...
#      endif /* COGMTVM */
	...
	if (returnStructByValue1) {
		if (((calloutState1->structReturnSize)) <= (WordSize * 2)) {
			registerType1 = registerTypeForStructSpecsOfLength(firstIndexableField((calloutState1->ffiRetSpec)), slotSizeOf((calloutState1->ffiRetSpec)));
		}
		else {
