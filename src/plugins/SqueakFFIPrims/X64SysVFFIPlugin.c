/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.1687 uuid: fde8cc46-be93-419f-8087-ef54c0b4f237
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1687 uuid: fde8cc46-be93-419f-8087-ef54c0b4f237
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1687 uuid: fde8cc46-be93-419f-8087-ef54c0b4f237 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-eem.1687 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.1687 (e)"
#endif
;
...
ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass, CalloutState *calloutState)
{
	...
	if (((calloutState->ffiArgHeader)) & FFIFlagStructure) {
		...
		if (ptrClass == (classExternalAddress())) {
			...
			if (structSize <= 16) {
				...
				passField0InXmmReg = (doubleType == ((((int *) argSpec1))[1]))
				 || ((floatType == ((((int *) argSpec1))[1]))
				 && (floatType == ((((int *) argSpec1))[2])));
				if (structSize <= 8) {
					...
					passField1InXmmReg = (doubleType == ((((int *) argSpec1))[argSpecSize - 1]))
					 || ((floatType == ((((int *) argSpec1))[argSpecSize - 2]))
					 && (floatType == ((((int *) argSpec1))[argSpecSize - 1])));
					numDoubleRegisters = ((passField0InXmmReg
	? 1
	...
	: 0));
				...
				if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <= NumFloatRegArgs)
				 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
					if (passField0InXmmReg) {
						/* begin ffiPushDoubleFloat:in: */
						if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
							((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) (((void *) ptrAddress))))[0]);
							(calloutState->floatRegisterIndex = ((calloutState->floatRegisterIndex)) + 1);
						}
						else {
							if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
							...
							storeFloatAtPointerfrom((calloutState->currentArg), (((double *) (((void *) ptrAddress))))[0]);
							(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
						}
					l5:	/* end ffiPushDoubleFloat:in: */;
						...
						value = ((sqLong) ((((long long *) (((void *) ptrAddress))))[0]));
					...
					l6:	/* end ffiPushSignedLongLong:in: */;
					}
					if (structSize > 8) {
						if (passField1InXmmReg) {
							/* begin ffiPushDoubleFloat:in: */
							if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
								((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = ((((double *) (((void *) ptrAddress))))[1]);
								(calloutState->floatRegisterIndex = ((calloutState->floatRegisterIndex)) + 1);
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								storeFloatAtPointerfrom((calloutState->currentArg), (((double *) (((void *) ptrAddress))))[1]);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
						l3:	/* end ffiPushDoubleFloat:in: */;
							...
							/* begin ffiPushSignedLongLong:in: */
							value1 = ((sqLong) ((((long long *) (((void *) ptrAddress))))[1]));
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				memcpy((calloutState->currentArg), ((char *) (((void *) ptrAddress))), structSize);
...
#        endif /* COGMTVM */
				...
				if (structSize1 <= 16) {
					...
					/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
					   ...
					   but not ones like this:
					   typedef struct { int a; float b; int c; float d; } s2h; */
					doubleType1 = (FFITypeDoubleFloat << FFIAtomicTypeShift) + FFITypeDoubleFloat;
					floatType1 = (FFITypeDoubleFloat << FFIAtomicTypeShift) + FFITypeSingleFloat;
					passField0InXmmReg1 = (doubleType1 == ((((int *) argSpec2))[1]))
					 || ((floatType1 == ((((int *) argSpec2))[1]))
					 && (floatType1 == ((((int *) argSpec2))[2])));
					if (structSize1 <= 8) {
						...
						passField1InXmmReg1 = (doubleType1 == ((((int *) argSpec2))[argSpecSize1 - 1]))
						 || ((floatType1 == ((((int *) argSpec2))[argSpecSize1 - 2]))
						 && (floatType1 == ((((int *) argSpec2))[argSpecSize1 - 1])));
						numDoubleRegisters1 = ((passField0InXmmReg1
	? 1
	...
	: 0));
					...
					if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters1) <= NumFloatRegArgs)
					 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
						...
						l8:	/* end ffiPushDoubleFloat:in: */;
						}
						else {
							/* begin ffiPushSignedLongLong:in: */
							value2 = ((sqLong) ((((long long *) (((void *) ptrAddress))))[0]));
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
								((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) value2));
								(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								longAtput((calloutState->currentArg), value2);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
						l10:	/* end ffiPushSignedLongLong:in: */;
						}
						if (structSize1 > 8) {
							...
							l7:	/* end ffiPushDoubleFloat:in: */;
							}
							else {
								/* begin ffiPushSignedLongLong:in: */
								value11 = ((sqLong) ((((long long *) (((void *) ptrAddress))))[1]));
								if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
									((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) value11));
									(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
								}
								else {
									if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
									...
									longAtput((calloutState->currentArg), value11);
									(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
								}
					...
					memcpy((calloutState->currentArg), ((char *) (((void *) ptrAddress))), structSize1);
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet = dispatchFunctionPointerwithwithwithwithwithwith(((double (*)(long, long, long, long, long, long)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		}
	}
	else {
		intRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturn (*)(long, long, long, long, long, long)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
	}
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet = dispatchFunctionPointerwithwithwithwithwithwith(((double (*)(long, long, long, long, long, long)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
		}
	}
	else {
		intRet = dispatchFunctionPointerwithwithwithwithwithwith(((SixteenByteReturn (*)(long, long, long, long, long, long)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5]);
	}
	if (isCalleePopsConvention((calloutState->callFlags))) {
		setsp((calloutState->argVector));
	}
		...
		if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <= NumFloatRegArgs)
		 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
			...
			l1:	/* end ffiPushDoubleFloat:in: */;
				...
				/* begin ffiPushSignedLongLong:in: */
				value = ((sqLong) ((((long long *) pointer))[0]));
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) value));
					(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
				}
			...
			if (structSize > 8) {
				...
				l3:	/* end ffiPushDoubleFloat:in: */;
					...
					/* begin ffiPushSignedLongLong:in: */
					value1 = ((sqLong) ((((long long *) pointer))[1]));
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqInt) value1));
						(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
					}
...
#endif /* SPURVM */
;
				memcpy(firstIndexableField(oop11), (returnStructInRegisters((calloutState->structReturnSize))
					? ((void *)((&intRet)))
					: (calloutState->limit)), (calloutState->structReturnSize));
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType2) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType2 == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet1 = dispatchFunctionPointerwithwithwithwithwithwith(((double (*)(long, long, long, long, long, long)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3], ((calloutState1->integerRegisters))[4], ((calloutState1->integerRegisters))[5]);
		}
	}
	else {
...
#if SPURVM
				oop21 = instantiateClassindexableSize(classExternalAddress(), 4);
				ptr3 = firstIndexableField(oop21);
				ptr3[0] = (((sqInt) retVal11));
...
#if SPURVM
			oop21 = instantiateClassindexableSize(classOop1, 4);
...
#endif /* SPURVM */
;
			memcpy(firstIndexableField(oop12), (returnStructInRegisters((calloutState1->structReturnSize))
				? ((void *)((&intRet1)))
	...
	if ((((usqInt) atomicType2) >> 1) == (FFITypeSingleFloat > 1)) {
		...
		if (atomicType2 == FFITypeBool) {
			...
			value1 = (byteSize1 == (sizeof(retVal2))
				? retVal2
				: retVal2 & ((1 << (byteSize1 * 8)) - 1));
			oop4 = (value1 == 0
				? falseObject()
				: trueObject());
			goto l14;
		...
		if (atomicType2 <= FFITypeSignedInt) {
			...
			if (atomicType2 <= FFITypeSignedShort) {
				...
				/* # of significant bits */
				shift1 = (((usqInt) atomicType2) >> 1) * 8;
				value1 = retVal2 & ((1 << shift1) - 1);
				if (atomicType2 & 1) {
			...
			oop4 = (atomicType2 & 1
				? signed32BitIntegerFor(retVal2)
				: positive32BitIntegerFor(retVal2));
			goto l14;
		}
		oop4 = ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
			? (atomicType2 & 1
					? signed64BitIntegerFor(retVal2)
					: positive64BitIntegerFor(retVal2))
			: characterObjectOf(retVal2 & Byte0Mask));
...
primitiveFFIAllocate(void)
{
	...
	oop = instantiateClassindexableSize(classExternalAddress(), sizeof(long));
	ptr = firstIndexableField(oop);
	ptr[0] = addr;
...
primitiveFFIFree(void)
{
	...
	addr = ptr[0];
	if ((addr == 0)
	 || ((((((unsigned long)addr)) & ((sizeof(long)) - 1)) != 0)
	 || (isInMemory(addr)))) {
		return primitiveFail();
	}
	ffiFree(addr);
...
void* X64SysVFFIPlugin_exports[][3] = {
	{"X64SysVFFIPlugin", "ffiLogCallsTo", (void*)ffiLogCallsTo},
	{"X64SysVFFIPlugin", "getModuleName", (void*)getModuleName},
	{"X64SysVFFIPlugin", "initialiseModule", (void*)initialiseModule},
	{"X64SysVFFIPlugin", "primitiveCallout\000\002", (void*)primitiveCallout},
	{"X64SysVFFIPlugin", "primitiveCalloutWithArgs\000\004", (void*)primitiveCalloutWithArgs},
	{"X64SysVFFIPlugin", "primitiveCreateManualSurface\000\000", (void*)primitiveCreateManualSurface},
	{"X64SysVFFIPlugin", "primitiveDestroyManualSurface\000\000", (void*)primitiveDestroyManualSurface},
	{"X64SysVFFIPlugin", "primitiveFFIAllocate\000\001", (void*)primitiveFFIAllocate},
	{"X64SysVFFIPlugin", "primitiveFFIDoubleAt\000\001", (void*)primitiveFFIDoubleAt},
	{"X64SysVFFIPlugin", "primitiveFFIDoubleAtPut\000\001", (void*)primitiveFFIDoubleAtPut},
	{"X64SysVFFIPlugin", "primitiveFFIFloatAt\000\001", (void*)primitiveFFIFloatAt},
	{"X64SysVFFIPlugin", "primitiveFFIFloatAtPut\000\001", (void*)primitiveFFIFloatAtPut},
	{"X64SysVFFIPlugin", "primitiveFFIFree\000\001", (void*)primitiveFFIFree},
	{"X64SysVFFIPlugin", "primitiveFFIGetLastError\000\377", (void*)primitiveFFIGetLastError},
	{"X64SysVFFIPlugin", "primitiveFFIIntegerAt\000\001", (void*)primitiveFFIIntegerAt},
	{"X64SysVFFIPlugin", "primitiveFFIIntegerAtPut\000\001", (void*)primitiveFFIIntegerAtPut},
	{"X64SysVFFIPlugin", "primitiveForceLoad\000\002", (void*)primitiveForceLoad},
	{"X64SysVFFIPlugin", "primitiveLoadSymbolFromModule\000\002", (void*)primitiveLoadSymbolFromModule},
	{"X64SysVFFIPlugin", "primitiveLogCallsTo\000\000", (void*)primitiveLogCallsTo},
	{"X64SysVFFIPlugin", "primitiveSetManualSurfacePointer\000\000", (void*)primitiveSetManualSurfacePointer},
	{"X64SysVFFIPlugin", "setInterpreter", (void*)setInterpreter},
	{NULL, NULL, NULL}
};
