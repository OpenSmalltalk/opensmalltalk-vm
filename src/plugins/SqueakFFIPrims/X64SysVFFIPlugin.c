/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1693 uuid: 609488bc-c34d-49c6-8040-676e1a9d9d0e
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1693 uuid: 609488bc-c34d-49c6-8040-676e1a9d9d0e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-eem.1693 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.1693 (e)"
#endif
;
...
#        endif /* SPURVM */
				...
				if ((fetchClassOf(oop)) == (classLargePositiveInteger())) {
				...
				if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <= NumFloatRegArgs)
				 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <= NumIntRegArgs)) {
					...
					l5:	/* end ffiPushDoubleFloat:in: */;
						...
						value = ((sqLong) ((((long long *) ptrAddress))[0]));
					...
					if (structSize > 8) {
						...
						l3:	/* end ffiPushDoubleFloat:in: */;
							...
							/* begin ffiPushSignedLongLong:in: */
							value1 = ((sqLong) ((((long long *) ptrAddress))[1]));
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters1) <= NumFloatRegArgs)
					 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
						...
						l8:	/* end ffiPushDoubleFloat:in: */;
							...
							/* begin ffiPushSignedLongLong:in: */
							value2 = ((sqLong) ((((long long *) ptrAddress))[0]));
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						if (structSize1 > 8) {
							...
							l7:	/* end ffiPushDoubleFloat:in: */;
								...
								/* begin ffiPushSignedLongLong:in: */
								value11 = ((sqLong) ((((long long *) ptrAddress))[1]));
								if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
	...
	if ((((usqInt) atomicType) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType <= FFITypeSignedInt) {
			...
			if (atomicType <= ((BytesPerWord == 8
				...
				value = retVal1 & (((((unsigned long)1)) << shift) - 1);
				if (atomicType & 1) {

					/* make the guy signed */
					mask = (((unsigned long)1)) << (shift - 1);
		...
		oop = ((((usqInt) atomicType) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
			? (atomicType & 1
					? signed64BitIntegerFor(retVal1)
					: positive64BitIntegerFor(retVal1))
			: characterObjectOf(retVal1 & Byte0Mask));
		...
		if (atomicType <= ((BytesPerWord == 8
			...
			shift = ((BytesPerWord == 8)
			 && (atomicType >= FFITypeUnsignedInt)
				? 32
				: (((usqInt) atomicType) >> 1) * 8);
			value = retVal & (((((unsigned long)1)) << shift) - 1);
			if (atomicType & 1) {
	...
	if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		...
		if (atomicType2 <= FFITypeSignedInt) {
			...
			if (atomicType2 <= ((BytesPerWord == 8
				...
				value1 = retVal11 & (((((unsigned long)1)) << shift1) - 1);
				if (atomicType2 & 1) {

					/* make the guy signed */
					mask1 = (((unsigned long)1)) << (shift1 - 1);
		...
		oop4 = ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedLongLong) >> 1)
			? (atomicType2 & 1
					? signed64BitIntegerFor(retVal11)
					: positive64BitIntegerFor(retVal11))
			: characterObjectOf(retVal11 & Byte0Mask));
...
primitiveFFIIntegerAtPut(void)
{
	...
	if (byteSize < BytesPerWord) {
		if (isSigned) {
			...
			if (!((((unsigned long long)value)) < (1L << (8 * byteSize)))) {
				return primitiveFail();
			}
		}
	}
