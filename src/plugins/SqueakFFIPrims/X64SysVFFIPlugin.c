/* Automatically generated by
   ...
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3453"
#define WordSize 8
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3453 " INT_EXT;
	...
	if (((((calloutState->ffiArgHeader)) & FFIFlagPointer) != 0)) {
		...
		if (((((calloutState->ffiArgHeader)) & FFIFlagAtomic) != 0)) {
			if (isStruct) {
				...
				atomicType1 = ((usqInt)((((calloutState->ffiArgHeader)) & FFIAtomicTypeMask))) >> FFIAtomicTypeShift;
				if (atomicType1 != FFITypeVoid) {
					...
					err = 0;
	l7:	/* end ffiValidateExternalData:AtomicType: */;
					if (err != 0) {
						return err;
					}
				}
			...
			atomicType2 = ((usqInt)((((calloutState->ffiArgHeader)) & FFIAtomicTypeMask))) >> FFIAtomicTypeShift;
...
#      endif // COGMTVM
			...
			if ((((usqInt)(atomicType2)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
				...
				if (isAlienObj) {
					pointer3 = pointerForOop(					/* begin startOfData: */
						((longAt(valueOop + BaseHeaderSize)) > 0
			...
			if (atomicType2 <= FFITypeDoubleFloat) {
				...
				if (isAlienObj) {
					pointer5 = pointerForOop(					/* begin startOfData: */
						((longAt(valueOop + BaseHeaderSize)) > 0
						? (valueOop + BaseHeaderSize) + BytesPerOop
						: longAt((valueOop + BaseHeaderSize) + BytesPerOop)));
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
...
ffiLoadCalloutModule(sqInt module)
{
	...
	if (moduleHandle == 0) {
		...
		ptr = ((sqInt *) (firstIndexableField(moduleHandlePtr)));
		ptr[0] = moduleHandle;
	}
	return moduleHandle;
}
...
#    endif // COGMTVM
		...
		ptrAddress = ((void *) (/* begin startOfData: */
	((longAt(oop + BaseHeaderSize)) > 0
...
ffiReturnCStringFrom(sqInt cPointer)
{
	...
	strPtr = ((char *) (firstIndexableField(strOop)));
...
ffiReturnPointerofTypein(usqLong retVal, sqInt retType, CalloutState *calloutState)
{
	...
	l1:	/* end ffiReturnCStringFrom: */;
		...
		ptr = ((sqInt *) (firstIndexableField(oop)));
		ptr[0] = (((sqInt) retVal));
...
primitiveCallout(void)
{
	...
	if (address1 == 0) {
		...
		ptr = ((sqIntptr_t *) (firstIndexableField(addressPtr)));
		ptr[0] = address1;
	}
	address = address1;
...
#  if COGMTVM
	if (!(		/* begin ffiSupportsCallingConvention: */
...
#      endif
	...
	vmHandle = disownVM(	/* begin disownFlagsFor: */
		(((((calloutState->callFlags)) & FFICallFlagThreaded) != 0)
	...
	l6:	/* end ffiReturnCStringFrom: */;
				...
				ptr1 = ((sqInt *) (firstIndexableField(oop2)));
				ptr1[0] = (((sqInt) intRet));
								retOop = instantiateClassindexableSize(classExternalData(), 0);
...
primitiveFFIAllocate(void)
{
	...
	ptr = ((sqIntptr_t *) (firstIndexableField(oop)));
	ptr[0] = addr;
...
primitiveLoadSymbolFromModule(void)
{
	...
	ptr = ((void **) (firstIndexableField(oop)));
	ptr[0] = address;
