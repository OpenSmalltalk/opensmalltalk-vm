/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.1977 uuid: e12daf50-ab4d-4d62-9c65-18cd20e5c0fe
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1977 uuid: e12daf50-ab4d-4d62-9c65-18cd20e5c0fe
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.1977 uuid: e12daf50-ab4d-4d62-9c65-18cd20e5c0fe " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64SysVFFIPlugin VMMaker.oscog-eem.1977 (i)"
#else
	"X64SysVFFIPlugin VMMaker.oscog-eem.1977 (e)"
#endif
;
	...
	if (((calloutState->ffiArgHeader)) & FFIFlagStructure) {
		...
		if (ptrClass == (classExternalAddress())) {
			...
			if (structSize <= 16) {
				...
				doubleType = (((int)((usqInt)(FFITypeDoubleFloat) << FFIAtomicTypeShift))) + FFITypeDoubleFloat;
				floatType = (((int)((usqInt)(FFITypeDoubleFloat) << FFIAtomicTypeShift))) + FFITypeSingleFloat;
...
#        endif /* COGMTVM */
				...
				if (structSize1 <= 16) {
					...
					/* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf. (dravft version 0.90).
					   ...
					   but not ones like this:
					   typedef struct { int a; float b; int c; float d; } s2h; */
					doubleType1 = (((int)((usqInt)(FFITypeDoubleFloat) << FFIAtomicTypeShift))) + FFITypeDoubleFloat;
					floatType1 = (((int)((usqInt)(FFITypeDoubleFloat) << FFIAtomicTypeShift))) + FFITypeSingleFloat;
	...
	: 0));
					...
					if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters1) <= NumFloatRegArgs)
					 && ((((calloutState->integerRegisterIndex)) + numIntegerRegisters1) <= NumIntRegArgs)) {
						...
						l12:	/* end ffiPushSignedLongLong:in: */;
						}
						if (structSize1 > 8) {
		...
		if (((calloutState->ffiArgHeader)) & FFIFlagAtomic) {
			...
			if (isStruct) {
				...
				if (atomicType != FFITypeVoid) {
					...
					err = 0;
				l13:	/* end ffiValidateExternalData:AtomicType: */;
					if (err != 0) {
						return err;
					}
				}
