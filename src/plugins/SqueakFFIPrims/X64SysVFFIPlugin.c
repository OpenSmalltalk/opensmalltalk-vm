/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3253 uuid: 28effaaf-689b-4650-90e9-4c3534bffdd0
   from
	ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3253 uuid: 28effaaf-689b-4650-90e9-4c3534bffdd0
 */
static char __buildInfo[] = "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3253 uuid: 28effaaf-689b-4650-90e9-4c3534bffdd0 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3253"
#define WordSize 8
...
static const char *moduleName = "X64SysVFFIPlugin VMMaker.oscog-eem.3253 " INT_EXT;
...
#      endif
	...
	: 0)));
			...
			if (isLargeNegativeIntegerObject(oop)) {
				intValue = signed64BitValueOf(oop);
				goto l2;
			}
		}
		intValue = ((sqLong) (signedMachineIntegerValueOf(oop)));
...
#        endif // SPURVM
	...
	: 0)));
				...
				if (isLargeNegativeIntegerObject(valueOop)) {
					intValue = signed64BitValueOf(valueOop);
					goto l34;
				}
			}
			intValue = ((sqLong) (signedMachineIntegerValueOf(valueOop)));
