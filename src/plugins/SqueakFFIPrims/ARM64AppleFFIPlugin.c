/* Automatically generated by
   ...
   from
	ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3242 uuid: 8971ffc8-7ec0-4556-8654-5abc437196bd
 */
static char __buildInfo[] = "ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3242 uuid: 8971ffc8-7ec0-4556-8654-5abc437196bd " __DATE__ ;
...
static const char *moduleName = "ARM64AppleFFIPlugin VMMaker.oscog-eem.3242 " INT_EXT;
	...
	if (((((calloutState->ffiArgHeader)) & FFIFlagStructure) != 0)) {
		...
		if (ptrClass == (classExternalAddress())) {
			...
			if (stackPartSize > 0) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes110 = (((sqInt)((calloutState->currentArg)))) & (7);
				if (misAlignedBytes110 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes110));
				}
...
#        endif // COGMTVM
				...
				if (stackPartSize1 > 0) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes21 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes21 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes21));
					}
...
primitiveCallout(void)
{
    ...
    sqInt flags;
    sqInt flags1;
    union { struct { float floats[8]; } f; struct dprr { double doubles[4]; } d; } floatRet;
    union { struct { float floats[8]; } f; struct dprr { double doubles[4]; } d; } floatRet1;
    sqInt functionName;
    sqInt functionName1;
    sqInt i;
    sqInt i1;
	...
	l5:	/* end ffiReturnCStringFrom: */;
		...
		if (atomicType <= FFITypeSignedInt32) {
			...
			if (((atomicType & 1) != 0)) {
				...
				result1 = signed64BitIntegerFor(((sqIntptr_t) intRet));
			}
			else {
				/* begin positiveMachineIntegerFor: */
				result1 = positive64BitIntegerFor(((usqIntptr_t) intRet));
			}
			goto l9;
		}
...
#  endif
	...
	if (atomicType2 <= FFITypeSignedInt32) {
		...
		if (((atomicType2 & 1) != 0)) {
			/* begin signedMachineIntegerFor: */
			result2 = signed64BitIntegerFor(((sqIntptr_t) intRet1));
		}
		else {
			/* begin positiveMachineIntegerFor: */
			result2 = positive64BitIntegerFor(((usqIntptr_t) intRet1));
		}
		goto l17;
	}
