/* Automatically generated by
   ...
   from
	ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f
 */
static char __buildInfo[] = "ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f " __DATE__ ;
...
static const char *moduleName = "ARM64AppleFFIPlugin VMMaker.oscog-eem.3455 " INT_EXT;
			...
			if ((((usqInt)(atomicType2)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
				...
				if (isStringObj
				 || (oopClass1 == (classByteArray()))) {
					...
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes10 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes10 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes10));
						}
				...
				if (isExternalAddress) {
					...
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes13 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes13 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes13));
						}
	...
	l3:	/* end ffiIntegerValueOf: */;
			...
			case 1:  // ffiPushUnsigned64:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes9 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes9 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes9));
					}
...
#endif /* SPURVM */
				storePointerofObjectwithValue(1, retOop2, returnType);
				result = retOop2;
				goto l7;
			}
...
#endif /* SPURVM */
		memcpy(firstIndexableField(oop1), longLongRetPtr1, (calloutState->structReturnSize));
