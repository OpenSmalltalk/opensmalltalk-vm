/* Automatically generated by
   ...
   from
	ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "ARM64AppleFFIPlugin VMMaker.oscog-eem.3423 " INT_EXT;
...
ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass, CalloutState *calloutState)
{
    ...
    sqInt misAlignedBytes42;
    sqInt misAlignedBytes5;
    sqInt misAlignedBytes51;
    sqInt misAlignedBytes6;
    sqInt misAlignedBytes61;
    sqInt misAlignedBytes7;
    sqInt misAlignedBytes71;
    sqInt misAlignedBytes8;
    sqInt misAlignedBytes9;
    sqInt nilOop;
    sqInt oopClass;
...
#        endif // COGMTVM
			...
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes4 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
				if (misAlignedBytes4 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes4));
				}
				longAtput((calloutState->currentArg), ptrAddress);
				(calloutState->currentArg = ((calloutState->currentArg)) + BytesPerWord);
			}
			...
			if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedChar8)) >> 1)) {
				...
				if (isStringObj) {
					...
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes6 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes6 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes6));
						}
...
#      endif // COGMTVM
			...
			if ((((usqInt)(atomicType1)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
				...
				if (isStringObj
				 || (oopClass1 == (classByteArray()))) {
					...
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes7 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes7 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes7));
						}
				...
				if (isExternalAddress) {
					...
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes12 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes12 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes12));
						}
				...
				if (isAlienObj) {
					/* begin ffiPushPointer:in: */
					pointer2 = pointerForOop(((longAt(valueOop + BaseHeaderSize)) > 0
			...
			if (atomicType1 <= FFITypeDoubleFloat) {
				if (isExternalAddress) {
					/* begin ffiPushPointer:in: */
					pointer3 = ((void *) (longAt(valueOop + BaseHeaderSize)));
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				if (isAlienObj) {
					/* begin ffiPushPointer:in: */
					pointer4 = pointerForOop(((longAt(valueOop + BaseHeaderSize)) > 0
						? (valueOop + BaseHeaderSize) + BytesPerOop
						: longAt((valueOop + BaseHeaderSize) + BytesPerOop)));
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				if (isWordsOrBytes(valueOop)) {
					/* begin ffiPushPointer:in: */
					pointer5 = firstIndexableField(valueOop);
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes5 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes5 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes5));
						}
...
#      if BytesPerWord == 8
			...
			case 4:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes32 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes32 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes32));
					}
					longAtput((calloutState->currentArg), ((unsigned short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
			...
			case 5:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes42 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes42 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes42));
					}
					longAtput((calloutState->currentArg), ((signed short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
			...
			case 6:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes51 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes51 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes51));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 7:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes61 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes61 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes61));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 8:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes71 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes71 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes71));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 8);
				}
...
#      else // BytesPerWord == 8
			...
			case 1:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes111 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes111 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes111));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 4:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes121 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes121 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes121));
					}
					longAtput((calloutState->currentArg), ((unsigned short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
