/* Automatically generated by
   ...
   from
	ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "ARM64AppleFFIPlugin VMMaker.oscog-eem.3453 " INT_EXT;
...
#      endif // !SPURVM
	...
	l1:	/* end ffiIntegerValueOf: */;
		...
		case 4:  // ffiPushUnsigned16:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes1 = (((sqInt)((calloutState->currentArg)))) & (1);
				if (misAlignedBytes1 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes1));
				}
		...
		case 5:  // ffiPushSigned16:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes2 = (((sqInt)((calloutState->currentArg)))) & (1);
				if (misAlignedBytes2 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes2));
				}
		...
		case 6:  // ffiPushUnsigned32:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes3 = (((sqInt)((calloutState->currentArg)))) & (3);
				if (misAlignedBytes3 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes3));
				}
				longAtput((calloutState->currentArg), intValue);
		...
		case 7:  // ffiPushSigned32:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes4 = (((sqInt)((calloutState->currentArg)))) & (3);
				if (misAlignedBytes4 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes4));
				}
				longAtput((calloutState->currentArg), intValue);
				(calloutState->currentArg = ((calloutState->currentArg)) + 4);
			}
		...
		case 8:  // ffiPushUnsigned64:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes5 = (((sqInt)((calloutState->currentArg)))) & (7);
				if (misAlignedBytes5 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes5));
				}
				longAtput((calloutState->currentArg), intValue);
				(calloutState->currentArg = ((calloutState->currentArg)) + 8);
			}
		...
		case 9:  // ffiPushSigned64:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes6 = (((sqInt)((calloutState->currentArg)))) & (7);
				if (misAlignedBytes6 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes6));
				}
				longAtput((calloutState->currentArg), intValue);
				(calloutState->currentArg = ((calloutState->currentArg)) + 8);
			}
		...
		case 14: // ffiPushUnsigned16:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes7 = (((sqInt)((calloutState->currentArg)))) & (1);
				if (misAlignedBytes7 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes7));
				}
				longAtput((calloutState->currentArg), ((unsigned short) intValue));
				(calloutState->currentArg = ((calloutState->currentArg)) + 2);
			}
		...
		case 15: // ffiPushUnsigned32:in:
			if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
				...
				/* begin alignCurrentArgOf:to: */
				misAlignedBytes8 = (((sqInt)((calloutState->currentArg)))) & (3);
				if (misAlignedBytes8 != 0) {
					(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes8));
				}
				longAtput((calloutState->currentArg), intValue);
				(calloutState->currentArg = ((calloutState->currentArg)) + 4);
			}
	...
	if (atomicType == FFITypeSingleFloat) {
		...
		if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
			...
			/* begin alignCurrentArgOf:to: */
			misAlignedBytes18 = (((sqInt)((calloutState->currentArg)))) & (3);
			if (misAlignedBytes18 != 0) {
				(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes18));
			}
		...
		if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
			...
			/* begin alignCurrentArgOf:to: */
			misAlignedBytes19 = (((sqInt)((calloutState->currentArg)))) & (7);
			if (misAlignedBytes19 != 0) {
				(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes19));
			}
...
#      endif // COGMTVM
			...
			if ((((usqInt)(atomicType2)) >> 1) == (((usqInt)(FFITypeSignedInt8)) >> 1)) {
				...
				if (isAlienObj) {
					pointer2 = pointerForOop(					/* begin startOfData: */
						((longAt(valueOop + BaseHeaderSize)) > 0
			...
			if (atomicType2 <= FFITypeDoubleFloat) {
				...
				if (isAlienObj) {
					pointer4 = pointerForOop(					/* begin startOfData: */
						((longAt(valueOop + BaseHeaderSize)) > 0
						? (valueOop + BaseHeaderSize) + BytesPerOop
						: longAt((valueOop + BaseHeaderSize) + BytesPerOop)));
					if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
						...
						/* begin alignCurrentArgOf:to: */
						misAlignedBytes42 = (((sqInt)((calloutState->currentArg)))) & (BytesPerWord - 1);
						if (misAlignedBytes42 != 0) {
							(calloutState->currentArg = ((calloutState->currentArg)) + (BytesPerWord - misAlignedBytes42));
						}
	...
	l3:	/* end ffiIntegerValueOf: */;
			...
			case 1:  // ffiPushUnsigned64:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes20 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes20 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes20));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 8);
				}
			...
			case 4:  // ffiPushUnsigned16:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes110 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes110 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes110));
					}
					longAtput((calloutState->currentArg), ((unsigned short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
			...
			case 5:  // ffiPushSigned16:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes21 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes21 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes21));
					}
					longAtput((calloutState->currentArg), ((signed short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
			...
			case 6:  // ffiPushUnsigned32:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes31 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes31 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes31));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 7:  // ffiPushSigned32:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes41 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes41 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes41));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
...
signed64BitIntegerFor(intRet)
	...
	l8:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
	return;
}
