/* Automatically generated by
   ...
   from
	ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8
 */
static char __buildInfo[] = "ThreadedARM64AppleFFIPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8 " __DATE__ ;
...
static const char *moduleName = "ARM64AppleFFIPlugin VMMaker.oscog-eem.3444 " INT_EXT;
	...
	l3:	/* end ffiIntegerValueOf: */;
			...
			case 5:  // ffiPushSigned16:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes22 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes22 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes22));
					}
					longAtput((calloutState->currentArg), ((signed short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
			...
			case 6:  // ffiPushUnsigned32:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes32 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes32 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes32));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 7:  // ffiPushSigned32:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes42 = (((sqInt)((calloutState->currentArg)))) & (3);
					if (misAlignedBytes42 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (4 - misAlignedBytes42));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				}
			...
			case 8:  // ffiPushUnsigned64:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes51 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes51 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes51));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 8);
				}
			...
			case 9:  // ffiPushSigned64:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes61 = (((sqInt)((calloutState->currentArg)))) & (7);
					if (misAlignedBytes61 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (8 - misAlignedBytes61));
					}
					longAtput((calloutState->currentArg), intValue);
					(calloutState->currentArg = ((calloutState->currentArg)) + 8);
				}
			...
			case 14: // ffiPushUnsigned16:in:
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					/* begin alignCurrentArgOf:to: */
					misAlignedBytes71 = (((sqInt)((calloutState->currentArg)))) & (1);
					if (misAlignedBytes71 != 0) {
						(calloutState->currentArg = ((calloutState->currentArg)) + (2 - misAlignedBytes71));
					}
					longAtput((calloutState->currentArg), ((unsigned short) intValue));
					(calloutState->currentArg = ((calloutState->currentArg)) + 2);
				}
