/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.3787 uuid: e4140a95-7620-4a8f-bc7b-d203220e7f73
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.3787 uuid: e4140a95-7620-4a8f-bc7b-d203220e7f73 " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-eem.3787 " INT_EXT;
static sqInt nilObj;
#if !COGMTVM
...
l1:
			...
			case 15: // ffiPushUnsigned32:in:
				...
				longAtput((calloutState->currentArg),((unsigned int) (((usqInt) intValue))));
				(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				return 0;
			...
			case 5:  // ffiPushSigned16:in:
				...
				return 0;
			case 7:
				value = ((sqInt) intValue);

				/* begin ffiPushSigned32:in: */
				if ((((calloutState->currentArg)) + 4) > ((calloutState->limit))) {
					return FFIErrorCallFrameTooBig;
				}
				longAtput((calloutState->currentArg),((signed int) value));
				(calloutState->currentArg = ((calloutState->currentArg)) + 4);
				return 0;
			case 8:  // ffiPushUnsigned64:in:
				...
				return 0;
			case 9:
				valueSqLong = intValue;

				/* begin ffiPushSigned64:in: */
				if ((((calloutState->currentArg)) + 8) > ((calloutState->limit))) {
					return FFIErrorCallFrameTooBig;
				}
				longAtput((calloutState->currentArg),((usqInt) valueSqLong));
				longAtput(((calloutState->currentArg)) + 4,((usqInt) (((usqLong)(valueSqLong)) >> 32)));
				(calloutState->currentArg = ((calloutState->currentArg)) + 8);
				return 0;
			}
		}
 ...
 || (isCharacterAtomicType((calloutState->errorResultType)))))));
	...
	if (((((calloutState->ffiRetHeader)) & (FFIFlagPointer + FFIFlagStructure)) != 0)) {
		...
		memcpy(firstIndexableField(oopSqInt), ((calloutState->structReturnType)
				? ((void *)((&intRet)))
				: ((void *)((calloutState->limit)))), (calloutState->structReturnSize));
		storePointerofObjectwithValue(0, retOop, oopSqInt);
		result = retOop;
		goto l7;
	}
