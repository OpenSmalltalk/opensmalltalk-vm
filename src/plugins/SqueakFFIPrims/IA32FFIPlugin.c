/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322 " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-eem.3310 " INT_EXT;
...
#    if BytesPerWord == 8
		...
		case 1:
			...
			longAtput(((calloutState->currentArg)) + 4, ((usqInt) ((intValue) >> 32)));
		...
		case 6:
			...
			longAtput((calloutState->currentArg), ((unsigned int) intValue));
			(calloutState->currentArg = ((calloutState->currentArg)) + 4);
			return 0;
		case 7:
			if ((((calloutState->currentArg)) + 4) > ((calloutState->limit))) {
			...
			longAtput((calloutState->currentArg), ((signed int) intValue));
			(calloutState->currentArg = ((calloutState->currentArg)) + 4);
			return 0;
		case 8:
			if ((((calloutState->currentArg)) + 8) > ((calloutState->limit))) {
...
#  else // COGMTVM
	...
	l12:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l15;
	}
...
#  endif // COGMTVM
	...
	if ((((calloutState1->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) == FFIFlagStructure) {
		...
		/* begin encodeStructReturnTypeIn: */
		(calloutState1->structReturnType = canReturnInRegistersStructOfSize((calloutState1->structReturnSize)));
	}
	err1 = 0;
