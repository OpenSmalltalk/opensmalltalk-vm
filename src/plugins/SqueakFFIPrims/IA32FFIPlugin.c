/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315 " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-nice.2763 " INT_EXT;
		...
		case FFIFlagStructure:
			...
			if (includesBehaviorThatOf(oopClass, argClass)) {
				...
				if (ptrClass3 == (classExternalAddress())) {
					...
					memcpy((calloutState->currentArg), ptrAddress2, structSize);
...
#            endif /* COGMTVM */
						...
						memcpy((calloutState->currentArg), ptrAddress2, structSize1);
			...
			if (includesBehaviorThatOf(oopClass, classExternalData())) {
				...
				if (ptrClass11 == (classExternalAddress())) {
					...
					roundedSize2 = (((structSize2 + 3) | 3) - 3);
					if ((((calloutState->currentArg)) + roundedSize2) > ((calloutState->limit))) {
						return FFIErrorCallFrameTooBig;
					}
					memcpy((calloutState->currentArg), ptrAddress1, structSize2);
...
#            endif /* COGMTVM */
						...
						roundedSize11 = (((structSize11 + 3) | 3) - 3);
						if ((((calloutState->currentArg)) + roundedSize11) > ((calloutState->limit))) {
							return FFIErrorCallFrameTooBig;
						}
						memcpy((calloutState->currentArg), ptrAddress1, structSize11);
...
ffiPushDereferenceSignedLongLongin(void *pointer, CalloutState *calloutState)
{
	...
	longAtput(((calloutState->currentArg)) + 4, ((usqInt) (((usqLong)(intValue)) >> 32)));
	(calloutState->currentArg = ((calloutState->currentArg)) + 8);
	return 0;
}
			...
			case FFIFlagStructure:
				...
				if (includesBehaviorThatOf(oopClass1, argClass1)) {
					...
					if (ptrClass31 == (classExternalAddress())) {
						...
						roundedSize3 = (((structSize3 + 3) | 3) - 3);
						if ((((calloutState1->currentArg)) + roundedSize3) > ((calloutState1->limit))) {
							err1 = FFIErrorCallFrameTooBig;
							goto l40;
						}
						memcpy((calloutState1->currentArg), ptrAddress21, structSize3);
...
#              endif /* COGMTVM */
							...
							roundedSize12 = (((structSize12 + 3) | 3) - 3);
							if ((((calloutState1->currentArg)) + roundedSize12) > ((calloutState1->limit))) {
								err1 = FFIErrorCallFrameTooBig;
								goto l40;
							}
							memcpy((calloutState1->currentArg), ptrAddress21, structSize12);
				...
				if (includesBehaviorThatOf(oopClass1, classExternalData())) {
					...
					if (ptrClass111 == (classExternalAddress())) {
						...
						roundedSize21 = (((structSize21 + 3) | 3) - 3);
						if ((((calloutState1->currentArg)) + roundedSize21) > ((calloutState1->limit))) {
							err1 = FFIErrorCallFrameTooBig;
							goto l40;
						}
						memcpy((calloutState1->currentArg), ptrAddress11, structSize21);
...
#              endif /* COGMTVM */
							...
							roundedSize111 = (((structSize111 + 3) | 3) - 3);
							if ((((calloutState1->currentArg)) + roundedSize111) > ((calloutState1->limit))) {
								err1 = FFIErrorCallFrameTooBig;
								goto l40;
							}
							memcpy((calloutState1->currentArg), ptrAddress11, structSize111);
