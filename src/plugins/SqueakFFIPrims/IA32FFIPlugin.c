/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.3024 uuid: 417aa150-be4e-4631-b35b-948afa18e190 " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-eem.3024 " INT_EXT;


/*** Macros ***/
#define allocaLiesSoSetSpBeforeCall() ALLOCA_LIES_SO_SETSP_BEFORE_CALL
#define canReturnInRegistersStructOfSize(sz) (WIN32_X86_STRUCT_RETURN && (sz) <= 8 && !((sz)&((sz)-1)))
...
#          endif
	...
	l2:	/* end ffiIntegerValueOf: */;
		...
		case 9:
			...
			longAtput(((calloutState->currentArg)) + 4, ((usqInt) (((usqLong)(value1)) >> 32)));
			(calloutState->currentArg = ((calloutState->currentArg)) + 8);
			return 0;
		case 10:
			if ((((calloutState->currentArg)) + 4) > ((calloutState->limit))) {
...
ffiCheckReturnWithin(sqInt retSpec, sqInt retClass, CalloutState *calloutState)
{
	...
	if ((((calloutState->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) == FFIFlagStructure) {
		...
		(calloutState->structReturnType = canReturnInRegistersStructOfSize((calloutState->structReturnSize)));
	}
	return 0;
}
