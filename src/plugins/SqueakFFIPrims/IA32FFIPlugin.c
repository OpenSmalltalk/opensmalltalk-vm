/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-eem.3423 " INT_EXT;
...
#      endif
	...
	l5:	/* end ffiReturnCStringFrom: */;
		...
		retOop = popRemappableOop();
#endif /* SPURVM */
		memcpy(firstIndexableField(oop2), ((calloutState->structReturnType)
			? longLongRetPtr
			: (calloutState->limit)), (calloutState->structReturnSize));
	...
	if (atomicType <= FFITypeSignedInt32) {
		...
		if (((atomicType & 1) != 0)) {
			...
			result = signed32BitIntegerFor(((sqIntptr_t) intRet));
		}
		else {
			/* begin positiveMachineIntegerFor: */
			result = positive32BitIntegerFor(((usqIntptr_t) intRet));
		}
		goto l9;
	}
