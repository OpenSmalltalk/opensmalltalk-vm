/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.2999 uuid: c7933314-4edf-4570-b6d8-3891b13c233d
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.2999 uuid: c7933314-4edf-4570-b6d8-3891b13c233d " __DATE__ ;
...
static const char *moduleName = "IA32FFIPlugin VMMaker.oscog-eem.2999 " INT_EXT;
...
/*	Set the return type to true if returning the struct via register */
	...
	/* ThreadedIA32FFIPlugin>>#encodeStructReturnTypeIn: */
static sqInt
...
ffiPushSignedLongLongOopin(sqInt oop, CalloutState *calloutState)
{
	...
	longAtput(((calloutState->currentArg)) + 4, ((usqInt) (((usqLong)(value)) >> 32)));
	(calloutState->currentArg = ((calloutState->currentArg)) + 8);
	return 0;
}
