/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.1064 uuid: 9d9d2583-03e6-4b6b-9b24-51587933f8f3
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.1064 uuid: 9d9d2583-03e6-4b6b-9b24-51587933f8f3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"IA32FFIPlugin VMMaker.oscog-eem.1064 (i)"
#else
	"IA32FFIPlugin VMMaker.oscog-eem.1064 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if ((atomicType2 == FFITypeSingleFloat)
	 || (atomicType2 == FFITypeDoubleFloat)) {
		floatRet1 = dispatchFunctionPointer(((double (*)()) address2));
	}
	else {
		intRet1 = dispatchFunctionPointer(((usqLong (*)()) address2));
	}
...
void* IA32FFIPlugin_exports[][3] = {
	...
	{"IA32FFIPlugin", "primitiveCallout\000\003", (void*)primitiveCallout},
