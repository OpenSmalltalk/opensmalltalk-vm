/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-nice.1989 uuid: 7e63fa13-3564-4b1b-8c0b-31378a87bc74
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-nice.1989 uuid: 7e63fa13-3564-4b1b-8c0b-31378a87bc74 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscog-nice.1989 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscog-nice.1989 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		if (atomicType2 == FFITypeSingleFloat) {
			floatRet1 = dispatchFunctionPointerwithwithwithwith(((float (*)(long, long, long, long)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
		}
		else {

			/* atomicType = FFITypeDoubleFloat */
			floatRet1 = dispatchFunctionPointerwithwithwithwith(((double (*)(long, long, long, long)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
		}
	}
	else {
		intRet1 = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(long, long, long, long)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
