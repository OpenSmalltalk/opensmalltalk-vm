/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322 " __DATE__ ;
...
static const char *moduleName = "X64Win64FFIPlugin VMMaker.oscog-eem.3310 " INT_EXT;
...
#  endif // COGMTVM
	...
	if ((((calloutState1->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) == FFIFlagStructure) {
		...
		/* begin encodeStructReturnTypeIn: */
		(calloutState1->structReturnType = (((calloutState1->structReturnSize)) <= WordSize)
		 && ((((calloutState1->structReturnSize)) & (((calloutState1->structReturnSize)) - 1)) == 0));
	}
	err1 = 0;
	l16:	/* end ffiCheckReturn:With:in: */;
	if (err1 != 0) {
		ffiFail(err1);
		goto l22;
	}
