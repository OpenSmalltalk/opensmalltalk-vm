/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.1693 uuid: 609488bc-c34d-49c6-8040-676e1a9d9d0e
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.1693 uuid: 609488bc-c34d-49c6-8040-676e1a9d9d0e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscog-eem.1693 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscog-eem.1693 (e)"
#endif
;
			...
			if ((structSize <= 16)
			 && ((structSize & (structSize - 1)) == 0)) {
				...
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqLong) ptrAddress));
					...
					longAtput((calloutState->currentArg), ((usqLong) ptrAddress));
					(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
				}
				return 0;
			}
