/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.1687 uuid: fde8cc46-be93-419f-8087-ef54c0b4f237
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.1687 uuid: fde8cc46-be93-419f-8087-ef54c0b4f237 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscog-eem.1687 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscog-eem.1687 (e)"
#endif
;
			...
			if ((structSize <= 16)
			 && ((structSize & (structSize - 1)) == 0)) {
				...
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqLong) (((void *) ptrAddress))));
					...
					longAtput((calloutState->currentArg), ((usqLong) (((void *) ptrAddress))));
					(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
				}
				return 0;
			}
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet = dispatchFunctionPointerwithwithwithwith(((double (*)(long, long, long, long)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
		}
	}
	else {
		intRet = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(long, long, long, long)) procAddr), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet = dispatchFunctionPointerwithwithwithwith(((double (*)(long, long, long, long)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
		}
	}
	else {
		intRet = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(long, long, long, long)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
	if (isCalleePopsConvention((calloutState->callFlags))) {
		setsp((calloutState->argVector));
	}
...
ffiPushStructureofSizetypeSpecofLengthin(void *pointer, sqInt structSize, sqInt *argSpec, sqInt argSpecSize, CalloutState *calloutState)
{
	...
	if ((structSize <= 16)
	 && ((structSize & (structSize - 1)) == 0)) {
		/* begin ffiPushUnsignedLongLong:in: */
		if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
			((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = (((usqLong) pointer));
			(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
		}
		else {
			if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
			...
			longAtput((calloutState->currentArg), ((usqLong) pointer));
			(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
		}
		return 0;
	}
...
primitiveCallout(void)
{
    ...
    usqLong intRet1;
    extern void loadFloatRegs(double, double, double, double);
    extern void loadFloatRegs1(double, double, double, double);
    sqInt mask;
    sqInt mask1;
    sqInt meth;
    sqInt myThreadIndex;
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType2) >> 1) == (FFITypeSingleFloat > 1)) {
		if (atomicType2 == FFITypeSingleFloat) {
			...
			/* atomicType = FFITypeDoubleFloat */
			floatRet1 = dispatchFunctionPointerwithwithwithwith(((double (*)(long, long, long, long)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
		}
	}
	else {
		intRet1 = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(long, long, long, long)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
...
void* X64Win64FFIPlugin_exports[][3] = {
	{"X64Win64FFIPlugin", "ffiLogCallsTo", (void*)ffiLogCallsTo},
	{"X64Win64FFIPlugin", "getModuleName", (void*)getModuleName},
	{"X64Win64FFIPlugin", "initialiseModule", (void*)initialiseModule},
	{"X64Win64FFIPlugin", "primitiveCallout\000\002", (void*)primitiveCallout},
	{"X64Win64FFIPlugin", "primitiveCalloutWithArgs\000\004", (void*)primitiveCalloutWithArgs},
	{"X64Win64FFIPlugin", "primitiveCreateManualSurface\000\000", (void*)primitiveCreateManualSurface},
	{"X64Win64FFIPlugin", "primitiveDestroyManualSurface\000\000", (void*)primitiveDestroyManualSurface},
	{"X64Win64FFIPlugin", "primitiveFFIAllocate\000\001", (void*)primitiveFFIAllocate},
	{"X64Win64FFIPlugin", "primitiveFFIDoubleAt\000\001", (void*)primitiveFFIDoubleAt},
	{"X64Win64FFIPlugin", "primitiveFFIDoubleAtPut\000\001", (void*)primitiveFFIDoubleAtPut},
	{"X64Win64FFIPlugin", "primitiveFFIFloatAt\000\001", (void*)primitiveFFIFloatAt},
	{"X64Win64FFIPlugin", "primitiveFFIFloatAtPut\000\001", (void*)primitiveFFIFloatAtPut},
	{"X64Win64FFIPlugin", "primitiveFFIFree\000\001", (void*)primitiveFFIFree},
	{"X64Win64FFIPlugin", "primitiveFFIGetLastError\000\377", (void*)primitiveFFIGetLastError},
	{"X64Win64FFIPlugin", "primitiveFFIIntegerAt\000\001", (void*)primitiveFFIIntegerAt},
	{"X64Win64FFIPlugin", "primitiveFFIIntegerAtPut\000\001", (void*)primitiveFFIIntegerAtPut},
	{"X64Win64FFIPlugin", "primitiveForceLoad\000\002", (void*)primitiveForceLoad},
	{"X64Win64FFIPlugin", "primitiveLoadSymbolFromModule\000\002", (void*)primitiveLoadSymbolFromModule},
	{"X64Win64FFIPlugin", "primitiveLogCallsTo\000\000", (void*)primitiveLogCallsTo},
	{"X64Win64FFIPlugin", "primitiveSetManualSurfacePointer\000\000", (void*)primitiveSetManualSurfacePointer},
	{"X64Win64FFIPlugin", "setInterpreter", (void*)setInterpreter},
	{NULL, NULL, NULL}
};
