/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-nice.2763 uuid: 685e3e10-e9d5-4dab-acf0-188b5a543315 " __DATE__ ;
...
static const char *moduleName = "X64Win64FFIPlugin VMMaker.oscog-nice.2763 " INT_EXT;
...
/*	Answer if a struct result of a given size is returned in registers or not. */
	...
	/* ThreadedX64Win64FFIPlugin>>#canReturnInRegistersStructOfSize: */
static sqInt
...
/*	Set the return type to true if returning the struct via register */
	...
	/* ThreadedX64Win64FFIPlugin>>#encodeStructReturnTypeIn: */
static sqInt
encodeStructReturnTypeIn(CalloutState *calloutState)
{
	(calloutState->structReturnType = (((calloutState->structReturnSize)) <= WordSize)
...
ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass, CalloutState *calloutState)
{
	...
	l15:	/* end ffiValidateExternalData:AtomicType: */;
				if (failed()) {
					return null;
				}
				...
				if (ptrClass3 == (classExternalAddress())) {
					...
					if ((structSize <= WordSize)
					 && ((structSize & (structSize - 1)) == 0)) {
						memcpy((&arg), ptrAddress2, structSize);
...
#            endif /* COGMTVM */
						...
						if ((structSize1 <= WordSize)
						 && ((structSize1 & (structSize1 - 1)) == 0)) {
							memcpy((&arg1), ptrAddress2, structSize1);
							/* begin ffiPushUnsignedLongLong:in: */
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
			...
			if (includesBehaviorThatOf(oopClass, classExternalData())) {
				...
				if (ptrClass11 == (classExternalAddress())) {
					...
					if ((structSize2 <= WordSize)
					 && ((structSize2 & (structSize2 - 1)) == 0)) {
						memcpy((&arg2), ptrAddress1, structSize2);
						/* begin ffiPushUnsignedLongLong:in: */
						if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
							((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = arg2;
							(calloutState->floatRegisterIndex) = ((calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1);
						}
						else {
							if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
							...
							longAtput((calloutState->currentArg), arg2);
							(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
						}
						return 0;
					}
...
#            endif /* COGMTVM */
						...
						if ((structSize11 <= WordSize)
						 && ((structSize11 & (structSize11 - 1)) == 0)) {
							memcpy((&arg11), ptrAddress1, structSize11);
							/* begin ffiPushUnsignedLongLong:in: */
							if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
								((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = arg11;
								(calloutState->floatRegisterIndex) = ((calloutState->integerRegisterIndex) = ((calloutState->integerRegisterIndex)) + 1);
							}
							else {
								if ((((calloutState->currentArg)) + WordSize) > ((calloutState->limit))) {
								...
								longAtput((calloutState->currentArg), arg11);
								(calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
							}
							return 0;
						}
...
#                endif /* BytesPerWord == 8 */
	...
	l39:	/* end ffiValidateExternalData:AtomicType: */;
					}
					if (failed()) {
						err = null;
						goto l43;
...
#              endif /* COGMTVM */
	...
	l43:	/* end ffiArgument:Spec:Class:in: */;
		if (err != 0) {
			/* begin cleanupCalloutState: */
			while (((calloutState->stringArgIndex)) > 0) {
				free(((calloutState->stringArgs))[(calloutState->stringArgIndex = ((calloutState->stringArgIndex)) - 1)]);
...
static sqInt
ffiReturnStructofTypein(void *intRetPtr, sqInt ffiRetType, CalloutState *calloutState)
{
    sqInt oop;
    sqInt retClass;
    sqInt retOop;
...
;
		...
		result = result1;
	l44:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
...
#  else /* COGMTVM */
	...
	l86:	/* end ffiContentsOfHandle:errCode: */;
	if (failed()) {
		address2 = 0;
		goto l84;
	}
...
#      endif /* COGMTVM */
	...
	l70:	/* end ffiValidateExternalData:AtomicType: */;
					if (failed()) {
						err1 = null;
						goto l53;
					}
	...
	l47:	/* end ffiFloatValueOf: */;
					...
					if (atomicType121 == FFITypeSingleFloat) {
						...
						if (((calloutState1->floatRegisterIndex)) < NumFloatRegArgs) {
							...
							/* begin incrementFloatRegisterIndex */
							(calloutState1->floatRegisterSignature) = ((calloutState1->floatRegisterSignature)) + (1U << ((calloutState1->floatRegisterIndex)));
							(calloutState1->integerRegisterIndex) = ((calloutState1->floatRegisterIndex) = ((calloutState1->floatRegisterIndex)) + 1);
						}
						else {
							if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
								err1 = FFIErrorCallFrameTooBig;
...
#                endif /* BytesPerWord == 8 */
	...
	l87:	/* end ffiValidateExternalData:AtomicType: */;
					}
					if (failed()) {
						err1 = null;
						goto l53;
			...
			case FFIFlagStructure:
				...
				if (includesBehaviorThatOf(oopClass1, argClass1)) {
					...
					if (ptrClass31 == (classExternalAddress())) {
						...
						if ((structSize3 <= WordSize)
						 && ((structSize3 & (structSize3 - 1)) == 0)) {
							memcpy((&arg3), ptrAddress21, structSize3);
							/* begin ffiPushUnsignedLongLong:in: */
							if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
								((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = arg3;
								(calloutState1->floatRegisterIndex) = ((calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1);
							}
							else {
								if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
								...
								longAtput((calloutState1->currentArg), arg3);
								(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
							}
							err1 = 0;
							goto l53;
...
#              endif /* COGMTVM */
							...
							if ((structSize12 <= WordSize)
							 && ((structSize12 & (structSize12 - 1)) == 0)) {
								memcpy((&arg12), ptrAddress21, structSize12);
								/* begin ffiPushUnsignedLongLong:in: */
								if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
									((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = arg12;
									(calloutState1->floatRegisterIndex) = ((calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1);
								}
								else {
									if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
									...
									longAtput((calloutState1->currentArg), arg12);
									(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
								}
								err1 = 0;
								goto l53;
				...
				if (includesBehaviorThatOf(oopClass1, classExternalData())) {
					...
					if (ptrClass111 == (classExternalAddress())) {
						...
						if ((structSize21 <= WordSize)
						 && ((structSize21 & (structSize21 - 1)) == 0)) {
							memcpy((&arg21), ptrAddress11, structSize21);
							/* begin ffiPushUnsignedLongLong:in: */
							if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
								((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = arg21;
								(calloutState1->floatRegisterIndex) = ((calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1);
							}
							else {
								if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
								...
								longAtput((calloutState1->currentArg), arg21);
								(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
							}
							err1 = 0;
							goto l53;
...
#              endif /* COGMTVM */
							...
							if ((structSize111 <= WordSize)
							 && ((structSize111 & (structSize111 - 1)) == 0)) {
								memcpy((&arg111), ptrAddress11, structSize111);
								/* begin ffiPushUnsignedLongLong:in: */
								if (((calloutState1->integerRegisterIndex)) < NumIntRegArgs) {
									((calloutState1->integerRegisters))[(calloutState1->integerRegisterIndex)] = arg111;
									(calloutState1->floatRegisterIndex) = ((calloutState1->integerRegisterIndex) = ((calloutState1->integerRegisterIndex)) + 1);
								}
								else {
									if ((((calloutState1->currentArg)) + WordSize) > ((calloutState1->limit))) {
									...
									longAtput((calloutState1->currentArg), arg111);
									(calloutState1->currentArg = ((calloutState1->currentArg)) + WordSize);
								}
								err1 = 0;
								goto l53;
	...
	l53:	/* end ffiArgument:Spec:Class:in: */;
		if (err1 != 0) {
			/* begin cleanupCalloutState: */
			while (((calloutState1->stringArgIndex)) > 0) {
				free(((calloutState1->stringArgs))[(calloutState1->stringArgIndex = ((calloutState1->stringArgIndex)) - 1)]);
...
;
	...
	l57:	/* end ffiCalloutTo:SpecOnStack:in: */;
...
;
	...
	l88:	/* end ffiCall:ArgArrayOrNil:NumArgs: */;
#  endif /* COGMTVM */
	return;
}
