/* Automatically generated by
   ...
   from
	ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3456 uuid: e316760f-1758-4b6b-aa08-f84bc7c44ef3
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3456 uuid: e316760f-1758-4b6b-aa08-f84bc7c44ef3 " __DATE__ ;
...
static const char *moduleName = "RiscV64FFIPlugin VMMaker.oscog-eem.3456 " INT_EXT;
		...
		if (atomicType == FFITypeSingleFloat) {
			...
			if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
				...
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					storeSingleFloatAtPointerfrom((&(((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)])), valueFloat);
					(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
				}
				else {
					if ((((calloutState->currentArg)) + BytesPerWord) > ((calloutState->limit))) {
					...
					longAtput((calloutState->currentArg), valueFloat);
					(calloutState->currentArg = ((calloutState->currentArg)) + BytesPerWord);
				}
			}
			return 0;
