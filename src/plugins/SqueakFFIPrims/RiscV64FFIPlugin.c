/* Automatically generated by
   ...
   from
	ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3254 uuid: 3b74b441-2801-46f6-ae88-40b662719aed
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3254 uuid: 3b74b441-2801-46f6-ae88-40b662719aed " __DATE__ ;
...
static const char *moduleName = "RiscV64FFIPlugin VMMaker.oscog-eem.3254 " INT_EXT;
...
#    endif
		...
		if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
			...
			ownVM(myThreadIndex);
			result1 = floatObjectOf(doubleRet);
			goto l9;
		}
		if (((((calloutState->ffiRetHeader)) & (FFIFlagPointer + FFIFlagStructure)) == FFIFlagStructure)
...
#  endif
	...
	if ((((usqInt)(atomicType2)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
		if (atomicType2 == FFITypeDoubleFloat) {
			doubleRet1 = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3], ((calloutState1->integerRegisters))[4], ((calloutState1->integerRegisters))[5], ((calloutState1->integerRegisters))[6], ((calloutState1->integerRegisters))[7]);
		}
		else {
			doubleRet1 = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address2))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3], ((calloutState1->integerRegisters))[4], ((calloutState1->integerRegisters))[5], ((calloutState1->integerRegisters))[6], ((calloutState1->integerRegisters))[7]);
		}
		if (isCalleePopsConvention((calloutState1->callFlags))) {
			setsp((calloutState1->argVector));
		}
		ownVM(myThreadIndex1);
		result2 = floatObjectOf(doubleRet1);
		goto l17;
	}
