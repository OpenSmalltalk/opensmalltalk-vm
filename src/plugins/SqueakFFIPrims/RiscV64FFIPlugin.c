/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3208 uuid: 6d9f20e5-9014-4529-89d7-edfe6fb1cab2
   from
	ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3208 uuid: 6d9f20e5-9014-4529-89d7-edfe6fb1cab2
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3208 uuid: 6d9f20e5-9014-4529-89d7-edfe6fb1cab2 " __DATE__ ;
...
#define PluginVersionInfo " VMMaker.oscog-eem.3208"
...
static sqInt numFloatRegArgs(void);
static sqInt numIntRegArgs(void);
...
static const char *moduleName = "RiscV64FFIPlugin VMMaker.oscog-eem.3208 " INT_EXT;
...
/*	Generic callout. Does the actual work. If argArrayOrNil is nil it takes
	...
	/* ThreadedRiscV64FFIPlugin>>#ffiCall:ArgArrayOrNil:NumArgs: */
static sqInt
...
/*	Answer if a struct returned in memory is returned to the
	...
	/* ThreadedRiscV64FFIPlugin>>#nonRegisterStructReturnIsViaImplicitFirstArgument */
static sqInt
nonRegisterStructReturnIsViaImplicitFirstArgument(void)
{
	...
	/* ThreadedRiscV64FFIPlugin>>#numFloatRegArgs */
static sqInt
numFloatRegArgs(void)
{
	return NumFloatRegArgs;
}

	/* ThreadedRiscV64FFIPlugin>>#numIntRegArgs */
static sqInt
numIntRegArgs(void)
{
	return NumIntRegArgs;
}
...
#  endif
	...
	if (((((usqInt)(atomicType2)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1))
	 ...
	 && (structIsHomogenousFloatArrayOfSizetypeSpecofLength(((calloutState1->ffiRetHeader)) & FFIStructSizeMask, ((unsigned int *) (firstIndexableField((calloutState1->ffiRetSpec)))), ((specSize1 = byteSizeOf((calloutState1->ffiRetSpec)))) / (sizeof(unsigned int)))))) {
		...
		ffiRetType2 = fetchPointerofObject(0, argTypes3);
		retClass3 = fetchPointerofObject(1, ffiRetType2);
	...
	l14:	/* end ffiReturnCStringFrom: */;
		...
		longLongRetPtr11 = ((calloutState1->structReturnType)
			...
			: (calloutState1->limit));
		/* begin ffiReturnType: */
		specLiteral21 = (null != null
			? stackValue(1)
			: literalofMethod(0, primitiveMethod()));
		argTypes21 = fetchPointerofObject(ExternalFunctionArgTypesIndex, specLiteral21);
		ffiRetType11 = fetchPointerofObject(0, argTypes21);
		retClass21 = fetchPointerofObject(1, ffiRetType11);
	...
	if (atomicType2 <= FFITypeSignedInt32) {
		...
		if (((atomicType2 & 1) != 0)) {
			/* begin signedMachineIntegerFor: */
			result2 = (BytesPerWord == 8
				? signed64BitIntegerFor(((sqIntptr_t) intRet1))
				: signed32BitIntegerFor(((sqIntptr_t) intRet1)));
		}
		else {
			/* begin positiveMachineIntegerFor: */
			result2 = (BytesPerWord == 8
				? positive64BitIntegerFor(((usqIntptr_t) intRet1))
				: positive32BitIntegerFor(((usqIntptr_t) intRet1)));
		}
		goto l13;
	}
