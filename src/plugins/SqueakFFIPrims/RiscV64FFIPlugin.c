/* Automatically generated by
	VMPluginCodeGenerator * VMMaker.oscog-eem.3201 uuid: eeca3935-f3e3-4c20-943f-14c88ff73857
   from
	ThreadedRiscV64FFIPlugin * VMMaker.oscog-eem.3201 uuid: eeca3935-f3e3-4c20-943f-14c88ff73857
@@@KenD -- ffiCallArgArrayOrNilNumArgs() hacked for float returns @@@
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin * VMMaker.oscog-eem.3201 uuid: eeca3935-f3e3-4c20-943f-14c88ff73857 " __DATE__ ;
...
#define PluginVersionInfo " * VMMaker.oscog-eem.3201"
...
static const char *moduleName = "RiscV64FFIPlugin * VMMaker.oscog-eem.3201 " INT_EXT;
...
ffiCallArgArrayOrNilNumArgs(sqInt externalFunction, sqInt argArrayOrNil, sqInt nArgs)
{
    ...
    float someFloat; double someDouble;  /* @@KenD@@ */
    sqInt functionName;
    sqInt i;
    sqInt i1;
    usqLong intRet;
...
#  endif
	...
	if (atomicType == FFITypeDoubleFloat) {
		...
		ownVM(myThreadIndex);
		result = floatObjectOf(someDouble);
		goto l10;
	}
	else if (atomicType == FFITypeSingleFloat) {

	  	(someFloat = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address))), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5], ((calloutState->integerRegisters))[6], ((calloutState->integerRegisters))[7]));
		if (isCalleePopsConvention((calloutState->callFlags))) {
			setsp((calloutState->argVector));
		}
		ownVM(myThreadIndex);
		result = floatObjectOf(someFloat);
		goto l10;
	} else  if (((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1))
