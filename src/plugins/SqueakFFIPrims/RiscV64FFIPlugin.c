/* Automatically generated by
	...
	(Compiler-ct.530)
   from
	ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3743 uuid: 563aff1c-0a1c-4d13-a505-99bf04b107a9
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3743 uuid: 563aff1c-0a1c-4d13-a505-99bf04b107a9 " __DATE__ ;
...
static const char *moduleName = "RiscV64FFIPlugin VMMaker.oscog-eem.3743 " INT_EXT;
static sqInt nilObj;
#if !COGMTVM
		...
		if (atomicType == FFITypeSingleFloat) {
			...
			if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
				...
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					singleFloatAtput((&(((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)])),valueFloat);
					(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
				}
				else {
					if ((((calloutState->currentArg)) + BytesPerWord) > ((calloutState->limit))) {
			...
			if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
				...
				/* Use integer register if available */
				if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					floatAtput((&(((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)])),floatValue);
					(calloutState->integerRegisterIndex = ((calloutState->integerRegisterIndex)) + 1);
				}
				else {
					if ((((calloutState->currentArg)) + BytesPerWord) > ((calloutState->limit))) {
...
l5:
	...
	if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
		if (atomicType == FFITypeDoubleFloat) {
			doubleRet = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5], ((calloutState->integerRegisters))[6], ((calloutState->integerRegisters))[7]);
		}
		else {
			doubleRet = dispatchFunctionPointerwithwithwithwithwithwithwithwith(((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3], ((calloutState->integerRegisters))[4], ((calloutState->integerRegisters))[5], ((calloutState->integerRegisters))[6], ((calloutState->integerRegisters))[7]);
		}
