/* Automatically generated by
   ...
   from
	ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3216 uuid: 6a3c37f5-cdcd-4eda-874c-cd4ea7f427a2
 */
static char __buildInfo[] = "ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3216 uuid: 6a3c37f5-cdcd-4eda-874c-cd4ea7f427a2 " __DATE__ ;
...
static const char *moduleName = "RiscV64FFIPlugin VMMaker.oscog-eem.3216 " INT_EXT;
...
#    endif // BytesPerWord == 8
	...
	if (atomicType == FFITypeSingleFloat) {
		...
		if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
			...
			longAtput((calloutState->currentArg), -1);
