/* Automatically generated by
   ...
   from
	ThreadedARM32FFIPlugin VMMaker.oscog-eem.3077 uuid: 8ad52133-62f2-4e1e-bf92-9b29ba104d62
 */
static char __buildInfo[] = "ThreadedARM32FFIPlugin VMMaker.oscog-eem.3077 uuid: 8ad52133-62f2-4e1e-bf92-9b29ba104d62 " __DATE__ ;
...
static const char *moduleName = "ARM32FFIPlugin VMMaker.oscog-eem.3077 " INT_EXT;
...
#    if BytesPerWord == 8
		...
		case 1:
			if (((calloutState->integerRegisterIndex)) < (NumIntRegArgs - 1)) {
				...
				((calloutState->integerRegisters))[((calloutState->integerRegisterIndex)) + 1] = (((usqInt) (((usqInt)(intValue)) >> 32)));
				...
				longAtput(((calloutState->currentArg)) + BytesPerWord, ((usqInt) (((usqInt)(intValue)) >> 32)));
