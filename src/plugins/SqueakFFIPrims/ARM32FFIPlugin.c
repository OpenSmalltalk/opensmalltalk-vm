/* Automatically generated by
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscog-eem.2040 uuid: 5c1c9278-c66a-4508-8b7c-fb1b0c8b3e46
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-eem.2040 uuid: 5c1c9278-c66a-4508-8b7c-fb1b0c8b3e46 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-eem.2040 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.2040 (e)"
#endif
;
		...
		if (((calloutState->ffiArgHeader)) & FFIFlagAtomic) {
			...
			if (isStruct) {
				...
				if (atomicType != FFITypeVoid) {
					...
					err = 0;
				l6:	/* end ffiValidateExternalData:AtomicType: */;
					if (err != 0) {
						return err;
					}
				}
				...
				if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedChar) >> 1)) {
					...
					if (isString) {
						...
						pointer6 = ((char *) (firstIndexableField(oop)));
				 ...
				 || ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSignedByte) >> 1))) {
					...
					if (isString
					 || (oopClass == (classByteArray()))) {
						...
						/* begin ffiPushPointer:in: */
						pointer = ((void *) (firstIndexableField(oop)));
						if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
					...
					if (oopClass == (classExternalAddress())) {
						/* begin ffiPushPointer:in: */
						pointer1 = ((void *) (longAt(oop + BaseHeaderSize)));
						if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
