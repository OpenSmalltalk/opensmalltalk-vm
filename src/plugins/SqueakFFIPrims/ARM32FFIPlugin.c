/* Automatically generated by
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscog-eem.2381 uuid: c8fa6961-f14a-4115-aa4c-f445c5f51e6f
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-eem.2381 uuid: c8fa6961-f14a-4115-aa4c-f445c5f51e6f " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-eem.2381 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.2381 (e)"
#endif
;
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop1), (((calloutState->structReturnSize)) <= 4
			? (&intRet)
...
#  endif /* COGMTVM */
	...
	if ((((calloutState->structReturnSize)) > 0)
	 && (1
	 && (!(((calloutState->structReturnSize)) <= 4)))) {
		/* begin ffiPushPointer:in: */
...
#endif /* SPURVM */
;
	memcpy(firstIndexableField(oop), (((calloutState->structReturnSize)) <= 4
		? (&longLongRet)
		: (calloutState->limit)), (calloutState->structReturnSize));
	storePointerofObjectwithValue(0, retOop, oop);
	return retOop;
...
#  endif /* COGMTVM */
	...
	if ((((calloutState1->structReturnSize)) > 0)
	 && (1
	 && (!(((calloutState1->structReturnSize)) <= 4)))) {
		/* begin ffiPushPointer:in: */
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop11), (((calloutState1->structReturnSize)) <= 4
			? (&intRet1)
