/* Automatically generated by
	...
	(Compiler-ct.530)
   from
	ThreadedARM32FFIPlugin VMMaker.oscog-eem.3751 uuid: 0c3bc24b-dd7e-4a46-9550-0ea7c9999b3a
 */
static char __buildInfo[] = "ThreadedARM32FFIPlugin VMMaker.oscog-eem.3751 uuid: 0c3bc24b-dd7e-4a46-9550-0ea7c9999b3a " __DATE__ ;
...
static const char *moduleName = "ARM32FFIPlugin VMMaker.oscog-eem.3751 " INT_EXT;
static sqInt nilObj;
#if !COGMTVM
		...
		if (atomicType == FFITypeSingleFloat) {
			...
			if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
				if (((calloutState->backfillFloatRegisterIndex)) > 0) {
					((calloutState->floatRegisters))[(calloutState->backfillFloatRegisterIndex)] = valueFloat;
					(calloutState->backfillFloatRegisterIndex = 0);
				}
				else {
					((calloutState->floatRegisters))[(calloutState->floatRegisterIndex)] = valueFloat;
...
l5:
	...
	if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
		if (atomicType == FFITypeSingleFloat) {
			floatRet = dispatchFunctionPointerwithwithwithwith(((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
		}
		else {
			floatRet = dispatchFunctionPointerwithwithwithwith(((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
		}
 ...
 || (isCharacterAtomicType((calloutState->errorResultType)))))));
	...
	intRet = dispatchFunctionPointerwithwithwithwith(((usqIntptr_t (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
 ...
 || (isCharacterAtomicType((calloutState->errorResultType)))))));
...
#endif /* SPURVM */
		memcpy(firstIndexableField(oopSqInt), ((calloutState->structReturnType)
				? (&intRet)
	...
	if (atomicType <= FFITypeSignedInt32) {
		...
		if (atomicType <= FFITypeSignedInt16) {
			...
			/* # of significant bits */
			shiftSqInt = (((usqInt)(atomicType)) >> 1) * 8;
...
l7:
	...
	if (((((calloutState->callFlags)) & FFICallFlagExternalFunctionHasErrorReaper) != 0)) {
		...
		if (((calloutState->errorResultType)) <= FFITypeSignedInt32) {
			/* these are all generall integer returns */
			if (((calloutState->errorResultType)) <= FFITypeSignedInt16) {
				/* byte/short(/int). first extract partial word, then sign extend */

				/* # of significant bits */
				shift = (((usqInt)(((calloutState->errorResultType)))) >> 1) * 8;
				...
				resultOop = (((((calloutState->errorResultType)) & 1) != 0)
							? signed32BitIntegerFor((calloutState->errorResult))
							: positive32BitIntegerFor((calloutState->errorResult)));
			}
		}
		else {
			resultOop = (((((calloutState->errorResultType)) & 1) != 0)
