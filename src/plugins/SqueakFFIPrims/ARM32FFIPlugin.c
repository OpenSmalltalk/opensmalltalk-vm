...
<<<<<<< HEAD
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscog-eem.2039 uuid: 78dde0e7-e826-47ad-b2ef-4a8aff88b963
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-eem.2039 uuid: 78dde0e7-e826-47ad-b2ef-4a8aff88b963 " __DATE__ ;
=======
	VMPluginCodeGenerator VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff
   from
	ThreadedARMFFIPlugin VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-nice.2038 uuid: f98d3e8c-e81d-fb42-b790-8e514777bfff " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
<<<<<<< HEAD
	"ARM32FFIPlugin VMMaker.oscog-eem.2039 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.2039 (e)"
=======
	"ARM32FFIPlugin VMMaker.oscog-nice.2038 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-nice.2038 (e)"
>>>>>>> 3a6a4e05ed7fe09f6f6702bc8207059f88b3c7a5
#endif
;
...
#  endif /* COGMTVM */
	...
	if ((((usqInt) atomicType2) >> 1) == (((usqInt) FFITypeSingleFloat) >> 1)) {
		if (atomicType2 == FFITypeSingleFloat) {
			floatRet1 = dispatchFunctionPointerwithwithwithwith(((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
		}
		else {

			/* atomicType = FFITypeDoubleFloat */
			floatRet1 = dispatchFunctionPointerwithwithwithwith(((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
		}
...
#    endif /* COGMTVM */
	...
	/* undo any callee argument pops because it may confuse stack management with the alloca. */
	intRet1 = dispatchFunctionPointerwithwithwithwith(((usqIntptr_t (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t)) (((void *) address1))), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	if (isCalleePopsConvention((calloutState1->callFlags))) {
		setsp((calloutState1->argVector));
	}
	/* begin maybeOwnVM:threadIndex: */
