/* Automatically generated by
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscog-eem.1064 uuid: 9d9d2583-03e6-4b6b-9b24-51587933f8f3
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-eem.1064 uuid: 9d9d2583-03e6-4b6b-9b24-51587933f8f3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-eem.1064 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.1064 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if (((calloutState->ffiRetHeader)) & FFIFlagPointer) {
		...
		if (((calloutState->ffiRetHeader)) & FFIFlagStructure) {
			classOop = classByteArray();
		}
		else {
			classOop = classExternalAddress();
		}
...
#      endif /* COGMTVM */
	...
	for (i = 1; i <= nArgs; i += 1) {
		...
		argSpec = fetchPointerofObject(0, argType);
		argClass = fetchPointerofObject(1, argType);
		if (argArrayOrNil == null) {
			oop = stackValue(nArgs - i);
		}
		else {
			oop = fetchPointerofObject(i - 1, argArrayOrNil);
		}
...
#  endif /* COGMTVM */
	...
	atomicType = ((usqInt) (typeSpec & FFIAtomicTypeMask)) >> FFIAtomicTypeShift;
	if (atomicType == FFITypeSingleFloat) {
		floatRet = dispatchFunctionPointerwithwithwithwith(((float (*)(int, int, int, int)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
	if (atomicType == FFITypeDoubleFloat) {
		floatRet = dispatchFunctionPointerwithwithwithwith(((double (*)(int, int, int, int)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
	else {
		intRet = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(int, int, int, int)) address), ((calloutState->integerRegisters))[0], ((calloutState->integerRegisters))[1], ((calloutState->integerRegisters))[2], ((calloutState->integerRegisters))[3]);
	}
	if (isCalleePopsConvention((calloutState->callFlags))) {
		setsp((calloutState->argVector));
	}
...
#    endif /* COGMTVM */
		...
		if ((longAt(oop + BaseHeaderSize)) > 0) {
			ptrAddress = (oop + BaseHeaderSize) + BytesPerOop;
		}
		else {
			ptrAddress = longAt((oop + BaseHeaderSize) + BytesPerOop);
		}
		/* begin ffiPushPointer:in: */
		if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
			((calloutState->integerRegisters))[(calloutState->integerRegisterIndex)] = ptrAddress;
...
#        endif /* COGMTVM */
		...
		for (i = 1; i <= nArgs; i += 1) {
			...
			if (null == null) {
				...
				oop = fetchPointerofObject(i - 1, null);
			}
			err = ffiArgumentSpecClassin(oop, argSpec, argClass, calloutState);
			if (err != 0) {
				/* begin cleanupCalloutState: */
...
#  endif /* COGMTVM */
	...
	if (requiredStackSize1 < 0) {
		stackSize1 = DefaultMaxStackSize;
	}
	else {
		stackSize1 = requiredStackSize1;
	}
	null;
...
#      endif /* COGMTVM */
	...
	for (i1 = 1; i1 <= nArgs1; i1 += 1) {
		...
		argClass1 = fetchPointerofObject(1, argType1);
		if (null == null) {
			oop1 = stackValue(nArgs1 - i1);
		}
		else {
			oop1 = fetchPointerofObject(i1 - 1, null);
		}
...
#  endif /* COGMTVM */
	...
	if (atomicType2 == FFITypeSingleFloat) {
		floatRet1 = dispatchFunctionPointerwithwithwithwith(((float (*)(int, int, int, int)) address2), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
	if (atomicType2 == FFITypeDoubleFloat) {
		floatRet1 = dispatchFunctionPointerwithwithwithwith(((double (*)(int, int, int, int)) address2), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
	else {
		intRet1 = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(int, int, int, int)) address2), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
...
#  endif /* COGMTVM */
	...
	if (((calloutState1->ffiRetHeader)) & FFIFlagPointer) {
		...
		if (((calloutState1->ffiRetHeader)) & FFIFlagStructure) {
			classOop1 = classByteArray();
		}
		else {
			classOop1 = classExternalAddress();
		}
...
#      endif /* COGMTVM */
	...
	for (i1 = 1; i1 <= nArgs; i1 += 1) {
		...
		argClass1 = fetchPointerofObject(1, argType1);
		if (argArray == null) {
			oop1 = stackValue(nArgs - i1);
		}
		else {
			oop1 = fetchPointerofObject(i1 - 1, argArray);
		}
		err1 = ffiArgumentSpecClassin(oop1, argSpec1, argClass1, calloutState1);
		if (err1 != 0) {
			/* begin cleanupCalloutState: */
...
void* ARM32FFIPlugin_exports[][3] = {
	...
	{"ARM32FFIPlugin", "primitiveCallout\000\003", (void*)primitiveCallout},
...
signed char primitiveCalloutAccessorDepth = 3;
