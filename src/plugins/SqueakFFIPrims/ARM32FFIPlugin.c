/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.957 uuid: ac5f8308-02e5-4277-b28c-595b7a4cf34a
   from
	ThreadedARMFFIPlugin VMMaker.oscog-eem.957 uuid: ac5f8308-02e5-4277-b28c-595b7a4cf34a
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-eem.957 uuid: ac5f8308-02e5-4277-b28c-595b7a4cf34a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-eem.957 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.957 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if (atomicType2 == FFITypeSingleFloat) {
		floatRet1 = dispatchFunctionPointerwithwithwithwith(((float (*)(int, int, int, int)) address1), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
	if (atomicType2 == FFITypeDoubleFloat) {
		floatRet1 = dispatchFunctionPointerwithwithwithwith(((double (*)(int, int, int, int)) address1), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
	else {
		intRet1 = dispatchFunctionPointerwithwithwithwith(((usqLong (*)(int, int, int, int)) address1), ((calloutState1->integerRegisters))[0], ((calloutState1->integerRegisters))[1], ((calloutState1->integerRegisters))[2], ((calloutState1->integerRegisters))[3]);
	}
