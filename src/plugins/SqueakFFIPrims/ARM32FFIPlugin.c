/* Automatically generated by
   ...
   from
	ThreadedARMFFIPlugin VMMaker.oscog-rmacnak.1532 uuid: 20303656-4854-4e5b-8bcd-eeff8cf5d262
 */
static char __buildInfo[] = "ThreadedARMFFIPlugin VMMaker.oscog-rmacnak.1532 uuid: 20303656-4854-4e5b-8bcd-eeff8cf5d262 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-rmacnak.1532 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-rmacnak.1532 (e)"
#endif
;
...
ffiAddressOfstartingAtsize(sqInt rcvr, sqInt byteOffset, sqInt byteSize)
{
	...
	if (rcvrClass == (classExternalAddress())) {
		...
		flag("This needs more thought.  Instead of always allowing this couldn't we allow it only if the address is associated with a pinned object?");
		if (addr == 0) {

			/* or: [interpreterProxy isInMemory: addr] */
