/* Automatically generated by
   ...
   from
	ThreadedARM32FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322
 */
static char __buildInfo[] = "ThreadedARM32FFIPlugin VMMaker.oscog-eem.3310 uuid: ccb9d141-68dd-4a1a-86b9-906b72753322 " __DATE__ ;
...
static const char *moduleName = "ARM32FFIPlugin VMMaker.oscog-eem.3310 " INT_EXT;
...
#  endif // COGMTVM
	...
	if ((((calloutState1->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) == FFIFlagStructure) {
		...
		/* begin encodeStructReturnTypeIn: */
		(calloutState1->structReturnType = ((calloutState1->structReturnSize)) <= BytesPerWord);
	}
	err1 = 0;
...
#  endif
	...
	if (((((calloutState1->ffiRetHeader)) & (FFIFlagPointer + FFIFlagStructure)) != 0)) {
		...
		returnType1 = fetchPointerofObject(0, argTypes1);
		if (((((calloutState1->ffiRetHeader)) & FFIFlagPointer) != 0)) {
			/* begin ffiReturnPointer:ofType:in: */
			retClass2 = fetchPointerofObject(1, returnType1);
...
#endif /* SPURVM */
				storePointerofObjectwithValue(1, retOop2, returnType1);
				result2 = retOop2;
				goto l17;
			}
	...
	if (atomicType2 <= FFITypeSignedInt32) {
		...
		/* these are all generall integer returns */
		if (atomicType2 <= (FFITypeSignedInt16)) {
