/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3306 uuid: 27c1af08-8727-4513-81b1-28bcf6486cf1
   from
	CameraPlugin VMMaker.oscog-eem.3306 uuid: 27c1af08-8727-4513-81b1-28bcf6486cf1
 */
static char __buildInfo[] = "CameraPlugin VMMaker.oscog-eem.3306 uuid: 27c1af08-8727-4513-81b1-28bcf6486cf1 " __DATE__ ;
...
static const char *moduleName = "CameraPlugin VMMaker.oscog-eem.3306 " INT_EXT;
...
/*	If double-buffering is in effect (set via primSetCameraBuffers) answer
	...
	buffer has been filled yet, answer nil. Otherwise fail with an appropriate
	error code. */
...
primGetLatestBufferIndex(void)
{
	...
	result = CameraGetLatestBufferIndex(integerValueOf(cameraNum));
	if (result == null) {
...
primSetParam(void)
{
	...
	paramValue = (isIntegerObject(paramValue)
		? integerValueOf(paramValue)
...
void* CameraPlugin_exports[][3] = {
	...
	{(void*)_m, "primAcknowledgeFrame\000\000\000", (void*)primAcknowledgeFrame},
	...
	{(void*)_m, "primGetCameraSemaphore\000\000\000", (void*)primGetCameraSemaphore},
	{(void*)_m, "primGetFrame\000\001\000", (void*)primGetFrame},
	{(void*)_m, "primGetLatestBufferIndex\000\000\000", (void*)primGetLatestBufferIndex},
