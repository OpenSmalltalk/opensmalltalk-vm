/* Automatically generated by
   ...
   from
	Matrix2x3Plugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "Matrix2x3Plugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "Matrix2x3Plugin VMMaker.oscog-eem.3423 " INT_EXT;
...
primitiveComposeMatrix(void)
{
	...
	m2 = firstIndexableField(matrix1);
	...
	m1 = firstIndexableField(matrix2);
...
primitiveInvertPoint(void)
{
	...
	matrix = firstIndexableField(matrix1);
	l1:	/* end loadArgumentMatrix: */;
	if (failed()) {
		return null;
	}
