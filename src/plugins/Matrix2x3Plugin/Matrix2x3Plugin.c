...
/* Automatically generated by
   ...
   from
	Matrix2x3Plugin VMMaker-dtl.379 uuid: 08564677-5e9d-48d5-a63c-b53bd85489f3
 */
static char __buildInfo[] = "Matrix2x3Plugin VMMaker-dtl.379 uuid: 08564677-5e9d-48d5-a63c-b53bd85489f3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"Matrix2x3Plugin 27 March 2016 (i)"
#else
	"Matrix2x3Plugin 27 March 2016 (e)"
#endif
;
...
l1:	/* end loadArgumentMatrix: */;
	...
	if (!(interpreterProxy->failed())) {
		...
		m23ResultX += 0.5;
		m23ResultY += 0.5;
		if (!((m23ResultX >= (((double) -1073741824 ))) && (m23ResultX <= (((double) 0x3FFFFFFF ))))) {
			interpreterProxy->primitiveFail();
			goto l2;
		}
