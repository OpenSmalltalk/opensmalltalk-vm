/* Automatically generated by
   ...
   from
	SoundPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "SoundPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "SoundPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveSetDefaultSoundPlayerAccessorDepth = 0;
EXPORT(signed char) primitiveSetDefaultSoundRecorderAccessorDepth = 0;
EXPORT(signed char) primitiveSoundEnableAECAccessorDepth = 0;
EXPORT(signed char) primitiveSoundInsertSamplesAccessorDepth = 0;
EXPORT(signed char) primitiveSoundPlaySamplesAccessorDepth = 0;
EXPORT(signed char) primitiveSoundRecordSamplesAccessorDepth = 0;
EXPORT(signed char) primitiveSoundSetLeftVolumeAccessorDepth = 0;
EXPORT(signed char) primitiveSoundSetRecordLevelAccessorDepth = 0;
EXPORT(signed char) primitiveSoundStartAccessorDepth = 0;
EXPORT(signed char) primitiveSoundStartRecordingAccessorDepth = 0;
EXPORT(signed char) primitiveSoundStartWithSemaphoreAccessorDepth = 0;
