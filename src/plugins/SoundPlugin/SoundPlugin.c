/* Automatically generated by
   ...
   from
	SoundPlugin VMMaker.oscog-eem.2785 uuid: 9fa77ef1-7255-47f3-9dd1-c500f9529cbb
 */
static char __buildInfo[] = "SoundPlugin VMMaker.oscog-eem.2785 uuid: 9fa77ef1-7255-47f3-9dd1-c500f9529cbb " __DATE__ ;
...
static const char *moduleName = "SoundPlugin VMMaker.oscog-eem.2785 " INT_EXT;
...
primitiveSoundInsertSamples(void)
{
	...
	if (!(frameCount <= (slotSizeOf(((sqInt)(sqIntptr_t)(buf) - BaseHeaderSize))))) {
		return primitiveFailFor(PrimErrBadArgument);
	}
