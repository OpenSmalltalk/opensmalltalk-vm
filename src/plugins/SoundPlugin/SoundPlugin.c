/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2813 uuid: c2ac4e4a-d7a9-49ef-92b0-200a234f2dfa
   from
	SoundPlugin VMMaker.oscog-eem.2813 uuid: c2ac4e4a-d7a9-49ef-92b0-200a234f2dfa
 */
static char __buildInfo[] = "SoundPlugin VMMaker.oscog-eem.2813 uuid: c2ac4e4a-d7a9-49ef-92b0-200a234f2dfa " __DATE__ ;
...
static const char *moduleName = "SoundPlugin VMMaker.oscog-eem.2813 " INT_EXT;
...
primitiveSoundInsertSamples(void)
{
	...
	buf = ((char *) (firstIndexableField(stackValue(1))));
