...
EXPORT(signed char) primitiveConfstrAccessorDepth = 0;
...
EXPORT(signed char) primitiveFpathconfAccessorDepth = 1;
...
EXPORT(signed char) primitivePathconfAccessorDepth = 1;
...
EXPORT(signed char) primitiveSpaceForByteSizeInDirectoryPathAccessorDepth = 2;
...
EXPORT(signed char) primitiveSysconfAccessorDepth = 0;
