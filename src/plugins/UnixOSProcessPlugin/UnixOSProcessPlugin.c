/* Automatically generated by
   ...
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.80 uuid: fb31a85b-5735-4fa9-bd48-0449646a9200
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.80 uuid: fb31a85b-5735-4fa9-bd48-0449646a9200 " __DATE__ ;
...
static int isValidFileSession(sqInt objectPointer);
...
static const char *moduleName = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.80 " INT_EXT;
...
forwardSignaltoSemaphoreAt(sqInt sigNum, sqInt semaphoreIndex)
{
	...
	if (semaphoreIndex == 0) {
		...
		if ((semaIndices[sigNum]) != 0) {
			...
			return SIG_ERR /* begin sigErrorNumber */;
		}
	}
	if ((semaIndices[sigNum]) > 0) {
	...
	oldHandler = setSignalNumberhandler(sigNum, handleSignal /* begin handleSignalFunctionAddress */);
	if (oldHandler != SIG_ERR /* begin sigErrorNumber */) {
...
makePipeForReaderwriter(FILEHANDLETYPE *readerIOStreamPtr, FILEHANDLETYPE *writerIOStreamPtr)
{
	...
	setSignalNumberhandler(SIGPIPE /* begin sigPipeNumber */, SIG_IGN /* begin sigIgnoreNumber */);
	if ((pipe(filedes)) == -1) {
		/* Translates to a pipe() system call */
		return 0;
	}
...
primitiveConfstr(void)
{
	...
	buffer = ((char *) (firstIndexableField(bufferString)));
...
primitiveForwardSignalToSemaphore(void)
{
	...
	if (handler == SIG_ERR /* begin sigErrorNumber */) {
		primitiveFail();
		return;
	}
...
primitiveKillOnExit(void)
{
	...
	pidPointer = ((sqInt *) (firstIndexableField(pids)));
	count = 0;
	p = pidArray;
...
primitiveReapChildProcess(void)
{
	...
	if (pidResult <= 0) {
		...
		arrayPtr = ((sqInt *) (firstIndexableField(resultArray)));
		arrayPtr[0] = pid;
		arrayPtr[1] = status;
		pop(2);
		push(resultArray);
...
primitiveSendSigabrtTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGABRT /* begin sigAbrtNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigalrmTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGALRM /* begin sigAlrmNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigchldTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGCHLD /* begin sigChldNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigcontTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGCONT /* begin sigContNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSighupTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGHUP /* begin sigHupNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigintTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGINT /* begin sigIntNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigkillTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGKILL /* begin sigKillNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigpipeTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGPIPE /* begin sigPipeNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigquitTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGQUIT /* begin sigQuitNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigstopTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGSTOP /* begin sigStopNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigtermTo(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGTERM /* begin sigTermNumber */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigusr1To(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGUSR1 /* begin sigUsr1Number */);
			pop(2);
			pushInteger(result);
		}
		else {
...
primitiveSendSigusr2To(void)
{
	...
	if ((sandboxSecurity()) == 1) {
		...
		if (isIntegerObject(stackValue(0))) {
			pidToSignal = stackIntegerValue(0);
			result = kill(pidToSignal, SIGUSR2 /* begin sigUsr2Number */);
			pop(2);
			pushInteger(result);
		}
		else {
...
{
	pop(1);
	pushInteger(SIGCHLD /* begin sigChldNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGHUP /* begin sigHupNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGINT /* begin sigIntNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGKILL /* begin sigKillNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGPIPE /* begin sigPipeNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGQUIT /* begin sigQuitNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGTERM /* begin sigTermNumber */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGUSR1 /* begin sigUsr1Number */);
	return 0;
}
...
{
	pop(1);
	pushInteger(SIGUSR2 /* begin sigUsr2Number */);
	return 0;
}
...
#  if defined(SA_NOCLDSTOP)
	...
	if ((sigaction(SIGCHLD, (&sigchldHandlerAction), 0)) == (((sqInt)SIG_ERR /* begin sigErrorNumber */))) {
		perror("sigaction");
	}
...
{
	setSignalNumberhandler(SIGINT /* begin sigIntNumber */, SIG_DFL /* begin sigDefaultNumber */);
}
...
{
	setSignalNumberhandler(SIGINT /* begin sigIntNumber */, SIG_IGN /* begin sigIgnoreNumber */);
}
...
setSignalNumberhandler(sqInt signalNumber, void *signalHandlerAddress)
{
	...
	if ((sigaction(signalNumber, (&sigHandlerAction), (&oldHandlerAction))) == (((sqInt)SIG_ERR /* begin sigErrorNumber */))) {
		perror("signal");
	}
...
{
	setSignalNumberhandler(SIGPIPE /* begin sigPipeNumber */, SIG_DFL /* begin sigDefaultNumber */);
}
...
socketDescriptorFrom(sqInt sqSocketOop)
{
	...
	/* begin socketValueOf: */
	sqSocket = ((SocketPtr) (arrayValueOf(sqSocketOop)));
