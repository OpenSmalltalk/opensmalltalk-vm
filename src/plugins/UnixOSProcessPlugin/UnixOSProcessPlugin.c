/* Automatically generated by
   ...
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.70 uuid: dd0d175b-da76-4776-a015-bab0d0a4673e
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.70 uuid: dd0d175b-da76-4776-a015-bab0d0a4673e " __DATE__ ;
...
static const char *moduleName = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.70 " INT_EXT;
		...
		if (p == null) {
			...
			methodReturnValue((((index >= 1) && (index <= envCnt))
				? (/* begin cString:asCollection: */
					(len = strlen(p[index])),
					(newString = instantiateClassindexableSize(classIdentifier, len)),
					strncpy(arrayValueOf(newString), p[index], len),
					newString)
				: nilObject()));
		}
	}
