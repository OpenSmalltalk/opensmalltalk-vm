/* Automatically generated by
   ...
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-EstebanLorenzano.53 uuid: f04fa728-6d1a-4be1-ba20-f96a4675ae62
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-EstebanLorenzano.53 uuid: f04fa728-6d1a-4be1-ba20-f96a4675ae62 " __DATE__ ;
...
static usqInt fileRecordSize(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-EstebanLorenzano.53 (i)"
#else
	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-EstebanLorenzano.53 (e)"
#endif
;
...
{
    struct sigaction sigchldHandlerAction = {{0}};
...
{
    struct sigaction oldHandlerAction = {{0}};
    struct sigaction sigHandlerAction = {{0}};
