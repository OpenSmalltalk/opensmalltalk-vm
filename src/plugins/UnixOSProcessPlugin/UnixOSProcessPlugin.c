/* Smalltalk from Squeak4.4 with VMMaker 4.12.10 translated as C source on 21 December 2013 11:35:08 am */
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin 21 December 2013 (i)"
#else
	"UnixOSProcessPlugin 21 December 2013 (e)"
#endif
;
