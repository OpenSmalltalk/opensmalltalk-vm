...
#ifdef SQUEAK_BUILTIN_PLUGIN
static 	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-dtl.66 (i)";
#else
static 	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-dtl.66 (e)";
#endif
