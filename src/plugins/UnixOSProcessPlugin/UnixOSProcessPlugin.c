/* Smalltalk from Squeak4.5 with VMMaker 4.13.12 translated as C source on 11 June 2015 9:31:34 pm */
/* Automatically generated by
	VMPluginCodeGenerator * VMMaker-dtl.364 uuid: ac0e9055-b98d-402d-a5bc-dd2d2c7604de
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin-dtl.40 uuid: 33d728d1-1448-4f94-a0a9-e761308aac97
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin-dtl.40 uuid: 33d728d1-1448-4f94-a0a9-e761308aac97 " __DATE__ ;
...
/* D T Lewis - UnixOSProcessPlugin.c translated from class
   UnixOSProcessPlugin of OSProcessPlugin version 4.6.1 */
#include <sys/time.h>
#include <sys/wait.h>
#include <signal.h>
#include <unistd.h>
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin 11 June 2015 (i)"
#else
	"UnixOSProcessPlugin 11 June 2015 (e)"
#endif
;
...
static void dupToStdErr(sqInt anSQFileDataStructure) {
	...
	if (!((((interpreterProxy->isBytes(anSQFileDataStructure)) && ((interpreterProxy->byteSizeOf(anSQFileDataStructure)) == (sizeof(SQFile)))) && ((interpreterProxy->getThisSessionID()) == (sessionIdentifierFromSqFile(interpreterProxy->arrayValueOf(anSQFileDataStructure))))) && (isNonNullSQFile(anSQFileDataStructure)))) {
		filenoToDup = -1;
		goto l1;
	}
