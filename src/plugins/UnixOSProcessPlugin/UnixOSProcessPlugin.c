/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.1883 uuid: a87f979f-7e5b-44d1-804d-fc8403bde06d
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.53 uuid: 19679cb9-5840-4a5d-876f-a506bf70a1b6
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.53 uuid: 19679cb9-5840-4a5d-876f-a506bf70a1b6 " __DATE__ ;
...
static usqInt sizeOfInt(void);
static usqInt sizeOfPointer(void);
static sqInt sizeOfSession(void);
static int socketDescriptorFrom(sqInt sqSocketOop);
static usqInt socketRecordSize(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.53 (i)"
#else
	"UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.53 (e)"
#endif
;
