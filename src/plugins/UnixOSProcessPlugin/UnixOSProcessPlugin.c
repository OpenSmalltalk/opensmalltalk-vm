/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2868 uuid: ff18b9dd-739b-43c9-b4c1-a994d4da65b8
   from
	UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-dtl.72 uuid: 6d4fa432-7fde-4829-8832-ddad21ca21a3
 */
static char __buildInfo[] = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-dtl.72 uuid: 6d4fa432-7fde-4829-8832-ddad21ca21a3 " __DATE__ ;
...
static const char *moduleName = "UnixOSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-dtl.72 " INT_EXT;
	...
	if (!(failed())) {
		...
		if (p == null) {
			...
			methodReturnValue((((index >= 1) && (index <= envCnt))
				? (/* begin cString:asCollection: */
					(len = strlen(p[index - 1])),
					(newString = instantiateClassindexableSize(classIdentifier, len)),
					strncpy(arrayValueOf(newString), p[index - 1], len),
					newString)
				: nilObject()));
		}
	}
...
primitiveConfstr(void)
{
	...
	popthenPush(2, cStringasCollection(buffer, classString()));
	return 0;
}
...
primitiveFpathconf(void)
{
	...
	fd = fileno(fileHandleFrom(aSQFileByteArray));
	l1:	/* end fileDescriptorFrom: */;
	if (fd < 0) {
		return primitiveFailFor(PrimErrBadArgument);
	}
...
void* UnixOSProcessPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveConfstr\000\000", (void*)primitiveConfstr},
	...
	{(void*)_m, "primitiveFpathconf\000\001", (void*)primitiveFpathconf},
	...
	{(void*)_m, "primitivePathconf\000\001", (void*)primitivePathconf},
	...
	{(void*)_m, "primitiveSysconf\000\000", (void*)primitiveSysconf},
...
signed char primitiveFpathconfAccessorDepth = 1;
...
signed char primitivePathconfAccessorDepth = 1;
signed char primitivePutEnvAccessorDepth = 2;
signed char primitiveRealpathAccessorDepth = 0;
signed char primitiveRealpathAsBytesAccessorDepth = 0;
...
signed char primitiveSpaceForByteSizeInDirectoryPathAccessorDepth = 2;
...
signed char primitiveSysconfAccessorDepth = 0;
