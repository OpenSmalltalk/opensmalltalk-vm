/* Automatically generated by
   ...
   from
	SqueakSSLPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "SqueakSSLPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "SqueakSSL VMMaker.oscog-eem.3453 " INT_EXT;
...
primitiveAccept(void)
{
	...
	srcPtr = ((char *) (firstIndexableField(srcOop)));
	dstPtr = ((char *) (firstIndexableField(dstOop)));
...
primitiveGetStringProperty(void)
{
	...
	if (stringPtr == null) {
		...
		oopPtr = ((char *) (firstIndexableField(stringOop)));
