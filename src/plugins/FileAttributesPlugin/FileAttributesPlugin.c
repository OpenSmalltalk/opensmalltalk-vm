/* Automatically generated by
   ...
   from
	FileAttributesPlugin FileAttributesPlugin.oscog-eem.55 uuid: 21ffb1fc-12ba-4363-ab53-4f2168cb7450
 */
static char __buildInfo[] = "FileAttributesPlugin FileAttributesPlugin.oscog-eem.55 uuid: 21ffb1fc-12ba-4363-ab53-4f2168cb7450 " __DATE__ ;
...
static const char *moduleName = "FileAttributesPlugin FileAttributesPlugin.oscog-eem.55 " INT_EXT;
static void * sCLPfn;
static void * sCOFfn;
...
primitiveFileMasks(void)
{
	...
	masks = ((int *) (firstIndexableField(masksObj)));
	masks[0] = S_IFMT;
#  if defined(S_IFSOCK)
	masks[1] = S_IFSOCK;
#  endif
