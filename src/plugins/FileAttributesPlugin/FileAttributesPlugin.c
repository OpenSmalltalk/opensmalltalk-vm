/* Automatically generated by
   ...
   from
	FileAttributesPlugin FileAttributesPlugin.oscog-eem.64 uuid: 7d40fd5c-6db1-4e27-9c56-5ca0b0ce4e14
 */
static char __buildInfo[] = "FileAttributesPlugin FileAttributesPlugin.oscog-eem.64 uuid: 7d40fd5c-6db1-4e27-9c56-5ca0b0ce4e14 " __DATE__ ;
...
static const char *moduleName = "FileAttributesPlugin FileAttributesPlugin.oscog-eem.64 " INT_EXT;
static void * sCLPfn;
static void * sCOFfn;
...
attributeArrayformask(sqInt *attributeArrayPtr, fapath *faPath, sqInt attributeMask)
{
	...
	if (!(getStats
		...
		primitiveFailForOSError(-6 /* begin invalidArguments */);
		return -6 /* begin invalidArguments */;
	}
	...
	if (getStats) {
		...
		if (!attributeArray) {
			...
			return -15 /* begin interpreterError */;
		}
...
#  endif // HAVE_CHMOD
	...
	primitiveFailForOSError(-13 /* begin unsupportedOperation */);
	return 0;
}
...
primitiveClosedir(void)
{
	...
	if (!(faValidateSessionId((faPathPtr->sessionId)))) {
		return primitiveFailForOSError(-17 /* begin badSessionId */);
	}
...
primitiveFileAttribute(void)
{
	...
	if (resultOop == 0) {
		...
		primitiveFailForOSError(-14 /* begin unexpectedError */);
	}
	else {
...
primitiveOpendir(void)
{
	...
	if (!faPath) {
		return primitiveFailForOSError(-10 /* begin cantAllocateMemory */);
	}
	...
	if (!(canOpenDirectoryStreamForlength(faGetStPath(faPath), faGetStPathLen(faPath)))) {
		free(faPath);
		primitiveFailForOSError(-9 /* begin cantOpenDir */);
	}
	status = faOpenDirectory(faPath);
	if (status == 1 /* begin noMoreData */) {
		free(faPath);
		return methodReturnValue(nilObject());
	}
	if (status < 0) {
...
{
	return methodReturnInteger(FA_PATH_MAX /* begin faPathMax */);
}
...
{
	methodReturnString("2.0.9" /* begin versionString */);
	return 0;
}
...
processDirectory(fapath *faPath)
{
	...
	if (status != 0) {
		if (status == -3 /* begin cantStatPath */) {
...
void* FileAttributesPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveChangeMode\000\000\000", (void*)primitiveChangeMode},
	{(void*)_m, "primitiveChangeOwner\000\000\000", (void*)primitiveChangeOwner},
	{(void*)_m, "primitiveClosedir\000\001\000", (void*)primitiveClosedir},
	{(void*)_m, "primitiveFileAttribute\000\000\000", (void*)primitiveFileAttribute},
	{(void*)_m, "primitiveFileAttributes\000\000\000", (void*)primitiveFileAttributes},
	{(void*)_m, "primitiveFileExists\000\000\000", (void*)primitiveFileExists},
	{(void*)_m, "primitiveFileMasks\000\377\000", (void*)primitiveFileMasks},
	{(void*)_m, "primitiveLogicalDrives\000\377\000", (void*)primitiveLogicalDrives},
	{(void*)_m, "primitiveOpendir\000\000\000", (void*)primitiveOpendir},
	{(void*)_m, "primitivePathMax\000\377\000", (void*)primitivePathMax},
	{(void*)_m, "primitivePlatToStPath\000\000\000", (void*)primitivePlatToStPath},
	{(void*)_m, "primitiveReaddir\000\001\000", (void*)primitiveReaddir},
	{(void*)_m, "primitiveRewinddir\000\001\000", (void*)primitiveRewinddir},
	{(void*)_m, "primitiveStToPlatPath\000\000\000", (void*)primitiveStToPlatPath},
	{(void*)_m, "primitiveSymlinkChangeOwner\000\000\000", (void*)primitiveSymlinkChangeOwner},
