/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2762 uuid: 4c244387-7f00-429e-8c37-1524f9397177
   from
	SHA2Plugin CryptographyPlugins-ul.22 uuid: 1308f614-8494-46ef-bffd-21a70d1f8dee
 */
static char __buildInfo[] = "SHA2Plugin CryptographyPlugins-ul.22 uuid: 1308f614-8494-46ef-bffd-21a70d1f8dee " __DATE__ ;
...
static const char *moduleName = "SHA2Plugin CryptographyPlugins-ul.22 " INT_EXT;
...
/*4*/	4131703408338449720LL, 6480981068601479193LL, 10538285296894168987ULL, 12329834152419229976ULL,
...
/*16*/	16472876342353939154ULL, 17275323862435702243ULL, 1135362057144423861LL, 2597628984639134821LL,
...
/*44*/	15101387698204529176ULL, 15463397548674623760ULL, 17586052441742319658ULL, 1182934255886127544LL,
/*48*/	1847814050463011016LL, 2177327727835720531LL, 2830643537854262169LL, 3796741975233480872LL,
...
primitiveCopyDoubleWordsIntoBytesBigEndian(void)
{
	...
	target = ((unsigned long *) (((unsigned long long*) bytes)));
	if (VMBIGENDIAN) {
		memcpy(target, ((unsigned long *) doubleWords), doubleWordCount * 8);
	}
	else {
		for (i = 0; i < doubleWordCount; i += 1) {
			target[i] = (SQ_SWAP_8_BYTES(((((unsigned long *) doubleWords))[i])));
		}
	}
...
primitiveSHA512ProcessBufferUpdatingHash(void)
{
	...
	source = ((unsigned long *) (((unsigned long long*) buffer)));
	if (VMBIGENDIAN) {
		memcpy(((unsigned long *) w), source, 128);
	}
	else {
		for (i1 = 0; i1 < 16; i1 += 1) {
			(((unsigned long *) w))[i1] = (SQ_SWAP_8_BYTES((source[i1])));
		}
	}
...
void* SHA2Plugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCopyDoubleWordsIntoBytesBigEndian\000\001", (void*)primitiveCopyDoubleWordsIntoBytesBigEndian},
	{(void*)_m, "primitiveCopyWordsIntoBytesBigEndian\000\001", (void*)primitiveCopyWordsIntoBytesBigEndian},
	{(void*)_m, "primitiveIsPluginAvailable\000\377", (void*)primitiveIsPluginAvailable},
	{(void*)_m, "primitiveSHA256ProcessBufferUpdatingHash\000\001", (void*)primitiveSHA256ProcessBufferUpdatingHash},
	{(void*)_m, "primitiveSHA512ProcessBufferUpdatingHash\000\001", (void*)primitiveSHA512ProcessBufferUpdatingHash},
...
signed char primitiveCopyDoubleWordsIntoBytesBigEndianAccessorDepth = 1;
signed char primitiveCopyWordsIntoBytesBigEndianAccessorDepth = 1;
signed char primitiveSHA256ProcessBufferUpdatingHashAccessorDepth = 1;
signed char primitiveSHA512ProcessBufferUpdatingHashAccessorDepth = 1;
