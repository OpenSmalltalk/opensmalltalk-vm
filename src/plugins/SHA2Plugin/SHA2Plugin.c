...
EXPORT(signed char) primitiveCopyDoubleWordsIntoBytesBigEndianAccessorDepth = 1;
EXPORT(signed char) primitiveCopyWordsIntoBytesBigEndianAccessorDepth = 1;
EXPORT(signed char) primitiveSHA256ProcessBufferUpdatingHashAccessorDepth = 1;
EXPORT(signed char) primitiveSHA512ProcessBufferUpdatingHashAccessorDepth = 1;
