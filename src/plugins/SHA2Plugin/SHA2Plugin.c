/* Automatically generated by
	...
	(Compiler-ct.529)
   from
	SHA2Plugin CryptographyPlugins-eem.30 uuid: 53c9140e-9395-49f1-acb1-539c6fb29813
 */
static char __buildInfo[] = "SHA2Plugin CryptographyPlugins-eem.30 uuid: 53c9140e-9395-49f1-acb1-539c6fb29813 " __DATE__ ;
...
static const char *moduleName = "SHA2Plugin CryptographyPlugins-eem.30 " INT_EXT;
...
primitiveSHA256ProcessBufferUpdatingHash(void)
{
	...
	for (j = 16; j <= 0x3F; j += 1) {
		s01 = (((((usqInt)((w[j - 15]))) >> 7) | ((((usqInt)((w[j - 15])) << (25))))) ^ ((((usqInt)((w[j - 15]))) >> 18) | ((((usqInt)((w[j - 15])) << (14)))))) ^ (((usqInt)((w[j - 15]))) >> 3);
		s11 = (((((usqInt)((w[j - 2]))) >> 17) | ((((usqInt)((w[j - 2])) << (15))))) ^ ((((usqInt)((w[j - 2]))) >> 19) | ((((usqInt)((w[j - 2])) << (13)))))) ^ (((usqInt)((w[j - 2]))) >> 10);
...
primitiveSHA512ProcessBufferUpdatingHash(void)
{
	...
	for (j = 16; j <= 79; j += 1) {
		s01 = (((((w[j - 15])) >> 1) | (((w[j - 15]) << (0x3F)))) ^ ((((w[j - 15])) >> 8) | (((w[j - 15]) << (56))))) ^ (((w[j - 15])) >> 7);
		s11 = (((((w[j - 2])) >> 19) | (((w[j - 2]) << (45)))) ^ ((((w[j - 2])) >> 61) | (((w[j - 2]) << (3))))) ^ (((w[j - 2])) >> 6);
		w[j] = (((s01 + s11) + (w[j - 16])) + (w[j - 7]));
	}
	a = hash[0];
	b = hash[1];
...
void* SHA2Plugin_exports[][3] = {
	...
	{(void*)_m, "primitiveSHA512ProcessBufferUpdatingHash\000\001\003", (void*)primitiveSHA512ProcessBufferUpdatingHash},
