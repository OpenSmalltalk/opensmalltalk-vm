/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3066 uuid: 8db97a47-7e9e-4784-8cf2-db4fc404ed95
   from
	BitBltSimulation VMMaker.oscog-eem.3066 uuid: 8db97a47-7e9e-4784-8cf2-db4fc404ed95
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.3066 uuid: 8db97a47-7e9e-4784-8cf2-db4fc404ed95 " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-eem.3066 " INT_EXT;
...
void* BitBltPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCompareColors\000\002\000", (void*)primitiveCompareColors},
	{(void*)_m, "primitiveCopyBits\000\002\000", (void*)primitiveCopyBits},
	{(void*)_m, "primitiveDisplayString\000\002\000", (void*)primitiveDisplayString},
	...
	{(void*)_m, "primitiveWarpBits\000\002\000", (void*)primitiveWarpBits},
...
#if SPURVM
EXPORT(signed short) primitiveCompareColorsMetadata = 0x200;
EXPORT(signed short) primitiveCopyBitsMetadata = 0x200;
EXPORT(signed short) primitiveDisplayStringMetadata = 0x200;
EXPORT(signed short) primitiveDrawLoopMetadata = 0x300;
EXPORT(signed short) primitivePixelValueAtMetadata = 0x100;
EXPORT(signed short) primitiveWarpBitsMetadata = 0x200;
#endif // SPURVM
