/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-nice.3248 uuid: 230bfa37-4d77-4fa6-a944-f7a51bf9dc32
   from
	BitBltSimulation VMMaker.oscog-nice.3248 uuid: 230bfa37-4d77-4fa6-a944-f7a51bf9dc32
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-nice.3248 uuid: 230bfa37-4d77-4fa6-a944-f7a51bf9dc32 " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-nice.3248 " INT_EXT;
...
alphaBlendConstwithpaintMode(unsigned int sourceWord, unsigned int destinationWord, sqInt paintMode)
{
	...
	if (destPPW == 1) {
		...
		if (!(paintMode && (sourceWord == 0))) {
			...
			/* divide by 255 */
			blendRB = (((usqInt)(((((usqInt)(blendRB)) >> 8) + blendRB))) >> 8) & 0xFF00FF;
			blendAG = (((usqInt)(((((usqInt)(blendAG)) >> 8) + blendAG))) >> 8) & 0xFF00FF;
