/* Automatically generated by
   ...
   from
	BitBltSimulation VMMaker.oscog-eem.3408 uuid: 99ace54d-4adf-4a36-9064-0f4fe0bbaae2
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.3408 uuid: 99ace54d-4adf-4a36-9064-0f4fe0bbaae2 " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-eem.3408 " INT_EXT;
...
loadBitBltFromwarping(sqInt bbObj, sqInt aBool)
{
	...
	l5:	/* end loadBitBltSourceForm */;
		...
		if (isWords(cmOop)) {
			...
			cmShiftTable = ((sqInt) (firstIndexableField(mapOop)));
	l6:	/* end loadColorMapShiftOrMaskFrom:type: */;
			...
			cmMaskTable = ((sqInt) (firstIndexableField(mapOop1)));
