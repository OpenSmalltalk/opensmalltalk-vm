/* Automatically generated by
   ...
   from
	BitBltSimulation VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BitBltPlugin VMMaker.oscog-eem.222 (i)"
#else
	"BitBltPlugin VMMaker.oscog-eem.222 (e)"
#endif
;
...
fetchIntOrFloatofObject(sqInt fieldIndex, sqInt objectPointer)
{
	...
	if (interpreterProxy->isIntegerObject(fieldOop)) {
		return interpreterProxy->integerValueOf(fieldOop);
	}
...
loadBitBltDestForm(void)
{
	...
	if (interpreterProxy->isIntegerObject(destBits)) {

		/* Query for actual surface dimensions */

		if (!(queryDestSurface(interpreterProxy->integerValueOf(destBits)))) {
			return 0;
		}
...
l3:	/* end loadBitBltDestForm */;
	...
	if (noSource) {
		...
		if (interpreterProxy->isIntegerObject(fieldOop)) {
			sourceWidth = interpreterProxy->integerValueOf(fieldOop);
			goto l8;
		}
		floatValue = interpreterProxy->floatValueOf(fieldOop);
		if (!((-2.147483648e9 <= floatValue)
	...
	l8:	/* end fetchIntOrFloat:ofObject: */;
		...
		if (interpreterProxy->isIntegerObject(fieldOop1)) {
			sourceHeight = interpreterProxy->integerValueOf(fieldOop1);
			goto l9;
		}
	...
	l9:	/* end fetchIntOrFloat:ofObject: */;
		...
		if (interpreterProxy->isIntegerObject(sourceBits)) {

			/* Query for actual surface dimensions */

			if (!(querySourceSurface(interpreterProxy->integerValueOf(sourceBits)))) {
				ok = 0;
				goto l10;
			}
			sourcePPW = 32 / sourceDepth;
	...
	l10:	/* end loadBitBltSourceForm */;
		...
		if (interpreterProxy->isWords(cmOop)) {
			...
			if (interpreterProxy->isIntegerObject(mapOop)) {
				interpreterProxy->primitiveFail();
				cmShiftTable = ((void *) null);
				goto l6;
			}
		...
		l6:	/* end loadColorMapShiftOrMaskFrom: */;
			...
			if (interpreterProxy->isIntegerObject(mapOop1)) {
				interpreterProxy->primitiveFail();
				cmMaskTable = ((void *) null);
				goto l7;
			}
...
unlockSurfaces(void)
{
	...
	if (hasSurfaceLock) {
		...
		if (interpreterProxy->isIntegerObject(destHandle)) {
		...
		if (!noSource) {
			...
			if (interpreterProxy->isIntegerObject(sourceHandle)) {
...
warpLoop(void)
{
	...
	if (interpreterProxy->isIntegerObject(fieldOop)) {
		pAx = interpreterProxy->integerValueOf(fieldOop);
		goto l3;
	}
	floatValue = interpreterProxy->floatValueOf(fieldOop);
	if (!((-2.147483648e9 <= floatValue)
...
l3:	/* end fetchIntOrFloat:ofObject: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop1)) {
		words = interpreterProxy->integerValueOf(fieldOop1);
		goto l4;
	}
	floatValue1 = interpreterProxy->floatValueOf(fieldOop1);
	if (!((-2.147483648e9 <= floatValue1)
...
l5:	/* end deltaFrom:to:nSteps: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop2)) {
		pAy = interpreterProxy->integerValueOf(fieldOop2);
		goto l6;
	}
...
l6:	/* end fetchIntOrFloat:ofObject: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop3)) {
		words = interpreterProxy->integerValueOf(fieldOop3);
		goto l7;
	}
...
l8:	/* end deltaFrom:to:nSteps: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop4)) {
		pBx = interpreterProxy->integerValueOf(fieldOop4);
		goto l9;
	}
...
l9:	/* end fetchIntOrFloat:ofObject: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop5)) {
		words = interpreterProxy->integerValueOf(fieldOop5);
		goto l10;
	}
...
l11:	/* end deltaFrom:to:nSteps: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop6)) {
		pBy = interpreterProxy->integerValueOf(fieldOop6);
		goto l12;
	}
...
l12:	/* end fetchIntOrFloat:ofObject: */;
	...
	if (interpreterProxy->isIntegerObject(fieldOop7)) {
		words = interpreterProxy->integerValueOf(fieldOop7);
		goto l13;
	}
