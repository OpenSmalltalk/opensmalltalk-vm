/* Automatically generated by
   ...
   from
	BitBltSimulation VMMaker.oscog-eem.3002 uuid: 618f5960-8dbf-452c-8709-f8201ee6433b
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.3002 uuid: 618f5960-8dbf-452c-8709-f8201ee6433b " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-eem.3002 " INT_EXT;
...
alphaBlendConstwithpaintMode(unsigned int sourceWord, unsigned int destinationWord, sqInt paintMode)
{
	...
	if (destPPW == 1) {
		...
		if (!(paintMode && (sourceWord == 0))) {
			...
			blendRB = (((sourceWord & 0xFF00FF) * sourceAlpha) + ((destinationWord & 0xFF00FF) * unAlpha)) + 0xFF00FF;

			/* blendRB alpha and green */
			blendAG = ((((((usqInt)(sourceWord)) >> 8) & 0xFF00FF) * sourceAlpha) + (((((usqInt)(destinationWord)) >> 8) & 0xFF00FF) * unAlpha)) + 0xFF00FF;
...
alphaBlendScaledwith(unsigned int sourceWord, unsigned int destinationWord)
{
	...
	rb = ((((usqInt)(((destinationWord & 0xFF00FF) * unAlpha))) >> 8) & 0xFF00FF) + (sourceWord & 0xFF00FF);

	/* blend alpha and green components */
	ag = ((((usqInt)((((((usqInt)(destinationWord)) >> 8) & 0xFF00FF) * unAlpha))) >> 8) & 0xFF00FF) + ((((usqInt)(sourceWord)) >> 8) & 0xFF00FF);
...
alphaBlendUnscaledwith(unsigned int sourceWord, unsigned int destinationWord)
{
	...
	blendA = ((0xFF * alpha) + ((0xFF - alpha) * (((usqInt)(destinationWord)) >> 24))) + 0xFF;

	/* divide by 255 */
	blendA = (((usqInt)((blendA + ((((usqInt)((blendA - 1))) >> 8) & 0xFF)))) >> 8) & 0xFF;

	/* blend red and blue */
	blendRB = (((sourceWord & 0xFF00FF) * alpha) + ((destinationWord & 0xFF00FF) * (blendA - alpha))) / blendA;

	/* blend green */
	blendG = (((sourceWord & 0xFF00) * alpha) + ((destinationWord & 0xFF00) * (blendA - alpha))) / blendA;
	result = (blendRB | blendG) | (((usqInt)(blendA) << 24));
	return result;
}
...
alphaScalewith(unsigned int sourceWord, unsigned int destinationWord)
{
	...
	rb = (((usqInt)(((destinationWord & 0xFF00FF) * alpha))) >> 8) & 0xFF00FF;

	/* scale green component */
	g = (((usqInt)(((destinationWord & 0xFF00) * alpha))) >> 8) & 0xFF00;
		...
		while (((deltaX -= 1)) != 0) {
			...
			if (srcAlpha == 0xFF) {
				...
				if (!(srcAlpha == 0)) {
					...
					/* begin dither32To16:threshold: */
					addThreshold1 = (((sqInt)((usqInt)(ditherThreshold) << 8)));
...
alphaUnscalewith(unsigned int sourceWord, unsigned int destinationWord)
{
	...
	/* unscale red and blue components */
	rb = (((usqInt)((destinationWord & 0xFF00FF)) << 8)) / alpha;

	/* unscale green component */
	g = (destinationWord & 0xFF00) / alpha;
	carry = ((((usqInt)(((((usqInt)(rb)) >> 8) & 0xAA00AA))) >> 1) | (((usqInt)(((((usqInt)(rb)) >> 8) & 0x550055)) << 1))) | ((((usqInt)((g & 0xAA00))) >> 1) | (((usqInt)((g & 0x5500)) << 1)));
	carry = (((usqInt)((carry & 0xCCCCCC))) >> 2) | (((usqInt)((carry & 0x333333)) << 2));
	carry = (((usqInt)((carry & 0xF0F0F0))) >> 4) | (((usqInt)((carry & 0xF0F0F)) << 4));
	rgb = (rb & 0xFF00FF) | ((((usqInt)(g) << 8)) & 0xFF00);
 ...
 && (skew == 0))));
	...
	if (combinationRule == 3) {
		for (i = 1; i <= bbH; i += 1) {
			...
			if (nWords > 1) {
				destMask = mask2;
				if (((((skew < 0) ? (((usqInt)(skewMask)) >> (-skew)) : (((usqInt)(skewMask) << skew)))) & mask2) == 0) {
				...
				do {
					...
					if ((mapperFlags & ColorMapPresent) != 0) {
						if ((mapperFlags & ColorMapFixedPart) != 0) {
							...
							val = val | ((((((int) (cmShiftTable[1]))) < 0) ? (((usqInt)((sourcePix & (cmMaskTable[1])))) >> (-(((int) (cmShiftTable[1]))))) : (((sqInt)((usqInt)((sourcePix & (cmMaskTable[1]))) << (((int) (cmShiftTable[1]))))))));
							val = val | ((((((int) (cmShiftTable[2]))) < 0) ? (((usqInt)((sourcePix & (cmMaskTable[2])))) >> (-(((int) (cmShiftTable[2]))))) : (((sqInt)((usqInt)((sourcePix & (cmMaskTable[2]))) << (((int) (cmShiftTable[2]))))))));
							pv = val | ((((((int) (cmShiftTable[3]))) < 0) ? (((usqInt)((sourcePix & (cmMaskTable[3])))) >> (-(((int) (cmShiftTable[3]))))) : (((sqInt)((usqInt)((sourcePix & (cmMaskTable[3]))) << (((int) (cmShiftTable[3]))))))));
							if ((pv == 0)
							 && (sourcePix != 0)) {
								pv = 1;
							}
...
dither32To16threshold(unsigned int srcWord, sqInt ditherValue)
{
	...
	/* You bet */
	addThreshold = (((sqInt)((usqInt)(ditherValue) << 8)));
...
expensiveDither32To16threshold(unsigned int srcWord, sqInt ditherValue)
{
	...
	value = ditherValues16[(((usqInt)(pv)) >> 3)];
	if (ditherValue < threshold) {
		out = out | ((((sqInt)((usqInt)((value + 1)) << 5))));
	}
	else {
		out = out | ((((sqInt)((usqInt)(value) << 5))));
	}
	pv = ((((usqInt)(srcWord)) >> 16)) & 0xFF;
	threshold = ditherThresholds16[pv & 7];
	value = ditherValues16[(((usqInt)(pv)) >> 3)];
	if (ditherValue < threshold) {
		out = out | ((((sqInt)((usqInt)((value + 1)) << 10))));
	}
	else {
		out = out | ((((sqInt)((usqInt)(value) << 10))));
	}
	return out;
}
...
initDither8Lookup(void)
{
	...
	for (b = 0; b <= 0xFF; b += 1) {
		for (t = 0; t <= 15; t += 1) {
			...
			value1 = ditherValues16[(((usqInt)(pv)) >> 3)];
			if (t < threshold) {
				out = out | ((((sqInt)((usqInt)((value1 + 1)) << 5))));
			}
			else {
				out = out | ((((sqInt)((usqInt)(value1) << 5))));
			}
			pv = ((((usqInt)((((unsigned int) b)))) >> 16)) & 0xFF;
			threshold = ditherThresholds16[pv & 7];
			value1 = ditherValues16[(((usqInt)(pv)) >> 3)];
			if (t < threshold) {
				out = out | ((((sqInt)((usqInt)((value1 + 1)) << 10))));
			}
			else {
				out = out | ((((sqInt)((usqInt)(value1) << 10))));
			}
			value = out;
...
loadBitBltFromwarping(sqInt bbObj, sqInt aBool)
{
	...
	l8:	/* end loadColorMapShiftOrMaskFrom: */;
			...
			cmMaskTable = firstIndexableField(mapOop1);
...
mapPixelflags(sqInt sourcePixel, sqInt mapperFlags)
{
	...
	if ((mapperFlags & ColorMapPresent) != 0) {
		if ((mapperFlags & ColorMapFixedPart) != 0) {
			/* begin rgbMapPixel:flags: */
			val = (((((int) (cmShiftTable[0]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[0])))) >> (-(((int) (cmShiftTable[0]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[0]))) << (((int) (cmShiftTable[0])))))));
			val = val | ((((((int) (cmShiftTable[1]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[1])))) >> (-(((int) (cmShiftTable[1]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[1]))) << (((int) (cmShiftTable[1]))))))));
			val = val | ((((((int) (cmShiftTable[2]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[2])))) >> (-(((int) (cmShiftTable[2]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[2]))) << (((int) (cmShiftTable[2]))))))));
			pv = val | ((((((int) (cmShiftTable[3]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[3])))) >> (-(((int) (cmShiftTable[3]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[3]))) << (((int) (cmShiftTable[3]))))))));
			if ((pv == 0)
			 && (sourcePixel != 0)) {
				pv = 1;
			}
...
rgbMapPixelflags(sqInt sourcePixel, sqInt mapperFlags)
{
	...
	val = val | ((((((int) (cmShiftTable[1]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[1])))) >> (-(((int) (cmShiftTable[1]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[1]))) << (((int) (cmShiftTable[1]))))))));
	val = val | ((((((int) (cmShiftTable[2]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[2])))) >> (-(((int) (cmShiftTable[2]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[2]))) << (((int) (cmShiftTable[2]))))))));
	return val | ((((((int) (cmShiftTable[3]))) < 0) ? (((usqInt)((sourcePixel & (cmMaskTable[3])))) >> (-(((int) (cmShiftTable[3]))))) : (((sqInt)((usqInt)((sourcePixel & (cmMaskTable[3]))) << (((int) (cmShiftTable[3]))))))));
}
...
void* BitBltPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCompareColors\000\003\000", (void*)primitiveCompareColors},
	{(void*)_m, "primitiveCopyBits\000\003\000", (void*)primitiveCopyBits},
	{(void*)_m, "primitiveDisplayString\000\003\000", (void*)primitiveDisplayString},
	{(void*)_m, "primitiveDrawLoop\000\003\000", (void*)primitiveDrawLoop},
	{(void*)_m, "primitivePixelValueAt\000\001\000", (void*)primitivePixelValueAt},
	{(void*)_m, "primitiveWarpBits\000\003\000", (void*)primitiveWarpBits},
...
EXPORT(signed short) primitiveCompareColorsMetadata = 0x300;
EXPORT(signed short) primitiveCopyBitsMetadata = 0x300;
EXPORT(signed short) primitiveDisplayStringMetadata = 0x300;
EXPORT(signed short) primitiveDrawLoopMetadata = 0x300;
EXPORT(signed short) primitivePixelValueAtMetadata = 0x100;
EXPORT(signed short) primitiveWarpBitsMetadata = 0x300;
