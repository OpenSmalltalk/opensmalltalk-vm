/* Automatically generated by
   ...
   from
	BitBltSimulation VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0 " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-eem.3417 " INT_EXT;
...
alphaSourceBlendBits16(void)
{
	...
	while (((deltaY -= 1)) != 0) {
		...
		while (((deltaX -= 1)) != 0) {
			...
			sourceWord = ((sqInt) (long32At(srcIndex)));
...
copyBitsLockedAndClipped(void)
{
	...
	startBits1 = destPPW - (dx & pixPerM11);
	endBits = (((dx + bbW) - 1) & pixPerM11) + 1;
	if (destMSB) {
		mask1 = ((usqInt)(AllOnes)) >> (32 - (startBits1 * destDepth));
		mask2 = (((usqInt)(AllOnes) << (32 - (endBits * destDepth)))) & AllOnes;
	}
	else {
		mask1 = (((usqInt)(AllOnes) << (32 - (startBits1 * destDepth)))) & AllOnes;
	...
	if (bbW <= startBits1) {
		...
		nWords = (((bbW - startBits1) + pixPerM11) / destPPW) + 1;
	}
...
copyLoop(void)
{
 ...
 && (skew == 0))));
	...
	if (noHalftone) {
		...
		/* begin halftoneAt: */
		halftoneWord = ((sqInt) (long32At(halftoneBase + ((0 % halftoneHeight) * 4))));
	}
	...
	if (combinationRule == 3) {
		for (i = 1; i <= bbH; i += 1) {
			...
			if (halftoneHeight > 1) {
				...
				/* begin halftoneAt: */
				halftoneWord = ((sqInt) (long32At(halftoneBase + ((y % halftoneHeight) * 4))));
				y += vDir;
			}
			if (preload) {
				...
				prevWord = ((sqInt) (long32At(sourceIndex)));
				/* begin incSrcIndex: */
				sourceIndex += hInc;
			}
			else {
			...
			/* begin srcLongAt: */
			assert((((usqInt)sourceIndex)) < endOfSource);
			thisWord = ((sqInt) (long32At(sourceIndex)));
			/* begin incSrcIndex: */
			sourceIndex += hInc;
		...
		do {
			...
			if (mapperFlags == (ColorMapPresent | ColorMapIndexedPart)) {
				...
				do {
					/* begin srcLongAt: */
					assert((((usqInt)sourceIndex)) < endOfSource);
					sourceWord = ((sqInt) (long32At(sourceIndex)));
...
loadBitBltFromwarping(sqInt bbObj, sqInt aBool)
{
	...
	l6:	/* end loadColorMapShiftOrMaskFrom:type: */;
			/* begin loadColorMapShiftOrMaskFrom:type: */
	...
	l7:	/* end loadColorMapShiftOrMaskFrom:type: */;
...
loadColorMap(void)
{
	...
	if (isWords(cmOop)) {
		...
		cmShiftTable = firstIndexableField(mapOop);
	l1:	/* end loadColorMapShiftOrMaskFrom:type: */;
		/* begin loadColorMapShiftOrMaskFrom:type: */
		mapOop1 = fetchPointerofObject(1, cmOop);
		if (mapOop1 == (nilObject())) {
			cmMaskTable = null;
		...
		cmMaskTable = firstIndexableField(mapOop1);
	l2:	/* end loadColorMapShiftOrMaskFrom:type: */;
		oop = fetchPointerofObject(2, cmOop);
		if (oop == (nilObject())) {
			cmSize = 0;
		}
