/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2457 uuid: 18deefc8-1a84-4c5f-ab59-02af686dfc0b
   from
	BitBltSimulation VMMaker.oscog-eem.2457 uuid: 18deefc8-1a84-4c5f-ab59-02af686dfc0b
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.2457 uuid: 18deefc8-1a84-4c5f-ab59-02af686dfc0b " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BitBltPlugin VMMaker.oscog-eem.2457 (i)"
#else
	"BitBltPlugin VMMaker.oscog-eem.2457 (e)"
#endif
;
			...
			if (mapperFlags == (ColorMapPresent | ColorMapIndexedPart)) {
				...
				do {
					...
					if (!((((srcShift1 += srcShiftInc)) & 0xFFFFFFE0U) == 0)) {
						...
						/* begin srcLongAt: */
						idx1 = (sourceIndex += 4);
						assert((((usqInt)idx1)) < endOfSource);
