/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	BitBltSimulation VMMaker.oscog-eem.3771 uuid: f42a1a6b-883f-49ca-897a-3b6ed5251764
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-eem.3771 uuid: f42a1a6b-883f-49ca-897a-3b6ed5251764 " __DATE__ ;
...
static const char *moduleName = "BitBltPlugin VMMaker.oscog-eem.3771 " INT_EXT;
...
primitiveWarpBits(void)
{
	...
	bbObj = stackValue(methodArgumentCount());
	if (!(loadBitBltFromwarping(bbObj, 1))) {
		return primitiveFailFor(PrimErrBadReceiver);
	}
