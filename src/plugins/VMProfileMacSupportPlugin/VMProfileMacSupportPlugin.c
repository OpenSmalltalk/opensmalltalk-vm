/* Automatically generated by
   ...
   from
	VMProfileMacSupportPlugin VMMaker.oscog-eem.1953 uuid: 1f1e4603-f82c-48df-915b-7bf0d38e3b60
 */
static char __buildInfo[] = "VMProfileMacSupportPlugin VMMaker.oscog-eem.1953 uuid: 1f1e4603-f82c-48df-915b-7bf0d38e3b60 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"VMProfileMacSupportPlugin VMMaker.oscog-eem.1953 (i)"
#else
	"VMProfileMacSupportPlugin VMMaker.oscog-eem.1953 (e)"
#endif
;
...
#    if __x86_64__
		h64 = _dyld_get_image_header(i);
		if (!(h64 == null)) {
			s = getsectbynamefromheader_64(h64,SEG_TEXT,SECT_TEXT);
			if (s != null) {
				start = s->addr;
				size = s->size;
			}
