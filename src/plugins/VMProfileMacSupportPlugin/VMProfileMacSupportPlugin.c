/* Automatically generated by
	...
	(Compiler-ct.535)
   from
	VMProfileMacSupportPlugin VMMaker.oscog-eem.3787 uuid: e4140a95-7620-4a8f-bc7b-d203220e7f73
 */
static char __buildInfo[] = "VMProfileMacSupportPlugin VMMaker.oscog-eem.3787 uuid: e4140a95-7620-4a8f-bc7b-d203220e7f73 " __DATE__ ;
...
static const char *moduleName = "VMProfileMacSupportPlugin VMMaker.oscog-eem.3787 " INT_EXT;
...
#  if __x86_64__ || __arm64__
	if ((h64 = ((const struct mach_header_64 *) (_dyld_get_image_header(moduleIndex))))) {
		if ((s64 = getsectbynamefromheader_64(h64, SEG_TEXT, SECT_TEXT))) {
...
#  endif // __x86_64__ || __arm64__
	...
	ifNil = (dlInfos = malloc((sizeof(Dl_info)) * ((ndlInfos = (increment = 0x400)))));
	if (!ifNil) {
