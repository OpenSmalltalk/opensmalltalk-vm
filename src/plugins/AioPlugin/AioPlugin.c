...
EXPORT(signed char) primitiveAioDisableAccessorDepth = 0;
EXPORT(signed char) primitiveAioEnableAccessorDepth = 0;
EXPORT(signed char) primitiveAioHandleAccessorDepth = 0;
EXPORT(signed char) primitiveAioSuspendAccessorDepth = 0;
EXPORT(signed char) primitiveOSFileHandleAccessorDepth = 1;
EXPORT(signed char) primitiveOSSocketHandleAccessorDepth = 1;
