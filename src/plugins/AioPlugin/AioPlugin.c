/* Automatically generated by
   ...
   from
	UnixAioPlugin VMConstruction-Plugins-AioPlugin-eem.19 uuid: 39db18ed-b647-4cd1-9843-6ac78e1d7018
 */
static char __buildInfo[] = "UnixAioPlugin VMConstruction-Plugins-AioPlugin-eem.19 uuid: 39db18ed-b647-4cd1-9843-6ac78e1d7018 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"AioPlugin VMConstruction-Plugins-AioPlugin-eem.19 (i)"
#else
	"AioPlugin VMConstruction-Plugins-AioPlugin-eem.19 (e)"
#endif
;


/*** Macros ***/
#define sessionIdentifierFromSqFile(SESSIONIDENTIFIERTYPE) (((SQFile *)(sqFile))->sessionID)
