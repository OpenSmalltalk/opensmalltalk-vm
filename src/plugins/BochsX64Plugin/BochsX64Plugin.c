/* Automatically generated by
   ...
   from
	BochsX64Plugin Cog-eem.458 uuid: 020d2521-b443-4f38-99c9-51dca417fef2
 */
static char __buildInfo[] = "BochsX64Plugin Cog-eem.458 uuid: 020d2521-b443-4f38-99c9-51dca417fef2 " __DATE__ ;
...
static const char *moduleName = "BochsX64Plugin Cog-eem.458 " INT_EXT;
...
primitiveDisassembleAtInMemory(void)
{
	...
	if (((cpu = ((void *) (/* begin startOfData: */
	((longAt(cpuAlien + BaseHeaderSize)) > 0
...
primitiveIntegerRegisterState(void)
{
	...
	registerStateVector = instantiateClassindexableSize(classDoubleWordArray(), NumIntegerRegisterStateFields);
	if (registerStateVector == 0) {
		return primitiveFailFor(PrimErrNoMemory);
	}
	if ((byteSizeOf(registerStateVector)) != (NumIntegerRegisterStateFields * (sizeof(sqLong /* begin integerRegisterElementType */)))) {
		return primitiveFailFor(PrimErrBadArgument);
	}
