/* Automatically generated by
	...
	(Compiler-eem.514)
   from
	BochsX64Plugin Cog-eem.469 uuid: 4be8c35b-6afc-424d-845e-3a1f69845d2f
 */
static char __buildInfo[] = "BochsX64Plugin Cog-eem.469 uuid: 4be8c35b-6afc-424d-845e-3a1f69845d2f " __DATE__ ;
...
static const char *moduleName = "BochsX64Plugin Cog-eem.469 " INT_EXT;
...
primitiveIntegerRegisterState(void)
{
	...
	if ((byteSizeOf(registerStateVector)) != (NumIntegerRegisterStateFields * (sizeof(sqLong /* integerRegisterElementType */)))) {
		return primitiveFailFor(PrimErrBadArgument);
	}
