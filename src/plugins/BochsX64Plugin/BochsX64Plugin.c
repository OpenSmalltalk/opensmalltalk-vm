/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2857 uuid: 4f72a34b-cd5d-4e2c-9eae-45498349bad6
   from
	BochsX64Plugin Cog-eem.418 uuid: c6071ebe-d541-48e9-82ec-da42f9cbb3d0
 */
static char __buildInfo[] = "BochsX64Plugin Cog-eem.418 uuid: c6071ebe-d541-48e9-82ec-da42f9cbb3d0 " __DATE__ ;
...
static const char *moduleName = "BochsX64Plugin Cog-eem.418 " INT_EXT;
...
primitiveDisassembleAtInMemory(void)
{
	...
	if (((cpu = ((void *) ((((BytesPerWord == 8
	? ((sqLong) (longAt(cpuAlien + BaseHeaderSize)))
	: ((int) (longAt(cpuAlien + BaseHeaderSize))))) > 0
...
signed char primitiveRunInMemoryOffsetMinimumAddressReadWriteAccessorDepth = 0;
...
signed char primitiveSingleStepInMemoryOffsetMinimumAddressReadWriteAccessorDepth = 0;
