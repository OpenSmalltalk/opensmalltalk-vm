/* Automatically generated by
   ...
   from
	GeniePlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554
 */
static char __buildInfo[] = "GeniePlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"GeniePlugin v2.0 20 February 2015 VMMaker.oscog-eem.1072 (i)"
#else
	"GeniePlugin v2.0 20 February 2015 VMMaker.oscog-eem.1072 (e)"
#endif
;
...
primVersionNO(void)
{
	...
	_return_value = integerObjectOf(((2 * 1000) + 0));
	if (failed()) {
		return null;
	}
...
void* GeniePlugin_exports[][3] = {
	...
	{"GeniePlugin", "primVersionNO\000\377", (void*)primVersionNO},
