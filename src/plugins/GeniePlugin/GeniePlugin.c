/* Automatically generated by
   ...
   from
	GeniePlugin VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f
 */
static char __buildInfo[] = "GeniePlugin VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f " __DATE__ ;
...
static const char *moduleName = "GeniePlugin v2.0 9 September 2024 VMMaker.oscog-eem.3455 " INT_EXT;
...
primSameClassAbsoluteStrokeDistanceMyPoints_otherPoints_myVectors_otherVectors_mySquaredLengths_otherSquaredLengths_myAngles_otherAngles_maxSizeAndReferenceFlag_rowBase_rowInsertRemove_rowInsertRemoveCount(void)
{
	...
	myPoints = ((int *) (firstIndexableField(myPointsOop)));
	otherPoints = ((int *) (firstIndexableField(otherPointsOop)));
	myVectors = ((int *) (firstIndexableField(myVectorsOop)));
	otherVectors = ((int *) (firstIndexableField(otherVectorsOop)));
	mySquaredLengths = ((int *) (firstIndexableField(mySquaredLengthsOop)));
	otherSquaredLengths = ((int *) (firstIndexableField(otherSquaredLengthsOop)));
	myAngles = ((int *) (firstIndexableField(myAnglesOop)));
	otherAngles = ((int *) (firstIndexableField(otherAnglesOop)));
	rowBase = ((int *) (firstIndexableField(rowBaseOop)));
	rowInsertRemove = ((int *) (firstIndexableField(rowInsertRemoveOop)));
	...
	rowInsertRemoveCount = ((int *) (firstIndexableField(rowInsertRemoveCountOop)));
...
#if SPURVM
EXPORT(signed short) primSameClassAbsoluteStrokeDistanceMyPoints_otherPoints_myVectors_otherVectors_mySquaredLengths_otherSquaredLengths_myAngles_otherAngles_maxSizeAndReferenceFlag_rowBase_rowInsertRemove_rowInsertRemoveCountMetadata = 0x100;
#endif // SPURVM
