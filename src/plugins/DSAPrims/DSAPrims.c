...
static sqInt primitiveBigDivide(void);
static sqInt primitiveBigMultiply(void);
static sqInt primitiveExpandBlock(void);
static sqInt primitiveHashBlock(void);
static sqInt primitiveHasSecureHashPrimitive(void);
static sqInt primitiveHighestNonZeroDigitIndex(void);
