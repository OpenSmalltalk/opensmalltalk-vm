/* Automatically generated by
   ...
   from
	DSAPlugin CryptographyPlugins-ul.22 uuid: 1308f614-8494-46ef-bffd-21a70d1f8dee
 */
static char __buildInfo[] = "DSAPlugin CryptographyPlugins-ul.22 uuid: 1308f614-8494-46ef-bffd-21a70d1f8dee " __DATE__ ;
...
static const char *moduleName = "DSAPrims CryptographyPlugins-ul.22 " INT_EXT;
...
bigDivideLoop(void)
{
	...
	for (j = remainderDigitCount; j >= (divisorDigitCount + 1); j += -1) {
		...
		if ((d2 * q) > (((((sqInt)((usqInt)((firstTwoDigits - (q * d1))) << 8)))) + thirdDigit)) {
			q -= 1;
			if ((d2 * q) > (((((sqInt)((usqInt)((firstTwoDigits - (q * d1))) << 8)))) + thirdDigit)) {
				q -= 1;
			}
		...
		if (q > 0) {
			...
			if (resultDigit < 0) {
				...
				dsaRemainder[rIndex1] = (resultDigit + 0x100);
				qTooBig = 1;
				goto l1;
			}
			else {
...
primitiveHashBlock(void)
{
	...
	e = statePtr[4];
	for (i = 0; i <= 19; i += 1) {
		tmp = (((0x5A827999 + ((b & c) | (((unsigned int)~b) & d))) + ((((usqInt)(a) << 5)) | (((usqInt)(a)) >> (27)))) + e) + (bufPtr[i]);
		e = d;
		d = c;
		/* begin leftRotate:by: */
...
void* DSAPrims_exports[][3] = {
	...
	{(void*)_m, "primitiveBigDivide\000\001\000", (void*)primitiveBigDivide},
	{(void*)_m, "primitiveBigMultiply\000\001\000", (void*)primitiveBigMultiply},
	{(void*)_m, "primitiveExpandBlock\000\001\000", (void*)primitiveExpandBlock},
	{(void*)_m, "primitiveHashBlock\000\001\000", (void*)primitiveHashBlock},
	{(void*)_m, "primitiveHasSecureHashPrimitive\000\377\000", (void*)primitiveHasSecureHashPrimitive},
	{(void*)_m, "primitiveHighestNonZeroDigitIndex\000\001\000", (void*)primitiveHighestNonZeroDigitIndex},
...
EXPORT(signed short) primitiveBigDivideMetadata = 0x100;
EXPORT(signed short) primitiveBigMultiplyMetadata = 0x100;
EXPORT(signed short) primitiveExpandBlockMetadata = 0x100;
EXPORT(signed short) primitiveHashBlockMetadata = 0x100;
EXPORT(signed short) primitiveHighestNonZeroDigitIndexMetadata = 0x100;
