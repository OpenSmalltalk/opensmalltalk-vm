...
primitiveHashBlock(void)
{
	...
	e = statePtr[4];
	for (i = 0; i <= 19; i += 1) {
tmp = (((1518500249 + ((b & c) | (((unsigned int)~b) & d))) + ((((sqInt)((usqInt)(a) << 5))) | (((usqInt) a) >> (32 - 5)))) + e) + (bufPtr[i]);
		e = d;
		d = c;
		c = (((sqInt)((usqInt)(b) << 30))) | (((usqInt) b) >> (32 - 30));
		b = a;
		a = tmp;
	}
	for (i = 20; i <= 39; i += 1) {
tmp = (((1859775393 + ((b ^ c) ^ d)) + ((((sqInt)((usqInt)(a) << 5))) | (((usqInt) a) >> (32 - 5)))) + e) + (bufPtr[i]);
		e = d;
		d = c;
		c = (((sqInt)((usqInt)(b) << 30))) | (((usqInt) b) >> (32 - 30));
		b = a;
	...
	for (i = 40; i <= 59; i += 1) {
tmp = (((2400959708U + (((b & c) | (b & d)) | (c & d))) + ((((sqInt)((usqInt)(a) << 5))) | (((usqInt) a) >> (32 - 5)))) + e) + (bufPtr[i]);
		e = d;
		d = c;
		c = (((sqInt)((usqInt)(b) << 30))) | (((usqInt) b) >> (32 - 30));
		b = a;
	...
	for (i = 60; i <= 79; i += 1) {
tmp = (((3395469782U + ((b ^ c) ^ d)) + ((((sqInt)((usqInt)(a) << 5))) | (((usqInt) a) >> (32 - 5)))) + e) + (bufPtr[i]);
		e = d;
		d = c;
		c = (((sqInt)((usqInt)(b) << 30))) | (((usqInt) b) >> (32 - 30));
		b = a;
