/* Automatically generated by
   ...
   from
	HostWindowPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "HostWindowPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "HostWindowPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
#endif /* TerfVM */
#if TerfVM
	{(void*)_m, "primitiveScreenRectangles\000\377", (void*)primitiveScreenRectangles},
#endif /* TerfVM */
...
EXPORT(signed char) primitiveCloseHostWindowAccessorDepth = 0;
EXPORT(signed char) primitiveCreateHostWindowAccessorDepth = 0;
EXPORT(signed char) primitiveHostWindowIconAccessorDepth = 0;
EXPORT(signed char) primitiveHostWindowPositionAccessorDepth = 0;
EXPORT(signed char) primitiveHostWindowPositionSetAccessorDepth = 0;
#if TerfVM
EXPORT(signed char) primitiveHostWindowScreenWorkAreaPositionAccessorDepth = 0;
#endif /* TerfVM */
#if TerfVM
EXPORT(signed char) primitiveHostWindowScreenWorkAreaSizeAccessorDepth = 0;
#endif /* TerfVM */
EXPORT(signed char) primitiveHostWindowSizeAccessorDepth = 0;
EXPORT(signed char) primitiveHostWindowSizeSetAccessorDepth = 0;
EXPORT(signed char) primitiveHostWindowTitleAccessorDepth = 0;
EXPORT(signed char) primitiveSetCursorPositionAccessorDepth = 0;
EXPORT(signed char) primitiveShowHostWindowRectAccessorDepth = 0;
