/* Automatically generated by
   ...
   from
	HostWindowPlugin VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a
 */
static char __buildInfo[] = "HostWindowPlugin VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"HostWindowPlugin VMMaker.oscog-eem.232 (i)"
#else
	"HostWindowPlugin VMMaker.oscog-eem.232 (e)"
#endif
;
...
primitiveCreateHostWindow(void)
{
	...
	listLength = slotSizeOf(((sqInt)(long)(list) - 4));
...
primitiveHostWindowPosition(void)
{
	...
	if (pos == -1) {
		...
		_return_value = makePointwithxValueyValue(((usqInt) pos) >> 16, pos & 65535);
		if (failed()) {
			return null;
		}
...
primitiveHostWindowSize(void)
{
	...
	if (size == -1) {
		...
		_return_value = makePointwithxValueyValue(((usqInt) size) >> 16, size & 65535);
		if (failed()) {
			return null;
		}
		popthenPush(2, _return_value);
...
primitiveHostWindowTitle(void)
{
	...
	titleLength = slotSizeOf(((sqInt)(long)(titleString) - 4));
