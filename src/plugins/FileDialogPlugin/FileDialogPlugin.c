/* Automatically generated by
   ...
   from
	FileDialogPlugin VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0
 */
static char __buildInfo[] = "FileDialogPlugin VMMaker.oscog-eem.3417 uuid: 6b0ab3f7-46c0-4e4c-a800-57a4d13ffef0 " __DATE__ ;
...
static const char *moduleName = "FileDialogPlugin VMMaker.oscog-eem.3417 " INT_EXT;
...
primitiveFileDialogAddFilter(void)
{
	...
	sz1 = byteSizeOf(obj1);
	dstPtr1 = alloca(sz1 + 1);
	if (!dstPtr1) {
		primitiveFailFor(PrimErrNoCMemory);
		filterDesc = null;
		goto l3;
	}
	memcpy(dstPtr1, firstIndexableField(obj1), sz1);
	dstPtr1[sz1] = 0;
	filterDesc = dstPtr1;
	l3:	/* end stackEphemeralStringValue: */;
	/* begin stackDialogHandle: */
