/* Automatically generated by
   ...
   from
	BalloonEnginePlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "B2DPlugin VMMaker.oscog-eem.3423 " INT_EXT;
...
addEdgeToGET(sqInt edge)
{
	...
	/* begin getUsedPut: */
	value = (workBuffer[GWGETUsed]) + 1;
	workBuffer[GWGETUsed] = value;
	return 0;
}
...
allocateBezierStackEntry(void)
{
	...
	/* begin wbTopPut: */
	value = (workBuffer[GWBufferTop]) - 6;
	workBuffer[GWBufferTop] = value;
	l2:	/* end wbStackPush: */;
	/* begin wbStackSize */
...
allocateGradientFillrampWidthisRadial(int *ramp, sqInt rampWidth, sqInt isRadial)
{
	...
	/* begin gradientRampLengthOf:put: */
...
allocateStackFillEntry(void)
{
	...
	/* begin wbStackPush: */
	if (!(allocateStackEntry(3 /* stackFillEntryLength */))) {
		return 0;
	}
	/* begin wbTopPut: */
	value = (workBuffer[GWBufferTop]) - 3 /* stackFillEntryLength */;
	workBuffer[GWBufferTop] = value;
	return 1;
}
...
checkCompressedFillIndexListmaxsegments(sqInt fillList, sqInt maxIndex, sqInt nSegs)
{
	...
	for (i = 0; i < length; i += 1) {
		/* begin shortRunLengthAt:from: */
		runLength = (((usqInt)(((((int *) fillPtr))[i]))) >> 16);
		/* begin shortRunValueAt:from: */
...
checkedAddBezierToGET(sqInt bezier)
{
	...
	if ((((objBuffer[bezier + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWide) != 0) {
		/* begin wideBezierExtentOf: */
		lineWidth = objBuffer[bezier + GBWideExtent];
	}
	else {
		lineWidth = 0;
	}
	if (((bezierEndYOf(bezier)) + lineWidth) < (workBuffer[GWFillMinY])) {
		return 0;
	}
	if ((((edgeXValueOf(bezier)) - lineWidth) >= (workBuffer[GWFillMaxX]))
	 && (((bezierEndXOf(bezier)) - lineWidth) >= (workBuffer[GWFillMaxX]))) {
		return 0;
	}
	addEdgeToGET(bezier);
	return 0;
...
checkedAddEdgeToGET(sqInt edge)
{
	...
	if ((((objBuffer[edge + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWideMask) == GEPrimitiveLine) {
		...
		if (((lineEndYOf(edge)) + lineWidth) < (workBuffer[GWFillMinY])) {
			return 0;
		}
		if ((((edgeXValueOf(edge)) - lineWidth) >= (workBuffer[GWFillMaxX]))
		 && (((lineEndXOf(edge)) - lineWidth) >= (workBuffer[GWFillMaxX]))) {
			return 0;
		}
		addEdgeToGET(edge);
		return null;
	...
	if ((((objBuffer[edge + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWideMask) == GEPrimitiveBezier) {
		...
		if (((bezierEndYOf(edge)) + lineWidth1) < (workBuffer[GWFillMinY])) {
			return 0;
		}
		if ((((edgeXValueOf(edge)) - lineWidth1) >= (workBuffer[GWFillMaxX]))
		 && (((bezierEndXOf(edge)) - lineWidth1) >= (workBuffer[GWFillMaxX]))) {
			return 0;
		}
		addEdgeToGET(edge);
		return null;
...
checkedAddLineToGET(sqInt line)
{
	...
	if (((lineEndYOf(line)) + lineWidth) < (workBuffer[GWFillMinY])) {
		return 0;
	}
	if ((((edgeXValueOf(line)) - lineWidth) >= (workBuffer[GWFillMaxX]))
	 && (((lineEndXOf(line)) - lineWidth) >= (workBuffer[GWFillMaxX]))) {
		return 0;
	}
	addEdgeToGET(line);
	return 0;
...
computeBezierSplitAtHalf(sqInt index)
{
	...
	/* begin bzEndY: */
	index11 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 5;
	endY = workBuffer[(workBuffer[GWBufferTop]) + index11];
	...
	/* begin bzViaX:put: */
	index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 2;
	workBuffer[(workBuffer[GWBufferTop]) + index12] = leftViaX;
	/* begin bzViaY:put: */
	index13 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 3;
	workBuffer[(workBuffer[GWBufferTop]) + index13] = leftViaY;
	/* begin bzEndX:put: */
	index14 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 4;
	workBuffer[(workBuffer[GWBufferTop]) + index14] = sharedX;
	/* begin bzEndY:put: */
	index15 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 5;
	workBuffer[(workBuffer[GWBufferTop]) + index15] = sharedY;
	/* begin bzStartX:put: */
	index16 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex);
	workBuffer[(workBuffer[GWBufferTop]) + index16] = sharedX;
	/* begin bzStartY:put: */
	index17 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex) + 1;
	workBuffer[(workBuffer[GWBufferTop]) + index17] = sharedY;
	/* begin bzViaX:put: */
	index18 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex) + 2;
	workBuffer[(workBuffer[GWBufferTop]) + index18] = rightViaX;
	/* begin bzViaY:put: */
	index19 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex) + 3;
	workBuffer[(workBuffer[GWBufferTop]) + index19] = rightViaY;
	/* begin bzEndX:put: */
	index110 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex) + 4;
	workBuffer[(workBuffer[GWBufferTop]) + index110] = endX;
	/* begin bzEndY:put: */
	index111 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - newIndex) + 5;
	workBuffer[(workBuffer[GWBufferTop]) + index111] = endY;
	return newIndex;
}
...
computeBeziersplitAt(sqInt index, double param)
{
	...
	l3:	/* end assureValue:between:and: */;
	/* begin assureValue:between:and: */
	if (sharedY > endY) {
	...
	l4:	/* end assureValue:between:and: */;
	/* begin allocateBezierStackEntry */
	if (!(allocateStackEntry(6))) {
		goto l16;
	}
...
createGlobalEdgeTable(void)
{
	...
	while (object < end) {
		...
		if (isEdge(object)) {
			...
			if (!((edgeYValueOf(object)) >= (workBuffer[GWFillMaxY]))) {
				...
				if ((((objBuffer[object + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWideMask) == GEPrimitiveLine) {
					...
					if (((lineEndYOf(object)) + lineWidth) < (workBuffer[GWFillMinY])) {
						goto l3;
					}
					if ((((edgeXValueOf(object)) - lineWidth) >= (workBuffer[GWFillMaxX]))
					 && (((lineEndXOf(object)) - lineWidth) >= (workBuffer[GWFillMaxX]))) {
						goto l3;
					}
					addEdgeToGET(object);
					goto l3;
				...
				if ((((objBuffer[object + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWideMask) == GEPrimitiveBezier) {
					...
					if (((bezierEndYOf(object)) + lineWidth1) < (workBuffer[GWFillMinY])) {
						goto l3;
					}
					if ((((edgeXValueOf(object)) - lineWidth1) >= (workBuffer[GWFillMaxX]))
					 && (((bezierEndXOf(object)) - lineWidth1) >= (workBuffer[GWFillMaxX]))) {
						goto l3;
					}
					addEdgeToGET(object);
					goto l3;
...
fillAllFromto(sqInt leftX, sqInt rightX)
{
	...
	if ((stackFillSize()) == 0) {
		...
		/* begin topFillValue */
		index2 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
	...
	if ((stackFillSize()) == 0) {
		...
		/* begin topFillRightX */
		index3 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
	...
	while (stopX < rightX) {
		...
		if ((stackFillSize()) == 0) {
			...
			/* begin topFillValue */
			index = (stackFillSize()) - 3 /* stackFillEntryLength */;
			/* begin wbStackValue: */
			fill = workBuffer[(workBuffer[GWBufferTop]) + index];
			goto l1;
		}
	l1:	/* end topFill */;
		if (!(fill == 0)) {
	...
	l2:	/* end quickRemoveInvalidFillsAt: */;
		...
		if ((stackFillSize()) == 0) {
			...
			/* begin topFillRightX */
			index1 = (stackFillSize()) - 3 /* stackFillEntryLength */;
			/* begin wbStackValue: */
	...
	if ((stackFillSize()) == 0) {
		...
		/* begin topFillValue */
		index4 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
		fill = workBuffer[(workBuffer[GWBufferTop]) + index4];
		goto l6;
	}
	l6:	/* end topFill */;
	if (!(fill == 0)) {
	...
	l4:	/* end clampValue:max: */;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			fillValue = uncheckedTransformColor(value);
	l24:	/* end bitmapValue:bits:atX:y: */;
	...
	l8:	/* end clampValue:max: */;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			fillValue = uncheckedTransformColor(value1);
	l27:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt)((fillValue & cMask))) >> cShift;
			idx = ((usqInt)(x)) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
	...
	l12:	/* end clampValue:max: */;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			fillValue = uncheckedTransformColor(value2);
	l30:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt)((fillValue & cMask))) >> cShift;
			idx = ((usqInt)(x)) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
...
fillSortsbefore(sqInt fillEntry1, sqInt fillEntry2)
{
	...
	return (((unsigned) (stackFillValue(fillEntry1)))) < (((unsigned) (stackFillValue(fillEntry2))));
}
...
findNextExternalFillFromAET(void)
{
	...
	l10:	/* end quickRemoveInvalidFillsAt: */;
	...
	if (rightX < (workBuffer[GWFillMaxX])) {
		...
		if ((stackFillSize()) == 0) {
			...
			/* begin topFillValue */
			index21 = (stackFillSize()) - 3 /* stackFillEntryLength */;
			/* begin wbStackValue: */
	...
	l15:	/* end topFill */;
		...
		if ((stackFillSize()) == 0) {
			...
			/* begin topFillRightX */
			index31 = (stackFillSize()) - 3 /* stackFillEntryLength */;
			/* begin wbStackValue: */
	...
	l11:	/* end topRightX */;
		while (stopX1 < (workBuffer[GWFillMaxX])) {
			...
			if ((stackFillSize()) == 0) {
				...
				/* begin topFillValue */
				index5 = (stackFillSize()) - 3 /* stackFillEntryLength */;
				/* begin wbStackValue: */
				fill1 = workBuffer[(workBuffer[GWBufferTop]) + index5];
				goto l13;
			}
	l13:	/* end topFill */;
			if (!(fill1 == 0)) {
	...
	l16:	/* end quickRemoveInvalidFillsAt: */;
			startX1 = stopX1;
			/* begin topRightX */
			if ((stackFillSize()) == 0) {
				stopX1 = 999999999;
				...
				/* begin topFillRightX */
				index11 = (stackFillSize()) - 3 /* stackFillEntryLength */;
				/* begin wbStackValue: */
	...
	l12:	/* end topRightX */;
		...
		if ((stackFillSize()) == 0) {
			...
			/* begin topFillValue */
			index41 = (stackFillSize()) - 3 /* stackFillEntryLength */;
			/* begin wbStackValue: */
			fill1 = workBuffer[(workBuffer[GWBufferTop]) + index41];
			goto l14;
		}
	l14:	/* end topFill */;
		if (!(fill1 == 0)) {
...
hideFilldepth(sqInt fillIndex, sqInt depth)
{
	...
	value1 = workBuffer[(workBuffer[GWBufferTop])];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + index] = value1;
	/* begin stackFillDepth:put: */
	value2 = workBuffer[(workBuffer[GWBufferTop]) + (1)];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + (index + 1)] = value2;
	/* begin stackFillRightX:put: */
	value3 = workBuffer[(workBuffer[GWBufferTop]) + (2)];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + (index + 2)] = value3;
	/* begin freeStackFillEntry */
	value4 = (workBuffer[GWBufferTop]) + 3 /* stackFillEntryLength */;
	workBuffer[GWBufferTop] = value4;
	if ((stackFillSize()) <= 3 /* stackFillEntryLength */) {
		return 1;
	}
	newTopIndex = 0;
	/* begin stackFillEntryLength */
	index = 3;
	while (index < (stackFillSize())) {
	...
	if ((newTopIndex + 3 /* stackFillEntryLength */) == (stackFillSize())) {
		return 1;
	}
	...
	index4 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue: */
	value5 = workBuffer[(workBuffer[GWBufferTop]) + index4];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + newTopIndex] = value5;
	/* begin topFillValuePut: */
	index1 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue:put: */
	...
	index5 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue: */
	value6 = workBuffer[(workBuffer[GWBufferTop]) + (index5 + 1)];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + (newTopIndex + 1)] = value6;
	/* begin topFillDepthPut: */
	index2 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue:put: */
	...
	/* begin stackFillRightX:put: */
	index6 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue: */
	value7 = workBuffer[(workBuffer[GWBufferTop]) + (index6 + 2)];
	/* begin wbStackValue:put: */
	workBuffer[(workBuffer[GWBufferTop]) + (newTopIndex + 2)] = value7;
	/* begin topFillRightXPut: */
	index3 = (stackFillSize()) - 3 /* stackFillEntryLength */;
	/* begin wbStackValue:put: */
...
initializeGETProcessing(void)
{
	...
	/* begin spanEndPut: */
	value8 = (((sqInt)((usqInt)((workBuffer[GWSpanSize])) << (workBuffer[GWAAShift])))) - 1;
	workBuffer[GWSpanEnd] = value8;
	clearSpanBuffer();
	return 0;
}
...
loadAndSubdivideBezierFromviatoisWide(int *point1, int *point2, int *point3, sqInt wideFlag)
{
	...
	/* begin bzStartX:put: */
	index11 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1);
	workBuffer[(workBuffer[GWBufferTop]) + index11] = (point1[0]);
	/* begin bzStartY:put: */
	index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1) + 1;
	workBuffer[(workBuffer[GWBufferTop]) + index12] = (point1[1]);
	/* begin bzViaX:put: */
	index13 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1) + 2;
	workBuffer[(workBuffer[GWBufferTop]) + index13] = (point2[0]);
	/* begin bzViaY:put: */
	index14 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1) + 3;
	workBuffer[(workBuffer[GWBufferTop]) + index14] = (point2[1]);
	/* begin bzEndX:put: */
	index15 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1) + 4;
	workBuffer[(workBuffer[GWBufferTop]) + index15] = (point3[0]);
	/* begin bzEndY:put: */
	index16 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - bz1) + 5;
	workBuffer[(workBuffer[GWBufferTop]) + index16] = (point3[1]);
...
loadBeziersegmentleftFillrightFilloffset(sqInt bezier, sqInt index, sqInt leftFillIndex, sqInt rightFillIndex, sqInt yOffset)
{
	...
	if ((bzEndY(index)) >= (bzStartY(index))) {
		...
		value1 = (bzStartY(index)) - yOffset;
		/* begin obj:at:put: */
		objBuffer[bezier + GEYValue] = value1;
		/* begin bezierViaXOf:put: */
		index11 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 2;
		value2 = workBuffer[(workBuffer[GWBufferTop]) + index11];
		/* begin obj:at:put: */
		objBuffer[bezier + GBViaX] = value2;
		/* begin bezierViaYOf:put: */
		value3 = (bzViaY(index)) - yOffset;
		/* begin obj:at:put: */
		objBuffer[bezier + GBViaY] = value3;
		/* begin bezierEndXOf:put: */
		index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 4;
		value4 = workBuffer[(workBuffer[GWBufferTop]) + index12];
		/* begin obj:at:put: */
		objBuffer[bezier + GBEndX] = value4;
		/* begin bezierEndYOf:put: */
		value5 = (bzEndY(index)) - yOffset;
		/* begin obj:at:put: */
		objBuffer[bezier + GBEndY] = value5;
	}
	else {
		/* begin edgeXValueOf:put: */
		index13 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 4;
		value6 = workBuffer[(workBuffer[GWBufferTop]) + index13];
		/* begin obj:at:put: */
		objBuffer[bezier + GEXValue] = value6;
		/* begin edgeYValueOf:put: */
		value7 = (bzEndY(index)) - yOffset;
		/* begin obj:at:put: */
		objBuffer[bezier + GEYValue] = value7;
		/* begin bezierViaXOf:put: */
		index14 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 2;
		value8 = workBuffer[(workBuffer[GWBufferTop]) + index14];
		/* begin obj:at:put: */
		objBuffer[bezier + GBViaX] = value8;
		/* begin bezierViaYOf:put: */
		value9 = (bzViaY(index)) - yOffset;
		/* begin obj:at:put: */
		objBuffer[bezier + GBViaY] = value9;
		/* begin bezierEndXOf:put: */
		index15 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index);
		value10 = workBuffer[(workBuffer[GWBufferTop]) + index15];
		/* begin obj:at:put: */
		objBuffer[bezier + GBEndX] = value10;
		/* begin bezierEndYOf:put: */
		value11 = (bzStartY(index)) - yOffset;
		/* begin obj:at:put: */
...
loadBitmapFillcolormaptilefromalongnormalxIndex(sqInt formOop, sqInt cmOop, sqInt tileFlag, int *point1, int *point2, int *point3, sqInt xIndex)
{
	...
	objBuffer[fill + GBColormapSize] = cmSize;
	bmFill = fill;
	l6:	/* end allocateBitmapFill:colormap: */;
	if (engineStopped) {
		return null;
	}
...
loadCompressedShapesegmentsleftFillsrightFillslineWidthslineFillsfillIndexListpointShort(int *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList, sqInt pointsShort)
{
	...
	l29:	/* end loadCompressedSegment:from:short:leftFill:rightFill:lineWidth:lineColor: */;
		if (engineStopped) {
			return null;
		}
	}
...
loadGradientFillfromalongnormalisRadial(sqInt rampOop, int *point1, int *point2, int *point3, sqInt isRadial)
{
	...
	fill = fill1;
	l7:	/* end allocateGradientFill:rampWidth:isRadial: */;
	if (engineStopped) {
		return null;
	}
...
loadShapenSegmentsfilllineWidthlineFillpointsShort(int *points, sqInt nSegments, sqInt fillIndex, sqInt lineWidth, sqInt lineFill, sqInt pointsShort)
{
	...
	for (i = 1; i <= nSegments; i += 1) {
		...
		loadWideBezierlineFillleftFillrightFilln(lineWidth, lineFill, fillIndex, 0, segs);
	l21:	/* end loadCompressedSegment:from:short:leftFill:rightFill:lineWidth:lineColor: */;
		if (engineStopped) {
			return null;
		}
	}
...
loadWideBezierlineFillleftFillrightFilln(sqInt lineWidth, sqInt lineFill, sqInt leftFill, sqInt rightFill, sqInt nSegments)
{
	...
	l9:	/* end allocateBezier */;
		...
		if (wide) {
			/* begin wideBezierFillOf:put: */
			objBuffer[bezier + GBWideFill] = lineFill;
			/* begin wideBezierWidthOf:put: */
			objBuffer[bezier + GBWideWidth] = lineWidth;
			/* begin wideBezierExtentOf:put: */
...
loadWideLinefromtolineFillleftFillrightFill(sqInt lineWidth, int *p1, int *p2, sqInt lineFill, sqInt leftFill, sqInt rightFill)
{
	...
	objBuffer[line + GLYDirection] = yDir;
	if ((((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) & GEPrimitiveWide) != 0) {
		/* begin wideLineFillOf:put: */
		objBuffer[line + GLWideFill] = lineFill;
		/* begin wideLineWidthOf:put: */
		objBuffer[line + GLWideWidth] = lineWidth;
		/* begin wideLineExtentOf:put: */
...
primitiveAddBitmapFill(void)
{
	...
	fill = bmFill;
	l15:	/* end loadBitmapFill:colormap:tile:from:along:normal:xIndex: */;
	if (engineStopped) {
		/* Make sure the stack is okay */
		return primitiveFailFor(GEFEngineStopped);
	}
...
primitiveMergeFillFrom(void)
{
	...
	if (!((objectIndexOf(workBuffer[GWLastExportedFill])) == value)) {
		return primitiveFailFor(GEFWrongFill);
	}
...
showFilldepthrightX(sqInt fillIndex, sqInt depth, sqInt rightX)
{
	...
	if (fillSortsbefore(0, (stackFillSize()) - 3 /* stackFillEntryLength */)) {
		/* New top fill */
		/* begin stackFillValue:put: */
		index3 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
		value = workBuffer[(workBuffer[GWBufferTop]) + index3];
		/* begin wbStackValue:put: */
		workBuffer[(workBuffer[GWBufferTop])] = value;
		/* begin stackFillDepth:put: */
		index4 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
		value1 = workBuffer[(workBuffer[GWBufferTop]) + (index4 + 1)];
		/* begin wbStackValue:put: */
		workBuffer[(workBuffer[GWBufferTop]) + (1)] = value1;
		/* begin stackFillRightX:put: */
		index5 = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue: */
		value2 = workBuffer[(workBuffer[GWBufferTop]) + (index5 + 2)];
		/* begin wbStackValue:put: */
		workBuffer[(workBuffer[GWBufferTop]) + (2)] = value2;
		/* begin topFillValuePut: */
		index = (stackFillSize()) - 3 /* stackFillEntryLength */;
		/* begin wbStackValue:put: */
...
stepToFirstWideBezierInat(sqInt bezier, sqInt yValue)
{
	...
	if (nLines == 0) {
		((objBuffer + bezier) + GBUpdateData)[GBUpdateX] = ((bezierFinalXOf(bezier)) * 0x100);
	}
	/* begin edgeNumLinesOf:put: */
	...
	if (!(startY == yValue)) {
		...
		/* begin edgeNumLinesOf:put: */
		value2 = (edgeNumLinesOf(bezier)) - (yValue - startY);
		/* begin obj:at:put: */
		objBuffer[bezier + GENumLines] = value2;
	}
	return 0;
}
...
stepToFirstWideLineInat(sqInt line, sqInt yValue)
{
	...
	if (xDir > 0) {
		/* begin wideLineWidthOf:put: */
		value = (lineXIncrementOf(line)) + lineWidth;
		/* begin obj:at:put: */
		objBuffer[line + GLWideWidth] = value;
	}
	else {
		/* begin wideLineWidthOf:put: */
		value1 = lineWidth - (lineXIncrementOf(line));
		/* begin obj:at:put: */
		objBuffer[line + GLWideWidth] = value1;
		/* begin edgeXValueOf:put: */
		value2 = (edgeXValueOf(line)) + (lineXIncrementOf(line));
		/* begin obj:at:put: */
		objBuffer[line + GEXValue] = value2;
	}
	/* turned on at lineOffset */
	yEntry = 0;
	/* turned off at zero */
	yExit = (0 - nLines) - lineOffset;
	/* begin wideLineEntryOf:put: */
	objBuffer[line + GLWideEntry] = yEntry;
	/* begin wideLineExitOf:put: */
	objBuffer[line + GLWideExit] = yExit;
	if ((yEntry >= lineOffset)
	 && (yExit < 0)) {
		/* begin edgeFillsValidate: */
		value3 = ((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) & ((unsigned int)~GEEdgeFillsInvalid);
		/* begin obj:at:put: */
		objBuffer[line + GEObjectType] = value3;
	}
	else {
		/* begin edgeFillsInvalidate: */
		value4 = ((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) | GEEdgeFillsInvalid;
		/* begin obj:at:put: */
	...
	if (!(startY == yValue)) {
		for (i = startY; i < yValue; i += 1) {
			...
			yEntry1 = (wideLineEntryOf(line)) + 1;
			yExit1 = (wideLineExitOf(line)) + 1;
			/* begin wideLineEntryOf:put: */
			...
			if (yEntry1 >= lineOffset1) {
				/* begin edgeFillsValidate: */
				value5 = ((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) & ((unsigned int)~GEEdgeFillsInvalid);
				/* begin obj:at:put: */
				objBuffer[line + GEObjectType] = value5;
			}
			if (yExit1 >= 0) {
				/* begin edgeFillsInvalidate: */
		...
		/* begin edgeNumLinesOf:put: */
		value6 = (edgeNumLinesOf(line)) - (yValue - startY);
		/* begin obj:at:put: */
		objBuffer[line + GENumLines] = value6;
	}
	return 0;
}
...
subdivideBezier(sqInt index)
{
	...
	/* begin bzStartX: */
	index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index);
	startX = workBuffer[(workBuffer[GWBufferTop]) + index12];
	/* begin bzEndX: */
	index13 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 4;
	endX = workBuffer[(workBuffer[GWBufferTop]) + index13];
	deltaX = endX - startX;
	if (deltaX < 0) {
		deltaX = 0 - deltaX;
	}
...
subdivideToBeMonotonInX(sqInt index)
{
	...
	/* begin bzViaX: */
	index11 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 2;
	viaX = workBuffer[(workBuffer[GWBufferTop]) + index11];
	/* begin bzEndX: */
	index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 4;
	endX = workBuffer[(workBuffer[GWBufferTop]) + index12];
	dx1 = viaX - startX;
	dx2 = endX - viaX;
	if ((dx1 * dx2) >= 0) {
		return index;
...
subdivideToBeMonotonInY(sqInt index)
{
	...
	startY = workBuffer[(workBuffer[GWBufferTop]) + index1];
	/* begin bzViaY: */
	index11 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 3;
	viaY = workBuffer[(workBuffer[GWBufferTop]) + index11];
	/* begin bzEndY: */
	index12 = (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - index) + 5;
	endY = workBuffer[(workBuffer[GWBufferTop]) + index12];
	dy1 = viaY - startY;
	dy2 = endY - viaY;
	if ((dy1 * dy2) >= 0) {
		return index;
...
wbStackPop(sqInt nItems)
{
	...
	/* begin wbTopPut: */
	value = (workBuffer[GWBufferTop]) + nItems;
	workBuffer[GWBufferTop] = value;
	return 0;
}
