/* Automatically generated by
   ...
   from
	BalloonEnginePlugin VMMaker.oscog-eem.2062 uuid: f42af46e-c315-4da9-8a34-aa300763e11c
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.2062 uuid: f42af46e-c315-4da9-8a34-aa300763e11c " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"B2DPlugin VMMaker.oscog-eem.2062 (i)"
#else
	"B2DPlugin VMMaker.oscog-eem.2062 (e)"
#endif
;
...
fillAllFromto(sqInt leftX, sqInt rightX)
{
	...
	if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
		...
		index2 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
...
l5:	/* end topFill */;
	...
	if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
		...
		index3 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
...
l6:	/* end topRightX */;
	while (stopX < rightX) {
		...
		if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
			...
			/* begin stackFillValue: */
			index = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
	...
	l8:	/* end quickRemoveInvalidFillsAt: */;
		...
		if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
			...
			/* begin stackFillRightX: */
			index1 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
	...
	if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
		...
		/* begin stackFillValue: */
		index4 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
...
l10:	/* end aaFirstPixelFrom:to: */;
	...
	cMask = ((sqInt) (workBuffer[GWAAColorMask]));
...
l3:	/* end aaFirstPixelFrom:to: */;
	...
	lastPixel = (rightX - 1) & ((unsigned int)~((workBuffer[GWAALevel]) - 1));
	/* begin aaColorMaskGet */
	colorMask = ((sqInt) (workBuffer[GWAAColorMask]));
	/* begin aaColorShiftGet */
	colorShift = workBuffer[GWAAColorShift];
	while ((x < firstPixel)
	 && ((rampIndex < rampSize)
...
findNextExternalFillFromAET(void)
{
	...
	if (rightX < (workBuffer[GWFillMaxX])) {
		...
		if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
			...
			/* begin stackFillValue: */
			index21 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
	...
	l14:	/* end topFill */;
		...
		if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
			...
			/* begin stackFillRightX: */
			index31 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
	...
	l18:	/* end topRightX */;
		while (stopX1 < (workBuffer[GWFillMaxX])) {
			...
			if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
				...
				/* begin stackFillValue: */
				index5 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
		...
		l17:	/* end quickRemoveInvalidFillsAt: */;
			...
			if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
				...
				/* begin stackFillRightX: */
				index11 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
		...
		if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
			...
			/* begin stackFillValue: */
			index41 = ((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3;
...
initializeGETProcessing(void)
{
	...
	/* begin fillMinXPut: */
	value3 = ((int)((usqInt)((workBuffer[GWClipMinX])) << (workBuffer[GWAAShift])));
	workBuffer[GWFillMinX] = value3;
	/* begin fillMinYPut: */
	value4 = ((int)((usqInt)((workBuffer[GWClipMinY])) << (workBuffer[GWAAShift])));
	workBuffer[GWFillMinY] = value4;
	/* begin fillMaxXPut: */
	value5 = ((int)((usqInt)((workBuffer[GWClipMaxX])) << (workBuffer[GWAAShift])));
	workBuffer[GWFillMaxX] = value5;
	/* begin fillMaxYPut: */
	value6 = ((int)((usqInt)((workBuffer[GWClipMaxY])) << (workBuffer[GWAAShift])));
...
loadCompressedSegmentfromshortleftFillrightFilllineWidthlineColor(sqInt segmentIndex, sqInt points, sqInt pointsShort, sqInt leftFill, sqInt rightFill, sqInt lineWidth, sqInt lineFill)
{
	...
	if (3 > 1) {
		/* begin transformPoint: */
		point11 = ((int *) (((int *) (workBuffer + GWPoint2))));
		if ((workBuffer[GWHasEdgeTransform]) != 0) {
	...
	if (3 > 2) {
		/* begin transformPoint: */
		point21 = ((int *) (((int *) (workBuffer + GWPoint3))));
		if ((workBuffer[GWHasEdgeTransform]) != 0) {
	...
	if (3 > 3) {
		/* begin transformPoint: */
		point31 = ((int *) (((int *) (workBuffer + GWPoint4))));
		if ((workBuffer[GWHasEdgeTransform]) != 0) {
