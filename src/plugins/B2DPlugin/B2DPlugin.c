/* Automatically generated by
   ...
   from
	BalloonEnginePlugin VMMaker.oscog-eem.3419 uuid: 70017fea-1b4a-4603-a657-4d77106c4cf0
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.3419 uuid: 70017fea-1b4a-4603-a657-4d77106c4cf0 " __DATE__ ;
...
static const char *moduleName = "B2DPlugin VMMaker.oscog-eem.3419 " INT_EXT;
	...
	l11:	/* end clampValue:max: */;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			fillValue = uncheckedTransformColor(value1);
	l14:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt)((fillValue & cMask))) >> cShift;
			idx = ((usqInt)(x)) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
	...
	l18:	/* end clampValue:max: */;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			fillValue = uncheckedTransformColor(value2);
	l21:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt)((fillValue & cMask))) >> cShift;
			idx = ((usqInt)(x)) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
...
hideFilldepth(sqInt fillIndex, sqInt depth)
{
	...
	value5 = workBuffer[(workBuffer[GWBufferTop]) + (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3 /* stackFillEntryLength */)];
	...
	value6 = workBuffer[(workBuffer[GWBufferTop]) + ((((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3 /* stackFillEntryLength */) + 1)];
	...
	value7 = workBuffer[(workBuffer[GWBufferTop]) + ((((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) - 3 /* stackFillEntryLength */) + 2)];
...
loadBitmapFillcolormaptilefromalongnormalxIndex(sqInt formOop, sqInt cmOop, sqInt tileFlag, int *point1, int *point2, int *point3, sqInt xIndex)
{
	...
	objBuffer[fill + GBColormapSize] = cmSize;
	bmFill = fill;
	l13:	/* end allocateBitmapFill:colormap: */;
	if (engineStopped) {
		return null;
	}
...
primitiveAddPolygon(void)
{
	...
	l6:	/* end loadArrayPolygon:nPoints:fill:lineWidth:lineFill: */;
	}
	else {
	...
	l19:	/* end loadPolygon:nPoints:fill:lineWidth:lineFill:pointsShort: */;
	}
	if (engineStopped) {
		return primitiveFailFor(GEFEngineStopped);
	}
...
stepToFirstWideLineInat(sqInt line, sqInt yValue)
{
	...
	if (xDir > 0) {
		/* begin wideLineWidthOf:put: */
		value = (objBuffer[line + GLXIncrement]) + lineWidth;
		objBuffer[line + GLWideWidth] = value;
	}
	else {
		/* begin wideLineWidthOf:put: */
		value1 = lineWidth - (objBuffer[line + GLXIncrement]);
		objBuffer[line + GLWideWidth] = value1;
		/* begin edgeXValueOf:put: */
		value2 = (objBuffer[line + GEXValue]) + (objBuffer[line + GLXIncrement]);
	...
	if ((yEntry >= lineOffset)
	 && (yExit < 0)) {
		...
		value5 = ((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) | GEEdgeFillsInvalid;
	...
	if (!(startY == yValue)) {
		for (i = startY; i < yValue; i += 1) {
			...
			if (yEntry1 >= lineOffset1) {
				...
				value6 = ((objBuffer[line + GEObjectType]) & GEPrimitiveTypeMask) & ((unsigned int)~GEEdgeFillsInvalid);
				objBuffer[line + GEObjectType] = value6;
			}
			if (yExit1 >= 0) {
				/* begin edgeFillsInvalidate: */
		...
		/* begin edgeNumLinesOf:put: */
		value3 = (objBuffer[line + GENumLines]) - (yValue - startY);
		objBuffer[line + GENumLines] = value3;
	}
	return 0;
}
