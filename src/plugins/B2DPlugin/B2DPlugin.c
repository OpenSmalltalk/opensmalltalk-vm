/* Automatically generated by
   ...
   from
	BalloonEnginePlugin VMMaker.oscog-eem.2724 uuid: 8312b062-c234-4dbb-bc52-8541f45811bb
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.2724 uuid: 8312b062-c234-4dbb-bc52-8541f45811bb " __DATE__ ;
...
static const char *moduleName = "B2DPlugin VMMaker.oscog-eem.2724 " INT_EXT;
...
stepToFirstBezierInat(sqInt bezier, sqInt yValue)
{
	...
	if (!(((startY = objBuffer[bezier + GEYValue])) == yValue)) {
		...
		while ((minY > lastY)
		 && (fwDy1 >= 0)) {
			lastX += (((usqInt)((fwDx1 + 32768))) >> 16);
			lastY += (((usqInt)((fwDy1 + 32768))) >> 16);
...
stepToNextWideBezierInat(sqInt bezier, sqInt yValue)
{
	...
	while ((minY1 > lastY1)
	 && (fwDy1 >= 0)) {
		lastX1 += (((usqInt)((fwDx1 + 32768))) >> 16);
		lastY1 += (((usqInt)((fwDy1 + 32768))) >> 16);
		fwDx1 += updateData1[GBUpdateDDX];
		fwDy1 += updateData1[GBUpdateDDY];
	}
