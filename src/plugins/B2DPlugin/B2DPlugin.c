/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3461 uuid: a28f832c-aec3-49ea-855b-750565b69a4c
	(Compiler-eem.508)
   from
	BalloonEnginePlugin VMMaker.oscog-eem.3461 uuid: a28f832c-aec3-49ea-855b-750565b69a4c
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.3461 uuid: a28f832c-aec3-49ea-855b-750565b69a4c " __DATE__ ;
...
static const char *moduleName = "B2DPlugin VMMaker.oscog-eem.3461 " INT_EXT;
...
l1:	/* end loadCompressedSegment:fromIntPoints:leftFill:rightFill:lineWidth:lineColor: */;
		if (engineStopped) {
			return null;
		}
	}
...
loadCompressedShapeFromShortPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(short *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList)
{
	...
	for (i = 1; i <= nSegments; i += 1) {
		...
		loadWideBezierlineFillleftFillrightFilln(widthValue, lineFillValue, leftValue, rightValue, segs);
l1:	/* end loadCompressedSegment:fromShortPoints:leftFill:rightFill:lineWidth:lineColor: */;
		if (engineStopped) {
			return null;
		}
	}
...
l2:	/* end loadShapeFromShortPoints:nSegments:fill:lineWidth:lineFill: */;
		}
		else {
			...
			for (i = 1; i <= nSegments; i += 1) {
				...
				loadWideBezierlineFillleftFillrightFilln(lineWidth, lineFill, fillIndex, 0, segs);
l3:	/* end loadCompressedSegment:fromIntPoints:leftFill:rightFill:lineWidth:lineColor: */;
				if (engineStopped) {
					goto l4;
				}
			}
l4:	/* end loadShapeFromIntPoints:nSegments:fill:lineWidth:lineFill: */;
		}
	}
	if (engineStopped) {
		return primitiveFailFor(GEFEngineStopped);
...
l1:	/* end loadPolygonFromArray:nPoints:fill:lineWidth:lineFill: */;
	}
	else {
		if (pointsIsShorts) {
...
l2:	/* end loadPolygonFromShortPoints:nPoints:fill:lineWidth:lineFill: */;
		}
		else {
...
l3:	/* end loadPolygonFromIntPoints:nPoints:fill:lineWidth:lineFill: */;
		}
	}
	if (engineStopped) {
		return primitiveFailFor(GEFEngineStopped);
