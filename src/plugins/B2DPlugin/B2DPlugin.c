/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.2252 uuid: 2f3e9b0e-ecd3-4adf-b092-cce2e2587a5c
   from
	BalloonEnginePlugin VMMaker.oscog-eem.2252 uuid: 2f3e9b0e-ecd3-4adf-b092-cce2e2587a5c
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.2252 uuid: 2f3e9b0e-ecd3-4adf-b092-cce2e2587a5c " __DATE__ ;
...
#else
	"B2DPlugin VMMaker.oscog-eem.2252 (e)"
#endif
;
...
primitiveAddPolygon(void)
{
	...
	l7:	/* end loadArrayPolygon:nPoints:fill:lineWidth:lineFill: */;
		...
		for (i1 = 1; i1 < nPoints; i1 += 1) {
			if (nPoints == length) {
				/* begin loadPointShortAt:from: */
				x12 = ((short) ((((short *) points1))[i1 * 2]));
				/* begin loadPointShortAt:from: */
				y12 = ((short) ((((short *) points1))[(i1 * 2) + 1]));
			}
			else {
				/* begin loadPointIntAt:from: */
