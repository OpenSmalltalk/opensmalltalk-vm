/* Automatically generated by
   ...
   from
	BalloonEnginePlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"B2DPlugin VMMaker.oscog-eem.1809 (i)"
#else
	"B2DPlugin VMMaker.oscog-eem.1809 (e)"
#endif
;
...
bitmapValuebitsatXy(sqInt bmFill, sqInt bits, sqInt xp, sqInt yp)
{
	...
	if (bmDepth == 32) {
		...
		if ((value != 0)
		 && ((value & 0xFF000000ULL) == 0)) {
			value = value | 0xFF000000ULL;
		}
	...
	cMask = (1L << bmDepth) - 1;
	rShift = (32 - bmDepth) - ((xp & ((1L << rShift) - 1)) * bmDepth);
...
l19:	/* end aaFirstPixelFrom:to: */;
	...
	cMask = (((usqInt) (workBuffer[GWAAColorMask])) >> (workBuffer[GWAAShift])) | 4042322160ULL;
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			if (bmDepth1 == 32) {
				...
				if ((value1 != 0)
				 && ((value1 & 0xFF000000ULL) == 0)) {
					value1 = value1 | 0xFF000000ULL;
				}
			...
			/* rShift - shift value to move the pixel in the word to the lowest bit position */
			cMask2 = (1L << bmDepth1) - 1;
			rShift1 = (32 - bmDepth1) - ((xp & ((1L << rShift1) - 1)) * bmDepth1);
			...
			fillValue = uncheckedTransformColor(value1);
		l12:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt) (fillValue & cMask)) >> cShift;
			idx = ((usqInt) x) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
		...
		if ((xp >= 0)
		 ...
		 && (yp < bmHeight)))) {
			...
			if (bmDepth2 == 32) {
				...
				if ((value2 != 0)
				 && ((value2 & 0xFF000000ULL) == 0)) {
					value2 = value2 | 0xFF000000ULL;
				}
			...
			/* rShift - shift value to move the pixel in the word to the lowest bit position */
			cMask3 = (1L << bmDepth2) - 1;
			rShift2 = (32 - bmDepth2) - ((xp & ((1L << rShift2) - 1)) * bmDepth2);
			...
			fillValue = uncheckedTransformColor(value2);
		l18:	/* end bitmapValue:bits:atX:y: */;
			fillValue = ((usqInt) (fillValue & cMask)) >> cShift;
			idx = ((usqInt) x) >> baseShift;
			spanBuffer[idx] = ((spanBuffer[idx]) + fillValue);
		}
...
l1:	/* end aaFirstPixelFrom:to: */;
	...
	if (x < lastPixel) {
		colorMask = (((usqInt) (workBuffer[GWAAColorMask])) >> (workBuffer[GWAAShift])) | 4042322160ULL;
...
findNextExternalFillFromAET(void)
{
	...
	l18:	/* end topRightX */;
		...
		l6:	/* end quickRemoveInvalidFillsAt: */;
			startX1 = stopX1;
			/* begin topRightX */
			if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
				stopX1 = 999999999;
...
loadGradientFillfromalongnormalisRadial(sqInt rampOop, int *point1, int *point2, int *point3, sqInt isRadial)
{
	...
	fill = fill1;
l2:	/* end allocateGradientFill:rampWidth:isRadial: */;
	if (engineStopped) {
		return null;
	}
...
setAALevel(sqInt level)
{
	...
	if (aaLevel == 1) {
		...
		workBuffer[GWAAColorMask] = 0xFFFFFFFFULL;
		workBuffer[GWAAScanMask] = 0;
	}
	if (aaLevel == 2) {
		workBuffer[GWAAShift] = 1;
		workBuffer[GWAAColorMask] = 4244438268ULL;
		workBuffer[GWAAScanMask] = 1;
	}
	if (aaLevel == 4) {
		workBuffer[GWAAShift] = 2;
		workBuffer[GWAAColorMask] = 4042322160ULL;
