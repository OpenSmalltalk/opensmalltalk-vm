/* Smalltalk from Squeak4.4 with VMMaker 4.12.10 translated as C source on 21 December 2013 11:34:54 am */
/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker-dtl.332 uuid: 78ecdbe9-481f-4ef7-b190-13eba921157e
   from
	SocketPlugin VMMaker-dtl.332 uuid: 78ecdbe9-481f-4ef7-b190-13eba921157e
 */
static char __buildInfo[] = "SocketPlugin VMMaker-dtl.332 uuid: 78ecdbe9-481f-4ef7-b190-13eba921157e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SocketPlugin 21 December 2013 (i)"
#else
	"SocketPlugin 21 December 2013 (e)"
#endif
;
...
EXPORT(sqInt) primitiveSocketBindTo(void) {
	...
	/* begin socketValueOf: */
	interpreterProxy->success((interpreterProxy->isBytes(socket)) && ((interpreterProxy->byteSizeOf(socket)) == (socketRecordSize())));
...
EXPORT(sqInt) primitiveSocketAccept(void) {
	...
	/* begin socketValueOf: */
	interpreterProxy->success((interpreterProxy->isBytes(sockHandle)) && ((interpreterProxy->byteSizeOf(sockHandle)) == (socketRecordSize())));
