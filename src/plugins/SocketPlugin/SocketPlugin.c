/* Automatically generated by
   ...
   from
	SocketPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867
 */
static char __buildInfo[] = "SocketPlugin VMMaker.oscog-eem.1809 uuid: ea36b0b1-2bb5-4763-87fc-d5fecda34867 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SocketPlugin VMMaker.oscog-eem.1809 (i)"
#else
	"SocketPlugin VMMaker.oscog-eem.1809 (e)"
#endif
;
...
primitiveResolverStartAddressLookup(void)
{
	...
	addr = (((ptrToByteArray[3]) + ((ptrToByteArray[2]) << 8)) + ((ptrToByteArray[1]) << 16)) + ((ptrToByteArray[0]) << 24);
...
primitiveSocketSendUDPDataBufCount(void)
{
	...
	if (!(failed())) {
		...
		address = (((ptrToByteArray[3]) + ((ptrToByteArray[2]) << 8)) + ((ptrToByteArray[1]) << 16)) + ((ptrToByteArray[0]) << 24);
	l1:	/* end netAddressToInt: */;
