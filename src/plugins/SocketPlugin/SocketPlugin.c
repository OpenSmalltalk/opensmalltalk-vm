/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2823 uuid: c3499cc6-9d5a-4f10-a63e-1420d71368e5
   from
	SocketPlugin VMMaker.oscog-eem.2823 uuid: c3499cc6-9d5a-4f10-a63e-1420d71368e5
 */
static char __buildInfo[] = "SocketPlugin VMMaker.oscog-eem.2823 uuid: c3499cc6-9d5a-4f10-a63e-1420d71368e5 " __DATE__ ;
...
static const char *moduleName = "SocketPlugin VMMaker.oscog-eem.2823 " INT_EXT;
...
#  endif
	...
	hostAddressInteger = ((((((unsigned char *) hostAddress))[3]) + (((usqInt)(((((unsigned char *) hostAddress))[2])) << 8))) + (((usqInt)(((((unsigned char *) hostAddress))[1])) << 16))) + (((usqInt)(((((unsigned char *) hostAddress))[0])) << 24));
	l1:	/* end netAddressToInt: */;
	if (!(failed())) {
