/* Automatically generated by
   ...
   from
	SocketPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b
 */
static char __buildInfo[] = "SocketPlugin VMMaker.oscog-eem.3453 uuid: 6917573f-1029-4681-87bc-5f02f287102b " __DATE__ ;
...
static const char *moduleName = "SocketPlugin VMMaker.oscog-eem.3453 " INT_EXT;
...
primitiveSocketAccept(void)
{
	...
	/* begin socketValueOf: */
	serverSocket = ((isBytes(sockHandle))
	 && ((byteSizeOf(sockHandle)) == (sizeof(SQSocket)))
		? firstIndexableField(sockHandle)
		: (primitiveFailFor(PrimErrBadArgument),
			((SocketPtr) null)));
	if (!(failed())) {
