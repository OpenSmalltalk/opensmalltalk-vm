/* Automatically generated by
   ...
   from
	SHA256Plugin CryptographyPlugins-eem.14 uuid: 54292ff0-b538-43ba-9195-26766c158ba9
 */
static char __buildInfo[] = "SHA256Plugin CryptographyPlugins-eem.14 uuid: 54292ff0-b538-43ba-9195-26766c158ba9 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
static 	"SHA256Plugin CryptographyPlugins-eem.14 (i)";
#else
static 	"SHA256Plugin CryptographyPlugins-eem.14 (e)";
#endif
...
primitiveProcessBufferWithState(void)
{
	...
	for (i2 = 16; i2 <= 0x3F; i2 += 1) {
		s01 = ((((usqInt) (w[i2 - 15])) >> 7) | (((usqInt)((w[i2 - 15])) << (32 - 7)))) ^ (((((usqInt) (w[i2 - 15])) >> 18) | (((usqInt)((w[i2 - 15])) << (32 - 18)))) ^ (((usqInt) (w[i2 - 15])) >> 3));
		s11 = ((((usqInt) (w[i2 - 2])) >> 17) | (((usqInt)((w[i2 - 2])) << (32 - 17)))) ^ (((((usqInt) (w[i2 - 2])) >> 19) | (((usqInt)((w[i2 - 2])) << (32 - 19)))) ^ (((usqInt) (w[i2 - 2])) >> 10));
