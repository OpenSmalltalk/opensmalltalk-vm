/* Automatically generated by
   ...
   from
	JPEGReadWriter2Plugin VMMaker.oscog-eem.3270 uuid: 2ed5e56f-f39f-4da9-9403-c83acc745010
 */
static char __buildInfo[] = "JPEGReadWriter2Plugin VMMaker.oscog-eem.3270 uuid: 2ed5e56f-f39f-4da9-9403-c83acc745010 " __DATE__ ;
...
static const char *moduleName = "JPEGReadWriter2Plugin VMMaker.oscog-eem.3270 " INT_EXT;
...
{
	methodReturnValue(integerObjectOf((sizeof(struct jpeg_compress_struct))));
	return null;
}
...
{
	methodReturnValue(integerObjectOf((sizeof(struct jpeg_decompress_struct))));
	return null;
}
...
{
	methodReturnValue(integerObjectOf((sizeof(struct error_mgr2))));
	return null;
}
