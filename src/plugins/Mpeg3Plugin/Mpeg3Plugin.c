/* Automatically generated by
	SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.2672 uuid: 335f401c-b41b-48dc-b7be-2d33156978af
   from
	Mpeg3Plugin VMMaker.oscog-eem.2672 uuid: 335f401c-b41b-48dc-b7be-2d33156978af
 */
static char __buildInfo[] = "Mpeg3Plugin VMMaker.oscog-eem.2672 uuid: 335f401c-b41b-48dc-b7be-2d33156978af " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
static 	"Mpeg3Plugin VMMaker.oscog-eem.2672 (i)";
#else
static 	"Mpeg3Plugin VMMaker.oscog-eem.2672 (e)";
#endif
...
primitiveMPEG3DropFrames(void)
{
	...
	if (!(failed())) {
		popthenPush(4, integerObjectOf(result));
	}
	return null;
}
...
primitiveMPEG3ReadAudio(void)
{
	...
	if (!(failed())) {
		popthenPush(6, integerObjectOf(result));
	}
	return null;
}
...
primitiveMPEG3ReadFrame(void)
{
	...
	if (!(failed())) {
		popthenPush(12, integerObjectOf(result));
	}
	return null;
}
...
primitiveMPEG3ReadFrameBufferOffset(void)
{
	...
	memoryFree(outputRowsPtr);
	if (!(failed())) {
		popthenPush(13, integerObjectOf(result));
	}
	return null;
}
...
primitiveMPEG3TotalAStreams(void)
{
	...
	if (!(failed())) {
		popthenPush(2, integerObjectOf(result));
	}
	return null;
}
