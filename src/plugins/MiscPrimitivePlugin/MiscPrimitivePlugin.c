...
/* Automatically generated by
   ...
   from
	MiscPrimitivePlugin VMMaker-dtl.379 uuid: 08564677-5e9d-48d5-a63c-b53bd85489f3
 */
static char __buildInfo[] = "MiscPrimitivePlugin VMMaker-dtl.379 uuid: 08564677-5e9d-48d5-a63c-b53bd85489f3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"MiscPrimitivePlugin 27 March 2016 (i)"
#else
	"MiscPrimitivePlugin 27 March 2016 (e)"
#endif
;
...
l5:	/* end encodeInt:in:at: */;
	...
	while (k <= size) {
		word = bm[k];
		lowByte = word & 0xFF;
		eqBytes = (((((usqInt) word) >> 8) & 0xFF) == lowByte) && ((((((usqInt) word) >> 16) & 0xFF) == lowByte) && (((((usqInt) word) >> 24) & 0xFF) == lowByte));
		j = k;
