/* Automatically generated by
   ...
   from
	MiscPrimitivePlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015
 */
static char __buildInfo[] = "MiscPrimitivePlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015 " __DATE__ ;
...
static const char *moduleName = "MiscPrimitivePlugin VMMaker.oscog-eem.2995 " INT_EXT;
...
primitiveCompressToByteArray(void)
{
	...
	for (j7 = 0; j7 <= 3; j7 += 1) {
		ba[(1) + j7] = ((((usqInt)(size)) >> ((3 - j7) * 8)) & 0xFF);
	}
	i = 5;
	...
	l2:	/* end encodeInt:in:at: */;
			...
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (j4 = 0; j4 <= 3; j4 += 1) {
					ba[(i + 1) + j4] = ((((usqInt)((5))) >> ((3 - j4) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
...
primitiveStringHash(void)
{
	...
	byteArrayOop = stackValue(1);
	if (!((isBytes(byteArrayOop))
		 && (isWordsOrBytesNonImm(byteArrayOop)))) {
...
void* MiscPrimitivePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCompareString\000\002\001", (void*)primitiveCompareString},
	{(void*)_m, "primitiveCompressToByteArray\000\377\001", (void*)primitiveCompressToByteArray},
	{(void*)_m, "primitiveConvert8BitSigned\000\002\001", (void*)primitiveConvert8BitSigned},
	{(void*)_m, "primitiveDecompressFromByteArray\000\000\001", (void*)primitiveDecompressFromByteArray},
	{(void*)_m, "primitiveFindFirstInString\000\002\001", (void*)primitiveFindFirstInString},
	{(void*)_m, "primitiveFindSubstring\000\002\001", (void*)primitiveFindSubstring},
	{(void*)_m, "primitiveIndexOfAsciiInString\000\002\001", (void*)primitiveIndexOfAsciiInString},
...
EXPORT(signed short) primitiveCompareStringMetadata = 513;
EXPORT(signed short) primitiveCompressToByteArrayMetadata = -255;
EXPORT(signed short) primitiveConvert8BitSignedMetadata = 513;
EXPORT(signed short) primitiveDecompressFromByteArrayMetadata = 1;
EXPORT(signed short) primitiveFindFirstInStringMetadata = 513;
EXPORT(signed short) primitiveFindSubstringMetadata = 513;
EXPORT(signed short) primitiveIndexOfAsciiInStringMetadata = 513;
