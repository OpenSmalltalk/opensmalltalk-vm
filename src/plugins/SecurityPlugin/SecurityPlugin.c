 ...
 */
static char __buildInfo[] = "SecurityPlugin * VMMaker-dtl.367 uuid: fbd694df-9f36-40b7-bc0b-bfb2bd4b3d38 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SecurityPlugin 21 July 2015 (i)"
#else
	"SecurityPlugin 21 July 2015 (e)"
#endif
;
