/* Automatically generated by
   ...
   from
	InternetConfigPlugin VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a
 */
static char __buildInfo[] = "InternetConfigPlugin VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"InternetConfigPlugin VMMaker.oscog-eem.232 (i)"
#else
	"InternetConfigPlugin VMMaker.oscog-eem.232 (e)"
#endif
;
...
primitiveGetMacintoshFileTypeAndCreatorFrom(void)
{
	...
	keyLength = byteSizeOf(((sqInt)(long)(aFileName) - 4));
...
primitiveGetStringKeyedBy(void)
{
	...
	keyLength = byteSizeOf(((sqInt)(long)(aKey) - 4));
