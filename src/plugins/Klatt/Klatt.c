/* Automatically generated by
   ...
   from
	KlattSynthesizerPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8
 */
static char __buildInfo[] = "KlattSynthesizerPlugin VMMaker.oscog-eem.3444 uuid: 2a902a4a-be82-4097-91a4-28da2fa623c8 " __DATE__ ;
...
static const char *moduleName = "Klatt VMMaker.oscog-eem.3444 " INT_EXT;
static sqInt nmod;
static sqInt nopen;
static sqInt nper;
...
cascadeBranch(float source)
{
	...
	answer1 = (((resonatorA(Rnpc)) * out) + ((resonatorB(Rnpc)) * ((p11 = resonatorP1(Rnpc))))) + ((resonatorC(Rnpc)) * (resonatorP2(Rnpc)));
	resonators[(Rnpc * 5) - 1] = p11;
	resonators[(Rnpc * 5) - 2] = answer1;
	out = answer1;
	/* begin antiResonator:value: */
	answer2 = (((resonatorA(Rtz)) * out) + ((resonatorB(Rtz)) * ((p12 = resonatorP1(Rtz))))) + ((resonatorC(Rtz)) * (resonatorP2(Rtz)));
	resonators[(Rtz * 5) - 1] = p12;
	resonators[(Rtz * 5) - 2] = out;
	out = answer2;
	/* begin resonator:value: */
	/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
	   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
	answer3 = (((resonatorA(Rtpc)) * out) + ((resonatorB(Rtpc)) * ((p13 = resonatorP1(Rtpc))))) + ((resonatorC(Rtpc)) * (resonatorP2(Rtpc)));
	resonators[(Rtpc * 5) - 1] = p13;
	resonators[(Rtpc * 5) - 2] = answer3;
	out = answer3;
	if (cascade >= 8) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer4 = (((resonatorA(R8c)) * out) + ((resonatorB(R8c)) * ((p14 = resonatorP1(R8c))))) + ((resonatorC(R8c)) * (resonatorP2(R8c)));
		resonators[(R8c * 5) - 1] = p14;
		resonators[(R8c * 5) - 2] = answer4;
		out = answer4;
	}
	if (cascade >= 7) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer5 = (((resonatorA(R7c)) * out) + ((resonatorB(R7c)) * ((p15 = resonatorP1(R7c))))) + ((resonatorC(R7c)) * (resonatorP2(R7c)));
		resonators[(R7c * 5) - 1] = p15;
		resonators[(R7c * 5) - 2] = answer5;
		out = answer5;
	}
	if (cascade >= 6) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer6 = (((resonatorA(R6c)) * out) + ((resonatorB(R6c)) * ((p16 = resonatorP1(R6c))))) + ((resonatorC(R6c)) * (resonatorP2(R6c)));
		resonators[(R6c * 5) - 1] = p16;
		resonators[(R6c * 5) - 2] = answer6;
		out = answer6;
	}
	if (cascade >= 5) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer7 = (((resonatorA(R5c)) * out) + ((resonatorB(R5c)) * ((p17 = resonatorP1(R5c))))) + ((resonatorC(R5c)) * (resonatorP2(R5c)));
		resonators[(R5c * 5) - 1] = p17;
		resonators[(R5c * 5) - 2] = answer7;
		out = answer7;
	}
	if (cascade >= 4) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer8 = (((resonatorA(R4c)) * out) + ((resonatorB(R4c)) * ((p18 = resonatorP1(R4c))))) + ((resonatorC(R4c)) * (resonatorP2(R4c)));
		resonators[(R4c * 5) - 1] = p18;
		resonators[(R4c * 5) - 2] = answer8;
		out = answer8;
	}
	if (cascade >= 3) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer9 = (((resonatorA(R3c)) * out) + ((resonatorB(R3c)) * ((p19 = resonatorP1(R3c))))) + ((resonatorC(R3c)) * (resonatorP2(R3c)));
		resonators[(R3c * 5) - 1] = p19;
		resonators[(R3c * 5) - 2] = answer9;
		out = answer9;
	}
	if (cascade >= 2) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer10 = (((resonatorA(R2c)) * out) + ((resonatorB(R2c)) * ((p110 = resonatorP1(R2c))))) + ((resonatorC(R2c)) * (resonatorP2(R2c)));
		resonators[(R2c * 5) - 1] = p110;
		resonators[(R2c * 5) - 2] = answer10;
		out = answer10;
	}
	if (cascade >= 1) {
		/* begin resonator:value: */
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer11 = (((resonatorA(R1c)) * out) + ((resonatorB(R1c)) * ((p111 = resonatorP1(R1c))))) + ((resonatorC(R1c)) * (resonatorP2(R1c)));
		resonators[(R1c * 5) - 1] = p111;
		resonators[(R1c * 5) - 2] = answer11;
		out = answer11;
	}
	return out;
}
		...
		if ((frame[F0]) > 0) {
			...
			if (qzero > 0) {
				...
				while (qb > 0) {
					...
					/* begin qu:phi:cosphi:sinphi:rphid: */
					expuphi2 = exp(ub * phi);
					qb = (expuphi2 * ((((rphid * ((ub * ub) + 1.0)) + ub) * sinphi) - cosphi)) + 1.0;
				}
			}
			else {
				ua = -1;
				...
				while (qa < 0) {
					...
					/* begin qu:phi:cosphi:sinphi:rphid: */
					expuphi4 = exp(ua * phi);
					qa = (expuphi4 * ((((rphid * ((ua * ua) + 1.0)) + ua) * sinphi) - cosphi)) + 1.0;
				}
			}
			while ((ub - ua) > Epsilon) {
				uc = (ub + ua) / 2.0;
				/* begin qu:phi:cosphi:sinphi:rphid: */
				expuphi5 = exp(uc * phi);
				qc = (expuphi5 * ((((rphid * ((uc * uc) + 1.0)) + uc) * sinphi) - cosphi)) + 1.0;
				if (qc > 0) {
					ua = uc;
					qa = qc;
				}
...
primitiveSynthesizeFrameIntoStartingAt(void)
{
	...
	buffer = firstIndexableField(oop1);
	...
	/* begin loadFrom: */
	success((slotSizeOf(rcvr)) == 22);
	if (failed()) {
		return null;
	}
	oop2 = fetchPointerofObject(0, rcvr);
	/* begin checkedFloatPtrOf: */
	success(isWords(oop2));
	if (failed()) {
		resonators = 0;
		goto l3;
	}
	resonators = firstIndexableField(oop2);
	l3:	/* end checkedFloatPtrOf: */;
	pitch = fetchFloatofObject(2, rcvr);
	t0 = fetchIntegerofObject(3, rcvr);
	nper = fetchIntegerofObject(4, rcvr);
	nopen = fetchIntegerofObject(5, rcvr);
	nmod = fetchIntegerofObject(6, rcvr);
	a1 = fetchFloatofObject(7, rcvr);
	a2 = fetchFloatofObject(8, rcvr);
	x1 = fetchFloatofObject(9, rcvr);
	x2 = fetchFloatofObject(10, rcvr);
	b1 = fetchFloatofObject(11, rcvr);
	c1 = fetchFloatofObject(12, rcvr);
	glast = fetchFloatofObject(13, rcvr);
	vlast = fetchFloatofObject(14, rcvr);
	nlast = fetchFloatofObject(15, rcvr);
	periodCount = fetchIntegerofObject(16, rcvr);
	samplesCount = fetchIntegerofObject(17, rcvr);
	seed = fetchIntegerofObject(18, rcvr);
	cascade = fetchIntegerofObject(19, rcvr);
	samplesPerFrame = fetchIntegerofObject(20, rcvr);
	samplingRate = fetchIntegerofObject(21, rcvr);
	if ((failed()) == 0) {
		goto l4;
	}
	else {
	...
	l11:	/* end glottalSource */;
		...
		/* begin antiResonator:value: */
		answer = (((resonatorA(Rnz)) * glotout) + ((resonatorB(Rnz)) * ((p1 = resonatorP1(Rnz))))) + ((resonatorC(Rnz)) * (resonatorP2(Rnz)));
		resonators[(Rnz * 5) - 1] = p1;
		...
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer1 = (((resonatorA(Rnpc)) * out1) + ((resonatorB(Rnpc)) * ((p11 = resonatorP1(Rnpc))))) + ((resonatorC(Rnpc)) * (resonatorP2(Rnpc)));
		resonators[(Rnpc * 5) - 1] = p11;
		resonators[(Rnpc * 5) - 2] = answer1;
		out1 = answer1;
		/* begin antiResonator:value: */
		answer2 = (((resonatorA(Rtz)) * out1) + ((resonatorB(Rtz)) * ((p12 = resonatorP1(Rtz))))) + ((resonatorC(Rtz)) * (resonatorP2(Rtz)));
		resonators[(Rtz * 5) - 1] = p12;
		...
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer3 = (((resonatorA(Rtpc)) * out1) + ((resonatorB(Rtpc)) * ((p13 = resonatorP1(Rtpc))))) + ((resonatorC(Rtpc)) * (resonatorP2(Rtpc)));
		resonators[(Rtpc * 5) - 1] = p13;
		resonators[(Rtpc * 5) - 2] = answer3;
		out1 = answer3;
		if (cascade >= 8) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer4 = (((resonatorA(R8c)) * out1) + ((resonatorB(R8c)) * ((p14 = resonatorP1(R8c))))) + ((resonatorC(R8c)) * (resonatorP2(R8c)));
			resonators[(R8c * 5) - 1] = p14;
			resonators[(R8c * 5) - 2] = answer4;
			out1 = answer4;
		}
		if (cascade >= 7) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer5 = (((resonatorA(R7c)) * out1) + ((resonatorB(R7c)) * ((p15 = resonatorP1(R7c))))) + ((resonatorC(R7c)) * (resonatorP2(R7c)));
			resonators[(R7c * 5) - 1] = p15;
			resonators[(R7c * 5) - 2] = answer5;
			out1 = answer5;
		}
		if (cascade >= 6) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer6 = (((resonatorA(R6c)) * out1) + ((resonatorB(R6c)) * ((p16 = resonatorP1(R6c))))) + ((resonatorC(R6c)) * (resonatorP2(R6c)));
			resonators[(R6c * 5) - 1] = p16;
			resonators[(R6c * 5) - 2] = answer6;
			out1 = answer6;
		}
		if (cascade >= 5) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer7 = (((resonatorA(R5c)) * out1) + ((resonatorB(R5c)) * ((p17 = resonatorP1(R5c))))) + ((resonatorC(R5c)) * (resonatorP2(R5c)));
			resonators[(R5c * 5) - 1] = p17;
			resonators[(R5c * 5) - 2] = answer7;
			out1 = answer7;
		}
		if (cascade >= 4) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer8 = (((resonatorA(R4c)) * out1) + ((resonatorB(R4c)) * ((p18 = resonatorP1(R4c))))) + ((resonatorC(R4c)) * (resonatorP2(R4c)));
			resonators[(R4c * 5) - 1] = p18;
			resonators[(R4c * 5) - 2] = answer8;
			out1 = answer8;
		}
		if (cascade >= 3) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer9 = (((resonatorA(R3c)) * out1) + ((resonatorB(R3c)) * ((p19 = resonatorP1(R3c))))) + ((resonatorC(R3c)) * (resonatorP2(R3c)));
			resonators[(R3c * 5) - 1] = p19;
			resonators[(R3c * 5) - 2] = answer9;
			out1 = answer9;
		}
		if (cascade >= 2) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer10 = (((resonatorA(R2c)) * out1) + ((resonatorB(R2c)) * ((p110 = resonatorP1(R2c))))) + ((resonatorC(R2c)) * (resonatorP2(R2c)));
			resonators[(R2c * 5) - 1] = p110;
			resonators[(R2c * 5) - 2] = answer10;
			out1 = answer10;
		}
		if (cascade >= 1) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer11 = (((resonatorA(R1c)) * out1) + ((resonatorB(R1c)) * ((p111 = resonatorP1(R1c))))) + ((resonatorC(R1c)) * (resonatorP2(R1c)));
			resonators[(R1c * 5) - 1] = p111;
			resonators[(R1c * 5) - 2] = answer11;
			out1 = answer11;
		}
		out = out1;
	l24:	/* end cascadeBranch: */;
		...
		/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
		   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
		answer12 = (((resonatorA(Rout)) * out) + ((resonatorB(Rout)) * ((p112 = resonatorP1(Rout))))) + ((resonatorC(Rout)) * (resonatorP2(Rout)));
