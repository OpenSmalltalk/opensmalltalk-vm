/* Automatically generated by
   ...
   from
	KlattSynthesizerPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9
 */
static char __buildInfo[] = "KlattSynthesizerPlugin VMMaker.oscog-eem.3423 uuid: 83ef643c-2070-48fa-b2a0-8ffa0fdc55e9 " __DATE__ ;
...
static const char *moduleName = "Klatt VMMaker.oscog-eem.3423 " INT_EXT;
static sqInt nmod;
static sqInt nopen;
static sqInt nper;
...
primitiveSynthesizeFrameIntoStartingAt(void)
{
	...
	l39:	/* end glottalSource */;
		...
		if (cascade >= 8) {
			...
			/* (p1 between: -100000 and: 100000) ifFalse: [self halt].
			   (answer between: -100000 and: 100000) ifFalse: [self halt]. */
			answer = (((resonatorA(R8c)) * out1) + ((resonatorB(R8c)) * ((p1 = resonatorP1(R8c))))) + ((resonatorC(R8c)) * (resonatorP2(R8c)));
			resonators[(R8c * 5) - 1] = p1;
			/* begin resonatorP1:put: */
			resonators[(R8c * 5) - 2] = answer;
			out1 = answer;
