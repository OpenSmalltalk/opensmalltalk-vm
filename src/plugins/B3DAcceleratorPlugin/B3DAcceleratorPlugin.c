/* Automatically generated by
   ...
   from
	B3DAcceleratorPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5
 */
static char __buildInfo[] = "B3DAcceleratorPlugin VMMaker.oscog-eem.2950 uuid: dbcba85e-dc26-495f-9ce8-aa01633f6aa5 " __DATE__ ;
...
static const char *moduleName = "B3DAcceleratorPlugin VMMaker.oscog-eem.2950 " INT_EXT;
...
EXPORT(signed char) primitiveAllocateTextureAccessorDepth = 0;
EXPORT(signed char) primitiveClearDepthBufferAccessorDepth = 0;
EXPORT(signed char) primitiveClearViewportAccessorDepth = 0;
EXPORT(signed char) primitiveCompositeTextureAccessorDepth = 0;
EXPORT(signed char) primitiveCreateRendererAccessorDepth = 0;
EXPORT(signed char) primitiveCreateRendererFlagsAccessorDepth = 0;
EXPORT(signed char) primitiveDestroyRendererAccessorDepth = 0;
EXPORT(signed char) primitiveDestroyTextureAccessorDepth = 0;
EXPORT(signed char) primitiveDrawArraysAccessorDepth = 1;
EXPORT(signed char) primitiveDrawElementsAccessorDepth = 1;
EXPORT(signed char) primitiveDrawRangeElementsAccessorDepth = 1;
EXPORT(signed char) primitiveFinishRendererAccessorDepth = 0;
EXPORT(signed char) primitiveFlushRendererAccessorDepth = 0;
EXPORT(signed char) primitiveGetIntPropertyAccessorDepth = 0;
EXPORT(signed char) primitiveGetRendererColorMasksAccessorDepth = 0;
EXPORT(signed char) primitiveGetRendererSurfaceDepthAccessorDepth = 0;
EXPORT(signed char) primitiveGetRendererSurfaceHandleAccessorDepth = 0;
EXPORT(signed char) primitiveGetRendererSurfaceHeightAccessorDepth = 0;
EXPORT(signed char) primitiveGetRendererSurfaceWidthAccessorDepth = 0;
EXPORT(signed char) primitiveIsOverlayRendererAccessorDepth = 0;
EXPORT(signed char) primitiveRenderVertexBufferAccessorDepth = 1;
EXPORT(signed char) primitiveSetBufferRectAccessorDepth = 0;
EXPORT(signed char) primitiveSetFogAccessorDepth = 0;
EXPORT(signed char) primitiveSetIntPropertyAccessorDepth = 0;
EXPORT(signed char) primitiveSetLightsAccessorDepth = 1;
EXPORT(signed char) primitiveSetMaterialAccessorDepth = 0;
EXPORT(signed char) primitiveSetTransformAccessorDepth = 0;
EXPORT(signed char) primitiveSetVerboseLevelAccessorDepth = 0;
EXPORT(signed char) primitiveSetViewportAccessorDepth = 0;
EXPORT(signed char) primitiveSwapRendererBuffersAccessorDepth = 0;
EXPORT(signed char) primitiveTextureByteSexAccessorDepth = 0;
EXPORT(signed char) primitiveTextureDepthAccessorDepth = 0;
EXPORT(signed char) primitiveTextureGetColorMasksAccessorDepth = 0;
EXPORT(signed char) primitiveTextureSurfaceHandleAccessorDepth = 0;
EXPORT(signed char) primitiveTextureUploadAccessorDepth = 2;
