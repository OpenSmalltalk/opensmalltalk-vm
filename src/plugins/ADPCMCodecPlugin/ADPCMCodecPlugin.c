/* Automatically generated by
   ...
   from
	ADPCMCodecPlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554
	ADPCMCodec * Sound-bf.42 uuid: 01b2784a-0ad7-4a6b-a996-3388ab820acd
 */
static char __buildInfo[] = "ADPCMCodecPlugin VMMaker.oscog-eem.1072 uuid: bd9d8dd5-dea0-49da-8be7-cb246f49f554\n\
ADPCMCodec * Sound-bf.42 uuid: 01b2784a-0ad7-4a6b-a996-3388ab820acd " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ADPCMCodecPlugin VMMaker.oscog-eem.1072 (i)"
#else
	"ADPCMCodecPlugin VMMaker.oscog-eem.1072 (e)"
#endif
;
	...
	for (i = 1; i <= count; i += 1) {
		...
		l1:	/* end nextBits:put: */;
			if (i < count) {
				...
				nextSample = samples[sampleIndex + 1];
