/* Automatically generated by
   ...
   from
	ADPCMCodecPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015
	ADPCMCodec * Sound-eem.81 uuid: 43c1e089-1145-4a27-b5b8-f35e872fc99a
 */
static char __buildInfo[] = "ADPCMCodecPlugin VMMaker.oscog-eem.2995 uuid: d5fbffa6-5db7-4c4d-8937-a45036ab3015\n\
ADPCMCodec * Sound-eem.81 uuid: 43c1e089-1145-4a27-b5b8-f35e872fc99a " __DATE__ ;
...
static const char *moduleName = "ADPCMCodecPlugin VMMaker.oscog-eem.2995 " INT_EXT;
...
void* ADPCMCodecPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveDecodeMono\000\001\000", (void*)primitiveDecodeMono},
	{(void*)_m, "primitiveDecodeStereo\000\001\000", (void*)primitiveDecodeStereo},
	{(void*)_m, "primitiveEncodeMono\000\001\000", (void*)primitiveEncodeMono},
	{(void*)_m, "primitiveEncodeStereo\000\000\000", (void*)primitiveEncodeStereo},
...
EXPORT(signed short) primitiveDecodeMonoMetadata = 0x100;
EXPORT(signed short) primitiveDecodeStereoMetadata = 0x100;
EXPORT(signed short) primitiveEncodeMonoMetadata = 0x100;
EXPORT(signed short) primitiveEncodeStereoMetadata = 0;
