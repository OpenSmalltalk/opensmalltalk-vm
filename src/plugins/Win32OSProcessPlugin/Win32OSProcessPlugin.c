/* Automatically generated by
   ...
   from
	Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.73 uuid: 78f4b0c0-0615-44be-81ad-5804b1f8a80c
 */
static char __buildInfo[] = "Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.73 uuid: 78f4b0c0-0615-44be-81ad-5804b1f8a80c " __DATE__ ;
...
static sqInt getCurrentWorkingDirectoryAsType(sqInt classIdentifier);
...
static const char *moduleName = "Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.73 " INT_EXT;
...
/*	Answer a string containing the current working directory. */
	...
	/* Win32OSProcessPlugin>>#getCurrentWorkingDirectoryAsType: */
static sqInt
...
void* Win32OSProcessPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveGetEnvironmentStringsAsBytes\000\377", (void*)primitiveGetEnvironmentStringsAsBytes},
...
EXPORT(signed char) primitiveBufferValuesAtAccessorDepth = 1;
EXPORT(signed char) primitiveCanAccessChildProcessAccessorDepth = 1;
EXPORT(signed char) primitiveCloseHandleAccessorDepth = 1;
EXPORT(signed char) primitiveCommandAccessorDepth = 2;
EXPORT(signed char) primitiveCommandWithInputOutputErrorAccessorDepth = 2;
...
EXPORT(signed char) primitiveGetExitStatusForHandleAccessorDepth = 1;
EXPORT(signed char) primitiveGetStdErrorAccessorDepth = 1;
EXPORT(signed char) primitiveGetStdInputAccessorDepth = 1;
EXPORT(signed char) primitiveGetStdOutputAccessorDepth = 1;
EXPORT(signed char) primitiveLastReadForAccessorDepth = 0;
EXPORT(signed char) primitiveLastReadForStoreInAccessorDepth = 0;
EXPORT(signed char) primitiveMakePipeWithSessionIdentifierAccessorDepth = 1;
EXPORT(signed char) primitiveNextFromSignalingAccessorDepth = 1;
EXPORT(signed char) primitiveSetStdErrAccessorDepth = 1;
EXPORT(signed char) primitiveSetStdInAccessorDepth = 1;
EXPORT(signed char) primitiveSetStdOutAccessorDepth = 1;
EXPORT(signed char) primitiveSetWaitForAnyProcessExitThenSignalSemaphoreWithIndexAccessorDepth = 1;
EXPORT(signed char) primitiveTerminateThreadAccessorDepth = 1;
