/* Automatically generated by
   ...
   from
	Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.81 uuid: 9b4cc8a5-4a9a-4dbb-92f1-f5290a13a66e
 */
static char __buildInfo[] = "Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.81 uuid: 9b4cc8a5-4a9a-4dbb-92f1-f5290a13a66e " __DATE__ ;
...
static const char *moduleName = "Win32OSProcessPlugin VMConstruction-Plugins-OSProcessPlugin.oscog-eem.81 " INT_EXT;
...
primitiveNextFromSignaling(void)
{
	...
	/* Safety net: Remember the identity of the thread which should be active for this
	   semaphore index. */
	hThread = CreateThread(null, 0x400, readCharThread, (&threadArgs), STACK_SIZE_PARAM_IS_A_RESERVATION, (&threadID));
...
primitiveSetWaitForAnyProcessExitThenSignalSemaphoreWithIndex(void)
{
	...
	hThread = CreateThread(null, 0x400, handleAnyChildProc, (&threadArgs), STACK_SIZE_PARAM_IS_A_RESERVATION, (&threadID));
	if (!hThread) {
...
l1:	/* end startHandlerThreadForAny:count:signalingSemaphoreAt: */;
