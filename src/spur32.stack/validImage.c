/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d
	(Compiler-eem.514)
   from
	ImageLeakChecker VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3550 uuid: 926f33f4-b032-41f1-9e05-4e0a41b7cb9d " __DATE__ ;
...
static char * traceSources[] = {
		"?", "m", "i", "enterCritical", "exitCritical", "resume", "signal", "syncsig",
		"suspend", "wait", "yield"
	};
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3550]";
...
bytesInBody(sqInt objOop)
{
	...
	headerNumSlots = byteAt((void *)(objOop + 7));
...
setFormatOfto(sqInt objOop, sqInt format)
{
	...
	longAtput((void *)(objOop),((longAt((void *)(objOop))) & ((unsigned int)~(((sqInt)((usqInt)((formatMask())) << (formatShift())))))) + ((((usqInt)(format) << (formatShift())))));
}
...
{
	longAtput((void *)(objOop),(aBoolean
			? (longAt((void *)(objOop))) | (1U << (pinnedBitShift()))
			: (longAt((void *)(objOop))) & ((unsigned int)~(1U << (pinnedBitShift())))));
}
...
{
	longAtput((void *)(objOop),(aBoolean
			? (longAt((void *)(objOop))) | (1U << (rememberedBitShift()))
			: (longAt((void *)(objOop))) & ((unsigned int)~(1U << (rememberedBitShift())))));
}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (isMarked(obj)) {
		...
		byteAtput((void *)(newObj + (markedBitByteOffset())),(byteAt((void *)(newObj + (markedBitByteOffset())))) | (1U << (markedBitByteShift())));

		/* begin setIsMarkedOf:to: */
		assert(!(isFreeObject(obj)));
		byteAtput((void *)(obj + (markedBitByteOffset())),(byteAt((void *)(obj + (markedBitByteOffset())))) & (0xFF - (1U << (markedBitByteShift()))));
	}
	freeObject(obj);
		...
		if (isFreeObject(objOop)) {
			...
			if ((!((longAt((void *)(objOop))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
				...
				if (classIndicesShouldBeValid
				 ...
				 && (!(isHiddenObj(objOop))))) {
					fprintf(GIV(transcript),
							"object leak in %p invalid class index %p -> classOop ifNil: ['nil'] ifNotNil: ['nilObj'\n",
							objOop,
							classIndex);
					ok = 0;
				}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (((byteAt((void *)(oop + 7))) == (numSlotsMask()))
	 && ((byteAt((void *)((oop - BaseHeaderSize) + 7))) != (numSlotsMask()))) {
		fprintf(GIV(transcript),
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (!delta) {
		if (hasOverflowHeader(objOop)) {
			...
			/* rawNumSlotsOf:put: */
			byteAtput((void *)(objOop + 7),numSlots);
		}
		return 0;
	}
	 ...
	 || ((fetchPointerofObject(ObjStackTopx, stackOrNil)) >= ObjStackLimit)) {
		...
		if (freeOrNewPage) {
			...
			if (GIV(marking)) {
				...
				byteAtput((void *)(freeOrNewPage + (markedBitByteOffset())),(byteAt((void *)(freeOrNewPage + (markedBitByteOffset())))) | (1U << (markedBitByteShift())));
			}
		}
...
{
	return (((usqInt)((longAt((void *)(objOop))))) >> (formatShift())) & (formatMask());
}
...
#  endif
	...
	if (!(byteAt((void *)(obj1 + 7)))) {
		/* rawNumSlotsOf:put: */
		byteAtput((void *)(obj1 + 7),1);
	}
}
...
{
	return (byteAt((void *)(objOop + 7))) == (numSlotsMask());
}
...
isGrey(sqInt objOop)
{
	return ((((usqInt)((longAt((void *)(objOop))))) >> (greyBitShift())) & 1) != 0;
}
...
{
	return ((((usqInt)((longAt((void *)(objOop))))) >> (immutableBitShift())) & 1) != 0;
}
...
{
	return ((byteAt((void *)(objOop + (markedBitByteOffset())))) & (1U << (markedBitByteShift()))) != 0;
}
...
{
	return ((((usqInt)((longAt((void *)(objOop))))) >> (pinnedBitShift())) & 1) != 0;
}
...
{
	return ((((usqInt)((longAt((void *)(objOop))))) >> (rememberedBitShift())) & 1) != 0;
}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (!(isMarked(classObj))) {
		...
		byteAtput((void *)(classObj + (markedBitByteOffset())),(byteAt((void *)(classObj + (markedBitByteOffset())))) | (1U << (markedBitByteShift())));
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	byteAtput((void *)(objOop + (markedBitByteOffset())),(byteAt((void *)(objOop + (markedBitByteOffset())))) | (1U << (markedBitByteShift())));
	format = formatOf(objOop);
	if (isPureBitsFormat(format)) {
		...
		if (scanLargeObject) {
			...
			while (index > 0) {
				...
				if (isNonImmediate(field)) {
					...
					byteAtput((void *)(field + (markedBitByteOffset())),(byteAt((void *)(field + (markedBitByteOffset())))) | (1U << (markedBitByteShift())));
...
l1:;
			...
			while (index > 0) {
				...
				if (isNonImmediate(field)) {
					...
					/* There should be no weaklings on the mark stack. */
					noCheckPushonObjStack(field, objStack1);
					if (((byteAt((void *)(field + 7))) > (traceImmediatelySlotLimit()))
...
numSlotsOf(sqInt objOop)
{
	...
	return (((numSlots = byteAt((void *)(objOop + 7)))) == (numSlotsMask())
			? longAt((void *)(objOop - BaseHeaderSize))
			: numSlots);
}
...
objectStartingAt(sqInt address)
{
	...
	numSlots = byteAt((void *)(address + 7));
	return (numSlots == (numSlotsMask())
...
printEntity(sqInt oop)
{
	...
	/* begin space */
	printChar(' ');
	printHexnpnp(byteAt((void *)(oop + 7)));
	print("/");
...
printHeaderOf(sqInt objOop)
{
	...
	if (hasOverflowHeader(objOop)) {
		print(" hdr16 slotf ");
		printHexnp(byteAt((void *)(objOop + 7)));
		print(" slotc ");
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	return (fieldIndex >= 0)
	 ...
	 || (((formatOf(objOop)) >= (sixtyFourBitIndexableFormat()))
	 && (((formatOf(objOop)) < (firstCompiledMethodFormat()))
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	while (1) {
		...
		bridgeSpan = (byteAt((void *)(bridgehead + 7))
...
l1:
	heapSize = roundUpHeapSize(((dataSize + headroom) + GIV(edenBytes)) + ((headroom > allocationReserve
		? 0
		: allocationReserve)));
	mem = ((usqInt)(allocateMemoryMinimumImageFileHeaderSize(heapSize, minimumMemory, f, headerSize)));
	if (mem) {
