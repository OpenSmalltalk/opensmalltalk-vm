/* Automatically generated by
	...
	(Compiler-eem.526)
   from
	ImageLeakChecker VMMaker.oscog-eem.3690 uuid: b8fa6d9a-c8b4-4de4-9ecb-3bbc0d42fc4c
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3690 uuid: b8fa6d9a-c8b4-4de4-9ecb-3bbc0d42fc4c " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3690]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if ((vmEndianness()) == (imageFloatsBigEndian())) {
		return null;
	}
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	swapFloatWords = (vmEndianness()) != (imageFloatsBigEndian());
	assert(ClassFloatCompactIndex != 0);
