/* Automatically generated by
   ...
   from
	ImageLeakChecker VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3455 uuid: 3fb5350e-7e08-4a76-8b1b-7755e8e0811f " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3455]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	/* begin allObjectsDo: */
	objOop = 0;
	startObject = objectStartingAt(	/* begin startAddressForBridgedHeapEnumeration */
		(GIV(pastSpaceStart) > (((pastSpace()).start))
		? ((pastSpace()).start)
		: (GIV(freeStart) > (((eden()).start))
				? ((eden()).start)
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	l6:	/* end numStrongSlotsOfInephemeral: */;
