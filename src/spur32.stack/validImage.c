/* Automatically generated by
	...
	(* Compiler-eem.512)
   from
	ImageLeakChecker VMMaker.oscog-eem.3491 uuid: ee037a39-d1f3-4ad1-9cb7-336094cf4b51
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3491 uuid: ee037a39-d1f3-4ad1-9cb7-336094cf4b51 " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3491]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	/* begin lastHash: */
	if (!((GIV(lastHash) = seed))) {
		GIV(lastHash) = ((usqInt) 1 /* ioUTCMicrosecondsNow */);
	}
