/* Automatically generated by
	...
	(Compiler-eem.512)
   from
	ImageLeakChecker VMMaker.oscog-eem.3487 uuid: 0cb5e53f-fb06-4acf-87f3-c6ec09b46e4b
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3487 uuid: 0cb5e53f-fb06-4acf-87f3-c6ec09b46e4b " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3487]";
...
forwardto(sqInt obj1, sqInt obj2)
{
	...
	assert(((format >= 0) && (format <= (formatMask()))));
	flag("endianness");
	longAtput(obj1, ((longAt(obj1)) & ((unsigned int)~(((((usqInt)((formatMask())) << (formatShift())))) + (classIndexMask())))) + ((isForwardedObjectClassIndexPun()) + ((((usqInt)(format) << (formatShift()))))));
#  if IMMUTABILITY
