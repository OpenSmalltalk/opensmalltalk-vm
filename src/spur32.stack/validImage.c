/* Automatically generated by
	...
	(Compiler-eem.514)
   from
	ImageLeakChecker VMMaker.oscog-eem.3547 uuid: 9fdd05e7-6928-4a10-a546-c1b12df6ca8a
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3547 uuid: 9fdd05e7-6928-4a10-a546-c1b12df6ca8a " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3547]";
...
checkImageHeaderFromBytesAndSize(char *bytes, sqInt totalSize)
{
	...
	version = long32AtPointer(bytes);
	headerSize = long32AtPointer(bytes + 4);
	dataSize = longAtPointer(bytes + 8);
