...
static NoDbgRegParms usqLong rawOverflowSlotsOf(sqInt objOop);
...
addressAfter(sqInt objOop)
{
	...
	if (numSlots == (numSlotsMask())) {
		...
		numSlots = ((usqLong) (((((usqInt)(((sqInt)((usqInt)((longAt(objOop - BaseHeaderSize))) << 8)))))) >> 8));
	}
...
objectBytesForSlots(sqInt numSlots)
{
	...
	/* Spur64BitMemoryManager>>#rawOverflowSlotsOf: */
static NoDbgRegParms usqLong
rawOverflowSlotsOf(sqInt objOop)
{
	return ((((usqInt)(((sqInt)((usqInt)((longAt(objOop - BaseHeaderSize))) << 8)))))) >> 8;
}
...
forwardto(sqInt obj1, sqInt obj2)
{
	...
	longAtput(obj1, ((longAt(obj1)) & (~(usqIntptr_t)(((((usqInt)((formatMask())) << (formatShift())))) + (classIndexMask())))) + ((isForwardedObjectClassIndexPun()) + ((((usqInt)((forwardedFormat())) << (formatShift()))))));
#  if IMMUTABILITY
...
numSlotsOfAny(sqInt objOop)
{
	...
	if (numSlots == (numSlotsMask())) {
		/* begin rawOverflowSlotsOf: */
		return ((usqLong) (((((usqInt)(((sqInt)((usqInt)((longAt(objOop - BaseHeaderSize))) << 8)))))) >> 8));
	}
	else {
		return numSlots;
	}
