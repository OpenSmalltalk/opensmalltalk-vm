/* Automatically generated by
   ...
   from
	ImageLeakChecker VMMaker.oscog-eem.3061 uuid: f660358c-9f5e-474e-8a1d-c41b4226a48c
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3061 uuid: f660358c-9f5e-474e-8a1d-c41b4226a48c " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3061]";
...
/*	Object parsing.
	...
	and is in new space, then it slot size can be zeroed and its overflow
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	newSpaceStartnewSpaceBytessurvivorBytes(GIV(newSpaceStart), GIV(oldSpaceStart) - GIV(newSpaceStart), ((GIV(oldSpaceStart) - GIV(newSpaceStart)) - reserve) / 7 /* scavengerDenominator */);
	GIV(freeStart) = ((eden()).start);
	GIV(pastSpaceStart) = ((pastSpace()).start);
