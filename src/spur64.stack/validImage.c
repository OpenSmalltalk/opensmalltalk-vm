/* Automatically generated by
   ...
   from
	ImageLeakChecker VMMaker.oscog-eem.3072 uuid: 11a316ba-c087-4847-85b0-5aa2626e4155
 */
static char __buildInfo[] = "ImageLeakChecker VMMaker.oscog-eem.3072 uuid: 11a316ba-c087-4847-85b0-5aa2626e4155 " __DATE__ ;
...
const char *interpreterVersion = "Open Smalltalk ImageChecker VM [ImageLeakChecker VMMaker.oscog-eem.3072]";
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (!(addressCouldBeObj(oop))) {
		return (print(((oop & ((allocationUnit()) - 1)) != 0
					? " is misaligned"
					: whereIs(oop))),
			/* begin cr */
			(GIV(verbose)
