...
allocateSlotsInOldSpacebytesformatclassIndex(sqInt numSlots, usqInt totalBytes, sqInt formatField, sqInt classIndex)
{
	...
	if (numSlots >= (numSlotsMask())) {
		longAtput((void *)(chunk),numSlots + ((((usqInt)((numSlotsMask())) << (numSlotsFullShift())))));
		longAtput((void *)(chunk + BaseHeaderSize),((((((usqLong) (numSlotsMask()))) << (numSlotsFullShift()))) + ((((usqInt)(formatField) << (formatShift()))))) + classIndex);
		checkFreeSpaceignoring(GCModeNewSpace, chunk + BaseHeaderSize);
		return chunk + BaseHeaderSize;
	}

	/* for header parsing we put a saturated slot count in the prepended overflow size word */
	longAtput((void *)(chunk),((((((usqLong) numSlots)) << (numSlotsFullShift()))) + ((((usqInt)(formatField) << (formatShift()))))) + classIndex);
...
setFormatOfto(sqInt objOop, sqInt format)
{
	...
	longAtput((void *)(objOop),((longAt((void *)(objOop))) & (~(usqIntptr_t)(((sqInt)((usqInt)((formatMask())) << (formatShift())))))) + ((((usqInt)(format) << (formatShift())))));
}
...
setIsPinnedOfto(sqInt objOop, sqInt aBoolean)
{
	longAtput((void *)(objOop),(aBoolean
			...
			: (longAt((void *)(objOop))) & (~(usqIntptr_t)(1U << (pinnedBitShift())))));
}
...
setIsRememberedOfto(sqInt objOop, sqInt aBoolean)
{
	longAtput((void *)(objOop),(aBoolean
			...
			: (longAt((void *)(objOop))) & (~(usqIntptr_t)(1U << (rememberedBitShift())))));
}
