...
forwardto(sqInt obj1, sqInt obj2)
{
	...
	longAtput(obj1, ((longAt(obj1)) & (~(usqIntptr_t)((((sqInt)((usqInt)((formatMask())) << (formatShift())))) + (classIndexMask())))) + ((isForwardedObjectClassIndexPun()) + (((sqInt)((usqInt)((forwardedFormat())) << (formatShift()))))));
#  if IMMUTABILITY
...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	for (i = 0, iLimiT = ((numFreeLists()) - 1); i <= iLimiT; i += 1) {
		...
		if (((i + 1) % (((usqInt)(32)) >> (logBytesPerOop()))) == 0) {
			cr();
		}
		else {
			print("  ");
...
bailOutOfImageLoad(sqInt rawVersion)
{
	...
	printNum(68021 /* begin imageFormatVersion */);
...
{
	return (imageFormatVersionFromSnapshot(imageVersion)) == 68021 /* begin imageFormatVersion */;
}
