/* Smalltalk from Squeak4.5 with VMMaker 4.13.1 translated as C source on 27 January 2014 3:24:10 pm */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.339 uuid: e3da01c0-18c5-4297-9fc2-3fc56d5db9d6
   from
	Interpreter VMMaker-dtl.339 uuid: e3da01c0-18c5-4297-9fc2-3fc56d5db9d6
 */
static char __buildInfo[] = "Interpreter VMMaker-dtl.339 uuid: e3da01c0-18c5-4297-9fc2-3fc56d5db9d6 " __DATE__ ;
...
#define InterpreterSourceVersion "4.13.1"
...
sqInt instanceSizeOf(sqInt classObj) {
	...
	assert(((classObj & 3) == 0) && (((((usqInt)classObj)) >= memory) && (((((usqInt)classObj)) < foo->freeBlock) && (((longAt(classObj)) & TypeMask) != HeaderTypeGC))));
...
l7:	/* end firstAccessibleObject */;
	...
	resultArray = instantiateClassindexableSize(fetchPointerofObject(ClassArray, foo->specialObjectsOop), count);
	if (resultArray == null) {
...
l8:	/* end firstAccessibleObject */;
	...
	/* begin push: */
	longAtput((sp = foo->stackPointer + (BYTES_PER_WORD)), resultArray);
	foo->stackPointer = sp;
}
...
sqInt primitiveErrorTable(void) {
	...
	/* begin fetchPointer:ofObject: */
	oop = foo->specialObjectsOop;
	return longAt((oop + (BASE_HEADER_SIZE)) + (PrimErrTableIndex << (SHIFT_FOR_WORD)));
}
