/* Smalltalk from Squeak4.3 with VMMaker 4.12.7 translated as C source on 19 October 2013 3:01:01 pm */
...
sqInt extraVMMemory;
const char *interpreterVersion = "Squeak4.3 of 22 June 2013 [latest update: #12810]";
