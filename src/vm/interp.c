/* Smalltalk from Squeak4.5 with VMMaker 4.15.6 translated as C source on 1 May 2016 10:11:47 am */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.382 uuid: c8058d87-c626-4cc5-ad9f-8469e42cd043
   from
	ContextInterpreter VMMaker-dtl.382 uuid: c8058d87-c626-4cc5-ad9f-8469e42cd043
 */
static char __buildInfo[] = "ContextInterpreter VMMaker-dtl.382 uuid: c8058d87-c626-4cc5-ad9f-8469e42cd043 " __DATE__ ;
...
#define InterpreterSourceVersion "4.15.6"
...
#pragma export off
void primitiveAdoptInstance(void);
#pragma export on
...
void primitiveArrayBecomeOneWayCopyHash(void);
...
void primitiveBehaviorHash(void);
...
void primitiveCalloutToFFI(void);
void primitiveChangeClass(void);
#pragma export on
EXPORT(sqInt) primitiveChangeClassWithClass(void);
#pragma export off
void primitiveClass(void);
void primitiveClipboardText(void);
...
void primitiveEnterCriticalSection(void);
...
void primitiveExitCriticalSection(void);
...
void primitiveFindHandlerContext(void);
void primitiveFindNextUnwindContext(void);
...
void primitiveFlushExternalPrimitives(void);
void primitiveForceDisplayUpdate(void);
#pragma export on
EXPORT(sqInt) primitiveForceTenure(void);
#pragma export off
void primitiveFormPrint(void);
void primitiveFractionalPart(void);
void primitiveFullGC(void);
void primitiveGetAttribute(void);
void primitiveGetNextEvent(void);
...
void primitiveInputSemaphore(void);
void primitiveInputWord(void);
void primitiveInstVarAt(void);
void primitiveInstVarAtPut(void);
void primitiveIntegerAt(void);
void primitiveIntegerAtPut(void);
#pragma export on
...
#pragma export off
void primitiveListBuiltinModule(void);
void primitiveListExternalModule(void);
void primitiveLoadImageSegment(void);
void primitiveLoadInstVar(void);
#pragma export on
EXPORT(void) primitiveLocalMicrosecondClock(void);
#pragma export off
void primitiveLogN(void);
void primitiveLowSpaceSemaphore(void);
void primitiveMakePoint(void);
void primitiveMarkHandlerMethod(void);
void primitiveMarkUnwindMethod(void);
void primitiveMaxIdentityHash(void);
...
#pragma export off
void primitiveRelinquishProcessor(void);
#pragma export on
...
#pragma export off
void primitiveScanCharacters(void);
#pragma export on
...
#pragma export off
void primitiveSetIdentityHash(void);
void primitiveSetInterruptKey(void);
void primitiveShortAt(void);
void primitiveShortAtPut(void);
...
void primitiveSnapshot(void);
void primitiveSnapshotEmbedded(void);
...
void primitiveTestAndSetOwnershipOfCriticalSection(void);
void primitiveTestDisplayDepth(void);
#pragma export on
...
#pragma export on
EXPORT(void) primitiveUTCMicrosecondClock(void);
#pragma export off
void primitiveUnloadModule(void);
#pragma export on
EXPORT(sqInt) primitiveUtcWithOffset(void);
#pragma export off
void primitiveVMParameter(void);
void primitiveVMPath(void);
#pragma export on
...
sqInt isContext(sqInt oop) {
	return ((oop & 1) == 0) && ((((((usqInt) (longAt(oop))) >> 12) & 0x1F) == 13) || ((((((usqInt) (longAt(oop))) >> 12) & 0x1F) == 14) || (((((usqInt) (longAt(oop))) >> 12) & 0x1F) == 4)));
}
...
void primitiveFloatAdd(void) {
register struct foo * foo = &fum;
	primitiveFloatAddtoArg(longAt(foo->stackPointer - (1 * (BYTES_PER_WORD))), longAt(foo->stackPointer)); return;
}
...
void primitiveFloatSubtract(void) {
register struct foo * foo = &fum;
	primitiveFloatSubtractfromArg(longAt(foo->stackPointer - (1 * (BYTES_PER_WORD))), longAt(foo->stackPointer)); return;
}
...
register struct foo * foo = &fum;
	...
	if (!(isContext(longAt((proc + (BASE_HEADER_SIZE)) + (SuspendedContextIndex << (SHIFT_FOR_WORD)))))) {
		/* begin primitiveFail */
		if (foo->primFailCode == 0) {
			foo->primFailCode = 1;
		}
	...
	if (!foo->primFailCode) {
		...
		newPriority = ((longAt((proc + (BASE_HEADER_SIZE)) + (PriorityIndex << (SHIFT_FOR_WORD)))) >> 1);
		if (newPriority > activePriority) {
			...
			/* begin putToSleep: */
			priority1 = ((longAt((proc + (BASE_HEADER_SIZE)) + (PriorityIndex << (SHIFT_FOR_WORD)))) >> 1);
			/* begin fetchPointer:ofObject: */
			/* begin fetchPointer:ofObject: */
			...
			addLastLinktoList(proc, processList1);
		}
	}
}
