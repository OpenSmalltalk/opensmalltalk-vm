/* Smalltalk from Squeak4.5 with VMMaker 4.13.3 translated as C source on 23 February 2014 10:38:59 am */
/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker-dtl.342 uuid: b96b3f58-94e9-45e0-a1b5-833b62ca2284
   from
	Interpreter VMMaker-dtl.342 uuid: b96b3f58-94e9-45e0-a1b5-833b62ca2284
 */
static char __buildInfo[] = "Interpreter VMMaker-dtl.342 uuid: b96b3f58-94e9-45e0-a1b5-833b62ca2284 " __DATE__ ;
...
#define InterpreterSourceVersion "4.13.3"
...
sqInt adjustFieldsAndClassOfby(sqInt oop, sqInt offsetBytes);
sqInt allButTypeMask(void);
...
sqInt assertClassOfis(sqInt oop, sqInt classOop);
...
sqInt isClassOfNonImmequalTocompactClassIndex(sqInt oop, sqInt classOop, sqInt compactClassIndex);
...
sqInt lastPointerWhileForwarding(sqInt oop);
sqInt lengthOf(sqInt oop);
sqInt lengthOfbaseHeaderformat(sqInt oop, sqInt hdr, sqInt fmt);
...
sqInt objectAfterWhileForwarding(sqInt oop);
...
sqInt remapClassOf(sqInt oop);
sqInt remapFieldsAndClassOf(sqInt oop);
sqInt removeFirstLinkOfList(sqInt aList);
#pragma export on
EXPORT(sqInt) removeGCRoot(sqInt *varLoc);
#pragma export off
sqInt restoreHeaderOf(sqInt oop);
sqInt restoreHeadersAfterBecomingwith(sqInt list1, sqInt list2);
sqInt restoreHeadersAfterForwardBecome(sqInt copyHashFlag);
...
sqInt setSizeOfFreeto(sqInt chunk, sqInt byteSize);
...
sqInt sizeBitsOfSafe(sqInt oop);
sqInt sizeMask(void);
...
sqInt extraVMMemory;
const char *interpreterVersion = "Squeak4.5 of 12 January 2014 [latest update: #13621]";
...
sqInt adjustFieldsAndClassOfby(sqInt oop, sqInt offsetBytes) {
	...
	if (((longAt(oop)) & TypeMask) != HeaderTypeShort) {
		...
		newClassOop = (classHeader & (ALL_BUT_TYPE_MASK)) + offsetBytes;
...
register struct foo * foo = &fum;
	...
	setSizeOfFreeto(foo->freeBlock, newFreeSize);
...
sqInt asciiOfCharacter(sqInt characterObj) {
register struct foo * foo = &fum;
	assertClassOfis(characterObj, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassCharacter << (SHIFT_FOR_WORD))));
	if (!foo->primFailCode) {
...
sqInt byteLengthOf(sqInt oop) {
	...
	if (fmt < 8) {
		...
		return (sz - (BASE_HEADER_SIZE)) - (fmt & 3);
	}
}
...
sqInt byteSizeOf(sqInt oop) {
	...
	/* begin lengthOf: */
	header = longAt(oop);
	slots = lengthOfbaseHeaderformat(oop, header, (((usqInt) header) >> 8) & 15);
l1:	/* end slotSizeOf: */;
...
register struct foo * foo = &fum;
	...
	flag("Dan");
	assertClassOfis(oop, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassFloat << (SHIFT_FOR_WORD))));
	if (!foo->primFailCode) {
		;
...
register struct foo * foo = &fum;
	...
	setSizeOfFreeto(foo->freeBlock, BASE_HEADER_SIZE);
	...
	setSizeOfFreeto(foo->endOfMemory, BASE_HEADER_SIZE);
...
register struct foo * foo = &fum;
	...
	setSizeOfFreeto(foo->freeBlock, foo->endOfMemory - firstFree);
	setSizeOfFreeto(foo->endOfMemory, BASE_HEADER_SIZE);
	if (DoAssertionChecks) {
...
register struct foo * foo = &fum;
	...
	newObj1 = allocateChunk(byteSize + ((hdrSize - 1) * (BYTES_PER_WORD)));
	if (hdrSize > 1) {
		/* begin popRemappableOop */
		oop = foo->remapBuffer[foo->remapBufferCount];
		foo->remapBufferCount -= 1;
...
register struct foo * foo = &fum;
	...
	newObj = allocateChunk(sizeInBytes + ((hdrSize - 1) * (BYTES_PER_WORD)));
	if (hdrSize > 1) {
		/* begin popRemappableOop */
		oop = foo->remapBuffer[foo->remapBufferCount];
		foo->remapBufferCount -= 1;
...
;
		...
		case 32:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((32 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 33:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((33 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 34:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((34 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 35:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((35 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 36:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((36 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 37:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((37 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 38:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((38 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 39:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((39 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 40:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((40 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 41:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((41 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 42:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((42 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 43:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((43 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 44:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((44 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 45:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((45 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 46:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((46 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 47:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((47 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 48:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((48 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 49:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((49 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 50:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((50 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 51:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((51 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 52:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((52 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 53:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((53 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 54:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((54 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 55:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((55 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 56:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((56 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 57:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((57 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 58:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((58 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 59:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((59 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 60:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((60 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 61:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((61 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 62:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((62 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 63:
			/* pushLiteralConstantBytecode */
			{
				...
				/* begin pushLiteralConstant: */
				/* begin internalPush: */
				object = longAt((foo->method + (BASE_HEADER_SIZE)) + (((63 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
			break;
		case 64:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((64 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		case 65:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((65 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 66:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((66 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 67:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((67 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 68:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((68 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 69:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((69 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 70:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((70 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 71:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((71 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 72:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((72 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 73:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((73 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 74:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((74 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 75:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((75 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 76:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((76 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 77:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((77 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 78:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((78 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 79:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((79 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 80:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((80 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 81:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((81 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 82:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((82 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 83:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((83 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 84:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((84 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 85:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((85 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 86:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((86 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 87:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((87 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 88:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((88 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 89:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((89 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 90:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((90 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 91:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((91 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 92:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((92 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 93:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((93 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 94:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((94 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
		...
		case 95:
			/* pushLiteralVariableBytecode */
			{
				...
				/* begin internalPush: */
				/* begin fetchPointer:ofObject: */
				oop = longAt((foo->method + (BASE_HEADER_SIZE)) + (((95 & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
				object = longAt((oop + (BASE_HEADER_SIZE)) + (ValueIndex << (SHIFT_FOR_WORD)));
				longAtPointerput((localSP += BYTES_PER_WORD), object);
			}
;
...
;
		...
		case 131:
			/* singleExtendedSendBytecode */
			{
				sqInt descriptor;
				descriptor = byteAtPointer(++localIP);
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((descriptor & 31) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		normalSend:
			/* normalSend */
			{
				...
				foo->lkupClass = fetchClassOf(rcvr);
...
;
		...
		commonSend:
			/* commonSend */
			{
				...
				ok = 0;
			l38:	/* end lookupInMethodCacheSel:class: */;
				if (!(ok)) {
			...
			l39:	/* end internalExecuteNewMethod */;
				/* begin fetchNextBytecode */
				currentBytecode = byteAtPointer(++localIP);
			}
;
...
;
		...
		commonSupersend:
			/* superclassSend */
			{
				...
				rcvr = longAtPointer(localSP - (foo->argumentCount * (BYTES_PER_WORD)));
				foo->receiverClass = fetchClassOf(rcvr);
				goto commonSend;
			}
;
			break;
		case 134:
			/* secondExtendedSendBytecode */
			{
				sqInt descriptor;
				descriptor = byteAtPointer(++localIP);
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((descriptor & 63) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		case 201:
			/* bytecodePrimValue */
			{
				...
				foo->primFailCode = 0;
				if ((maybeBlock & 1) == 0) {
					rcvrClass = fetchClassOfNonInt(maybeBlock);
...
;
		...
		case 206:
			/* bytecodePrimPointX */
			{
				...
				foo->primFailCode = 0;
				rcvr = longAtPointer(localSP);
				assertClassOfis(rcvr, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassPoint << (SHIFT_FOR_WORD))));
				if (!foo->primFailCode) {
					/* begin internalPop:thenPush: */
...
;
		...
		case 248:
			/* sendLiteralSelectorBytecode */
			{
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((248 & 15) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		case 252:
			/* sendLiteralSelectorBytecode */
			{
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((252 & 15) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		case 254:
			/* sendLiteralSelectorBytecode */
			{
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((254 & 15) + LiteralStart) << (SHIFT_FOR_WORD)));
...
;
		...
		case 255:
			/* sendLiteralSelectorBytecode */
			{
				foo->messageSelector = longAt((foo->method + (BASE_HEADER_SIZE)) + (((255 & 15) + LiteralStart) << (SHIFT_FOR_WORD)));
...
register struct foo * foo = &fum;
	...
	ok = isClassOfNonImmequalTocompactClassIndex(oop, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassLargePositiveInteger << (SHIFT_FOR_WORD))), ClassLargePositiveIntegerCompactIndex);
	if (ok) {
		return 0;
	}
	ok = isClassOfNonImmequalTocompactClassIndex(oop, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassLargeNegativeInteger << (SHIFT_FOR_WORD))), ClassLargeNegativeIntegerCompactIndex);
	if (ok) {
		return 1;
	}
	/* begin primitiveFail */
...
sqInt lengthOf(sqInt oop) {
	...
	header = longAt(oop);
	return lengthOfbaseHeaderformat(oop, header, (((usqInt) header) >> 8) & 15);
}
...
register struct foo * foo = &fum;
	...
	/* begin lengthOf: */
	header = longAt(oop);
	sz = lengthOfbaseHeaderformat(oop, header, (((usqInt) header) >> 8) & 15);
	if (sz > (sizeof(sqLong))) {
		/* begin primitiveFail */
		if (foo->primFailCode == 0) {
			foo->primFailCode = 1;
...
register struct foo * foo = &fum;
	...
	foo->field = oop + lastFieldOffset;
	action = StartField;
	foo->youngStartLocal = foo->youngStart;
...
register struct foo * foo = &fum;
	...
	foo->stackPointer -= BYTES_PER_WORD;
	top = top1;
	assertClassOfis(top, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassFloat << (SHIFT_FOR_WORD))));
	if (!foo->primFailCode) {
		;
...
register struct foo * foo = &fum;
	...
	assertClassOfis(oop, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassLargePositiveInteger << (SHIFT_FOR_WORD))));
	if (!foo->primFailCode) {
		/* begin lengthOf: */
		header = longAt(oop);
		sz = lengthOfbaseHeaderformat(oop, header, (((usqInt) header) >> 8) & 15);
...
register struct foo * foo = &fum;
	...
	/* begin fetchWordLengthOf: */
	sz = sizeBitsOf(argumentArray);
	arraySize = ((usqInt) (sz - (BASE_HEADER_SIZE))) >> (SHIFT_FOR_WORD);
	/* begin fetchWordLengthOf: */
	sz1 = sizeBitsOf(foo->activeContext);
...
l2:	/* end stackObjectValue: */;
	...
	/* begin lengthOf: */
	header = longAt(rcvr);
	length = lengthOfbaseHeaderformat(rcvr, header, (((usqInt) header) >> 8) & 15);
...
l1:	/* end checkedIntegerValueOf: */;
	...
	if (moduleName == foo->nilObj) {
		...
		moduleLength = lengthOfbaseHeaderformat(moduleName, header, (((usqInt) header) >> 8) & 15);
		;
	}
	...
	functionLength = lengthOfbaseHeaderformat(functionName, header1, (((usqInt) header1) >> 8) & 15);
	if (!(!foo->primFailCode)) {
		return;
	}
...
register struct foo * foo = &fum;
	...
	if (foo->argumentCount == 1) {
		...
		s = longAt(foo->stackPointer);
		assertClassOfis(s, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassString << (SHIFT_FOR_WORD))));
		if (!foo->primFailCode) {
			sz = stSizeOf(s);
...
l1:	/* end stackIntegerValue: */;
	...
	/* begin lengthOf: */
	header = longAt(rcvr);
	sz = lengthOfbaseHeaderformat(rcvr, header, (((usqInt) header) >> 8) & 15);
	/* begin success: */
...
register struct foo * foo = &fum;
	...
	lookupClass = fetchClassOf(newReceiver);
...
register struct foo * foo = &fum;
	...
	if (format < 8) {
		...
		spaceOkay = sufficientSpaceToAllocate(2500 + (0 * (BYTES_PER_WORD)));
		goto l1;
	} else {
		...
		spaceOkay = sufficientSpaceToAllocate(2500 + 0);
		goto l1;
	}
...
# endif  // SQ_IMAGE64 && SQ_HOST64
	...
	if (!foo->primFailCode) {
		...
		if (format < 8) {
			...
			spaceOkay = sufficientSpaceToAllocate(2500 + (size * (BYTES_PER_WORD)));
			goto l1;
		} else {
			...
			spaceOkay = sufficientSpaceToAllocate(2500 + size);
			goto l1;
		}
	l1:	/* end sufficientSpaceToInstantiate:indexableSize: */;
		/* begin success: */
...
register struct foo * foo = &fum;
	...
	/* begin instanceAfter: */
	classPointer = fetchClassOf(object);
	/* begin accessibleObjectAfter: */
	obj1 = objectAfter(object);
	while ((((usqInt) obj1)) < (((usqInt) foo->endOfMemory))) {
		if (!(((longAt(obj1)) & TypeMask) == HeaderTypeFree)) {
			thisObj = obj1;
			goto l3;
...
register struct foo * foo = &fum;
	...
	rcvr = longAt(foo->stackPointer - (3 * (BYTES_PER_WORD)));
	currentClass = fetchClassOf(rcvr);
...
register struct foo * foo = &fum;
	...
	assertClassOfis(sema, longAt((foo->specialObjectsOop + (BASE_HEADER_SIZE)) + (ClassSemaphore << (SHIFT_FOR_WORD))));
	if (!foo->primFailCode) {
		synchronousSignal(sema);
	}
}
...
register struct foo * foo = &fum;
	...
	if (foo->argumentCount == 0) {
		...
		longAtput((result + (BASE_HEADER_SIZE)) + (31 << (SHIFT_FOR_WORD)), ((foo->statShrinkMemory << 1) | 1));
		/* begin storePointer:ofObject:withValue: */
		if ((((usqInt) result)) < (((usqInt) foo->youngStart))) {
...
register struct foo * foo = &fum;
	...
	if (((classOop & 1) == 0) && (((longAt(classOop)) & (MARK_BIT)) != 0)) {
		fwdBlock = ((longAt(classOop)) & (ALL_BUT_MARK_BIT_AND_TYPE_MASK)) << 1;
		if (DoAssertionChecks) {
			/* begin fwdBlockValidate: */
			if (!(((((usqInt) fwdBlock)) > (((usqInt) foo->endOfMemory))) && (((((usqInt) fwdBlock)) <= (((usqInt) foo->fwdTableNext))) && ((fwdBlock & 3) == 0)))) {
				error("invalid fwd table entry");
...
sqInt restoreHeadersAfterBecomingwith(sqInt list1, sqInt list2) {
	...
	if (fmt <= 4) {
		if ((fmt == 3) && ((((((usqInt) header) >> 12) & 31) == 13) || ((((((usqInt) header) >> 12) & 31) == 14) || (((((usqInt) header) >> 12) & 31) == 4)))) {
			/* begin fetchStackPointerOf: */
			sp = longAt((list1 + (BASE_HEADER_SIZE)) + (StackPointerIndex << (SHIFT_FOR_WORD)));
			if (!((sp & 1))) {
				contextSize = 0;
				goto l1;
			}
	...
	methodHeader = longAt(list1 + (BASE_HEADER_SIZE));
	fieldOffset = (((((usqInt) methodHeader) >> 10) & 255) * (BYTES_PER_WORD)) + (BASE_HEADER_SIZE);
l2:	/* end lastPointerOf: */;
	while (fieldOffset >= (BASE_HEADER_SIZE)) {
...
register struct foo * foo = &fum;
	...
	while ((((usqInt) fwdBlock)) <= (((usqInt) foo->fwdTableNext))) {
		...
		oop1 = longAt(fwdBlock + ((BYTES_PER_WORD) * 2));
...
register struct foo * foo = &fum;
	...
	foo->lkupClass = fetchClassOfNonInt(foo->receiver);
...
sqInt setSizeOfFreeto(sqInt chunk, sqInt byteSize) {
	longAtput(chunk, (byteSize & (ALL_BUT_TYPE_MASK)) | HeaderTypeFree);
}
...
sqInt shortentoIndexableSize(sqInt obj, sqInt nSlots) {
	...
	hdr = longAt(obj);
	fmt = (((usqInt) hdr) >> 8) & 15;
	totalLength = lengthOfbaseHeaderformat(obj, hdr, fmt);
	/* begin fixedFieldsOf:format:length: */
	if ((fmt > 4) || (fmt == 2)) {
		fixedFields = 0;
		goto l1;
...
l1:	/* end fixedFieldsOf:format:length: */;
	...
	setSizeOfFreeto((obj + (BASE_HEADER_SIZE)) + (desiredLength * (BYTES_PER_WORD)), deltaBytes);
...
sqInt sizeBitsOfSafe(sqInt oop) {
	...
	header = longAt(oop);
	/* begin rightType: */
	if ((header & (SIZE_MASK)) == 0) {
		type = HeaderTypeSizeAndClass;
		goto l1;
	} else {
		if ((header & CompactClassMask) == 0) {
...
l1:	/* end rightType: */;
	if (type == HeaderTypeSizeAndClass) {
		return (longAt(oop - ((BYTES_PER_WORD) * 2))) & (ALL_BUT_TYPE_MASK);
	} else {
		return header & (SIZE_MASK);
	}
}
...
register struct foo * foo = &fum;
	...
	oop1 = memory + (foo->headerTypeBytes[(longAt(memory)) & TypeMask]);
	while ((((usqInt) oop1)) < (((usqInt) foo->endOfMemory))) {
		if (!(((longAt(oop1)) & TypeMask) == HeaderTypeFree)) {
			header = longAt(oop1);
			fmt = (((usqInt) header) >> 8) & 15;
			if ((fmt == 3) && ((((((usqInt) header) >> 12) & 31) == 13) || ((((((usqInt) header) >> 12) & 31) == 14) || (((((usqInt) header) >> 12) & 31) == 4)))) {
				sz = sizeBitsOf(oop1);
				for (i = ((lastPointerOf(oop1)) + (BYTES_PER_WORD)); i <= (sz - (BASE_HEADER_SIZE)); i += (BYTES_PER_WORD)) {
					longAtput(oop1 + i, foo->nilObj);
				}
			}
			if (fmt >= 12) {
				if ((primitiveIndexOf(oop1)) == PrimitiveExternalCallIndex) {
					flushExternalPrimitiveOf(oop1);
				}
			}
		}
		oop1 = objectAfter(oop1);
	}
	clearRootsTable();
...
register struct foo * foo = &fum;
	...
	foo->child = longAt(foo->field);
	typeBits = foo->child & TypeMask;
	if ((typeBits & 1) == 1) {

		/* field contains a SmallInteger; skip it */

		foo->field -= BYTES_PER_WORD;
		return StartField;
	}
	if (typeBits == 0) {
		...
		longAtput(foo->field, foo->parentField);
		foo->parentField = foo->field;
		return StartObj;
	}
	if (typeBits == 2) {
		...
		if ((foo->child & CompactClassMask) != 0) {

			/* object's class is compact; we're done */
			/* restore the header type bits */

			foo->child = foo->child & (ALL_BUT_TYPE_MASK);
			/* begin rightType: */
			if ((foo->child & (SIZE_MASK)) == 0) {
		...
		l1:	/* end rightType: */;
			longAtput(foo->field, foo->child | childType);
			return Upward;
		} else {
			...
			foo->child = longAt(foo->field - (BYTES_PER_WORD));

			/* clear type bits */

			foo->child = foo->child & (ALL_BUT_TYPE_MASK);
			longAtput(foo->field - (BYTES_PER_WORD), foo->parentField);

			/* point at class word; mark as working on the class.  */

			foo->parentField = (foo->field - (BYTES_PER_WORD)) | 1;
			return StartObj;
		}
	}
}
...
register struct foo * foo = &fum;
	...
	oop = foo->child;
	if ((((usqInt) oop)) < (((usqInt) foo->youngStartLocal))) {
	...
	if ((header & (MARK_BIT)) == 0) {
		...
		header = header & (ALL_BUT_TYPE_MASK);
		header = (header | (MARK_BIT)) | HeaderTypeGC;
		longAtput(oop, header);
		foo->field = oop + lastFieldOffset;
		return StartField;
	} else {
...
register struct foo * foo = &fum;
	...
	if ((foo->parentField & 1) == 1) {
		if (foo->parentField == GCTopMarker) {

			/* top of the chain */

			header = (longAt(foo->field)) & (ALL_BUT_TYPE_MASK);
			/* begin rightType: */
			if ((header & (SIZE_MASK)) == 0) {
				type = HeaderTypeSizeAndClass;
				goto l1;
		...
		l1:	/* end rightType: */;
			longAtput(foo->field, header | type);
			return Done;
		} else {
			...
			foo->field = foo->parentField - 1;
			foo->parentField = longAt(foo->field);

			/* base header word */

			header = longAt(foo->field + (BYTES_PER_WORD));
			/* begin rightType: */
			if ((header & (SIZE_MASK)) == 0) {
				type = HeaderTypeSizeAndClass;
				goto l2;
		...
		l2:	/* end rightType: */;
			longAtput(foo->field, foo->child | type);
		...
		foo->field = foo->parentField;
		foo->parentField = longAt(foo->field);
		longAtput(foo->field, foo->child);
