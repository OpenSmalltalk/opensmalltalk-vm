/* Automatically generated by
	CCodeGeneratorGlobalStructure * VMMaker.oscog-eem.90 uuid: efb3c8a3-db33-4387-b560-49b3d9f04cde
 */
...
sqInt implicitReceiverForMixinimplementing(sqInt mixin, sqInt selector);
...
sqInt mframeReceiverExport(void);
