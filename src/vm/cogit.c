/* Automatically generated by
   ...
   from
	StackToRegisterMappingCogit VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a
 */
static char __buildInfo[] = "StackToRegisterMappingCogit VMMaker.oscog-eem.232 uuid: 9ecffa1b-c204-4dbd-b148-79e209e6470a " __DATE__ ;
...
compileBlockBodies(void)
{
    ...
    sqInt (*pushNilSizeFunction)(sqInt) = v3PushNilSize;
    sqInt result;
...
scanBlock(BlockStart *blockStart)
{
    BytecodeDescriptor *descriptor;
    sqInt end;
    sqInt (*isPushNilFunction)(struct _BytecodeDescriptor *,sqInt,sqInt,sqInt) = v3IsPushNil;
    sqInt nExts;
    sqInt pc;
    sqInt pushingNils;
    sqInt stackDelta;
