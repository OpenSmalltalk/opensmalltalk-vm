/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-eem.3785 uuid: ea2d7aa6-48ae-41bd-b800-27d6eee91a45
...
extern void ceTakeProfileSample(void);
...
#if VMInvestigations
extern int methodHeaderHasPrimitive(sqInt methodHeader);
...
extern int primitivePropertyFlagsprimIndex(sqInt methodObj, sqInt primIndex);
...
extern unsigned short literalCountOfMethodHeader(sqInt header);
extern unsigned short literalCountOf(sqInt methodPointer);
...
extern int rawHashBitsOf(sqInt objOop);
...
extern unsigned char argumentCountOfMethodHeader(sqInt header);
extern unsigned char argumentCountOf(sqInt methodPointer);
...
extern unsigned char tempCountOf(sqInt methodPointer);
extern unsigned char temporaryCountOfMethodHeader(sqInt header);
...
#define nullHeaderForMachineCodeMethod() 0x8000000A000035LL
...
#define numericPrimsMixArithmetic() (imageHeaderFlags & 0x100)
#define numericPrimsMixComparison() (imageHeaderFlags & 0x800)
...
#define OwnVMForFFIExceptionFlag 16
