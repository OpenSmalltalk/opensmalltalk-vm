...
extern void ceCollectArgumentsTypeForFramefulActivation(void);
extern void ceCollectArgumentsTypeForFramlessSpilledActivationOf(CogMethod *cogMethod);
extern void ceCollectArgumentsTypeForFramlessUnspilledActivationWithArgargof(sqInt arg0, sqInt arg1, CogMethod *cogMethod);
extern void ceCollectArgumentsTypeForFramlessUnspilledActivationWithArgof(sqInt arg, CogMethod *cogMethod);
extern void ceCollectInstVarTypeForatof(sqInt rcvr, sqInt instVarIndex, sqInt assignedObject);
extern void ceCollectRemoteTempVarTypeAtof(sqInt tempVarIndex, sqInt assignedObject);
extern void ceCollectReturnTypeForof(CogMethod *cogMethod, sqInt returnObject);
extern void ceCollectTempVarTypeAtof(sqInt tempVarIndex, sqInt assignedObject);
extern void ceCollectTypesForPrimitiveSlotAtputof(sqInt slotIndex, sqInt assignedObject, sqInt rcvr);
