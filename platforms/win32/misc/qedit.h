/* This qedit.h file is an old old autogenerated file originating from the
 * 2004 release of the dx9sdk.  It has been edited to remove IDXInterface,
 * the Internet Explorer interface, and subclasses.  We really should generate
 * this file from the Windows SDK in use and the MIDL compiler. But time is
 * pressing, so we're keeping this short-cut for now.  If you have the energy,
 * please feel free to use MIDL to generate a replacement from suitable .idl
 * files in a Windows SDK.
 *
 * eem 2020/04/17
 */
