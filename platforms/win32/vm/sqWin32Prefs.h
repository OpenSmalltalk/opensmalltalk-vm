...
#define ID_3BUTTONMOUSE 0x0060
#define ID_1BUTTONMOUSE 0x0070
#define ID_DEFAULTPRINTER 0x0080
#define ID_SHOWALLOCATIONS 0x0090
#define ID_DIRECTSOUND 0x00A0

#define ID_FILEACCESS 0x00B0
#define ID_IMAGEWRITE 0x00C0
#define ID_SOCKETACCESS 0x00D0

#define ID_DBGPRINTSTACK 0x00E0
#define ID_PRIORITYBOOST 0x00F0

#define ID_USEOPENGL 0x0100
#define ID_CASEFILES 0x0110
#define ID_PRINTALLSTACKS 0x0120
#define ID_DUMPPRIMLOG 0x0130
...
#define VM_VERSION_VERBOSE NICKNAME NICKNAME_EXTRA VM_VERSION \
		" (release) from " __DATE__ "\n" \
