...
/* TELEPLACE: otherwise, redefinition error.  I don't like this fix, because I haven't proved to myself
   that there isn't some path through the preprocessor where the first declaration wouldn't occur. */
/*
typedef struct IDirectSoundFullDuplex *LPDIRECTSOUNDFULLDUPLEX;
#endif /* TELEPLACE */
