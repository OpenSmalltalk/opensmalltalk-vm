/* Automatically generated from Squeak on 15 June 2010 5:06:10 pm 
   by VMMaker 4.2.4
 */
...
static sqInt fillRadialGradientfromtoat(sqInt fill, sqInt leftX, sqInt rightX, sqInt yValue) {
	...
	if (x < (objBuffer[fill + GFOriginX])) {
		if ((workBuffer[GWAALevel]) == 1) {
			...
			while (x2 < x13) {
				while ((x2 < x13) && ((((((sqInt) ds1 >> 16)) * (((sqInt) ds1 >> 16))) + ((((sqInt) dt1 >> 16)) * (((sqInt) dt1 >> 16)))) >= length21)) {
...
static sqInt findNextExternalFillFromAET(void) {
	...
	l2:	/* end quickRemoveInvalidFillsAt: */;
		...
		if ((workBuffer[GWAETStart]) < (workBuffer[GWAETUsed])) {
			...
			l8:	/* end topRightX */;
				...
				l5:	/* end quickRemoveInvalidFillsAt: */;
					startX = stopX;
					/* begin topRightX */
					if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
						stopX = 999999999;
	...
	l14:	/* end topRightX */;
		...
		l11:	/* end quickRemoveInvalidFillsAt: */;
			startX1 = stopX1;
			/* begin topRightX */
			if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
				stopX1 = 999999999;
...
static sqInt loadEdgeStateFrom(sqInt edgeOop) {
	...
	value1 = interpreterProxy->fetchIntegerofObject(ETXValueIndex, edgeOop);
	objBuffer[edge + GEXValue] = value1;
	...
	value = interpreterProxy->fetchIntegerofObject(ETLinesIndex, edgeOop);
