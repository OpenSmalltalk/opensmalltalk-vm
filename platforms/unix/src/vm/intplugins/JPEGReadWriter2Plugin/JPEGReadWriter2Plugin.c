/* Automatically generated from Squeak on #(19 March 2005 10:08:56 am) */
...
#pragma export on
EXPORT(int) primImageHeight(void);
EXPORT(int) primImageWidth(void);
EXPORT(int) primJPEGCompressStructSize(void);
EXPORT(int) primJPEGDecompressStructSize(void);
EXPORT(int) primJPEGErrorMgr2StructSize(void);
EXPORT(int) primJPEGPluginIsPresent(void);
EXPORT(int) primJPEGReadHeaderfromByteArrayerrorMgr(void);
EXPORT(int) primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgr(void);
EXPORT(int) primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgr(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReadWriter2Plugin 19 March 2005 (i)"
#else
	"JPEGReadWriter2Plugin 19 March 2005 (e)"
#endif
;
...
EXPORT(int) primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgr(void) {
	...
	interpreterProxy->success((interpreterProxy->isWordsOrBytes(formBitsAsInt)) && (formBitsSize == (formPitch * formHeight)));
	if (interpreterProxy->failed()) {
		return null;
	}
