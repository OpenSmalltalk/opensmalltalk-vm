/* Automatically generated from Squeak on #(19 March 2005 10:09:10 am) */
...
#pragma export on
EXPORT(int) b3dClipPolygon(void);
EXPORT(int) b3dComputeMinIndexZ(void);
EXPORT(int) b3dComputeMinZ(void);
EXPORT(int) b3dDetermineClipFlags(void);
EXPORT(int) b3dInitPrimitiveObject(void);
EXPORT(int) b3dInitializeRasterizerState(void);
EXPORT(int) b3dInplaceHouseHolderInvert(void);
EXPORT(int) b3dLoadIndexArray(void);
EXPORT(int) b3dLoadVertexBuffer(void);
EXPORT(int) b3dMapVertexBuffer(void);
EXPORT(int) b3dOrthoNormInverseMatrix(void);
EXPORT(int) b3dPrimitiveNextClippedTriangle(void);
EXPORT(int) b3dPrimitiveObjectSize(void);
EXPORT(int) b3dPrimitiveTextureSize(void);
EXPORT(int) b3dRasterizerVersion(void);
EXPORT(int) b3dShadeVertexBuffer(void);
EXPORT(int) b3dShaderVersion(void);
EXPORT(int) b3dStartRasterizer(void);
EXPORT(int) b3dTransformDirection(void);
EXPORT(int) b3dTransformMatrixWithInto(void);
EXPORT(int) b3dTransformPoint(void);
EXPORT(int) b3dTransformPrimitiveNormal(void);
EXPORT(int) b3dTransformPrimitivePosition(void);
EXPORT(int) b3dTransformPrimitiveRasterPosition(void);
EXPORT(int) b3dTransformVertexBuffer(void);
EXPORT(int) b3dTransformerVersion(void);
EXPORT(int) b3dTransposeMatrix(void);
#pragma export off
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"Squeak3D 19 March 2005 (i)"
#else
	"Squeak3D 19 March 2005 (e)"
#endif
;
