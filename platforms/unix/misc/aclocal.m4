...
# Hacked by Tim Rowledge (tim@sumeru.stanford.edu) to support VMMaker system
...
# TP - what does this do? Seems to work out parent dir.
#topdir=`echo $srcdir | sed 's,/src/unix$,,'`
# fudge it for now and leave to somebody that knows what they're doing to sort it out
topdir=..
AC_SUBST(topdir)
mh_frag=$1
mt_frag=$2
