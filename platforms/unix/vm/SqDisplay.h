...
struct SqDisplay
{
  ...
  long    (*hostWindowShowDisplay)(unsigned char *dispBitsIndex, long width, long height, long depth, long affectedL, long affectedR, long affectedT, long affectedB, sqIntptr_t windowIndex);
