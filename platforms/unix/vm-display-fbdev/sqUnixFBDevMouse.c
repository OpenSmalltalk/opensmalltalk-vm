 ...
 * 
 * Last edited: 2003-08-20 01:19:43 by piumarta on felina.inria.fr
 */
...
static int ms_open(_self, char *msDev)
{
  ms_init_t init= 0;
  ...
  if (msDev)
	...
	char *dev;		ms_init_t init;	ms_handler_t handler;
      } mice[]=	{
	{ "/dev/psaux",		ms_ps2_init,	ms_ps2_handleEvents,	},
	{ "/dev/input/mice",	ms_ps2_init,	ms_ps2_handleEvents,	},
	{ "/dev/adbmouse",	ms_adb_init,	ms_adb_handleEvents,	},
	{ 0, 0, 0 }
      };
      int i;
