/* Automatically generated by
   ...
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-eem.1950 uuid: b4089b49-1494-49d2-8966-57cba5c92194
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-eem.1950 uuid: b4089b49-1494-49d2-8966-57cba5c92194 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"IA32FFIPlugin VMMaker.oscog-eem.1950 (i)"
#else
	"IA32FFIPlugin VMMaker.oscog-eem.1950 (e)"
#endif
;
...
shift = ((BytesPerWord == 8)
				...
				value = intRet & (((((unsigned long)1)) << shift) - 1);
				if (atomicType & 1) {
...
intRet1 = dispatchFunctionPointer(((usqLong (*)()) (((void *) address1))));
	}
...
;
			if (returnStructInRegisters((calloutState1->structReturnSize))) {
				memcpy(firstIndexableField(oop12), (&intRet1), (calloutState1->structReturnSize));
			}
			else {
...
shift1 = ((BytesPerWord == 8)
				...
				value1 = intRet1 & (((((unsigned long)1)) << shift1) - 1);
				if (atomicType2 & 1) {
