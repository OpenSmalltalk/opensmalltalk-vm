...
static sqInt genConvertIntegerToCharacterInScratchReg(sqInt reg);
...
genAllocFloatValueintoscratchRegscratchReg(sqInt dpreg, sqInt resultReg, sqInt scratch1, sqInt scratch2)
{
	...
	if ((BytesPerWord) == (BaseHeaderSize)) {
		/* begin MoveR:Mw:r: */
		...
		flag("endianness");
		/* begin MoveCq:R: */
		genoperandoperand(MoveCqR, 0, scratch1);
		/* begin MoveR:Mw:r: */
		genoperandoperandoperand(MoveRMwr, scratch2, 0, resultReg);
		/* begin MoveR:Mw:r: */
...
static sqInt
genConvertIntegerToCharacterInScratchReg(sqInt reg)
{
    sqInt quickConstant;
...
genGetHashFieldNonImmOfasSmallIntegerInto(sqInt instReg, sqInt destReg)
{
	...
	genoperandoperand(AndCqR, quickConstant, destReg);
	genConvertIntegerToSmallIntegerInScratchReg(destReg);
	return 0;
}
...
genInnerPrimitiveAt(sqInt retNoffset)
{
	...
	genoperandoperand(LogicalShiftRightCqR, quickConstant10, formatReg);
	/* begin AndCq:R: */
	...
	/* begin JumpAboveOrEqual: */
	jumpBytesOutOfBounds = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin AddCq:R: */
	genoperandoperand(AddCqR, BaseHeaderSize, Arg0Reg);
	/* begin MoveXbr:R:R: */
	genoperandoperandoperand(MoveXbrRR, Arg0Reg, ReceiverResultReg, ReceiverResultReg);
	...
	genoperandoperand(CmpRR, Arg0Reg, ClassReg);
	/* begin JumpAboveOrEqual: */
	jumpShortsOutOfBounds = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin AddR:R: */
	...
	jmpTarget(jumpIsWords, gCmpRR(Arg0Reg, ClassReg));
	/* begin JumpAboveOrEqual: */
	jumpWordsOutOfBounds = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin AddCq:R: */
	quickConstant6 = ((usqInt) (BaseHeaderSize)) >> (shiftForWord());
	genoperandoperand(AddCqR, quickConstant6, Arg0Reg);
	/* begin MoveXwr:R:R: */
	genoperandoperandoperand(MoveXwrRR, Arg0Reg, ReceiverResultReg, TempReg);
	/* begin SubCq:R: */
	quickConstant11 = ((usqInt) (BaseHeaderSize)) >> (shiftForWord());
	genoperandoperand(SubCqR, quickConstant11, Arg0Reg);
	...
	/* begin PopR: */
	genoperand(PopR, ClassReg);
	genConvertSmallIntegerToIntegerInScratchReg(formatReg);
	/* begin AndCq:R: */
	...
	genoperandoperand(CmpRR, Arg0Reg, ClassReg);
	/* begin JumpAboveOrEqual: */
	jumpFixedFieldsOutOfBounds = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin AddR:R: */
	...
	jmpTarget(jumpIsArray, gCmpRR(Arg0Reg, ClassReg));
	/* begin JumpAboveOrEqual: */
	jumpArrayOutOfBounds = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin AddCq:R: */
	...
	jmpTarget(jumpFixedFieldsOutOfBounds, jmpTarget(jumpArrayOutOfBounds, jmpTarget(jumpBytesOutOfBounds, jmpTarget(jumpShortsOutOfBounds, jmpTarget(jumpWordsOutOfBounds, jmpTarget(jumpWordTooBig, jmpTarget(jumpNotIndexable, jmpTarget(jumpIsContext, gLabel()))))))));
	/* begin AddCq:R: */
...
genInnerPrimitiveNewWithArg(sqInt retNoffset)
{
	...
	/* begin LogicalShiftRightCq:R: */
	quickConstant4 = (fixedFieldsFieldWidth()) + (numSmallIntegerTagBits());
	genoperandoperand(LogicalShiftRightCqR, quickConstant4, instSpecReg);
	/* begin AndCq:R: */
	quickConstant = formatMask();
	...
	genoperandoperand(LogicalShiftRightCqR, quickConstant7, instSpecReg);
	/* begin MoveCq:R: */
	genoperandoperand(MoveCqR, 0, TempReg);
	/* begin PushR: */
	genoperand(PushR, TempReg);
	...
	/* begin CmpCq:R: */
	genoperandoperand(CmpCqR, 0, instSpecReg);
	/* begin JumpNonZero: */
	jumpHasSlots = genoperand(JumpNonZero, ((sqInt)0));
	/* begin MoveCq:R: */
	genoperandoperand(MoveCqR, (BaseHeaderSize) * 2, instSpecReg);
	/* begin Jump: */
	skip = genoperand(Jump, ((sqInt)0));
	jmpTarget(jumpHasSlots, gMoveRR(instSpecReg, TempReg));
	/* begin AndCq:R: */
	genoperandoperand(AndCqR, 1, TempReg);
	/* begin AddR:R: */
	genoperandoperand(AddRR, TempReg, instSpecReg);
	/* begin AddCq:R: */
	genoperandoperand(AddCqR, (BaseHeaderSize) / (BytesPerWord), instSpecReg);
	/* begin LogicalShiftLeftCq:R: */
	quickConstant8 = shiftForWord();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant8, instSpecReg);
	jmpTarget(skip, gMoveAwR(scavengeThresholdAddress(), TempReg));
	/* begin LogicalShiftLeftCq:R: */
	quickConstant9 = numSlotsHalfShift();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant9, halfHeaderReg);
	/* begin SubR:R: */
	genoperandoperand(SubRR, Arg1Reg, TempReg);
	/* begin CmpR:R: */
	genoperandoperand(CmpRR, TempReg, instSpecReg);
	/* begin JumpAbove: */
	jumpNoSpace = genoperand(JumpAbove, ((sqInt)0));
	/* begin MoveR:R: */
	genoperandoperand(MoveRR, Arg1Reg, ReceiverResultReg);
	/* begin AddR:R: */
	genoperandoperand(AddRR, instSpecReg, Arg1Reg);
	/* begin MoveR:Aw: */
	address1 = freeStartAddress();
	genoperandoperand(MoveRAw, Arg1Reg, address1);
	/* begin MoveR:Mw:r: */
	genoperandoperandoperand(MoveRMwr, halfHeaderReg, 4, ReceiverResultReg);
	/* begin PopR: */
	genoperand(PopR, halfHeaderReg);
	/* begin LoadEffectiveAddressMw:r:R: */
	genoperandoperandoperand(LoadEffectiveAddressMwrR, BaseHeaderSize, ReceiverResultReg, instSpecReg);
	/* begin MoveR:Mw:r: */
	fillLoop = genoperandoperandoperand(MoveRMwr, halfHeaderReg, 0, instSpecReg);
	/* begin MoveR:Mw:r: */
	genoperandoperandoperand(MoveRMwr, halfHeaderReg, 4, instSpecReg);
	/* begin AddCq:R: */
	genoperandoperand(AddCqR, 8, instSpecReg);
	/* begin CmpR:R: */
	genoperandoperand(CmpRR, Arg1Reg, instSpecReg);
	/* begin JumpBelow: */
	genoperand(JumpBelow, ((sqInt)fillLoop));
	/* begin RetN: */
	genoperand(RetN, retNoffset);
	jmpTarget(jumpNoSpace, gPopR(TempReg));
	jmpTarget(jumpUnhashed, jmpTarget(jumpFailCuzFixed, jmpTarget(jumpArrayTooBig, jmpTarget(jumpByteTooBig, jmpTarget(jumpLongTooBig, jmpTarget(jumpNoSpace, jmpTarget(jumpNElementsNonInt, gLabel())))))));
	return 0;
}
...
genInnerPrimitiveNew(sqInt retNoffset)
{
	...
	genoperandoperand(MoveRR, TempReg, instSpecReg);
	/* begin LogicalShiftRightCq:R: */
	quickConstant4 = fixedFieldsFieldWidth();
	...
	genoperandoperand(LogicalShiftLeftCqR, quickConstant6, instSpecReg);
	jmpTarget(skip, gMoveAwR(scavengeThresholdAddress(), TempReg));
	/* begin LogicalShiftLeftCq:R: */
	quickConstant7 = numSlotsHalfShift();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant7, halfHeaderReg);
	/* begin SubR:R: */
	genoperandoperand(SubRR, Arg1Reg, TempReg);
	/* begin CmpR:R: */
	genoperandoperand(CmpRR, TempReg, instSpecReg);
	...
	genoperandoperand(MoveCqR, quickConstant8, halfHeaderReg);
	/* begin MoveR:Mw:r: */
	fillLoop = genoperandoperandoperand(MoveRMwr, halfHeaderReg, 0, instSpecReg);
	/* begin MoveR:Mw:r: */
	genoperandoperandoperand(MoveRMwr, halfHeaderReg, 4, instSpecReg);
...
genInnerPrimitiveSize(sqInt retNoffset)
{
	...
	genoperandoperand(LogicalShiftRightCqR, quickConstant7, SendNumArgsReg);
	/* begin AndCq:R: */
	quickConstant = formatMask();
	...
	genConvertSmallIntegerToIntegerInScratchReg(SendNumArgsReg);
	/* begin PopR: */
	genoperand(PopR, ClassReg);
	/* begin AndCq:R: */
...
genInnerPrimitiveStringAt(sqInt retNoffset)
{
	...
	/* begin LogicalShiftRightCq:R: */
	quickConstant5 = formatShift();
	genoperandoperand(LogicalShiftRightCqR, quickConstant5, formatReg);
	/* begin AndCq:R: */
	quickConstant = formatMask();
	genoperandoperand(AndCqR, quickConstant, formatReg);
	/* begin MoveCq:R: */
	...
	genConvertIntegerToCharacterInScratchReg(ReceiverResultReg);
	/* begin RetN: */
	genoperand(RetN, retNoffset);
	jmpTarget(jumpIsShorts, gLogicalShiftLeftCqR((shiftForWord()) - 1, ClassReg));
	/* begin AndCq:R: */
	...
	/* begin SubCq:R: */
	quickConstant6 = ((usqInt) (BaseHeaderSize)) >> (shiftForWord());
	genoperandoperand(SubCqR, quickConstant6, Arg0Reg);
	jumpWordTooBig = jumpNotCharacterUnsignedValueInRegister(TempReg);
	/* begin MoveR:R: */
	genoperandoperand(MoveRR, TempReg, ReceiverResultReg);
	/* begin Jump: */
	genoperand(Jump, ((sqInt)done));
	jmpTarget(jumpBytesOutOfBounds, jmpTarget(jumpShortsOutOfBounds, jmpTarget(jumpWordsOutOfBounds, jmpTarget(jumpWordTooBig, jmpTarget(jumpNotIndexable, gLabel())))));
	/* begin AddCq:R: */
	genoperandoperand(AddCqR, 1, Arg0Reg);
	genConvertIntegerToSmallIntegerInScratchReg(Arg0Reg);
...
genStoreSourceRegslotIndexdestRegscratchReg(sqInt sourceReg, sqInt index, sqInt destReg, sqInt scratchReg)
{
	...
	rememberedBitByteOffset = (isBigEndian(jmpSourceOld)
		? ((BaseHeaderSize) - 1) - (((sqInt) (rememberedBitShift()) >> 3))
		: ((sqInt) (rememberedBitShift()) >> 3));
