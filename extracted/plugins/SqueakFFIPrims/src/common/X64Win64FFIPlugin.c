/* Automatically generated by
   ...
   from
	ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.2481 uuid: 43e5789a-92ab-47cd-9c5b-ffe711bbfa4e
 */
static char __buildInfo[] = "ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.2481 uuid: 43e5789a-92ab-47cd-9c5b-ffe711bbfa4e " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"X64Win64FFIPlugin VMMaker.oscog-eem.2481 (i)"
#else
	"X64Win64FFIPlugin VMMaker.oscog-eem.2481 (e)"
#endif
;
...
#  endif /* COGMTVM */
	...
	if (((calloutState->floatRegisterSignature)) > 0) {
		loadFloatRegs(((calloutState->floatRegisters))[0], ((calloutState->floatRegisters))[1], ((calloutState->floatRegisters))[2], ((calloutState->floatRegisters))[3]);
	}
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop1), ((((calloutState->structReturnSize)) <= WordSize)
		 && ((((calloutState->structReturnSize)) & (((calloutState->structReturnSize)) - 1)) == 0)
			? (&intRet)
...
#endif /* SPURVM */
;
	memcpy(firstIndexableField(oop), ((((calloutState->structReturnSize)) <= WordSize)
	 && ((((calloutState->structReturnSize)) & (((calloutState->structReturnSize)) - 1)) == 0)
		? (&intRet)
		: (calloutState->limit)), (calloutState->structReturnSize));
	storePointerofObjectwithValue(0, retOop, oop);
...
#  endif /* COGMTVM */
	...
	if ((((calloutState1->structReturnSize)) > 0)
	 && (1
	 && (!((((calloutState1->structReturnSize)) <= WordSize)
	 && ((((calloutState1->structReturnSize)) & (((calloutState1->structReturnSize)) - 1)) == 0))))) {
		/* begin ffiPushPointer:in: */
...
#  endif /* COGMTVM */
	...
	if (((calloutState1->floatRegisterSignature)) > 0) {
		loadFloatRegs(((calloutState1->floatRegisters))[0], ((calloutState1->floatRegisters))[1], ((calloutState1->floatRegisters))[2], ((calloutState1->floatRegisters))[3]);
	}
	if ((allocaLiesSoSetSpBeforeCall())
	 || (mustAlignStack())) {
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop11), ((((calloutState1->structReturnSize)) <= WordSize)
		 && ((((calloutState1->structReturnSize)) & (((calloutState1->structReturnSize)) - 1)) == 0)
			? (&intRet1)
