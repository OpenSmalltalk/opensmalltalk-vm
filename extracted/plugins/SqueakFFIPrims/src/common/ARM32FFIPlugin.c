/* Automatically generated by
   ...
   from
	ThreadedARM32FFIPlugin VMMaker.oscog-eem.2518 uuid: 33deb326-de86-45aa-be20-d64c10de4e70
 */
static char __buildInfo[] = "ThreadedARM32FFIPlugin VMMaker.oscog-eem.2518 uuid: 33deb326-de86-45aa-be20-d64c10de4e70 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ARM32FFIPlugin VMMaker.oscog-eem.2518 (i)"
#else
	"ARM32FFIPlugin VMMaker.oscog-eem.2518 (e)"
#endif
;
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop1), (((calloutState->structReturnSize)) <= BytesPerWord
			? (&intRet)
...
ffiPushSignedLongLongOopin(sqInt oop, CalloutState *calloutState)
{
	...
	if (((calloutState->integerRegisterIndex)) < (NumIntRegArgs - 1)) {
		...
		longAtput(((calloutState->currentArg)) + BytesPerWord, ((usqInt) (((unsigned sqLong)value) >> 32)));
		(calloutState->currentArg = ((calloutState->currentArg)) + 8);
	}
	return 0;
}
...
#endif /* SPURVM */
;
	memcpy(firstIndexableField(oop), (((calloutState->structReturnSize)) <= BytesPerWord
		? (&longLongRet)
		: (calloutState->limit)), (calloutState->structReturnSize));
	storePointerofObjectwithValue(0, retOop, oop);
	return retOop;
...
#  endif /* COGMTVM */
	...
	if ((((calloutState1->structReturnSize)) > 0)
	 && (1
	 && (!(((calloutState1->structReturnSize)) <= BytesPerWord)))) {
		/* begin ffiPushPointer:in: */
...
#endif /* SPURVM */
;
		memcpy(firstIndexableField(oop11), (((calloutState1->structReturnSize)) <= BytesPerWord
			? (&intRet1)
