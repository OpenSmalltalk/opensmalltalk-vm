/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-cb.1211 uuid: 5bfea133-65e7-4b14-a105-9d71ebc8266a
 */
...
sqInt ceSendabovetonumArgs(sqInt selector, sqInt startAssociationArg, sqInt rcvr, sqInt numArgs);
sqInt ceSendsupertonumArgs(sqInt selector, sqInt superNormalBar, sqInt rcvr, sqInt numArgs);
sqInt ceSistaTrap(void);
...
sqInt isOptimizedMethod(sqInt methodObj);
