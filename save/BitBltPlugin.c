/* Automatically generated by
	SmartSyntaxPluginCodeGenerator * VMMaker.oscog-eem.2153 uuid: fd47d333-75f0-46ea-a3a7-fab3a6ddebdd
   from
	BitBltSimulation * VMMaker.oscog-eem.2153 uuid: fd47d333-75f0-46ea-a3a7-fab3a6ddebdd
 */
static char __buildInfo[] = "BitBltSimulation * VMMaker.oscog-eem.2153 uuid: fd47d333-75f0-46ea-a3a7-fab3a6ddebdd " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BitBltPlugin * VMMaker.oscog-eem.2153 (i)"
#else
	"BitBltPlugin * VMMaker.oscog-eem.2153 (e)"
#endif
;
...
lockSurfaces(void)
{
	sqInt b;
	sqInt destHandle;
	sqIntptr_t (*fn)(sqIntptr_t, int*, int, int, int, int);
	sqInt l;
	sqInt r;
	sqInt sourceHandle;
	sqInt t;
	...
	if (destBits == 0) {
		...
		fn = ((sqIntptr_t (*)(sqIntptr_t, int*, int, int, int, int)) lockSurfaceFn);
...
OLDtallyIntoMapwith(sqInt sourceWord, sqInt destinationWord)
{
	...
	if (destDepth == 16) {
		...
		if (((d = cmBitsPerColor - 5)) > 0) {
			...
			mask = ((int)((usqInt)(mask) << d));
			destPix = srcPix & mask;
			mask = ((int)((usqInt)(mask) << cmBitsPerColor));
			srcPix = ((sqInt)((usqInt)(srcPix) << d));
			mapIndex = (destPix + (srcPix & mask)) + ((((sqInt)((usqInt)(srcPix) << d))) & (((int)((usqInt)(mask) << cmBitsPerColor))));
			goto l2;
		}
		else {
			...
			destPix = (destPix + (srcPix & mask)) + ((((usqInt) srcPix) >> d) & (((int)((usqInt)(mask) << cmBitsPerColor))));
			if (destPix == 0) {
				mapIndex = 1;
				goto l2;
			}
	...
	l2:	/* end rgbMap:from:to: */;
		...
		if (((d1 = cmBitsPerColor - 5)) > 0) {
			...
			mask3 = ((int)((usqInt)(mask3) << d1));
			destPix1 = srcPix1 & mask3;
			mask3 = ((int)((usqInt)(mask3) << cmBitsPerColor));
			srcPix1 = ((sqInt)((usqInt)(srcPix1) << d1));
			mapIndex = (destPix1 + (srcPix1 & mask3)) + ((((sqInt)((usqInt)(srcPix1) << d1))) & (((int)((usqInt)(mask3) << cmBitsPerColor))));
			goto l4;
		}
		else {
			...
			destPix1 = (destPix1 + (srcPix1 & mask3)) + ((((usqInt) srcPix1) >> d1) & (((int)((usqInt)(mask3) << cmBitsPerColor))));
			if (destPix1 == 0) {
				mapIndex = 1;
				goto l4;
			}
	...
	l4:	/* end rgbMap:from:to: */;
		...
		if (((d2 = cmBitsPerColor - 8)) > 0) {
			...
			mask4 = ((int)((usqInt)(mask4) << d2));
			destPix2 = srcPix2 & mask4;
			mask4 = ((int)((usqInt)(mask4) << cmBitsPerColor));
			srcPix2 = ((sqInt)((usqInt)(srcPix2) << d2));
			mapIndex = (destPix2 + (srcPix2 & mask4)) + ((((sqInt)((usqInt)(srcPix2) << d2))) & (((int)((usqInt)(mask4) << cmBitsPerColor))));
			goto l6;
		}
		else {
			...
			destPix2 = (destPix2 + (srcPix2 & mask4)) + ((((usqInt) srcPix2) >> d2) & (((int)((usqInt)(mask4) << cmBitsPerColor))));
			if (destPix2 == 0) {
				mapIndex = 1;
				goto l6;
			}
	...
	for (i = 1; i <= nParts; i += 1) {
		...
		if (!(nBits == 32)) {
			...
			if (((d = nBits - 32)) > 0) {
				...
				mask3 = ((int)((usqInt)(mask3) << d));
				destPix = srcPix & mask3;
				mask3 = ((int)((usqInt)(mask3) << nBits));
				srcPix = ((sqInt)((usqInt)(srcPix) << d));
				v = (destPix + (srcPix & mask3)) + ((((sqInt)((usqInt)(srcPix) << d))) & (((int)((usqInt)(mask3) << nBits))));
				goto l1;
			}
			else {
				...
				mask3 = ((int)((usqInt)(mask3) << nBits));
				srcPix = ((usqInt) srcPix) >> d;
				destPix = (destPix + (srcPix & mask3)) + ((((usqInt) srcPix) >> d) & (((int)((usqInt)(mask3) << nBits))));
				if (destPix == 0) {
					v = 1;
					goto l1;
				}
...
queryDestSurface(sqInt handle)
{
	...
	return  ((int (*) (sqIntptr_t, int*, int*, int*, int*))querySurfaceFn)
	...
	for (i = 1; i <= destPPW; i += 1) {
		...
		if (!(destDepth == 32)) {
			...
			if (((d = destDepth - 32)) > 0) {
				...
				mask3 = ((int)((usqInt)(mask3) << d));
				destPix = srcPix & mask3;
				mask3 = ((int)((usqInt)(mask3) << destDepth));
				srcPix = ((sqInt)((usqInt)(srcPix) << d));
				v = (destPix + (srcPix & mask3)) + ((((sqInt)((usqInt)(srcPix) << d))) & (((int)((usqInt)(mask3) << destDepth))));
				goto l1;
			}
			else {
				...
				mask3 = ((int)((usqInt)(mask3) << destDepth));
				srcPix = ((usqInt) srcPix) >> d;
				destPix = (destPix + (srcPix & mask3)) + ((((usqInt) srcPix) >> d) & (((int)((usqInt)(mask3) << destDepth))));
				if (destPix == 0) {
					v = 1;
					goto l1;
				}
...
rgbMapfromto(sqInt sourcePixel, sqInt nBitsIn, sqInt nBitsOut)
{
	...
	if (((d = nBitsOut - nBitsIn)) > 0) {
		...
		mask = ((int)((usqInt)(mask) << d));
		destPix = srcPix & mask;
		mask = ((int)((usqInt)(mask) << nBitsOut));
		srcPix = ((sqInt)((usqInt)(srcPix) << d));
		return (destPix + (srcPix & mask)) + ((((sqInt)((usqInt)(srcPix) << d))) & (((int)((usqInt)(mask) << nBitsOut))));
	}
	else {
		...
		mask = ((int)((usqInt)(mask) << nBitsOut));
		srcPix = ((usqInt) srcPix) >> d;
		destPix = (destPix + (srcPix & mask)) + ((((usqInt) srcPix) >> d) & (((int)((usqInt)(mask) << nBitsOut))));
		if (destPix == 0) {
			return 1;
		}
		return destPix;
...
setupColorMasksFromto(sqInt srcBits, sqInt targetBits)
{
	...
	if (deltaBits <= 0) {
		...
		masks[RedIndex] = (((int)((usqInt)(mask) << ((srcBits * 2) - deltaBits))));
		masks[GreenIndex] = (((int)((usqInt)(mask) << (srcBits - deltaBits))));
		masks[BlueIndex] = (((int)((usqInt)(mask) << (0 - deltaBits))));
		masks[AlphaIndex] = 0;
	}
	else {
		...
		/* Mask for extracting a color part of the source */
		mask = (1U << srcBits) - 1;
		masks[RedIndex] = (((int)((usqInt)(mask) << (srcBits * 2))));
		masks[GreenIndex] = (((int)((usqInt)(mask) << srcBits)));
...
unlockSurfaces(void)
{
	sqInt destHandle;
	sqInt destLocked;
	int (*fn)(sqIntptr_t, int, int, int, int);
	sqInt sourceHandle;
	...
	fn = ((int (*)(sqIntptr_t, int, int, int, int)) unlockSurfaceFn);
	destLocked = 0;
...
void* BitBltPlugin_exports[][3] = {
	{(void*)_m, "copyBits\000\001", (void*)copyBits},
