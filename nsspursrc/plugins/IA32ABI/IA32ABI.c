/* Automatically generated by
   ...
   from
	NewsqueakIA32ABIPlugin VMMaker.oscog-eem.1660 uuid: 372f5635-366a-462d-8979-ae86dee05577
 */
static char __buildInfo[] = "NewsqueakIA32ABIPlugin VMMaker.oscog-eem.1660 uuid: 372f5635-366a-462d-8979-ae86dee05577 " __DATE__ ;
...
/*	<Alien> primAddressField ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primAddressField */
EXPORT(sqInt)
...
/*	<Alien> addressFieldPut: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primAddressFieldPut */
EXPORT(sqInt)
...
/*	Copy some number of bytes from some source object starting at the index
	...
	/* NewsqueakIA32ABIPlugin>>#primAlienReplace */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primAllocateExecutablePage */
EXPORT(sqInt)
...
/*	proxy <Alien> primFree ^<Alien>
	...
	/* NewsqueakIA32ABIPlugin>>#primBoxedFree */
EXPORT(sqInt)
primBoxedFree(void)
{
    sqInt addr;
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primCallOutDoubleReturn */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primCallOutFloatReturn */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primCallOutIntegralReturn */
EXPORT(sqInt)
...
/*	primCalloc: byteSize <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primCalloc */
EXPORT(sqInt)
primCalloc(void)
{
    usqInt addr;
...
/*	<Alien> doubleAt: index <Integer> ^<Float>
	...
	/* NewsqueakIA32ABIPlugin>>#primDoubleAt */
EXPORT(sqInt)
primDoubleAt(void)
{
    sqInt addr;
...
/*	<Alien> doubleAt: index <Integer> put: value <Float | Integer> ^<Float |
	...
	/* NewsqueakIA32ABIPlugin>>#primDoubleAtPut */
EXPORT(sqInt)
primDoubleAtPut(void)
{
	...
	/* NewsqueakIA32ABIPlugin>>#primDrainOSEventQueue */
EXPORT(sqInt)
...
/*	<Alien> floatAt: index <Integer> ^<Float>
	...
	/* NewsqueakIA32ABIPlugin>>#primFloatAt */
EXPORT(sqInt)
primFloatAt(void)
{
    sqInt addr;
...
/*	<Alien> floatAt: index <Integer> put: value <Float | Integer> ^<Float |
	...
	/* NewsqueakIA32ABIPlugin>>#primFloatAtPut */
EXPORT(sqInt)
primFloatAtPut(void)
{
    sqInt addr;
...
/*	<Anywhere> primFree: address <Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primFree */
EXPORT(sqInt)
primFree(void)
{
    sqInt addr;
...
/*	Answer the address of the int inIOProcessEvents flag. This can be used to
	...
	/* NewsqueakIA32ABIPlugin>>#primInIOProcessEventsFlagAddress */
EXPORT(sqInt)
...
/*	Attempt to find the address of a symbol in a loaded library.
	...
	/* NewsqueakIA32ABIPlugin>>#primInLibraryFindSymbol */
EXPORT(sqInt)
...
/*	Attempt to load a library of the given name. The primitive will have a
	...
	/* NewsqueakIA32ABIPlugin>>#primLoadLibrary */
EXPORT(sqInt)
...
/*	primMalloc: byteSize <Integer> <^Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primMalloc */
EXPORT(sqInt)
primMalloc(void)
{
    usqInt addr;
...
/*	Return a result from a callback to the callback's callee. The primitive
	...
	/* NewsqueakIA32ABIPlugin>>#primReturnAsFromContextThrough */
EXPORT(sqInt)
...
/*	Return a result from a callback to the callback's callee. The primitive
	...
	/* NewsqueakIA32ABIPlugin>>#primReturnFromContextThrough */
EXPORT(sqInt)
...
/*	<Alien> unsignedByteAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedByteAt */
EXPORT(sqInt)
...
/*	<Alien> signedByteAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedByteAtPut */
EXPORT(sqInt)
...
/*	<Alien> signedLongAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedLongAt */
EXPORT(sqInt)
...
/*	<Alien> signedLongAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedLongAtPut */
EXPORT(sqInt)
...
/*	<Alien> signedLongLongAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedLongLongAt */
EXPORT(sqInt)
...
/*	<Alien> signedLongLongAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedLongLongAtPut */
EXPORT(sqInt)
...
/*	<Alien> signedShortAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedShortAt */
EXPORT(sqInt)
...
/*	<Alien> signedShortAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSignedShortAtPut */
EXPORT(sqInt)
...
/*	<Alien> primSizeField ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSizeField */
EXPORT(sqInt)
primSizeField(void)
{
    sqInt rcvr;
...
/*	<Alien> sizeFieldPut: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primSizeFieldPut */
EXPORT(sqInt)
...
/*	<Alien> primStrlenFrom: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primStrlenFromStartIndex */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primStrlenThroughPointerAtIndex */
EXPORT(sqInt)
...
/*	Answer the address of the entry-point for thunk callbacks:
	...
	/* NewsqueakIA32ABIPlugin>>#primThunkEntryAddress */
EXPORT(sqInt)
...
/*	<Alien> unsignedByteAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedByteAt */
EXPORT(sqInt)
...
/*	<Alien> unsignedByteAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedByteAtPut */
EXPORT(sqInt)
...
/*	<Alien> unsignedLongAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedLongAt */
EXPORT(sqInt)
...
/*	<Alien> unsignedLongAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedLongAtPut */
EXPORT(sqInt)
...
/*	<Alien>unsignedLongLongAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedLongLongAt */
EXPORT(sqInt)
...
/*	<Alien> unsignedLongLongAt: index <Integer> put: value <Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedLongLongAtPut */
EXPORT(sqInt)
...
/*	<Alien> unsignedShortAt: index <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedShortAt */
EXPORT(sqInt)
...
/*	<Alien> unsignedShortAt: index <Integer> put: value <Integer> ^<Integer>
	...
	/* NewsqueakIA32ABIPlugin>>#primUnsignedShortAtPut */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primVarArgsCallOutDoubleReturn */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primVarArgsCallOutFloatReturn */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#primVarArgsCallOutIntegralReturn */
EXPORT(sqInt)
...
/*	Note: This is coded so that is can be run from Squeak. */
	...
	/* NewsqueakIA32ABIPlugin>>#setInterpreter: */
EXPORT(sqInt)
 ...
 */
	...
	/* NewsqueakIA32ABIPlugin>>#sizeField: */
static sqInt
...
/*	Answer the start of rcvr's data, given that it is not an alien. */
	...
	/* NewsqueakIA32ABIPlugin>>#startOfByteData: */
static sqInt
...
/*	Answer the start of rcvr's data. For direct aliens this is the address of
	...
	/* NewsqueakIA32ABIPlugin>>#startOfData: */
static sqInt
...
/*	Answer the start of rcvr's data. For direct aliens this is the address of
	...
	/* NewsqueakIA32ABIPlugin>>#startOfData:withSize: */
static sqInt
