/* Automatically generated by
	CCodeGeneratorGlobalStructure VMMaker.oscog-eem.1331 uuid: 2da6f9fc-7921-4c8b-8c78-dd47f9ddd76e
 */
...
signed char accessorDepthForPrimitiveIndex(sqInt primIndex);
...
sqInt ceImplicitReceiverSendreceiver(sqInt cacheAddress, sqInt methodReceiver);
...
sqInt ceOuterSendreceiver(sqInt cacheAddress, sqInt methodReceiver);
sqInt ceReturnToInterpreter(sqInt anOop);
sqInt ceSelfSendtonumArgs(sqInt selector, sqInt rcvr, sqInt numArgs);
...
void executeCogPICfromLinkedSendWithReceiverandCacheTag(CogMethod *cogPIC, sqInt rcvr, sqInt cacheTag);
...
sqInt marryFrameCopiesTemps(void);
