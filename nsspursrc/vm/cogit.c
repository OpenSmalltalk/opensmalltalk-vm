...
genInnerPrimitiveMirrorNewWithArg(sqInt retNoffset)
{
	...
	genoperandoperand(MoveRR, TempReg, instSpecReg);
	/* begin MoveCq:R: */
	quickConstant7 = wordSize();
	genoperandoperand(MoveCqR, quickConstant7, TempReg);
	/* begin SubR:R: */
	genoperandoperand(SubRR, instSpecReg, TempReg);
	/* begin AndCq:R: */
	quickConstant8 = (wordSize()) - 1;
	genoperandoperand(AndCqR, quickConstant8, TempReg);
	/* begin LogicalShiftLeftCq:R: */
	...
	/* begin AddCq:R: */
	quickConstant10 = (wordSize()) - 1;
	genoperandoperand(AddCqR, quickConstant10, instSpecReg);
	/* begin LogicalShiftRightCq:R: */
	quickConstant11 = shiftForWord();
	genoperandoperand(LogicalShiftRightCqR, quickConstant11, instSpecReg);
	/* begin MoveCq:R: */
	genoperandoperand(MoveCqR, 0, TempReg);
	/* begin PushR: */
	genoperand(PushR, TempReg);
	...
	/* begin AddCq:R: */
	quickConstant12 = (BaseHeaderSize) / (wordSize());
	genoperandoperand(AddCqR, quickConstant12, byteSizeReg);
	/* begin LogicalShiftLeftCq:R: */
	...
	/* begin CmpCq:R: */
	quickConstant14 = getScavengeThreshold();
	genoperandoperand(CmpCqR, quickConstant14, byteSizeReg);
	/* begin JumpAboveOrEqual: */
...
genInnerPrimitiveMirrorNew(sqInt retNoffset)
{
	...
	genoperandoperand(CmpCqR, quickConstant9, byteSizeReg);
	/* begin JumpAboveOrEqual: */
	jumpNoSpace = genoperand(JumpAboveOrEqual, ((sqInt)0));
	/* begin MoveR:Aw: */
	address1 = freeStartAddress();
