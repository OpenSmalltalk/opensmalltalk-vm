/* Automatically generated by
   ...
   from
	StackToRegisterMappingCogit VMMaker.oscog-eem.727 uuid: c4880b9d-5eff-44bc-8908-a6e831764659
 */
static char __buildInfo[] = "StackToRegisterMappingCogit VMMaker.oscog-eem.727 uuid: c4880b9d-5eff-44bc-8908-a6e831764659 " __DATE__ ;
...
genInnerPrimitiveMirrorNewWithArg(sqInt retNoffset)
{
	...
	/* begin LogicalShiftRightCq:R: */
	quickConstant9 = (fixedFieldsFieldWidth()) + (numSmallIntegerTagBits());
	genoperandoperand(LogicalShiftRightCqR, quickConstant9, instSpecReg);
	/* begin AndCq:R: */
	...
	genoperandoperand(MoveRR, TempReg, instSpecReg);
	/* begin MoveCq:R: */
	quickConstant11 = wordSize();
	genoperandoperand(MoveCqR, quickConstant11, TempReg);
	/* begin SubR:R: */
	...
	/* begin LogicalShiftLeftCq:R: */
	quickConstant12 = formatShift();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant12, TempReg);
	/* begin AddR:R: */
	genoperandoperand(AddRR, TempReg, halfHeaderReg);
	/* begin AddCq:R: */
	quickConstant6 = (wordSize()) - 1;
	genoperandoperand(AddCqR, quickConstant6, instSpecReg);
	/* begin LogicalShiftRightCq:R: */
	quickConstant13 = shiftForWord();
	genoperandoperand(LogicalShiftRightCqR, quickConstant13, instSpecReg);
	/* begin MoveCq:R: */
	genoperandoperand(MoveCqR, 0, TempReg);
	/* begin PushR: */
	genoperand(PushR, TempReg);
	...
	/* begin AddCq:R: */
	quickConstant7 = (BaseHeaderSize) / (wordSize());
	genoperandoperand(AddCqR, quickConstant7, byteSizeReg);
	/* begin LogicalShiftLeftCq:R: */
	quickConstant14 = shiftForWord();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant14, byteSizeReg);
...
genInnerPrimitiveMirrorNew(sqInt retNoffset)
{
	...
	/* begin LogicalShiftRightCq:R: */
	quickConstant7 = fixedFieldsFieldWidth();
	genoperandoperand(LogicalShiftRightCqR, quickConstant7, TempReg);
	/* begin AndCq:R: */
	quickConstant1 = formatMask();
	...
	genoperandoperand(AddRR, TempReg, byteSizeReg);
	/* begin AddCq:R: */
	quickConstant5 = (BaseHeaderSize) / (wordSize());
	genoperandoperand(AddCqR, quickConstant5, byteSizeReg);
	/* begin LogicalShiftLeftCq:R: */
	quickConstant9 = shiftForWord();
	genoperandoperand(LogicalShiftLeftCqR, quickConstant9, byteSizeReg);
	jmpTarget(skip, gLogicalShiftLeftCqR(numSlotsHalfShift(), halfHeaderReg));
	/* begin AddR:R: */
	genoperandoperand(AddRR, Arg1Reg, byteSizeReg);
	/* begin CmpCq:R: */
