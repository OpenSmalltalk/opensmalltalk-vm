...
/* This version of the code has been hacked around by tim@rowledge.org to
   suport usage within the Squeak Cog VM development system; in particular
   the pc gets saved to state->temp at each pass around the dispatch, unless
   the instruction is our special fake SWI_CogPrefetch */
