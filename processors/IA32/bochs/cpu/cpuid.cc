...
{
#if COG // COG eschews the whole SIM interface
# if BX_CPU_VENDOR_INTEL
      Bit8u *vendor_string = (Bit8u *)"GenuineIntel"; 
# else
      Bit8u *vendor_string = (Bit8u *)"AuthenticAMD"; 
# endif
# if BX_CPU_VENDOR_INTEL
      Bit8u *brand_string = (Bit8u *)"              Intel(R) Pentium(R) 4 CPU        "; 
# else
      Bit8u *brand_string = (Bit8u *)"AMD Athlon(tm) processor";
# endif
#else
