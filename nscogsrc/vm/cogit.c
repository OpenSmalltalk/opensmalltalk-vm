...
generateSendTrampolines(void)
{
	...
	dynamicSuperSendTrampolines[NumSendTrampolines - 1] = (genSendTrampolineFornumArgscalledargargarg(ceDynamicSuperSendtonumArgs, 1 + 1, trampolineNamenumArgs("ceDynSuperSend", -1), ClassReg, ReceiverResultReg, SendNumArgsReg));
