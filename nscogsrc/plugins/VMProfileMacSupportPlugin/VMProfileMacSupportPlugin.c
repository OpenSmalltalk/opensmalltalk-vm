/* Automatically generated by
   ...
   from
	VMProfileMacSupportPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "VMProfileMacSupportPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"VMProfileMacSupportPlugin VMMaker.oscog-eem.222 (i)"
#else
	"VMProfileMacSupportPlugin VMMaker.oscog-eem.222 (e)"
#endif
;
...
primitiveDLSym(void)
{
	...
	return interpreterProxy->methodReturnValue((addr == 0
		...
		: interpreterProxy->positive32BitIntegerFor(((unsigned long)addr))));
}
