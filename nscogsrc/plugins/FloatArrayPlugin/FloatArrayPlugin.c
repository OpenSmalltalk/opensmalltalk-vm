/* Automatically generated by
   ...
   from
	FloatArrayPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "FloatArrayPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FloatArrayPlugin VMMaker.oscog-eem.222 (i)"
#else
	"FloatArrayPlugin VMMaker.oscog-eem.222 (e)"
#endif
;
...
primitiveAtPut(void)
{
	...
	if (interpreterProxy->isIntegerObject(value)) {
		floatValue = ((double) (interpreterProxy->integerValueOf(value)) );
	}
	else {
