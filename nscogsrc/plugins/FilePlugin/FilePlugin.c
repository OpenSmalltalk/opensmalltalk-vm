/* Automatically generated by
   ...
   from
	FilePlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "FilePlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin VMMaker.oscog-eem.222 (i)"
#else
	"FilePlugin VMMaker.oscog-eem.222 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
primitiveFileRead(void)
{
 ...
 && (((retryCount += 1)) <= 2))) break;
	...
	if (!(interpreterProxy->failed())) {
		interpreterProxy->popthenPush(5, interpreterProxy->integerObjectOf(bytesRead / elementSize));
	}
}
...
l1:	/* end fileValueOf: */;
	...
	if (!(interpreterProxy->failed())) {
		interpreterProxy->popthenPush(5, interpreterProxy->integerObjectOf(bytesWritten / byteSize));
	}
}
