/* Automatically generated by
   ...
   from
	NewsqueakIA32ABIPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6
 */
static char __buildInfo[] = "NewsqueakIA32ABIPlugin VMMaker.oscog-eem.222 uuid: 9255d122-7216-4700-8ead-493416ce0cf6 " __DATE__ ;
...
primAlienReplace(void)
{
	...
	if (interpreterProxy->internalIsImmutable(array)) {
		return interpreterProxy->primitiveFailFor(PrimErrNoModification);
	}
	count = (stop - start) + 1;
