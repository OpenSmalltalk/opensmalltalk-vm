...
static void sqNull_initialize(void)
{
}

static void sqNull_shutdown(void)
{
}

static sqInt sqNull_setCursorARGB(sqInt cursorBitsIndex, sqInt extentX, sqInt extentY, sqInt offsetX, sqInt offsetY)
{
    return false;
}

static sqInt sqNull_forceDisplayUpdate(void)
{
    return 0;
}

static sqInt sqNull_formPrint(sqInt bitsAddr, sqInt width, sqInt height, sqInt depth,
		  double hScale, double vScale, sqInt landscapeFlag)
{
    return 0;
}

static sqInt sqNull_setFullScreen(sqInt fullScreen)
{
    return 0;
}

static sqInt sqNull_setCursor(sqInt cursorBitsIndex, sqInt offsetX, sqInt offsetY)
{
    return 0;
}

static sqInt sqNull_setCursorWithMask(sqInt cursorBitsIndex, sqInt cursorMaskIndex, sqInt offsetX, sqInt offsetY)
{
    return 0;
}

static sqInt sqNull_showDisplay(sqInt dispBitsIndex, sqInt width, sqInt height, sqInt depth,
		    sqInt affectedL, sqInt affectedR, sqInt affectedT, sqInt affectedB)
{
    return 0;
}

static sqInt sqNull_hasDisplayDepth(sqInt depth)
{
    return true;
}

static sqInt sqNull_setDisplayMode(sqInt width, sqInt height, sqInt depth, sqInt fullscreenFlag)
{
...
static char* sqNull_getWindowLabel(void)
{
    return "";
}

static sqInt sqNull_setWindowLabelOfSize(void *lblIndex, sqInt sz)
{
    return 0;
}

static sqInt sqNull_getWindowWidth(void)
{
    return currentDisplayWidth;
}

static sqInt sqNull_getWindowHeight(void)
{
    return currentDisplayHeight;
}

static sqInt sqNull_setWindowWidthHeight(sqInt w, sqInt h)
{
...
static sqInt sqNull_isWindowObscured(void)
{
    return false;
}

/* Events */
static sqInt sqNull_getNextEvent(sqInputEvent *evt)
{
    evt->type = EventTypeNone;
    return 0;
}

static sqInt sqNull_getButtonState(void)
{
    return 0;
}

static sqInt sqNull_getKeystroke(void)
{
    return 0;
}

static sqInt sqNull_mousePoint(void)
{
    return 0;
}

static sqInt sqNull_peekKeystroke(void)
{
    return 0;
}

static sqInt sqNull_processEvents(void)
{
    return 0;
}

static double sqNull_screenScaleFactor(void)
{
    return (double)screenWidth / (double)screenHeight;
}

static sqInt sqNull_screenSize(void)
{
    return screenWidth | (screenHeight << 16);
}

static sqInt sqNull_screenDepth(void)
{
    return screenDepth;
}

/* Clipboard */
static sqInt sqNull_clipboardSize(void)
{
    return 0;
}

static sqInt sqNull_clipboardReadIntoAt(sqInt count, sqInt byteArrayIndex, sqInt startIndex)
{
    return 0;
}

static sqInt sqNull_clipboardWriteFromAt(sqInt count, sqInt byteArrayIndex, sqInt startIndex)
{
    return 0;
}
